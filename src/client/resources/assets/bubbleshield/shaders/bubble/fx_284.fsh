...
// stack: deep=ridge x4 taps | mid=kaleido+warp2+scroll | rim=graze_film | flourish=echo | tex=cracked_glass
// fbm: standard x6 octaves | seed 66b612470438b241
// v8 realism: refr 0.9869+1.0769*fres/dist (cap 0.1120) | energy 0.1961+0.3429*p | flow 0.077500 c/s | soft 0.7163m
...
void main() {
    ...
    float refrAmp = min((0.9869 + 1.0769 * fresnel) / max(length(worldPos), 1.0), 0.1120);
