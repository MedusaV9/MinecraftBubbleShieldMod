...
// stack: deep=fbm x3 taps | mid=phantomecho+warp2+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0768 + 0.1418 * presence + 0.6108 * pattern + 0.1509 * (1.0 - deepTrans), 0.8056);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3220), 0.8056);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4521 + 0.5479 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
