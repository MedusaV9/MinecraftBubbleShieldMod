...
// stack: deep=fbm x3 taps | mid=phantomecho+warp2+scroll | rim=lat | flourish=shimmer | tex=foam
// fbm: turb x4 octaves | seed 112adf142086bf3f
// v8 realism: refr 0.4651+0.5566*fres/dist (cap 0.1436) | energy 0.3654+0.4183*p | flow 0.068333 c/s | soft 1.4491m
...
void main() {
    ...
    float refrAmp = min((0.4651 + 0.5566 * fresnel) / max(length(worldPos), 1.0), 0.1436);
