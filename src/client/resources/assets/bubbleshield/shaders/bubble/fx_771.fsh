...
// stack: deep=ridge x4 taps | mid=gravlens+warp1+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0438 + 0.0960 * presence + 0.5804 * pattern + 0.0924 * (1.0 - deepTrans), 0.8571);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3001), 0.8571);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3835 + 0.6165 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
