...
// stack: deep=ridge x3 taps | mid=chrome+warp1+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0507 + 0.3458 * presence + 0.4613 * pattern + 0.1070 * (1.0 - deepTrans), 0.8968);
