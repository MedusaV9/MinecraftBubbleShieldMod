...
// stack: deep=voro x3 taps | mid=deepice+warp1+pulse | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0515 + 0.3297 * presence + 0.3215 * pattern + 0.1089 * (1.0 - deepTrans), 0.8250);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2117), 0.8250);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3847 + 0.6153 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
