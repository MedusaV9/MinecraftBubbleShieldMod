...
// stack: deep=ridge x4 taps | mid=mycelia+warp2+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0448 + 0.1509 * presence + 0.4627 * pattern + 0.1599 * (1.0 - deepTrans), 0.8374);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1545), 0.8374);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4471 + 0.5529 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
