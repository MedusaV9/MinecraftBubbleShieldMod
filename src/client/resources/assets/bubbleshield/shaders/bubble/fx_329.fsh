...
// stack: deep=voro x4 taps | mid=starfield+warp1+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0737 + 0.1443 * presence + 0.4866 * pattern + 0.0978 * (1.0 - deepTrans), 0.8323);
