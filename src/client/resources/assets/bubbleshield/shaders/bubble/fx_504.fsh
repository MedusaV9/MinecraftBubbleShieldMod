...
// stack: deep=ridge x4 taps | mid=orbittrap+warp1+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0457 + 0.1935 * presence + 0.4929 * pattern + 0.1436 * (1.0 - deepTrans), 0.7968);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2793), 0.7968);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4458 + 0.5542 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
