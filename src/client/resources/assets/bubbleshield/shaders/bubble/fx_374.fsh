...
// stack: deep=caustic x4 taps | mid=shardtess+warp1+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0468 + 0.3359 * presence + 0.3953 * pattern + 0.1532 * (1.0 - deepTrans), 0.7886);
