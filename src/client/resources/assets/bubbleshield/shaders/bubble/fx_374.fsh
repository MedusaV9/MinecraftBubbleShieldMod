...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6144, 0.0, 1.0);
    ...
    deepCol += 0.5187 * dp * mix(baseCol, deepStop, 0.2933);
    deepPat += 0.5187 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 3.5465) + par * 0.1021, time);
    deepCol += 0.2690 * dp * mix(baseCol, deepStop, 0.5865);
    deepPat += 0.2690 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 4.3263) + par * 0.1532, time);
    deepCol += 0.1395 * dp * mix(baseCol, deepStop, 0.8798);
    deepPat += 0.1395 * dp;
    deepCol *= 0.5704;
    deepPat = pow(clamp(deepPat * 0.5189, 0.0, 1.0), 1.6789);
    ...
    rgb += hotStop * 0.3231 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0468 + 0.3359 * presence + 0.3953 * pattern, 0.7886);
