...
// stack: deep=caustic x4 taps | mid=shardtess+warp1+flicker | rim=graze_film | flourish=echo | tex=cracked_glass
// fbm: standard x3 octaves | seed deaf4efed92ec5d8
// v8 realism: refr 1.0269+1.5971*fres/dist (cap 0.1447) | energy 0.2030+0.3519*p | flow 0.080000 c/s | soft 1.0669m
...
void main() {
    ...
    float refrAmp = min((1.0269 + 1.5971 * fresnel) / max(length(worldPos), 1.0), 0.1447);
