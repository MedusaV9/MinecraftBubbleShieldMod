...
void main() {
    ...
    mid = clamp(mid * (0.6932 + 0.4541 * texDetail) + 0.2178 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7202 + 0.3463 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1711 * (0.5 + 0.5 * sin(time * 0.230383)));
    ...
    float alpha = vertexColor.a * min(0.3482 + 0.4759 * presence + 0.3953 * pattern + 0.1532 * (1.0 - deepTrans) + 0.1637 * emit, 0.8486);
