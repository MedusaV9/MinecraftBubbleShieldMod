...
// stack: deep=ridge x4 taps | mid=moire+curl+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0738 + 0.3444 * presence + 0.3563 * pattern + 0.1399 * (1.0 - deepTrans), 0.7925);
