...
// stack: deep=ridge x4 taps | mid=oilslick+warp1+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0490 + 0.3091 * presence + 0.4575 * pattern + 0.1462 * (1.0 - deepTrans), 0.8028);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2365), 0.8028);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5452 + 0.4548 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
