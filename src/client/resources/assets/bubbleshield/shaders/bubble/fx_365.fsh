...
// stack: deep=fbm x3 taps | mid=chrome+none+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0774 + 0.4343 * presence + 0.4688 * pattern + 0.1422 * (1.0 - deepTrans), 0.8423);
