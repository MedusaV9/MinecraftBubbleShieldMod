...
// stack: deep=fbm x4 taps | mid=spectralveil+none+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0715 + 0.1710 * presence + 0.3887 * pattern + 0.0946 * (1.0 - deepTrans), 0.7293);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2580), 0.7293);
    // [layer:v5:ghostalpha]
