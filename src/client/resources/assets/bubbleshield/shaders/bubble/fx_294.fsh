...
// stack: deep=caustic x4 taps | mid=triweave+warp2+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0732 + 0.3153 * presence + 0.4164 * pattern + 0.1358 * (1.0 - deepTrans), 0.8551);
