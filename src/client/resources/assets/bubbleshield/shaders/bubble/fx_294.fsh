...
// stack: deep=caustic x4 taps | mid=triweave+warp2+scroll | rim=graze | flourish=glint | tex=hex_lattice
// fbm: standard x4 octaves | seed fed74b933699bb4d
// v8 realism: refr 0.5207+0.4522*fres/dist (cap 0.1194) | energy 0.3084+0.4637*p | flow 0.058333 c/s | soft 0.5979m
...
void main() {
    ...
    float refrAmp = min((0.5207 + 0.4522 * fresnel) / max(length(worldPos), 1.0), 0.1194);
