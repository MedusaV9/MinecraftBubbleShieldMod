...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.012500, 0.033333) * time, time);
    deep += 0.4000 * deepField(duvBase + rimDir * 0.0732 + vec2(-0.020000, 0.053333) * time, time);
    deep += 0.1600 * deepField(duvBase + rimDir * 0.1463 + vec2(-0.027500, 0.070000) * time, time);
    deep = pow(clamp(deep * 0.6410, 0.0, 1.0), 1.2902);
