...
// stack: deep=voro x4 taps | mid=spectralveil+curl+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0638 + 0.1241 * presence + 0.4349 * pattern + 0.1184 * (1.0 - deepTrans), 0.7380);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1692), 0.7380);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4172 + 0.5828 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
