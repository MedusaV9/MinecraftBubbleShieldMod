...
// stack: deep=fbm x4 taps | mid=crystalsdf+warp1+scroll | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1930), 0.8125);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4351 + 0.5649 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
