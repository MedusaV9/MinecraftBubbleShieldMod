...
// stack: deep=voro x4 taps | mid=runecircuit+none+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0434 + 0.1773 * presence + 0.5885 * pattern + 0.0933 * (1.0 - deepTrans), 0.8586);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3060), 0.8586);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4005 + 0.5995 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
