...
// stack: deep=caustic x4 taps | mid=orbittrap+none+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0561 + 0.1726 * presence + 0.5442 * pattern + 0.1117 * (1.0 - deepTrans), 0.8269);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1734), 0.8269);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4698 + 0.5302 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
