...
// stack: deep=voro x3 taps | mid=spectralveil+curl+pulse | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0764 + 0.1080 * presence + 0.3995 * pattern + 0.0943 * (1.0 - deepTrans), 0.7227);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2152), 0.7227);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5366 + 0.4634 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
