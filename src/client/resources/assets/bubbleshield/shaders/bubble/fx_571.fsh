...
// stack: deep=ridge x4 taps | mid=gravlens+warp2+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0401 + 0.1085 * presence + 0.5171 * pattern + 0.1400 * (1.0 - deepTrans), 0.8168);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2007), 0.8168);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4302 + 0.5698 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
