...
// stack: deep=ridge x4 taps | mid=raymarchfog+warp2+pulse | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0433 + 0.2818 * presence + 0.3085 * pattern + 0.1582 * (1.0 - deepTrans), 0.8694);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1612), 0.8694);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5481 + 0.4519 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
