...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.018333, 0.032500) * time, time);
    deep += 0.5303 * deepField(duvBase + rimDir * 0.0732 + vec2(0.028333, 0.050000) * time, time);
    deep += 0.2812 * deepField(duvBase + rimDir * 0.1464 + vec2(0.038333, 0.067500) * time, time);
    deep = pow(clamp(deep * 0.5520, 0.0, 1.0), 1.3137);
