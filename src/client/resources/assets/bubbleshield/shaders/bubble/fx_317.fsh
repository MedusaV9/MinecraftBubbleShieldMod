...
void main() {
    ...
    deepCol += 0.5303 * dp * mix(baseCol, deepStop, 0.3100);
    deepPat += 0.5303 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 5.6494) + par * 0.1464, time);
    deepCol += 0.2812 * dp * mix(baseCol, deepStop, 0.6199);
    deepPat += 0.2812 * dp;
    deepCol *= 0.5675;
    deepPat = pow(clamp(deepPat * 0.5520, 0.0, 1.0), 1.3137);
    ...
    rgb += hotStop * 0.3028 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0509 + 0.2920 * presence + 0.3733 * pattern, 0.7954);
