...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7919, 0.0, 1.0);
    ...
    deepCol += 0.4194 * dp * mix(baseCol, deepStop, 0.3832);
    deepPat += 0.4194 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 3.4646) + par * 0.0969, time);
    deepCol += 0.1759 * dp * mix(baseCol, deepStop, 0.7663);
    deepPat += 0.1759 * dp;
    deepCol *= 0.7346;
    deepPat = pow(clamp(deepPat * 0.6268, 0.0, 1.0), 1.0068);
    ...
    float alpha = vertexColor.a * min(0.0450 + 0.3698 * presence + 0.4017 * pattern, 0.8531);
