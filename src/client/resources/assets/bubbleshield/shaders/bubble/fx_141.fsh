...
// stack: deep=caustic x3 taps | mid=hex+warp2+pulse | rim=graze_sparkle | flourish=swirl | tex=hex_lattice
// fbm: standard x4 octaves | seed ae59385b80956c89
// v8 realism: refr 0.7020+0.8562*fres/dist (cap 0.1089) | energy 0.3474+0.3831*p | flow 0.100833 c/s | soft 0.7677m
...
void main() {
    ...
    float refrAmp = min((0.7020 + 0.8562 * fresnel) / max(length(worldPos), 1.0), 0.1089);
