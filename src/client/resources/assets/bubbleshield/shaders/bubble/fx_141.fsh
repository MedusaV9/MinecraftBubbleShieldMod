...
void main() {
    ...
    mid = clamp(mid * (0.7097 + 0.6708 * texDetail) + 0.2781 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7481 + 0.4281 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1332 * (0.5 + 0.5 * sin(time * 0.167552)));
    ...
    float alpha = vertexColor.a * min(0.3428 + 0.5098 * presence + 0.4017 * pattern + 0.0931 * (1.0 - deepTrans) + 0.1777 * emit, 0.9131);
