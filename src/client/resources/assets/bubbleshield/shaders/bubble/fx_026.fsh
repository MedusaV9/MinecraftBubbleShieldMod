...
void main() {
    ...
    mid = clamp(mid * (0.7463 + 0.6319 * texDetail) + 0.2351 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3595), 0.0, 1.0);
    float emit = atlas.a * (0.5526 + 0.2894 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1547 * (0.5 + 0.5 * sin(time * 0.146608)));
    rgb += emit * 0.6596 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3565 + 0.3897 * presence + 0.4675 * pattern + 0.1538 * (1.0 - deepTrans) + 0.1354 * emit, 0.8930);
