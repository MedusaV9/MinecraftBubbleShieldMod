...
// stack: deep=caustic x3 taps | mid=sparkle+warp2+scroll | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0496 + 0.2497 * presence + 0.4675 * pattern + 0.1538 * (1.0 - deepTrans), 0.8330);
