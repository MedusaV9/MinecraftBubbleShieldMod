...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7290, 0.0, 1.0);
    ...
    deepCol += 0.5695 * dp * mix(baseCol, deepStop, 0.3186);
    deepPat += 0.5695 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.4486) + par * 0.1063, time);
    deepCol += 0.3243 * dp * mix(baseCol, deepStop, 0.6371);
    deepPat += 0.3243 * dp;
    deepCol *= 0.6191;
    deepPat = pow(clamp(deepPat * 0.5281, 0.0, 1.0), 1.2387);
    ...
    rgb += hotStop * 0.3130 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0496 + 0.2497 * presence + 0.4675 * pattern, 0.8330);
