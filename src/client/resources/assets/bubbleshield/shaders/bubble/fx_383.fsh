...
// stack: deep=voro x3 taps | mid=frostfern+warp1+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0503 + 0.2880 * presence + 0.3885 * pattern + 0.1120 * (1.0 - deepTrans), 0.8232);
