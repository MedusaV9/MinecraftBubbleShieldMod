...
// stack: deep=fbm x4 taps | mid=fluidink+warp2+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0772 + 0.2819 * presence + 0.4541 * pattern + 0.0983 * (1.0 - deepTrans), 0.8085);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1816), 0.8085);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4312 + 0.5688 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
