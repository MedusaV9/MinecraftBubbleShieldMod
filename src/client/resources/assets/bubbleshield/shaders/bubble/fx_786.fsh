...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.8676 + fiR.y * 0.7981)), 0.3774);
    ...
    float alpha = vertexColor.a * min(0.0772 + 0.3419 * presence + 0.4541 * pattern + 0.0983 * (1.0 - deepTrans), 0.8085);
    // [layer:v5:backface]
