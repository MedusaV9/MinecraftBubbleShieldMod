...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5869, 0.0, 1.0);
    ...
    deepCol += 0.5091 * dp * mix(baseCol, deepStop, 0.3111);
    deepPat += 0.5091 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 3.8795) + par * 0.1223, time);
    deepCol += 0.2592 * dp * mix(baseCol, deepStop, 0.6222);
    deepPat += 0.2592 * dp;
    deepCol *= 0.5571;
    deepPat = pow(clamp(deepPat * 0.5655, 0.0, 1.0), 1.0074);
    ...
    rgb += hotStop * 0.2932 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0500 + 0.2453 * presence + 0.3978 * pattern, 0.7930);
