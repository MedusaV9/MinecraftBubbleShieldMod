...
// stack: deep=voro x3 taps | mid=voronoi+none+scroll | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0500 + 0.2453 * presence + 0.3978 * pattern + 0.1044 * (1.0 - deepTrans), 0.7930);
