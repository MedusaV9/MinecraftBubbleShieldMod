...
// stack: deep=caustic x3 taps | mid=ectoplasm+none+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0633 + 0.2188 * presence + 0.5282 * pattern + 0.1336 * (1.0 - deepTrans), 0.8152);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2991), 0.8152);
    // [layer:v5:ghostalpha]
