...
// stack: deep=fbm x4 taps | mid=plasmaglobe+warp1+scroll | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0471 + 0.0988 * presence + 0.5701 * pattern + 0.1415 * (1.0 - deepTrans), 0.8075);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3304), 0.8075);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4014 + 0.5986 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
