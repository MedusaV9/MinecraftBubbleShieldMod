...
// stack: deep=fbm x4 taps | mid=plasmaglobe+warp1+scroll | rim=graze_film | flourish=glint | tex=filaments
// fbm: ridged x5 octaves | seed be1754aa05532360
// v8 realism: refr 0.4936+0.5244*fres/dist (cap 0.1442) | energy 0.3412+0.4504*p | flow 0.094167 c/s | soft 1.0994m
...
void main() {
    ...
    float refrAmp = min((0.4936 + 0.5244 * fresnel) / max(length(worldPos), 1.0), 0.1442);
