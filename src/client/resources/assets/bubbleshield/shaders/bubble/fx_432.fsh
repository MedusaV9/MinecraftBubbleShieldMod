...
// stack: deep=voro x3 taps | mid=mycelia+none+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0512 + 0.1366 * presence + 0.4916 * pattern + 0.0817 * (1.0 - deepTrans), 0.8176);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1805), 0.8176);
    // [layer:v5:ghostalpha]
