...
// stack: deep=fbm x4 taps | mid=spectralveil+warp2+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0678 + 0.1536 * presence + 0.4549 * pattern + 0.1338 * (1.0 - deepTrans), 0.7826);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1590), 0.7826);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5498 + 0.4502 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
