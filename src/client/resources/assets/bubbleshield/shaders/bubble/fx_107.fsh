...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8168, 0.0, 1.0);
    ...
    deepCol += 0.4318 * dp * mix(baseCol, deepStop, 0.3857);
    deepPat += 0.4318 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 4.7653) + par * 0.1242, time);
    deepCol += 0.1865 * dp * mix(baseCol, deepStop, 0.7714);
    deepPat += 0.1865 * dp;
    deepCol *= 0.6654;
    deepPat = pow(clamp(deepPat * 0.6179, 0.0, 1.0), 1.4075);
    ...
    float alpha = vertexColor.a * min(0.0671 + 0.3112 * presence + 0.3732 * pattern, 0.7892);
