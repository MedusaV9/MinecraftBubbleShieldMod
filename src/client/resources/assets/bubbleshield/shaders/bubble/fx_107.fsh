...
// stack: deep=fbm x3 taps | mid=truchet+warp2+pulse | rim=lat | flourish=shimmer | tex=runes
// fbm: standard x3 octaves | seed eb2eb5d3c3d0e042
// v8 realism: refr 0.7081+0.8101*fres/dist (cap 0.1372) | energy 0.4169+0.4496*p | flow 0.109167 c/s | soft 0.8201m
...
void main() {
    ...
    float refrAmp = min((0.7081 + 0.8101 * fresnel) / max(length(worldPos), 1.0), 0.1372);
