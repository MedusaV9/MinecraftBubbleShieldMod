...
void main() {
    ...
    mid = clamp(mid * (0.6699 + 0.6026 * texDetail) + 0.2594 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7305 + 0.3766 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1320 * (0.5 + 0.5 * sin(time * 0.204204)));
    rgb += emit * 0.6866 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4083 + 0.4512 * presence + 0.3732 * pattern + 0.0957 * (1.0 - deepTrans) + 0.1899 * emit, 0.8492);
