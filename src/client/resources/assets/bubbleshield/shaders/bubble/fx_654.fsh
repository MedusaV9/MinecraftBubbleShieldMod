...
// stack: deep=caustic x3 taps | mid=deepice+warp1+scroll | rim=lat | flourish=swirl | tex=cracked_glass
// fbm: turb x5 octaves | seed 82c7af39121ea5ac
// v8 realism: refr 1.0065+1.6646*fres/dist (cap 0.1236) | energy 0.2515+0.4183*p | flow 0.102500 c/s | soft 0.5112m
...
void main() {
    ...
    float refrAmp = min((1.0065 + 1.6646 * fresnel) / max(length(worldPos), 1.0), 0.1236);
