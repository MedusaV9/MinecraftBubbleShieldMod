...
// stack: deep=caustic x3 taps | mid=deepice+warp1+scroll | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0467 + 0.3625 * presence + 0.4030 * pattern + 0.1229 * (1.0 - deepTrans), 0.8829);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1576), 0.8829);
    // [layer:v5:ghostalpha]
