...
// stack: deep=fbm x3 taps | mid=phantomecho+warp2+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0729 + 0.0928 * presence + 0.5267 * pattern + 0.1225 * (1.0 - deepTrans), 0.8113);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3147), 0.8113);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5394 + 0.4606 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
