...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8159, 0.0, 1.0);
    ...
    deepCol += 0.3944 * dp * mix(baseCol, deepStop, 0.3414);
    deepPat += 0.3944 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 3.4194) + par * 0.1187, time);
    deepCol += 0.1556 * dp * mix(baseCol, deepStop, 0.6828);
    deepPat += 0.1556 * dp;
    deepCol *= 0.7154;
    deepPat = pow(clamp(deepPat * 0.6452, 0.0, 1.0), 1.5471);
    ...
    rgb += hotStop * 0.3267 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0538 + 0.3125 * presence + 0.4070 * pattern, 0.8341);
