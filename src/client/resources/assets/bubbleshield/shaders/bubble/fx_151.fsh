...
// stack: deep=fbm x3 taps | mid=interference+warp2+scroll | rim=graze_film | flourish=echo | tex=caustic_web
// fbm: standard x5 octaves | seed 4447d74efd4a59bd
// v8 realism: refr 0.9453+1.5973*fres/dist (cap 0.1340) | energy 0.2762+0.3852*p | flow 0.111667 c/s | soft 0.8363m
...
void main() {
    ...
    float refrAmp = min((0.9453 + 1.5973 * fresnel) / max(length(worldPos), 1.0), 0.1340);
