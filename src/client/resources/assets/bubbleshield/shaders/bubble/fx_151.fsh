...
// stack: deep=fbm x3 taps | mid=interference+warp2+scroll | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0538 + 0.3125 * presence + 0.4070 * pattern + 0.0928 * (1.0 - deepTrans), 0.8341);
