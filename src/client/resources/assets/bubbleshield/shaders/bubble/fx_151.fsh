...
void main() {
    ...
    mid = clamp(mid * (0.7069 + 0.5162 * texDetail) + 0.2014 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6028 + 0.4712 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1292 * (0.5 + 0.5 * sin(time * 0.293215)));
    rgb += emit * 0.8431 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3689 + 0.4525 * presence + 0.4070 * pattern + 0.0928 * (1.0 - deepTrans) + 0.1298 * emit, 0.8941);
