...
void main() {
    ...
    deepCol += 0.4925 * dp * mix(baseCol, deepStop, 0.4199);
    deepPat += 0.4925 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 3.5869) + par * 0.1519, time);
    deepCol += 0.2426 * dp * mix(baseCol, deepStop, 0.8399);
    deepPat += 0.2426 * dp;
    deepCol *= 0.5669;
    deepPat = pow(clamp(deepPat * 0.5763, 0.0, 1.0), 1.5148);
    ...
    rgb += hotStop * 0.2071 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0574 + 0.3631 * presence + 0.4017 * pattern, 0.8340);
