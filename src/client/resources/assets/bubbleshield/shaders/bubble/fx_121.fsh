...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.046667, 0.032500) * time, time);
    deep += 0.4925 * deepField(duvBase + rimDir * 0.0760 + vec2(0.071667, 0.050000) * time, time);
    deep = pow(clamp(deep * 0.6700, 0.0, 1.0), 1.5148);
