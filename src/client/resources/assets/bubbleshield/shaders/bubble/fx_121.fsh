...
// stack: deep=voro x3 taps | mid=rings+none+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0574 + 0.3631 * presence + 0.4017 * pattern + 0.1182 * (1.0 - deepTrans), 0.8340);
