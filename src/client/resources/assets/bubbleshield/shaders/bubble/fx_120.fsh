...
// stack: deep=ridge x3 taps | mid=plasma+warp1+scroll | rim=graze_sparkle | flourish=echo | tex=nebula
// fbm: standard x6 octaves | seed f77ebdac6b6f53d7
// v8 realism: refr 0.6356+0.7505*fres/dist (cap 0.1518) | energy 0.3084+0.4000*p | flow 0.055833 c/s | soft 0.8546m
...
void main() {
    ...
    float refrAmp = min((0.6356 + 0.7505 * fresnel) / max(length(worldPos), 1.0), 0.1518);
