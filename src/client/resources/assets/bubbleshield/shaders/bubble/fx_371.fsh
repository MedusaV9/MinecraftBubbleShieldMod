...
// stack: deep=ridge x4 taps | mid=hologrid+warp2+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0469 + 0.1066 * presence + 0.5161 * pattern + 0.0978 * (1.0 - deepTrans), 0.8343);
