...
// stack: deep=fbm x4 taps | mid=runecircuit+warp2+flicker | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0622 + 0.1656 * presence + 0.5884 * pattern + 0.1314 * (1.0 - deepTrans), 0.8511);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2700), 0.8511);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4842 + 0.5158 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
