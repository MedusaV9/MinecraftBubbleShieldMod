...
// stack: deep=ridge x3 taps | mid=interference+warp2+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0526 + 0.2629 * presence + 0.4817 * pattern + 0.0844 * (1.0 - deepTrans), 0.8598);
