...
// stack: deep=ridge x3 taps | mid=interference+warp2+pulse | rim=graze | flourish=shimmer | tex=caustic_web
// fbm: standard x6 octaves | seed 0d3198bb253f7902
// v8 realism: refr 0.8755+0.9974*fres/dist (cap 0.1219) | energy 0.1992+0.4117*p | flow 0.050833 c/s | soft 0.9772m
...
void main() {
    ...
    float refrAmp = min((0.8755 + 0.9974 * fresnel) / max(length(worldPos), 1.0), 0.1219);
