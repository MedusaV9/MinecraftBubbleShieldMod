...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8330, 0.0, 1.0);
    ...
    deepCol += 0.5208 * dp * mix(baseCol, deepStop, 0.3151);
    deepPat += 0.5208 * dp;
    dp = deepField(rotA(spinAxis, time * 0.089012) * (sdir * 4.8792) + par * 0.1545, time);
    deepCol += 0.2712 * dp * mix(baseCol, deepStop, 0.6301);
    deepPat += 0.2712 * dp;
    deepCol *= 0.7164;
    deepPat = pow(clamp(deepPat * 0.5580, 0.0, 1.0), 1.4333);
    ...
    rgb += hotStop * 0.2748 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0526 + 0.2629 * presence + 0.4817 * pattern, 0.8598);
