...
void main() {
    ...
    mid = clamp(mid * (0.6804 + 0.5983 * texDetail) + 0.3294 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7742 + 0.4422 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1235 * (0.5 + 0.5 * sin(time * 0.104720)));
    rgb += emit * 0.7275 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3653 + 0.4029 * presence + 0.4817 * pattern + 0.0844 * (1.0 - deepTrans) + 0.2078 * emit, 0.9198);
