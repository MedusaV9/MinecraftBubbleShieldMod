...
// stack: deep=fbm x4 taps | mid=holoparallax+warp1+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0474 + 0.1050 * presence + 0.4846 * pattern + 0.1031 * (1.0 - deepTrans), 0.8179);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3274), 0.8179);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3955 + 0.6045 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
