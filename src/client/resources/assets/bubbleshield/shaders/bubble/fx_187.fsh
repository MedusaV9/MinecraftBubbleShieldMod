...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6919, 0.0, 1.0);
    ...
    deepCol += 0.3879 * dp * mix(baseCol, deepStop, 0.2657);
    deepPat += 0.3879 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.4199) + par * 0.0644, time);
    deepCol += 0.1505 * dp * mix(baseCol, deepStop, 0.5313);
    deepPat += 0.1505 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 6.7943) + par * 0.0965, time);
    deepCol += 0.0584 * dp * mix(baseCol, deepStop, 0.7970);
    deepPat += 0.0584 * dp;
    deepCol *= 0.8038;
    deepPat = pow(clamp(deepPat * 0.6263, 0.0, 1.0), 1.3024);
    ...
    rgb += hotStop * 0.3434 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0712 + 0.3560 * presence + 0.4987 * pattern, 0.8187);
