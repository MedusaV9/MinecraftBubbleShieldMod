...
void main() {
    ...
    mid = clamp(mid * (0.7417 + 0.6536 * texDetail) + 0.2158 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7255 + 0.2767 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1388 * (0.5 + 0.5 * sin(time * 0.298451)));
    rgb += emit * 0.9663 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4204 + 0.4960 * presence + 0.4987 * pattern + 0.1060 * (1.0 - deepTrans) + 0.2191 * emit, 0.8787);
