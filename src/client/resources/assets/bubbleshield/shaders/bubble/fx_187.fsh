...
void main() {
    ...
    deep += 0.3879 * deepField(duvBase + rimDir * 0.0322 + vec2(-0.066667, 0.060000) * time, time);
    deep += 0.1505 * deepField(duvBase + rimDir * 0.0644 + vec2(-0.091667, 0.080000) * time, time);
    deep += 0.0584 * deepField(duvBase + rimDir * 0.0965 + vec2(-0.115000, 0.100000) * time, time);
    deep = pow(clamp(deep * 0.6263, 0.0, 1.0), 1.3024);
