...
// stack: deep=ridge x4 taps | mid=holoparallax+curl+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0430 + 0.1027 * presence + 0.6008 * pattern + 0.1101 * (1.0 - deepTrans), 0.8111);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3315), 0.8111);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4566 + 0.5434 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
