...
void main() {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        hpAcc += (hpGrid * 0.5385 + hpScan * 0.1050) * (1.0 - fi * 0.1744);
    }
    ...
    float mid = clamp(hpAcc * hpFlick + hpSync * 0.5175, 0.0, 1.25);
    ...
    float flourish = 0.2423 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
