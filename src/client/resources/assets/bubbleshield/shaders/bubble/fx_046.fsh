...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8001, 0.0, 1.0);
    ...
    deepCol += 0.4150 * dp * mix(baseCol, deepStop, 0.3038);
    deepPat += 0.4150 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 6.0247) + par * 0.1546, time);
    deepCol += 0.1722 * dp * mix(baseCol, deepStop, 0.6076);
    deepPat += 0.1722 * dp;
    deepCol *= 0.6678;
    deepPat = pow(clamp(deepPat * 0.6301, 0.0, 1.0), 1.1397);
    ...
    rgb += hotStop * 0.1983 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0545 + 0.3211 * presence + 0.4203 * pattern, 0.8085);
