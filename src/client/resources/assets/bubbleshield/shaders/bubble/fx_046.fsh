...
// stack: deep=fbm x3 taps | mid=hex+curl+rotate | rim=graze_film | flourish=echo | tex=hex_lattice
// fbm: standard x6 octaves | seed c578367999857b45
// v8 realism: refr 0.7363+0.8835*fres/dist (cap 0.1416) | energy 0.3529+0.4177*p | flow 0.083333 c/s | soft 0.9744m
...
void main() {
    ...
    float refrAmp = min((0.7363 + 0.8835 * fresnel) / max(length(worldPos), 1.0), 0.1416);
