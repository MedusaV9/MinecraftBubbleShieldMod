...
// stack: deep=fbm x3 taps | mid=hex+curl+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0545 + 0.3211 * presence + 0.4203 * pattern + 0.0923 * (1.0 - deepTrans), 0.8085);
