...
// stack: deep=fbm x3 taps | mid=waves+curl+flicker | rim=graze_sparkle | flourish=swirl | tex=caustic_web
// fbm: turb x5 octaves | seed bd6cbd6345d9b3cf
// v8 realism: refr 0.7673+1.1281*fres/dist (cap 0.1131) | energy 0.2315+0.4100*p | flow 0.115833 c/s | soft 0.8518m
...
void main() {
    ...
    float refrAmp = min((0.7673 + 1.1281 * fresnel) / max(length(worldPos), 1.0), 0.1131);
