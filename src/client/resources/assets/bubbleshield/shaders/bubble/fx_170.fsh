...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8318, 0.0, 1.0);
    ...
    deepCol += 0.5578 * dp * mix(baseCol, deepStop, 0.4216);
    deepPat += 0.5578 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 3.6336) + par * 0.1109, time);
    deepCol += 0.3112 * dp * mix(baseCol, deepStop, 0.8433);
    deepPat += 0.3112 * dp;
    deepCol *= 0.6532;
    deepPat = pow(clamp(deepPat * 0.5351, 0.0, 1.0), 1.2299);
    ...
    rgb += hotStop * 0.3144 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0624 + 0.2551 * presence + 0.4035 * pattern, 0.8153);
