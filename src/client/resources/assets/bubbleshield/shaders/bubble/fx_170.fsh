...
// stack: deep=fbm x3 taps | mid=waves+curl+flicker | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0624 + 0.2551 * presence + 0.4035 * pattern + 0.1233 * (1.0 - deepTrans), 0.8153);
