...
void main() {
    ...
    float flourish = 0.2729 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
    ...
    float alpha = vertexColor.a * min(0.0563 + 0.3132 * presence + 0.4015 * pattern + 0.1288 * (1.0 - deepTrans), 0.7848);
    // [layer:v5:backface]
