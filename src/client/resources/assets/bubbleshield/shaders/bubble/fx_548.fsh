...
// stack: deep=fbm x4 taps | mid=aethersmoke+curl+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0563 + 0.2532 * presence + 0.4015 * pattern + 0.1288 * (1.0 - deepTrans), 0.7848);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2858), 0.7848);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4748 + 0.5252 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
