...
void main() {
    ...
    mid = clamp(mid * (0.6974 + 0.4676 * texDetail) + 0.3096 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7797 + 0.3423 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1560 * (0.5 + 0.5 * sin(time * 0.120428)));
    ...
    float alpha = vertexColor.a * min(0.4014 + 0.4991 * presence + 0.4228 * pattern + 0.1160 * (1.0 - deepTrans) + 0.2003 * emit, 0.8406);
