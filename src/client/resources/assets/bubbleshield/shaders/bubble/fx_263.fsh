...
// stack: deep=voro x3 taps | mid=interference+curl+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0648 + 0.3591 * presence + 0.4228 * pattern + 0.1160 * (1.0 - deepTrans), 0.7806);
