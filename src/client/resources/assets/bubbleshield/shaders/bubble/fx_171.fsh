...
// stack: deep=caustic x4 taps | mid=arcs+warp2+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0750 + 0.2420 * presence + 0.3617 * pattern + 0.1056 * (1.0 - deepTrans), 0.8472);
