...
// stack: deep=caustic x4 taps | mid=arcs+warp2+rotate | rim=graze | flourish=swirl | tex=filaments
// fbm: standard x5 octaves | seed bc3f39bcf395dcd8
// v8 realism: refr 0.5456+0.4747*fres/dist (cap 0.1196) | energy 0.3287+0.4866*p | flow 0.083333 c/s | soft 0.9872m
...
void main() {
    ...
    float refrAmp = min((0.5456 + 0.4747 * fresnel) / max(length(worldPos), 1.0), 0.1196);
