...
// stack: deep=fbm x3 taps | mid=shardtess+warp1+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0630 + 0.2731 * presence + 0.3338 * pattern + 0.1172 * (1.0 - deepTrans), 0.8342);
