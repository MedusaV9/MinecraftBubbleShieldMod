...
// stack: deep=fbm x3 taps | mid=shardtess+warp1+pulse | rim=graze | flourish=shimmer | tex=cracked_glass
// fbm: ridged x5 octaves | seed dc251232f71d6bdb
// v8 realism: refr 0.7612+0.9577*fres/dist (cap 0.1427) | energy 0.2232+0.4539*p | flow 0.056667 c/s | soft 0.8100m
...
void main() {
    ...
    float refrAmp = min((0.7612 + 0.9577 * fresnel) / max(length(worldPos), 1.0), 0.1427);
