...
// stack: deep=fbm x4 taps | mid=portalvoid+curl+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0750 + 0.1947 * presence + 0.4834 * pattern + 0.1189 * (1.0 - deepTrans), 0.8293);
