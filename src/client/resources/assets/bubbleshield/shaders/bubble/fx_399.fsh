...
// v8 realism: refr 0.2489+0.2096*fres/dist (cap 0.1392) | energy 0.5170+0.4045*p | flow 0.063333 c/s | soft 0.6178m
...
void main() {
    ...
    float refrAmp = min((0.2489 + 0.2096 * fresnel) / max(length(worldPos), 1.0), 0.1392);
