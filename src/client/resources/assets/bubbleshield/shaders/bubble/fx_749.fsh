...
// stack: deep=caustic x4 taps | mid=stainedglass+warp1+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0727 + 0.3084 * presence + 0.4207 * pattern + 0.1093 * (1.0 - deepTrans), 0.8819);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2111), 0.8819);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4387 + 0.5613 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
