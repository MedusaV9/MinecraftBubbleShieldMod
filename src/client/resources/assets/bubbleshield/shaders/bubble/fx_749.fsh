...
// stack: deep=caustic x4 taps | mid=stainedglass+warp1+pulse | rim=graze_sparkle | flourish=echo | tex=worley_cells
// fbm: standard x4 octaves | seed 5e7d5885281c7877
// v8 realism: refr 0.9988+1.6744*fres/dist (cap 0.1029) | energy 0.2768+0.3581*p | flow 0.102500 c/s | soft 0.6554m
...
void main() {
    ...
    float refrAmp = min((0.9988 + 1.6744 * fresnel) / max(length(worldPos), 1.0), 0.1029);
