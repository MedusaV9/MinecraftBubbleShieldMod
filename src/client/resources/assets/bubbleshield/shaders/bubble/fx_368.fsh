...
// stack: deep=fbm x4 taps | mid=galaxyswirl+curl+scroll | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0764 + 0.1941 * presence + 0.4693 * pattern + 0.1271 * (1.0 - deepTrans), 0.7864);
