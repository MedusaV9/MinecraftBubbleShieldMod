...
void main() {
    ...
    mid = clamp(mid * (0.7374 + 0.6103 * texDetail) + 0.2848 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3652), 0.0, 1.0);
    float emit = atlas.a * (0.6534 + 0.3003 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1113 * (0.5 + 0.5 * sin(time * 0.146608)));
    ...
    float alpha = vertexColor.a * min(0.3615 + 0.3341 * presence + 0.4693 * pattern + 0.1271 * (1.0 - deepTrans) + 0.1426 * emit, 0.8464);
