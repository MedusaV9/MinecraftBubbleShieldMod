...
// stack: deep=ridge x4 taps | mid=triweave+curl+flicker | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0520 + 0.2887 * presence + 0.3224 * pattern + 0.1068 * (1.0 - deepTrans), 0.8129);
