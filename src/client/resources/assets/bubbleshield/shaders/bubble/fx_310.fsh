...
// stack: deep=ridge x4 taps | mid=triweave+curl+flicker | rim=graze_sparkle | flourish=glint | tex=hex_lattice
// fbm: ridged x3 octaves | seed 67c5f58c3cef7a35
// v8 realism: refr 0.6635+0.6563*fres/dist (cap 0.1050) | energy 0.3963+0.4816*p | flow 0.081667 c/s | soft 0.6187m
...
void main() {
    ...
    float refrAmp = min((0.6635 + 0.6563 * fresnel) / max(length(worldPos), 1.0), 0.1050);
