...
void main() {
    ...
    mid = clamp(mid * (0.6727 + 0.7049 * texDetail) + 0.2641 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4977), 0.0, 1.0);
    float emit = atlas.a * (0.6222 + 0.3580 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0990 * (0.5 + 0.5 * sin(time * 0.209440)));
    ...
    float alpha = vertexColor.a * min(0.3944 + 0.4586 * presence + 0.4913 * pattern + 0.1239 * (1.0 - deepTrans) + 0.1485 * emit, 0.9090);
