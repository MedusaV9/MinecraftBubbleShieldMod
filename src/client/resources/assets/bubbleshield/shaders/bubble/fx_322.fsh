...
// stack: deep=voro x4 taps | mid=curlsmoke+warp2+flicker | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0685 + 0.2729 * presence + 0.3269 * pattern + 0.1451 * (1.0 - deepTrans), 0.8307);
