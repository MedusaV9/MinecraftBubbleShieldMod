...
// stack: deep=ridge x4 taps | mid=stainedglass+none+flicker | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0784 + 0.3073 * presence + 0.4606 * pattern + 0.1426 * (1.0 - deepTrans), 0.8430);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2142), 0.8430);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4082 + 0.5918 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
