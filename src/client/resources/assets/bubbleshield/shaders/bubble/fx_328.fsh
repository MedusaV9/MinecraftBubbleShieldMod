...
void main() {
    ...
    mid = clamp(mid * (0.7075 + 0.6469 * texDetail) + 0.3045 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6641 + 0.3538 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1259 * (0.5 + 0.5 * sin(time * 0.130900)));
    rgb += emit * 0.7578 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3490 + 0.4603 * presence + 0.4265 * pattern + 0.1511 * (1.0 - deepTrans) + 0.1348 * emit, 0.8652);
