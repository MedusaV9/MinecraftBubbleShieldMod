...
// stack: deep=ridge x3 taps | mid=aethersmoke+warp2+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0731 + 0.3329 * presence + 0.4309 * pattern + 0.1159 * (1.0 - deepTrans), 0.8410);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1955), 0.8410);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4267 + 0.5733 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
