...
// stack: deep=ridge x4 taps | mid=fluidink+curl+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0510 + 0.2458 * presence + 0.4564 * pattern + 0.1031 * (1.0 - deepTrans), 0.8044);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3490), 0.8044);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4629 + 0.5371 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
