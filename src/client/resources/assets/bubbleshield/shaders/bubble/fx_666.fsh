...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.6756 + fiR.y * 0.4830)), 0.3298);
    ...
    float alpha = vertexColor.a * min(0.0510 + 0.3058 * presence + 0.4564 * pattern + 0.1031 * (1.0 - deepTrans), 0.8044);
    // [layer:v5:backface]
