...
// stack: deep=fbm x4 taps | mid=aethersmoke+warp2+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0564 + 0.2069 * presence + 0.3355 * pattern + 0.1334 * (1.0 - deepTrans), 0.8214);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1519), 0.8214);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4074 + 0.5926 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
