...
void main() {
    ...
    float flourish = 0.2514 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
    ...
    float alpha = vertexColor.a * min(0.0564 + 0.2669 * presence + 0.3355 * pattern + 0.1334 * (1.0 - deepTrans), 0.8214);
    // [layer:v5:backface]
