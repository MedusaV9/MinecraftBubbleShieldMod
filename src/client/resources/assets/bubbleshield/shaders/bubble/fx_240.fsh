...
// stack: deep=ridge x3 taps | mid=plasma+warp1+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0488 + 0.3115 * presence + 0.3355 * pattern + 0.0808 * (1.0 - deepTrans), 0.8397);
