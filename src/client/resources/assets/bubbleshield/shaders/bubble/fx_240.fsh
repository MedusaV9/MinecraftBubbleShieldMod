...
// stack: deep=ridge x3 taps | mid=plasma+warp1+rotate | rim=graze_film | flourish=echo | tex=nebula
// fbm: standard x5 octaves | seed e75e62cf458fb53c
// v8 realism: refr 0.7088+0.8127*fres/dist (cap 0.1340) | energy 0.4200+0.4049*p | flow 0.050000 c/s | soft 0.8106m
...
void main() {
    ...
    float refrAmp = min((0.7088 + 0.8127 * fresnel) / max(length(worldPos), 1.0), 0.1340);
