...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8433, 0.0, 1.0);
    ...
    deepCol += 0.3955 * dp * mix(baseCol, deepStop, 0.2730);
    deepPat += 0.3955 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.8803) + par * 0.1335, time);
    deepCol += 0.1564 * dp * mix(baseCol, deepStop, 0.5460);
    deepPat += 0.1564 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 5.8295) + par * 0.2002, time);
    deepCol += 0.0619 * dp * mix(baseCol, deepStop, 0.8190);
    deepPat += 0.0619 * dp;
    deepCol *= 0.6763;
    deepPat = pow(clamp(deepPat * 0.6196, 0.0, 1.0), 1.5171);
    ...
    float alpha = vertexColor.a * min(0.0669 + 0.3497 * presence + 0.3803 * pattern, 0.8390);
