...
void main() {
    ...
    mid = clamp(mid * (0.7407 + 0.6031 * texDetail) + 0.3313 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4933), 0.0, 1.0);
    float emit = atlas.a * (0.6612 + 0.3909 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1578 * (0.5 + 0.5 * sin(time * 0.099484)));
    ...
    float alpha = vertexColor.a * min(0.4076 + 0.4897 * presence + 0.3803 * pattern + 0.1535 * (1.0 - deepTrans) + 0.1907 * emit, 0.8990);
