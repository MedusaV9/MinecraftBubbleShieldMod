...
// stack: deep=fbm x4 taps | mid=waves+warp1+rotate | rim=lat | flourish=swirl | tex=caustic_web
// fbm: standard x4 octaves | seed 7459a17a6f6fa4da
// v8 realism: refr 0.8920+1.2116*fres/dist (cap 0.1374) | energy 0.1926+0.3472*p | flow 0.073333 c/s | soft 0.7461m
...
void main() {
    ...
    float refrAmp = min((0.8920 + 1.2116 * fresnel) / max(length(worldPos), 1.0), 0.1374);
