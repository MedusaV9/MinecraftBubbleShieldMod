...
// stack: deep=fbm x4 taps | mid=waves+warp1+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0669 + 0.3497 * presence + 0.3803 * pattern + 0.1535 * (1.0 - deepTrans), 0.8390);
