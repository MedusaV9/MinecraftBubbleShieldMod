...
void main() {
    ...
    mid = clamp(mid * (0.7411 + 0.5716 * texDetail) + 0.3323 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4531), 0.0, 1.0);
    float emit = atlas.a * (0.5775 + 0.3671 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0923 * (0.5 + 0.5 * sin(time * 0.235619)));
    rgb += emit * 0.7419 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4362 + 0.5347 * presence + 0.3231 * pattern + 0.1283 * (1.0 - deepTrans) + 0.1905 * emit, 0.9075);
