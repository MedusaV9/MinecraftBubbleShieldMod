...
// stack: deep=ridge x4 taps | mid=voronoi+warp2+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0726 + 0.2898 * presence + 0.4967 * pattern + 0.1257 * (1.0 - deepTrans), 0.8074);
