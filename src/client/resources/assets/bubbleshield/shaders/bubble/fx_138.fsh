...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6368, 0.0, 1.0);
    ...
    deepCol += 0.4689 * dp * mix(baseCol, deepStop, 0.1906);
    deepPat += 0.4689 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 4.1960) + par * 0.1224, time);
    deepCol += 0.2199 * dp * mix(baseCol, deepStop, 0.3811);
    deepPat += 0.2199 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 5.1157) + par * 0.1836, time);
    deepCol += 0.1031 * dp * mix(baseCol, deepStop, 0.5717);
    deepPat += 0.1031 * dp;
    deepCol *= 0.6176;
    deepPat = pow(clamp(deepPat * 0.5581, 0.0, 1.0), 1.1887);
    ...
    rgb += hotStop * 0.1867 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0726 + 0.2898 * presence + 0.4967 * pattern, 0.8074);
