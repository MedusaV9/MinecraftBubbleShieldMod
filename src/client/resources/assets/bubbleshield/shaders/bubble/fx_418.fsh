...
// stack: deep=caustic x4 taps | mid=volumecloud+warp2+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0650 + 0.3742 * presence + 0.3544 * pattern + 0.1464 * (1.0 - deepTrans), 0.8742);
