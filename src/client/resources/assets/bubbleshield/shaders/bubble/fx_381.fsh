...
// stack: deep=caustic x4 taps | mid=galaxyswirl+warp1+flicker | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0515 + 0.1868 * presence + 0.5321 * pattern + 0.0925 * (1.0 - deepTrans), 0.8083);
