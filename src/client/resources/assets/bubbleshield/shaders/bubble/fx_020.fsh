...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6335, 0.0, 1.0);
    ...
    deepCol += 0.4069 * dp * mix(baseCol, deepStop, 0.4074);
    deepPat += 0.4069 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 4.8944) + par * 0.0852, time);
    deepCol += 0.1655 * dp * mix(baseCol, deepStop, 0.8149);
    deepPat += 0.1655 * dp;
    deepCol *= 0.7211;
    deepPat = pow(clamp(deepPat * 0.6360, 0.0, 1.0), 1.3115);
    ...
    rgb += hotStop * 0.2950 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0605 + 0.3005 * presence + 0.4179 * pattern, 0.8568);
