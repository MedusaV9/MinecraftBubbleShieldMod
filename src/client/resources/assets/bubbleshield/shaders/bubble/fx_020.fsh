...
// stack: deep=caustic x3 taps | mid=starfield+warp2+pulse | rim=graze_sparkle | flourish=echo | tex=starfield
// fbm: ridged x5 octaves | seed 769b264f3573d769
// v8 realism: refr 0.3364+0.4537*fres/dist (cap 0.1582) | energy 0.4357+0.3909*p | flow 0.109167 c/s | soft 0.7995m
...
void main() {
    ...
    float refrAmp = min((0.3364 + 0.4537 * fresnel) / max(length(worldPos), 1.0), 0.1582);
