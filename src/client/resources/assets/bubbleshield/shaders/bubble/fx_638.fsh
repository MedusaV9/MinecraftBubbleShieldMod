...
// stack: deep=fbm x4 taps | mid=ectoplasm+curl+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0681 + 0.1862 * presence + 0.5037 * pattern + 0.1301 * (1.0 - deepTrans), 0.8002);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2925), 0.8002);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3905 + 0.6095 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
