...
void main() {
    ...
    mid = clamp(mid * (0.6204 + 0.7477 * texDetail) + 0.3063 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6202 + 0.4371 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1243 * (0.5 + 0.5 * sin(time * 0.130900)));
    rgb += emit * 0.9815 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4044 + 0.4879 * presence + 0.3239 * pattern + 0.0908 * (1.0 - deepTrans) + 0.1450 * emit, 0.9077);
