...
// stack: deep=caustic x4 taps | mid=voronoi+warp1+flicker | rim=graze | flourish=glint | tex=worley_cells
// fbm: standard x6 octaves | seed 80589eb85b1978c5
// v8 realism: refr 0.5296+0.5403*fres/dist (cap 0.1515) | energy 0.4181+0.5062*p | flow 0.115000 c/s | soft 0.5427m
...
void main() {
    ...
    float refrAmp = min((0.5296 + 0.5403 * fresnel) / max(length(worldPos), 1.0), 0.1515);
