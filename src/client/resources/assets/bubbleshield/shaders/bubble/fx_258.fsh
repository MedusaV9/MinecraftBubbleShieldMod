...
// stack: deep=caustic x4 taps | mid=voronoi+warp1+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0658 + 0.3479 * presence + 0.3239 * pattern + 0.0908 * (1.0 - deepTrans), 0.8477);
