...
// stack: deep=caustic x3 taps | mid=lavaflow+none+flicker | rim=graze_film | flourish=glint | tex=cracked_glass
// fbm: standard x6 octaves | seed acf064b968c2f66e
// v8 realism: refr 0.2531+0.3620*fres/dist (cap 0.1504) | energy 0.4526+0.4247*p | flow 0.110833 c/s | soft 0.5316m
...
void main() {
    ...
    float refrAmp = min((0.2531 + 0.3620 * fresnel) / max(length(worldPos), 1.0), 0.1504);
