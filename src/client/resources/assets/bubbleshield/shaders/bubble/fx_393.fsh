...
void main() {
    ...
    mid = clamp(mid * (0.7207 + 0.6882 * texDetail) + 0.3069 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6784 + 0.3078 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1785 * (0.5 + 0.5 * sin(time * 0.125664)));
    rgb += emit * 0.8870 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4089 + 0.5554 * presence + 0.4323 * pattern + 0.0925 * (1.0 - deepTrans) + 0.2175 * emit, 0.9467);
