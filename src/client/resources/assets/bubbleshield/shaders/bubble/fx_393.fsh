...
// stack: deep=caustic x3 taps | mid=lavaflow+none+flicker | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0526 + 0.4154 * presence + 0.4323 * pattern + 0.0925 * (1.0 - deepTrans), 0.8921);
