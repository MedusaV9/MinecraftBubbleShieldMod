...
// stack: deep=ridge x3 taps | mid=deepice+curl+rotate | rim=graze_sparkle | flourish=shimmer | tex=cracked_glass
// fbm: turb x3 octaves | seed af2f46f8b98e939c
// v8 realism: refr 0.9089+1.4766*fres/dist (cap 0.1149) | energy 0.2683+0.4696*p | flow 0.114167 c/s | soft 0.9555m
...
void main() {
    ...
    float refrAmp = min((0.9089 + 1.4766 * fresnel) / max(length(worldPos), 1.0), 0.1149);
