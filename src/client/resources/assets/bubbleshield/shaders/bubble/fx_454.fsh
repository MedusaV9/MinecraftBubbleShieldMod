...
// stack: deep=ridge x3 taps | mid=deepice+curl+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0453 + 0.3628 * presence + 0.4234 * pattern + 0.1401 * (1.0 - deepTrans), 0.8872);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3202), 0.8872);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4309 + 0.5691 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
