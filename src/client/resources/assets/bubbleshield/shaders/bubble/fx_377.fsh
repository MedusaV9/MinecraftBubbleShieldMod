...
// stack: deep=fbm x3 taps | mid=kaliset+warp1+rotate | rim=graze_film | flourish=glint | tex=nebula
// fbm: turb x6 octaves | seed 4465fbefd25b81c1
// v8 realism: refr 0.2828+0.2470*fres/dist (cap 0.1197) | energy 0.5565+0.4072*p | flow 0.051667 c/s | soft 0.6220m
...
void main() {
    ...
    float refrAmp = min((0.2828 + 0.2470 * fresnel) / max(length(worldPos), 1.0), 0.1197);
