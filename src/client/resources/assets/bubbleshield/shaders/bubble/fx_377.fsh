...
// stack: deep=fbm x3 taps | mid=kaliset+warp1+rotate | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0737 + 0.1746 * presence + 0.4651 * pattern + 0.1300 * (1.0 - deepTrans), 0.7941);
