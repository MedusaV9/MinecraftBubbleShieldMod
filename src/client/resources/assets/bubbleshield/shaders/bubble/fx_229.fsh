...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7195, 0.0, 1.0);
    ...
    deepCol += 0.4841 * dp * mix(baseCol, deepStop, 0.2567);
    deepPat += 0.4841 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 3.4094) + par * 0.0695, time);
    deepCol += 0.2343 * dp * mix(baseCol, deepStop, 0.5133);
    deepPat += 0.2343 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.2697) + par * 0.1043, time);
    deepCol += 0.1134 * dp * mix(baseCol, deepStop, 0.7700);
    deepPat += 0.1134 * dp;
    deepCol *= 0.5230;
    deepPat = pow(clamp(deepPat * 0.5459, 0.0, 1.0), 1.4303);
    ...
    rgb += hotStop * 0.2022 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0644 + 0.3256 * presence + 0.4621 * pattern, 0.7855);
