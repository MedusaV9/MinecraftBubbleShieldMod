...
// stack: deep=fbm x4 taps | mid=rings+curl+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0644 + 0.3256 * presence + 0.4621 * pattern + 0.1126 * (1.0 - deepTrans), 0.7855);
