...
// v8 realism: refr 0.3155+0.3162*fres/dist (cap 0.1130) | energy 0.5163+0.4752*p | flow 0.080000 c/s | soft 0.9815m
...
void main() {
    ...
    float refrAmp = min((0.3155 + 0.3162 * fresnel) / max(length(worldPos), 1.0), 0.1130);
