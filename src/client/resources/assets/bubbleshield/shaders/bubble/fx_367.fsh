...
// stack: deep=caustic x3 taps | mid=tendrilnet+warp2+rotate | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0445 + 0.1724 * presence + 0.5492 * pattern + 0.1367 * (1.0 - deepTrans), 0.7958);
