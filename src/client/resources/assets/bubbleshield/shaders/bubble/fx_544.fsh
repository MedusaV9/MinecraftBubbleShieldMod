...
// stack: deep=caustic x3 taps | mid=orbittrap+none+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0681 + 0.1830 * presence + 0.5262 * pattern + 0.1487 * (1.0 - deepTrans), 0.8207);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3389), 0.8207);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5446 + 0.4554 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
