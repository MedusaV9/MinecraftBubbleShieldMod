...
// stack: deep=fbm x4 taps | mid=plasma+warp2+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0716 + 0.2878 * presence + 0.4527 * pattern + 0.0863 * (1.0 - deepTrans), 0.8339);
