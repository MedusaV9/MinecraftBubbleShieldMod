...
// stack: deep=fbm x4 taps | mid=plasma+warp2+rotate | rim=graze_sparkle | flourish=shimmer | tex=nebula
// fbm: turb x4 octaves | seed 0ef4d6cb11fbb308
// v8 realism: refr 0.5117+0.5182*fres/dist (cap 0.1016) | energy 0.3689+0.4758*p | flow 0.110000 c/s | soft 0.8502m
...
void main() {
    ...
    float refrAmp = min((0.5117 + 0.5182 * fresnel) / max(length(worldPos), 1.0), 0.1016);
