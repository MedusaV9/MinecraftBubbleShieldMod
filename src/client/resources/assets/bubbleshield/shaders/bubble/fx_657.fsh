...
// stack: deep=caustic x4 taps | mid=plasmaglobe+warp1+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0767 + 0.0610 * presence + 0.6051 * pattern + 0.0932 * (1.0 - deepTrans), 0.8383);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2531), 0.8383);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4607 + 0.5393 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
