...
// stack: deep=caustic x3 taps | mid=vortex+warp1+scroll | rim=graze_film | flourish=swirl | tex=marble_ink
// fbm: ridged x4 octaves | seed e8f55397ac3bd032
// v8 realism: refr 0.7247+0.9076*fres/dist (cap 0.1048) | energy 0.3902+0.4797*p | flow 0.077500 c/s | soft 0.9362m
...
void main() {
    ...
    float refrAmp = min((0.7247 + 0.9076 * fresnel) / max(length(worldPos), 1.0), 0.1048);
