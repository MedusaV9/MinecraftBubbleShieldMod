...
// stack: deep=caustic x3 taps | mid=vortex+warp1+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0470 + 0.3381 * presence + 0.4442 * pattern + 0.1209 * (1.0 - deepTrans), 0.8239);
