...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5575, 0.0, 1.0);
    ...
    deepCol += 0.4749 * dp * mix(baseCol, deepStop, 0.3482);
    deepPat += 0.4749 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.6511) + par * 0.0836, time);
    deepCol += 0.2255 * dp * mix(baseCol, deepStop, 0.6965);
    deepPat += 0.2255 * dp;
    deepCol *= 0.5751;
    deepPat = pow(clamp(deepPat * 0.5881, 0.0, 1.0), 1.0578);
    ...
    rgb += hotStop * 0.3083 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0470 + 0.3381 * presence + 0.4442 * pattern, 0.8239);
