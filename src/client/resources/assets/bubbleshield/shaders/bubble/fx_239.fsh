...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7711, 0.0, 1.0);
    ...
    deepCol += 0.4665 * dp * mix(baseCol, deepStop, 0.2396);
    deepPat += 0.4665 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.5057) + par * 0.0992, time);
    deepCol += 0.2176 * dp * mix(baseCol, deepStop, 0.4793);
    deepPat += 0.2176 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 5.3614) + par * 0.1489, time);
    deepCol += 0.1015 * dp * mix(baseCol, deepStop, 0.7189);
    deepPat += 0.1015 * dp;
    deepCol *= 0.5817;
    deepPat = pow(clamp(deepPat * 0.5600, 0.0, 1.0), 1.7811);
    ...
    rgb += hotStop * 0.3218 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0679 + 0.3501 * presence + 0.3728 * pattern, 0.8469);
