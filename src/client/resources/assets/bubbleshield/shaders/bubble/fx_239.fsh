...
void main() {
    ...
    mid = clamp(mid * (0.6058 + 0.6002 * texDetail) + 0.1940 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4365), 0.0, 1.0);
    float emit = atlas.a * (0.7864 + 0.2808 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1563 * (0.5 + 0.5 * sin(time * 0.198968)));
    rgb += emit * 0.8336 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4108 + 0.4901 * presence + 0.3728 * pattern + 0.1546 * (1.0 - deepTrans) + 0.1481 * emit, 0.9069);
