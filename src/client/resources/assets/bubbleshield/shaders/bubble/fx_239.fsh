...
// stack: deep=voro x4 taps | mid=lightning+none+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0679 + 0.3501 * presence + 0.3728 * pattern + 0.1546 * (1.0 - deepTrans), 0.8469);
