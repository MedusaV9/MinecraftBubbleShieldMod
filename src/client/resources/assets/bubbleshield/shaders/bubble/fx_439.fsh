...
// stack: deep=fbm x4 taps | mid=voidrift+warp2+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0640 + 0.1949 * presence + 0.4728 * pattern + 0.1254 * (1.0 - deepTrans), 0.8418);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3071), 0.8418);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3832 + 0.6168 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
