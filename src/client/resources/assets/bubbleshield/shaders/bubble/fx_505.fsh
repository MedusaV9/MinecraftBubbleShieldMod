...
// stack: deep=caustic x3 taps | mid=crystalsdf+warp1+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0503 + 0.2393 * presence + 0.5199 * pattern + 0.0817 * (1.0 - deepTrans), 0.7844);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2879), 0.7844);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4290 + 0.5710 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
