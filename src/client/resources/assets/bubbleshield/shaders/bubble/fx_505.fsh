...
void main() {
    ...
    float mid = clamp(csEdge * 0.6219 + csSpec * (0.6165 + 0.3 * csTw) + csFill * 0.2310, 0.0, 1.3);
    ...
    float alpha = vertexColor.a * min(0.0503 + 0.3072 * presence + 0.5199 * pattern + 0.0817 * (1.0 - deepTrans), 0.7844);
    // [layer:v5:backface]
