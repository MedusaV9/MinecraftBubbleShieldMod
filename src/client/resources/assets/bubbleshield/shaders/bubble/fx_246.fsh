...
// stack: deep=caustic x4 taps | mid=vortex+curl+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0711 + 0.2515 * presence + 0.3437 * pattern + 0.1011 * (1.0 - deepTrans), 0.8165);
