...
// stack: deep=caustic x4 taps | mid=vortex+curl+pulse | rim=graze | flourish=shimmer | tex=marble_ink
// fbm: ridged x6 octaves | seed 21e50661486e6edc
// v8 realism: refr 0.5772+0.5308*fres/dist (cap 0.1578) | energy 0.3474+0.4580*p | flow 0.077500 c/s | soft 0.8836m
...
void main() {
    ...
    float refrAmp = min((0.5772 + 0.5308 * fresnel) / max(length(worldPos), 1.0), 0.1578);
