...
void main() {
    ...
    mid = clamp(mid * (0.6653 + 0.5805 * texDetail) + 0.3398 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5821 + 0.4898 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1062 * (0.5 + 0.5 * sin(time * 0.272271)));
    rgb += emit * 0.9511 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3709 + 0.4693 * presence + 0.3912 * pattern + 0.1546 * (1.0 - deepTrans) + 0.1415 * emit, 0.8417);
