...
// stack: deep=fbm x3 taps | mid=ridged+warp2+scroll | rim=graze_sparkle | flourish=glint | tex=ridged
// fbm: ridged x3 octaves | seed a0a88c301561d045
// v8 realism: refr 0.5107+0.6288*fres/dist (cap 0.1322) | energy 0.4040+0.4890*p | flow 0.118333 c/s | soft 0.7376m
...
void main() {
    ...
    float refrAmp = min((0.5107 + 0.6288 * fresnel) / max(length(worldPos), 1.0), 0.1322);
