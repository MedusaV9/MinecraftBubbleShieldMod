...
// stack: deep=fbm x3 taps | mid=ridged+warp2+scroll | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0545 + 0.3293 * presence + 0.3912 * pattern + 0.1546 * (1.0 - deepTrans), 0.7817);
