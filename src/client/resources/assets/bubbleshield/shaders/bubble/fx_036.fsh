...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.036667, -0.005000) * time, time);
    deep += 0.4740 * deepField(duvBase + rimDir * 0.0799 + vec2(-0.056667, -0.010000) * time, time);
    deep += 0.2247 * deepField(duvBase + rimDir * 0.1597 + vec2(-0.076667, -0.012500) * time, time);
    deep += 0.1065 * deepField(duvBase + rimDir * 0.2396 + vec2(-0.096667, -0.015000) * time, time);
    deep = pow(clamp(deep * 0.5540, 0.0, 1.0), 1.5624);
    ...
    float pn = fbm2(wuv + vec2(fbm2(wuv + vec2(time * 0.110833, 0.0), midPer), fbm2(wuv - vec2(0.0, time * 0.075000), midPer)), midPer);
