...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7720, 0.0, 1.0);
    ...
    deepCol += 0.4893 * dp * mix(baseCol, deepStop, 0.2125);
    deepPat += 0.4893 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 3.4396) + par * 0.0880, time);
    deepCol += 0.2394 * dp * mix(baseCol, deepStop, 0.4251);
    deepPat += 0.2394 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 4.3468) + par * 0.1320, time);
    deepCol += 0.1172 * dp * mix(baseCol, deepStop, 0.6376);
    deepPat += 0.1172 * dp;
    deepCol *= 0.5588;
    deepPat = pow(clamp(deepPat * 0.5417, 0.0, 1.0), 1.5157);
    ...
    rgb += hotStop * 0.2154 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0747 + 0.2589 * presence + 0.4952 * pattern, 0.8572);
