...
// stack: deep=caustic x4 taps | mid=scales+warp1+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0674 + 0.3619 * presence + 0.3746 * pattern + 0.1242 * (1.0 - deepTrans), 0.8445);
