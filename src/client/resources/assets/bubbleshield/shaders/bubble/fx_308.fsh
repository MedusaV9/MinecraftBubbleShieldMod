...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6605, 0.0, 1.0);
    ...
    deepCol += 0.5237 * dp * mix(baseCol, deepStop, 0.2928);
    deepPat += 0.5237 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 5.2755) + par * 0.1427, time);
    deepCol += 0.2742 * dp * mix(baseCol, deepStop, 0.5856);
    deepPat += 0.2742 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 6.5259) + par * 0.2140, time);
    deepCol += 0.1436 * dp * mix(baseCol, deepStop, 0.8783);
    deepPat += 0.1436 * dp;
    deepCol *= 0.6398;
    deepPat = pow(clamp(deepPat * 0.5151, 0.0, 1.0), 1.5995);
    ...
    float alpha = vertexColor.a * min(0.0674 + 0.3619 * presence + 0.3746 * pattern, 0.8445);
