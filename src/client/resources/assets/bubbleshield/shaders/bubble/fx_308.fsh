...
// stack: deep=caustic x4 taps | mid=scales+warp1+pulse | rim=graze_film | flourish=swirl | tex=scales
// fbm: turb x3 octaves | seed c058fb8d4e9da3ef
// v8 realism: refr 0.5437+0.4861*fres/dist (cap 0.1113) | energy 0.3649+0.4927*p | flow 0.064167 c/s | soft 0.9289m
...
void main() {
    ...
    float refrAmp = min((0.5437 + 0.4861 * fresnel) / max(length(worldPos), 1.0), 0.1113);
