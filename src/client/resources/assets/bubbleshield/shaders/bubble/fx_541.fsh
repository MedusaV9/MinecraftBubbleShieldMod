...
// stack: deep=voro x4 taps | mid=raymarchfog+curl+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0709 + 0.2671 * presence + 0.3016 * pattern + 0.1008 * (1.0 - deepTrans), 0.8093);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2301), 0.8093);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4838 + 0.5162 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
