...
// stack: deep=voro x4 taps | mid=fluidink+none+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0405 + 0.2965 * presence + 0.3415 * pattern + 0.0978 * (1.0 - deepTrans), 0.8425);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2212), 0.8425);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4775 + 0.5225 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
