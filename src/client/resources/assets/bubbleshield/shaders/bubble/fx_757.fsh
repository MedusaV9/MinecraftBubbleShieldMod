...
// stack: deep=ridge x3 taps | mid=plasmaglobe+warp2+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0578 + 0.0610 * presence + 0.5400 * pattern + 0.1145 * (1.0 - deepTrans), 0.8571);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1566), 0.8571);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3878 + 0.6122 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
