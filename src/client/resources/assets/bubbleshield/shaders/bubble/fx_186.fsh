...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5552, 0.0, 1.0);
    ...
    deepCol += 0.3937 * dp * mix(baseCol, deepStop, 0.4123);
    deepPat += 0.3937 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 4.6154) + par * 0.0845, time);
    deepCol += 0.1550 * dp * mix(baseCol, deepStop, 0.8246);
    deepPat += 0.1550 * dp;
    deepCol *= 0.6298;
    deepPat = pow(clamp(deepPat * 0.6457, 0.0, 1.0), 1.1602);
    ...
    rgb += hotStop * 0.2670 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0767 + 0.3109 * presence + 0.4841 * pattern, 0.8175);
