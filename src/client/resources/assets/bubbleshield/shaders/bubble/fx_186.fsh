...
// stack: deep=caustic x3 taps | mid=triweave+warp2+pulse | rim=graze_film | flourish=echo | tex=hex_lattice
// fbm: ridged x3 octaves | seed 4dfe05c36557bfe0
// v8 realism: refr 0.4749+0.4969*fres/dist (cap 0.1345) | energy 0.4124+0.4985*p | flow 0.093333 c/s | soft 0.5815m
...
void main() {
    ...
    float refrAmp = min((0.4749 + 0.4969 * fresnel) / max(length(worldPos), 1.0), 0.1345);
