...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.015833, 0.000000) * time, time);
    deep += 0.3937 * deepField(duvBase + rimDir * 0.0422 + vec2(-0.024167, 0.000000) * time, time);
    deep = pow(clamp(deep * 0.7175, 0.0, 1.0), 1.1602);
