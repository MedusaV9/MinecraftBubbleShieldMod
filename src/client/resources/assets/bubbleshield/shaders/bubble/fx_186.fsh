...
// stack: deep=caustic x3 taps | mid=triweave+warp2+pulse | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0767 + 0.3109 * presence + 0.4841 * pattern + 0.1079 * (1.0 - deepTrans), 0.8175);
