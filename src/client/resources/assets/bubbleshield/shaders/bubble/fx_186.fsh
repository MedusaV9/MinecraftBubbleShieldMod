...
void main() {
    ...
    mid = clamp(mid * (0.7457 + 0.6745 * texDetail) + 0.2113 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7882 + 0.2617 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1132 * (0.5 + 0.5 * sin(time * 0.204204)));
    rgb += emit * 0.6983 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4366 + 0.4509 * presence + 0.4841 * pattern + 0.1079 * (1.0 - deepTrans) + 0.1274 * emit, 0.8775);
