...
// stack: deep=fbm x3 taps | mid=oilslick+warp1+scroll | rim=graze_sparkle | flourish=swirl | tex=chrome
// fbm: standard x5 octaves | seed cab1ce78a289f97b
// v8 realism: refr 0.9957+1.1542*fres/dist (cap 0.1523) | energy 0.2214+0.3888*p | flow 0.105833 c/s | soft 0.7749m
...
void main() {
    ...
    float refrAmp = min((0.9957 + 1.1542 * fresnel) / max(length(worldPos), 1.0), 0.1523);
