...
// stack: deep=fbm x3 taps | mid=oilslick+warp1+scroll | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0700 + 0.2747 * presence + 0.3401 * pattern + 0.1470 * (1.0 - deepTrans), 0.7876);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1948), 0.7876);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4827 + 0.5173 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
