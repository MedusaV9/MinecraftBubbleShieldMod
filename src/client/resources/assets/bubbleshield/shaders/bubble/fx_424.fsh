...
// stack: deep=ridge x3 taps | mid=orbittrap+warp1+pulse | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0654 + 0.1291 * presence + 0.5731 * pattern + 0.1042 * (1.0 - deepTrans), 0.8018);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1990), 0.8018);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4720 + 0.5280 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
