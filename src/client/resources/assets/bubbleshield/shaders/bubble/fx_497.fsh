...
// stack: deep=voro x3 taps | mid=plasmaglobe+none+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0649 + 0.0852 * presence + 0.6201 * pattern + 0.1473 * (1.0 - deepTrans), 0.8498);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1604), 0.8498);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4691 + 0.5309 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
