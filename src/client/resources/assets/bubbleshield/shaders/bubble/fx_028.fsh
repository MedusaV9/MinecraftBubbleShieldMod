...
// stack: deep=ridge x3 taps | mid=hex+none+scroll | rim=graze | flourish=shimmer | tex=hex_lattice
// fbm: standard x4 octaves | seed c357f16eba06a3e1
// v8 realism: refr 0.5402+0.7524*fres/dist (cap 0.1161) | energy 0.3724+0.5465*p | flow 0.074167 c/s | soft 0.9445m
...
void main() {
    ...
    float refrAmp = min((0.5402 + 0.7524 * fresnel) / max(length(worldPos), 1.0), 0.1161);
