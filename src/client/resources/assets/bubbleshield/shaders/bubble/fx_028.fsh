...
float fbm2(vec2 p, vec2 per) {
    ...
    for (int i = 0; i < 4; i++) {
        ...
        p = vec2(p.x * 2.0, p.y * 1.9855) + vec2(17.7, 9.2);
        per = vec2(per.x * 2.0, per.y * 1.9855);
        amplitude *= 0.5;
    }
    return value;
}
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.007500, -0.003333) * time, time);
    deep += 0.4932 * deepField(duvBase + rimDir * 0.0760 + vec2(0.012500, -0.006667) * time, time);
    deep += 0.2433 * deepField(duvBase + rimDir * 0.1520 + vec2(0.017500, -0.010000) * time, time);
    deep = pow(clamp(deep * 0.5759, 0.0, 1.0), 1.7176);
