...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6478, 0.0, 1.0);
    ...
    deepCol += 0.5358 * dp * mix(baseCol, deepStop, 0.4180);
    deepPat += 0.5358 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 4.2911) + par * 0.0945, time);
    deepCol += 0.2871 * dp * mix(baseCol, deepStop, 0.8359);
    deepPat += 0.2871 * dp;
    deepCol *= 0.6430;
    deepPat = pow(clamp(deepPat * 0.5486, 0.0, 1.0), 1.2124);
    ...
    rgb += hotStop * 0.1725 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0783 + 0.3466 * presence + 0.3227 * pattern, 0.8112);
