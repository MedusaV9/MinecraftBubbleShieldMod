...
// stack: deep=fbm x4 taps | mid=solarflare+none+flicker | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0526 + 0.1313 * presence + 0.4650 * pattern + 0.1485 * (1.0 - deepTrans), 0.7885);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2046), 0.7885);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4933 + 0.5067 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
