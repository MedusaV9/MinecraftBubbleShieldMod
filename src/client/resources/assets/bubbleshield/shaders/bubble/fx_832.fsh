...
// stack: deep=voro x3 taps | mid=mycelia+warp2+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0491 + 0.1751 * presence + 0.5784 * pattern + 0.1342 * (1.0 - deepTrans), 0.8065);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2703), 0.8065);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5450 + 0.4550 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
