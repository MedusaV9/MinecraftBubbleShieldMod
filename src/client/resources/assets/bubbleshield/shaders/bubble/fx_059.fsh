...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.011667, -0.047500) * time, time);
    deep += 0.3909 * deepField(duvBase + rimDir * 0.0705 + vec2(0.018333, -0.075000) * time, time);
    deep += 0.1528 * deepField(duvBase + rimDir * 0.1410 + vec2(0.025000, -0.102500) * time, time);
    deep += 0.0597 * deepField(duvBase + rimDir * 0.2115 + vec2(0.031667, -0.127500) * time, time);
    deep = pow(clamp(deep * 0.6237, 0.0, 1.0), 1.7750);
