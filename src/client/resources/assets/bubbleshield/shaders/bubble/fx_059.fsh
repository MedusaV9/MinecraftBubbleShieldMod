...
void main() {
    ...
    mid = clamp(mid * (0.6984 + 0.6745 * texDetail) + 0.2169 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6202 + 0.4203 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1504 * (0.5 + 0.5 * sin(time * 0.146608)));
    rgb += emit * 0.7204 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3058 + 0.2799 * presence + 0.5171 * pattern + 0.0834 * (1.0 - deepTrans) + 0.1548 * emit, 0.9080);
