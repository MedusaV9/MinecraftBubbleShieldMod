...
// stack: deep=fbm x4 taps | mid=phantomecho+warp2+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0552 + 0.1295 * presence + 0.5763 * pattern + 0.0943 * (1.0 - deepTrans), 0.7767);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1607), 0.7767);
    // [layer:v5:ghostalpha]
