...
void main() {
    ...
    mid = clamp(mid * (0.6493 + 0.6958 * texDetail) + 0.2423 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7713 + 0.2991 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0856 * (0.5 + 0.5 * sin(time * 0.282743)));
    ...
    float alpha = vertexColor.a * min(0.3871 + 0.4090 * presence + 0.4853 * pattern + 0.0949 * (1.0 - deepTrans) + 0.1503 * emit, 0.8432);
