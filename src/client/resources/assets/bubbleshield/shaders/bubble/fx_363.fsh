...
// stack: deep=fbm x4 taps | mid=crystalrefract+none+pulse | rim=graze_sparkle | flourish=echo | tex=worley_cells
// fbm: turb x6 octaves | seed 14c996f74e83c3ce
// v8 realism: refr 0.8074+1.0835*fres/dist (cap 0.1041) | energy 0.1833+0.4115*p | flow 0.055000 c/s | soft 0.9958m
...
void main() {
    ...
    float refrAmp = min((0.8074 + 1.0835 * fresnel) / max(length(worldPos), 1.0), 0.1041);
