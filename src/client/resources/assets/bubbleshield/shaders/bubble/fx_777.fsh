...
// stack: deep=fbm x4 taps | mid=plasmaglobe+warp2+rotate | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0799 + 0.0966 * presence + 0.5632 * pattern + 0.1430 * (1.0 - deepTrans), 0.8005);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2696), 0.8005);
    // [layer:v5:ghostalpha]
