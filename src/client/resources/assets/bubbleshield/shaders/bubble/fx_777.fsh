...
// stack: deep=fbm x4 taps | mid=plasmaglobe+warp2+rotate | rim=graze | flourish=glint | tex=filaments
// fbm: ridged x4 octaves | seed 5608f057309e15cc
// v8 realism: refr 0.5802+0.6775*fres/dist (cap 0.1515) | energy 0.3253+0.4888*p | flow 0.064167 c/s | soft 0.7614m
...
void main() {
    ...
    float refrAmp = min((0.5802 + 0.6775 * fresnel) / max(length(worldPos), 1.0), 0.1515);
