...
// stack: deep=ridge x4 taps | mid=mycelia+warp2+rotate | rim=graze_sparkle | flourish=echo | tex=filaments
// fbm: standard x3 octaves | seed eab49ed5d253c019
// v8 realism: refr 0.3279+0.4354*fres/dist (cap 0.1011) | energy 0.5079+0.3529*p | flow 0.106667 c/s | soft 0.5210m
...
void main() {
    ...
    float refrAmp = min((0.3279 + 0.4354 * fresnel) / max(length(worldPos), 1.0), 0.1011);
