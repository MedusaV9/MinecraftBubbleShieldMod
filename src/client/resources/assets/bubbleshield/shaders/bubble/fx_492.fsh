...
// stack: deep=ridge x4 taps | mid=mycelia+warp2+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0727 + 0.1706 * presence + 0.4742 * pattern + 0.1177 * (1.0 - deepTrans), 0.8407);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2634), 0.8407);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3959 + 0.6041 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
