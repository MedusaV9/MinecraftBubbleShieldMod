...
float fbm2(vec2 p, vec2 per) {
    ...
    for (int i = 0; i < 4; i++) {
        ...
        p = vec2(p.x * 2.0, p.y * 2.0307) + vec2(17.7, 9.2);
        per = vec2(per.x * 2.0, per.y * 2.0307);
        amplitude *= 0.5;
    }
    return value;
}
...
void main() {
    ...
    deep += 0.3918 * deepField(duvBase + rimDir * 0.0690 + vec2(-0.070000, -0.010000) * time, time);
    deep += 0.1535 * deepField(duvBase + rimDir * 0.1380 + vec2(-0.095000, -0.015000) * time, time);
    deep += 0.0602 * deepField(duvBase + rimDir * 0.2070 + vec2(-0.120000, -0.017500) * time, time);
    deep = pow(clamp(deep * 0.6228, 0.0, 1.0), 1.5941);
