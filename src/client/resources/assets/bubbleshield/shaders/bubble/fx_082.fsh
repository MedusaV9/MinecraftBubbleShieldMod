...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(1.0000, 2.0000), t * 0.507891);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.010000, -0.013333) * time, time);
    deep += 0.3964 * deepField(duvBase + rimDir * 0.0571 + vec2(-0.015000, -0.020000) * time, time);
    deep = pow(clamp(deep * 0.7161, 0.0, 1.0), 1.0204);
