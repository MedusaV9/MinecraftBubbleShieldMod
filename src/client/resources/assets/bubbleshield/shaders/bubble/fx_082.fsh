...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7331, 0.0, 1.0);
    ...
    deepCol += 0.3964 * dp * mix(baseCol, deepStop, 0.3313);
    deepPat += 0.3964 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.5394) + par * 0.1142, time);
    deepCol += 0.1571 * dp * mix(baseCol, deepStop, 0.6626);
    deepPat += 0.1571 * dp;
    deepCol *= 0.8121;
    deepPat = pow(clamp(deepPat * 0.6437, 0.0, 1.0), 1.0204);
    ...
    rgb += hotStop * 0.1997 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0419 + 0.2987 * presence + 0.4536 * pattern, 0.8504);
