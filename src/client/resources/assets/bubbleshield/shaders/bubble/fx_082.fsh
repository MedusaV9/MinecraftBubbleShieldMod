...
void main() {
    ...
    mid = clamp(mid * (0.7456 + 0.4703 * texDetail) + 0.2184 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4580), 0.0, 1.0);
    float emit = atlas.a * (0.5855 + 0.2727 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0819 * (0.5 + 0.5 * sin(time * 0.157080)));
    rgb += emit * 0.9472 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3335 + 0.4387 * presence + 0.4536 * pattern + 0.1599 * (1.0 - deepTrans) + 0.1473 * emit, 0.9104);
