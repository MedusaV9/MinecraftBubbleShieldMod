...
// stack: deep=voro x3 taps | mid=aurora+curl+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0419 + 0.2987 * presence + 0.4536 * pattern + 0.1599 * (1.0 - deepTrans), 0.8504);
