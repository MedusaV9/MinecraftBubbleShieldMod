...
// stack: deep=ridge x4 taps | mid=truchet+none+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0551 + 0.2569 * presence + 0.3794 * pattern + 0.0881 * (1.0 - deepTrans), 0.8583);
