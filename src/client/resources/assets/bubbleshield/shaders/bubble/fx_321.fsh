...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6022, 0.0, 1.0);
    ...
    deepCol += 0.3959 * dp * mix(baseCol, deepStop, 0.4103);
    deepPat += 0.3959 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 3.0925) + par * 0.1173, time);
    deepCol += 0.1568 * dp * mix(baseCol, deepStop, 0.8206);
    deepPat += 0.1568 * dp;
    deepCol *= 0.7264;
    deepPat = pow(clamp(deepPat * 0.6440, 0.0, 1.0), 1.2848);
    ...
    rgb += hotStop * 0.2791 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0682 + 0.2788 * presence + 0.3610 * pattern, 0.8172);
