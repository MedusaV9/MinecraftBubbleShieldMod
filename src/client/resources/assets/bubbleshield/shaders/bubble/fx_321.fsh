...
void main() {
    ...
    mid = clamp(mid * (0.6106 + 0.6647 * texDetail) + 0.3275 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4955), 0.0, 1.0);
    float emit = atlas.a * (0.6331 + 0.3961 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1742 * (0.5 + 0.5 * sin(time * 0.272271)));
    ...
    float alpha = vertexColor.a * min(0.4115 + 0.4188 * presence + 0.3610 * pattern + 0.0894 * (1.0 - deepTrans) + 0.1923 * emit, 0.8772);
