...
// stack: deep=voro x3 taps | mid=circuit+curl+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0682 + 0.2788 * presence + 0.3610 * pattern + 0.0894 * (1.0 - deepTrans), 0.8172);
