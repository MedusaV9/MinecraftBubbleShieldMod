...
// stack: deep=ridge x3 taps | mid=thinfilm+warp1+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0485 + 0.3454 * presence + 0.3248 * pattern + 0.1468 * (1.0 - deepTrans), 0.8196);
