...
// stack: deep=ridge x3 taps | mid=thinfilm+warp1+rotate | rim=graze_sparkle | flourish=glint | tex=chrome
// fbm: standard x6 octaves | seed 75b5a9489f004734
// v8 realism: refr 0.7090+1.1930*fres/dist (cap 0.1580) | energy 0.2041+0.3502*p | flow 0.080833 c/s | soft 0.9027m
...
void main() {
    ...
    float refrAmp = min((0.7090 + 1.1930 * fresnel) / max(length(worldPos), 1.0), 0.1580);
