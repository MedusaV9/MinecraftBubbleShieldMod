...
// stack: deep=fbm x4 taps | mid=volumecloud+warp1+pulse | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0687 + 0.3606 * presence + 0.3189 * pattern + 0.1329 * (1.0 - deepTrans), 0.8603);
