...
// stack: deep=ridge x4 taps | mid=stainedglass+curl+scroll | rim=lat | flourish=shimmer | tex=worley_cells
// fbm: standard x6 octaves | seed b6004551fb500fa6
// v8 realism: refr 1.0063+1.7130*fres/dist (cap 0.1337) | energy 0.2135+0.4087*p | flow 0.100000 c/s | soft 0.5890m
...
void main() {
    ...
    float refrAmp = min((1.0063 + 1.7130 * fresnel) / max(length(worldPos), 1.0), 0.1337);
