...
// stack: deep=ridge x3 taps | mid=solarflare+none+rotate | rim=graze_film | flourish=glint | tex=worley_cells
// fbm: standard x6 octaves | seed 153fcf78acf782dd
// v8 realism: refr 0.6302+0.6367*fres/dist (cap 0.1003) | energy 0.3197+0.4804*p | flow 0.101667 c/s | soft 0.6180m
...
void main() {
    ...
    float refrAmp = min((0.6302 + 0.6367 * fresnel) / max(length(worldPos), 1.0), 0.1003);
