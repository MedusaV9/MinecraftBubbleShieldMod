...
// stack: deep=ridge x3 taps | mid=solarflare+none+rotate | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0570 + 0.1933 * presence + 0.4750 * pattern + 0.1509 * (1.0 - deepTrans), 0.8555);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3443), 0.8555);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5030 + 0.4970 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
