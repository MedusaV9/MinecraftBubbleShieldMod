...
// stack: deep=caustic x3 taps | mid=spectralveil+none+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0419 + 0.1574 * presence + 0.4965 * pattern + 0.1576 * (1.0 - deepTrans), 0.7661);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2853), 0.7661);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4166 + 0.5834 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
