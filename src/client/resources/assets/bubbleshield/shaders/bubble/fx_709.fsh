...
// stack: deep=voro x4 taps | mid=stainedglass+warp1+pulse | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0531 + 0.3252 * presence + 0.3554 * pattern + 0.1399 * (1.0 - deepTrans), 0.8433);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2440), 0.8433);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4222 + 0.5778 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
