...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5929, 0.0, 1.0);
    ...
    deepCol += 0.4735 * dp * mix(baseCol, deepStop, 0.2972);
    deepPat += 0.4735 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 4.6093) + par * 0.1588, time);
    deepCol += 0.2242 * dp * mix(baseCol, deepStop, 0.5945);
    deepPat += 0.2242 * dp;
    deepCol *= 0.5602;
    deepPat = pow(clamp(deepPat * 0.5890, 0.0, 1.0), 1.3264);
    ...
    rgb += hotStop * 0.3304 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0649 + 0.3155 * presence + 0.3628 * pattern, 0.8343);
