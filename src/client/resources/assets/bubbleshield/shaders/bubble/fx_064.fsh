...
// stack: deep=ridge x3 taps | mid=voronoi+warp1+scroll | rim=lat | flourish=shimmer | tex=worley_cells
// fbm: standard x3 octaves | seed 33d2fd84af047177
// v8 realism: refr 0.7333+0.7892*fres/dist (cap 0.1078) | energy 0.4056+0.4684*p | flow 0.080833 c/s | soft 0.8285m
...
void main() {
    ...
    float refrAmp = min((0.7333 + 0.7892 * fresnel) / max(length(worldPos), 1.0), 0.1078);
