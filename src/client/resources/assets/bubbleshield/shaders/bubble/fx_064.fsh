...
// stack: deep=ridge x3 taps | mid=voronoi+warp1+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0649 + 0.3155 * presence + 0.3628 * pattern + 0.1180 * (1.0 - deepTrans), 0.8343);
