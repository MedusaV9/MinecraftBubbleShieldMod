...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.021667, -0.025000) * time, time);
    deep += 0.4735 * deepField(duvBase + rimDir * 0.0794 + vec2(0.035000, -0.040000) * time, time);
    deep = pow(clamp(deep * 0.6786, 0.0, 1.0), 1.3264);
