...
void main() {
    ...
    mid = clamp(mid * (0.6555 + 0.5054 * texDetail) + 0.3272 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7778 + 0.2984 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1511 * (0.5 + 0.5 * sin(time * 0.277507)));
    rgb += emit * 0.9850 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4016 + 0.4555 * presence + 0.3628 * pattern + 0.1180 * (1.0 - deepTrans) + 0.1814 * emit, 0.8943);
