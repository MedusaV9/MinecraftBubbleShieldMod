...
// stack: deep=fbm x4 taps | mid=oilslick+warp1+rotate | rim=graze_sparkle | flourish=glint | tex=chrome
// fbm: turb x6 octaves | seed 89d6b07881320182
// v8 realism: refr 0.8034+0.8338*fres/dist (cap 0.1542) | energy 0.2684+0.3783*p | flow 0.080000 c/s | soft 0.9666m
...
void main() {
    ...
    float refrAmp = min((0.8034 + 0.8338 * fresnel) / max(length(worldPos), 1.0), 0.1542);
