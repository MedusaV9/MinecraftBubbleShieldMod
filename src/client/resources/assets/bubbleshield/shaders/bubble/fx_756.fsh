...
// stack: deep=fbm x4 taps | mid=oilslick+warp1+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0790 + 0.2991 * presence + 0.3906 * pattern + 0.1265 * (1.0 - deepTrans), 0.8366);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2373), 0.8366);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3891 + 0.6109 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
