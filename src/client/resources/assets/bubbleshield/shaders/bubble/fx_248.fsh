...
// stack: deep=fbm x3 taps | mid=ridged+curl+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0704 + 0.2871 * presence + 0.4104 * pattern + 0.1250 * (1.0 - deepTrans), 0.8257);
