...
void main() {
    ...
    mid = clamp(mid * (0.6483 + 0.5868 * texDetail) + 0.3395 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5506 + 0.4114 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1203 * (0.5 + 0.5 * sin(time * 0.251327)));
    ...
    float alpha = vertexColor.a * min(0.3904 + 0.3800 * presence + 0.3332 * pattern + 0.1552 * (1.0 - deepTrans) + 0.2023 * emit, 0.9024);
