...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6780, 0.0, 1.0);
    ...
    deepCol += 0.4478 * dp * mix(baseCol, deepStop, 0.2786);
    deepPat += 0.4478 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 4.3542) + par * 0.1285, time);
    deepCol += 0.2005 * dp * mix(baseCol, deepStop, 0.5573);
    deepPat += 0.2005 * dp;
    deepCol *= 0.6247;
    deepPat = pow(clamp(deepPat * 0.6067, 0.0, 1.0), 1.1878);
    ...
    rgb += hotStop * 0.1534 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0611 + 0.2400 * presence + 0.3332 * pattern, 0.8424);
