...
// stack: deep=ridge x3 taps | mid=scales+curl+rotate | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0611 + 0.2400 * presence + 0.3332 * pattern + 0.1552 * (1.0 - deepTrans), 0.8424);
