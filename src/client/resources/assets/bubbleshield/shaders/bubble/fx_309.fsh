...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7019, 0.0, 1.0);
    ...
    deepCol += 0.3874 * dp * mix(baseCol, deepStop, 0.1927);
    deepPat += 0.3874 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 3.2900) + par * 0.1042, time);
    deepCol += 0.1501 * dp * mix(baseCol, deepStop, 0.3853);
    deepPat += 0.1501 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 3.9650) + par * 0.1564, time);
    deepCol += 0.0582 * dp * mix(baseCol, deepStop, 0.5780);
    deepPat += 0.0582 * dp;
    deepCol *= 0.6857;
    deepPat = pow(clamp(deepPat * 0.6267, 0.0, 1.0), 1.2196);
    ...
    rgb += hotStop * 0.2447 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0782 + 0.2505 * presence + 0.3331 * pattern, 0.8042);
