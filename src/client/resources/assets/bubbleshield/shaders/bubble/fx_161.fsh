...
// stack: deep=caustic x3 taps | mid=moire+warp2+flicker | rim=lat | flourish=glint | tex=chrome
// fbm: ridged x6 octaves | seed 31ad5d5632da0061
// v8 realism: refr 0.8666+1.1595*fres/dist (cap 0.1392) | energy 0.2415+0.4065*p | flow 0.111667 c/s | soft 0.9295m
...
void main() {
    ...
    float refrAmp = min((0.8666 + 1.1595 * fresnel) / max(length(worldPos), 1.0), 0.1392);
