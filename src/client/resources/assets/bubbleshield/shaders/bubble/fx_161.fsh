...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6700, 0.0, 1.0);
    ...
    deepCol += 0.5356 * dp * mix(baseCol, deepStop, 0.4248);
    deepPat += 0.5356 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 4.3687) + par * 0.1142, time);
    deepCol += 0.2869 * dp * mix(baseCol, deepStop, 0.8496);
    deepPat += 0.2869 * dp;
    deepCol *= 0.5714;
    deepPat = pow(clamp(deepPat * 0.5487, 0.0, 1.0), 1.2610);
    ...
    rgb += hotStop * 0.2999 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0555 + 0.3211 * presence + 0.4641 * pattern, 0.7818);
