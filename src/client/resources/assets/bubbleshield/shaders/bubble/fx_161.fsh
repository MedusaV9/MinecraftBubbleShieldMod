...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.040000, 0.010000) * time, time);
    deep += 0.5356 * deepField(duvBase + rimDir * 0.0571 + vec2(-0.062500, 0.016667) * time, time);
    deep += 0.2869 * deepField(duvBase + rimDir * 0.1142 + vec2(-0.084167, 0.021667) * time, time);
    deep = pow(clamp(deep * 0.5487, 0.0, 1.0), 1.2610);
    ...
    float pattern = clamp(0.4721 * deep + 0.9517 * mid + 0.8322 * rim + flourish + grain, 0.0, 1.5);
    vec3 accent = accentPalette(0.1296 + pattern * 0.6156);
    vec3 rgb = vertexColor.rgb * (0.4166 + 0.5632 * pattern);
    ...
    float alpha = vertexColor.a * clamp(0.1249 + 0.6854 * pattern, 0.0, 1.0);
