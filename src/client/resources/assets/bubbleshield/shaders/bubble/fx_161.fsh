...
// stack: deep=caustic x3 taps | mid=moire+warp2+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0555 + 0.3211 * presence + 0.4641 * pattern + 0.0968 * (1.0 - deepTrans), 0.7818);
