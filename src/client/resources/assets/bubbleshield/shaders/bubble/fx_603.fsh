...
// stack: deep=caustic x3 taps | mid=holoparallax+none+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0795 + 0.1053 * presence + 0.5667 * pattern + 0.1362 * (1.0 - deepTrans), 0.8271);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2516), 0.8271);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5221 + 0.4779 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
