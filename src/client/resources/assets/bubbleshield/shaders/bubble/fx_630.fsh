...
// v8 realism: refr 0.3700+0.5356*fres/dist (cap 0.1067) | energy 0.4280+0.4542*p | flow 0.110000 c/s | soft 1.6993m
...
void main() {
    ...
    vec3 bumpN = normalize(sdir + (tanU * atlasSlope.x + tanV * atlasSlope.y) * (0.7481 * atlasPoleW));
    ...
    float refrAmp = min((0.3700 + 0.5356 * fresnel) / max(length(worldPos), 1.0), 0.1067);
