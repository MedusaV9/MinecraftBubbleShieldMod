...
// stack: deep=ridge x4 taps | mid=phantomecho+curl+scroll | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0506 + 0.1147 * presence + 0.5483 * pattern + 0.1298 * (1.0 - deepTrans), 0.7424);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3004), 0.7424);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4972 + 0.5028 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
