...
// stack: deep=voro x3 taps | mid=oilslick+curl+pulse | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0470 + 0.3251 * presence + 0.4102 * pattern + 0.1295 * (1.0 - deepTrans), 0.7974);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2422), 0.7974);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4211 + 0.5789 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
