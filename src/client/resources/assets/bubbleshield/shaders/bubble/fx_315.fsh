...
// stack: deep=fbm x4 taps | mid=aurora+warp2+rotate | rim=lat | flourish=echo | tex=filaments
// fbm: standard x4 octaves | seed a5203b6b62702380
// v8 realism: refr 0.7200+0.6886*fres/dist (cap 0.1425) | energy 0.3033+0.4227*p | flow 0.066667 c/s | soft 0.8540m
...
void main() {
    ...
    float refrAmp = min((0.7200 + 0.6886 * fresnel) / max(length(worldPos), 1.0), 0.1425);
