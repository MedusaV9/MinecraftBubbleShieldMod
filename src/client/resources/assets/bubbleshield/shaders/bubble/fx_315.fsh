...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5589, 0.0, 1.0);
    ...
    deepCol += 0.4486 * dp * mix(baseCol, deepStop, 0.1890);
    deepPat += 0.4486 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 5.3319) + par * 0.1055, time);
    deepCol += 0.2013 * dp * mix(baseCol, deepStop, 0.3779);
    deepPat += 0.2013 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 6.6542) + par * 0.1583, time);
    deepCol += 0.0903 * dp * mix(baseCol, deepStop, 0.5669);
    deepPat += 0.0903 * dp;
    deepCol *= 0.6037;
    deepPat = pow(clamp(deepPat * 0.5746, 0.0, 1.0), 1.5004);
    ...
    rgb += hotStop * 0.2808 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0766 + 0.3358 * presence + 0.4926 * pattern, 0.8468);
