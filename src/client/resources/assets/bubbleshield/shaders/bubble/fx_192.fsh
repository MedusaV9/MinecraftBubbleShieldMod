...
// stack: deep=caustic x3 taps | mid=scales+warp1+scroll | rim=lat | flourish=glint | tex=scales
// fbm: ridged x4 octaves | seed 4fd8cab7414cab1f
// v8 realism: refr 0.6390+0.6749*fres/dist (cap 0.1279) | energy 0.3788+0.4871*p | flow 0.050833 c/s | soft 0.7849m
...
void main() {
    ...
    float refrAmp = min((0.6390 + 0.6749 * fresnel) / max(length(worldPos), 1.0), 0.1279);
