...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7056, 0.0, 1.0);
    ...
    deepCol += 0.3997 * dp * mix(baseCol, deepStop, 0.3012);
    deepPat += 0.3997 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 3.3226) + par * 0.1000, time);
    deepCol += 0.1597 * dp * mix(baseCol, deepStop, 0.6024);
    deepPat += 0.1597 * dp;
    deepCol *= 0.6356;
    deepPat = pow(clamp(deepPat * 0.6413, 0.0, 1.0), 1.4137);
    ...
    rgb += hotStop * 0.2250 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0785 + 0.3401 * presence + 0.4399 * pattern, 0.7957);
