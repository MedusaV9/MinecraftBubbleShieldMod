...
// stack: deep=fbm x3 taps | mid=aurora+warp2+scroll | rim=graze_sparkle | flourish=shimmer | tex=filaments
// fbm: ridged x4 octaves | seed 847aba04cd13e77d
// v8 realism: refr 0.4971+0.4651*fres/dist (cap 0.1068) | energy 0.3064+0.4838*p | flow 0.090000 c/s | soft 0.5808m
...
void main() {
    ...
    float refrAmp = min((0.4971 + 0.4651 * fresnel) / max(length(worldPos), 1.0), 0.1068);
