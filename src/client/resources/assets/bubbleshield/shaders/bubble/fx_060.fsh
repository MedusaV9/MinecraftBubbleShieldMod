...
// stack: deep=fbm x3 taps | mid=aurora+warp2+scroll | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0532 + 0.3231 * presence + 0.3256 * pattern + 0.1004 * (1.0 - deepTrans), 0.8203);
