...
void main() {
    ...
    mid = clamp(mid * (0.6883 + 0.6746 * texDetail) + 0.2868 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7139 + 0.2880 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1793 * (0.5 + 0.5 * sin(time * 0.162316)));
    rgb += emit * 0.8520 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3671 + 0.4631 * presence + 0.3256 * pattern + 0.1004 * (1.0 - deepTrans) + 0.1983 * emit, 0.8803);
