...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7415, 0.0, 1.0);
    ...
    deepCol += 0.5669 * dp * mix(baseCol, deepStop, 0.2960);
    deepPat += 0.5669 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.4888) + par * 0.0859, time);
    deepCol += 0.3213 * dp * mix(baseCol, deepStop, 0.5921);
    deepPat += 0.3213 * dp;
    deepCol *= 0.6598;
    deepPat = pow(clamp(deepPat * 0.5296, 0.0, 1.0), 1.5056);
    ...
    rgb += hotStop * 0.3046 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0532 + 0.3231 * presence + 0.3256 * pattern, 0.8203);
