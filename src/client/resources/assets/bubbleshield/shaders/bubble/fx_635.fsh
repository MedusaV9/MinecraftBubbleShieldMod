...
// stack: deep=caustic x4 taps | mid=runecircuit+warp2+rotate | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0468 + 0.1477 * presence + 0.6271 * pattern + 0.1015 * (1.0 - deepTrans), 0.8458);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2717), 0.8458);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4586 + 0.5414 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
