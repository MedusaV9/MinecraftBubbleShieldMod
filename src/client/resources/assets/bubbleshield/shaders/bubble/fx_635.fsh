...
// stack: deep=caustic x4 taps | mid=runecircuit+warp2+rotate | rim=graze_film | flourish=shimmer | tex=runes
// fbm: ridged x4 octaves | seed d9acf205e55e68db
// v8 realism: refr 0.2666+0.2749*fres/dist (cap 0.1454) | energy 0.5071+0.4272*p | flow 0.079167 c/s | soft 0.9758m
...
void main() {
    ...
    float refrAmp = min((0.2666 + 0.2749 * fresnel) / max(length(worldPos), 1.0), 0.1454);
