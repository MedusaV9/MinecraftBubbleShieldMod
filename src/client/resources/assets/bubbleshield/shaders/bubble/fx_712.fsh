...
// stack: deep=voro x4 taps | mid=mycelia+none+flicker | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0534 + 0.1641 * presence + 0.4804 * pattern + 0.1398 * (1.0 - deepTrans), 0.8410);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3476), 0.8410);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4164 + 0.5836 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
