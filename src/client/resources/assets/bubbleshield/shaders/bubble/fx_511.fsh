...
// stack: deep=caustic x3 taps | mid=gravlens+curl+flicker | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0720 + 0.1282 * presence + 0.5780 * pattern + 0.0828 * (1.0 - deepTrans), 0.8081);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3484), 0.8081);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5269 + 0.4731 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
