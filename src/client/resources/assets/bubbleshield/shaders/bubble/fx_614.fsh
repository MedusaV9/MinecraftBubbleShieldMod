...
// stack: deep=ridge x3 taps | mid=deepice+warp1+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0551 + 0.3869 * presence + 0.3714 * pattern + 0.1147 * (1.0 - deepTrans), 0.8286);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2117), 0.8286);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4880 + 0.5120 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
