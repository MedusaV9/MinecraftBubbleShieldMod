...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.7908 + fiR.y * 0.7634)), 0.3519);
    ...
    float alpha = vertexColor.a * min(0.0549 + 0.3602 * presence + 0.3302 * pattern + 0.1443 * (1.0 - deepTrans), 0.7806);
    // [layer:v5:backface]
