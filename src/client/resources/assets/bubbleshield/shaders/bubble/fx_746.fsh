...
// stack: deep=ridge x3 taps | mid=fluidink+warp1+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0549 + 0.3002 * presence + 0.3302 * pattern + 0.1443 * (1.0 - deepTrans), 0.7806);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1965), 0.7806);
    // [layer:v5:ghostalpha]
