...
// stack: deep=ridge x4 taps | mid=solarflare+warp1+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0761 + 0.1829 * presence + 0.4918 * pattern + 0.1477 * (1.0 - deepTrans), 0.8025);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3408), 0.8025);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4200 + 0.5800 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
