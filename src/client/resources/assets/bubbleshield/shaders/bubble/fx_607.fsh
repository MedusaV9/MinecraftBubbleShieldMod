...
// stack: deep=caustic x4 taps | mid=irisfilm+warp2+pulse | rim=graze_sparkle | flourish=swirl | tex=chrome
// fbm: standard x5 octaves | seed 9f17ea416fa66a1e
// v8 realism: refr 0.7440+1.0041*fres/dist (cap 0.1501) | energy 0.1943+0.3689*p | flow 0.078333 c/s | soft 0.8402m
...
void main() {
    ...
    float refrAmp = min((0.7440 + 1.0041 * fresnel) / max(length(worldPos), 1.0), 0.1501);
