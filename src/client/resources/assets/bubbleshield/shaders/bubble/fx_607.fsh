...
// stack: deep=caustic x4 taps | mid=irisfilm+warp2+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0570 + 0.1772 * presence + 0.4595 * pattern + 0.1529 * (1.0 - deepTrans), 0.8088);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3310), 0.8088);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4954 + 0.5046 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
