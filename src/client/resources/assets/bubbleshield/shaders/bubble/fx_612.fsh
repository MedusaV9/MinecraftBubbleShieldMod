...
// stack: deep=voro x3 taps | mid=mycelia+none+flicker | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0751 + 0.1605 * presence + 0.5514 * pattern + 0.1224 * (1.0 - deepTrans), 0.8094);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2134), 0.8094);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5383 + 0.4617 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
