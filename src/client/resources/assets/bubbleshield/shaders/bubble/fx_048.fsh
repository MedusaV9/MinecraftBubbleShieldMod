...
void main() {
    ...
    mid = clamp(mid * (0.6789 + 0.5453 * texDetail) + 0.2127 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6850 + 0.2896 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1633 * (0.5 + 0.5 * sin(time * 0.219911)));
    rgb += emit * 0.8480 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3570 + 0.2950 * presence + 0.5337 * pattern + 0.1169 * (1.0 - deepTrans) + 0.1870 * emit, 0.9200);
