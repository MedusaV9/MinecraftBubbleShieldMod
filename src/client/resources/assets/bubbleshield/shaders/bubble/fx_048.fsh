...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7764, 0.0, 1.0);
    ...
    deepCol += 0.5194 * dp * mix(baseCol, deepStop, 0.3729);
    deepPat += 0.5194 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 5.5578) + par * 0.0630, time);
    deepCol += 0.2698 * dp * mix(baseCol, deepStop, 0.7457);
    deepPat += 0.2698 * dp;
    deepCol *= 0.6068;
    deepPat = pow(clamp(deepPat * 0.5589, 0.0, 1.0), 1.1518);
    ...
    rgb += hotStop * 0.3249 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0783 + 0.3294 * presence + 0.4205 * pattern, 0.8600);
