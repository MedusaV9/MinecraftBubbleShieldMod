...
// stack: deep=fbm x3 taps | mid=starfield+warp2+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0783 + 0.1550 * presence + 0.5337 * pattern + 0.1169 * (1.0 - deepTrans), 0.8600);
