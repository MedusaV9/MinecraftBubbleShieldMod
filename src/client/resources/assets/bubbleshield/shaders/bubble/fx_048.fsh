...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.035000, 0.042500) * time, time);
    deep += 0.5194 * deepField(duvBase + rimDir * 0.0315 + vec2(0.053333, 0.065000) * time, time);
    deep = pow(clamp(deep * 0.6581, 0.0, 1.0), 1.1518);
