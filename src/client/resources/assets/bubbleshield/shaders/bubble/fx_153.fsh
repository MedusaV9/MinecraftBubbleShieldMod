...
// stack: deep=fbm x4 taps | mid=moire+curl+rotate | rim=graze_film | flourish=shimmer | tex=chrome
// fbm: turb x5 octaves | seed 2cdc5c6cfd55ceb3
// v8 realism: refr 0.8516+1.2554*fres/dist (cap 0.1464) | energy 0.2014+0.3689*p | flow 0.112500 c/s | soft 0.8811m
...
void main() {
    ...
    float refrAmp = min((0.8516 + 1.2554 * fresnel) / max(length(worldPos), 1.0), 0.1464);
