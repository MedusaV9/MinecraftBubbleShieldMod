...
// stack: deep=voro x3 taps | mid=aethersmoke+warp1+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0597 + 0.2460 * presence + 0.3028 * pattern + 0.1004 * (1.0 - deepTrans), 0.8320);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1650), 0.8320);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4300 + 0.5700 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
