...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5825, 0.0, 1.0);
    ...
    deepCol += 0.5620 * dp * mix(baseCol, deepStop, 0.4266);
    deepPat += 0.5620 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 4.3862) + par * 0.0916, time);
    deepCol += 0.3158 * dp * mix(baseCol, deepStop, 0.8532);
    deepPat += 0.3158 * dp;
    deepCol *= 0.6207;
    deepPat = pow(clamp(deepPat * 0.5326, 0.0, 1.0), 1.2162);
    ...
    rgb += hotStop * 0.2995 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0463 + 0.2631 * presence + 0.4243 * pattern, 0.8411);
