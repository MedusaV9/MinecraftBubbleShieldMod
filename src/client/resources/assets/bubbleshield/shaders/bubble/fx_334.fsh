...
void main() {
    ...
    mid = clamp(mid * (0.6180 + 0.4953 * texDetail) + 0.1970 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7469 + 0.4508 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1095 * (0.5 + 0.5 * sin(time * 0.141372)));
    rgb += emit * 0.6764 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3467 + 0.4031 * presence + 0.4243 * pattern + 0.0984 * (1.0 - deepTrans) + 0.2021 * emit, 0.9011);
