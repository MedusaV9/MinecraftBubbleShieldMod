...
// stack: deep=ridge x3 taps | mid=petals+warp1+pulse | rim=graze_sparkle | flourish=glint | tex=scales
// fbm: standard x6 octaves | seed 2103cee54e9a8de0
// v8 realism: refr 0.5390+0.6342*fres/dist (cap 0.1447) | energy 0.3362+0.4321*p | flow 0.066667 c/s | soft 0.5376m
...
void main() {
    ...
    float refrAmp = min((0.5390 + 0.6342 * fresnel) / max(length(worldPos), 1.0), 0.1447);
