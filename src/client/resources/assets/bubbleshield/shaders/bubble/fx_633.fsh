...
// stack: deep=fbm x3 taps | mid=solarflare+warp2+pulse | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0449 + 0.1981 * presence + 0.4756 * pattern + 0.1312 * (1.0 - deepTrans), 0.8032);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2480), 0.8032);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4979 + 0.5021 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
