...
// stack: deep=fbm x3 taps | mid=solarflare+warp2+pulse | rim=graze | flourish=swirl | tex=worley_cells
// fbm: turb x4 octaves | seed b2ea00fd59c7657b
// v8 realism: refr 0.5615+0.7448*fres/dist (cap 0.1483) | energy 0.3616+0.4869*p | flow 0.064167 c/s | soft 0.9062m
...
void main() {
    ...
    float refrAmp = min((0.5615 + 0.7448 * fresnel) / max(length(worldPos), 1.0), 0.1483);
