...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.010000, -0.040000) * time, time);
    deep += 0.4111 * deepField(duvBase + rimDir * 0.0676 + vec2(-0.016667, -0.062500) * time, time);
    deep = pow(clamp(deep * 0.7087, 0.0, 1.0), 1.3359);
