...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7186, 0.0, 1.0);
    ...
    deepCol += 0.4111 * dp * mix(baseCol, deepStop, 0.4291);
    deepPat += 0.4111 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 4.8938) + par * 0.1352, time);
    deepCol += 0.1690 * dp * mix(baseCol, deepStop, 0.8581);
    deepPat += 0.1690 * dp;
    deepCol *= 0.6866;
    deepPat = pow(clamp(deepPat * 0.6329, 0.0, 1.0), 1.3359);
    ...
    rgb += hotStop * 0.3019 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0771 + 0.3503 * presence + 0.4957 * pattern, 0.8473);
