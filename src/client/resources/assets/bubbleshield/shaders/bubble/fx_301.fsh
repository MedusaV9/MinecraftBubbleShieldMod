...
// stack: deep=caustic x3 taps | mid=caustic+none+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0771 + 0.3503 * presence + 0.4957 * pattern + 0.0923 * (1.0 - deepTrans), 0.8473);
