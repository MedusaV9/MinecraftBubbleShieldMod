...
// stack: deep=caustic x3 taps | mid=caustic+none+scroll | rim=graze | flourish=swirl | tex=caustic_web
// fbm: ridged x4 octaves | seed 9f51f7383da12d52
// v8 realism: refr 0.9375+1.2736*fres/dist (cap 0.1371) | energy 0.2186+0.3681*p | flow 0.070000 c/s | soft 0.5559m
...
void main() {
    ...
    float refrAmp = min((0.9375 + 1.2736 * fresnel) / max(length(worldPos), 1.0), 0.1371);
