...
// stack: deep=ridge x4 taps | mid=runecircuit+warp1+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0775 + 0.1557 * presence + 0.5748 * pattern + 0.0828 * (1.0 - deepTrans), 0.7922);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3274), 0.7922);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5412 + 0.4588 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
