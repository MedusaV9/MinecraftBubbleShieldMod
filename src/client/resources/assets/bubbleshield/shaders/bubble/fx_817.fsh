...
// stack: deep=fbm x4 taps | mid=plasmaglobe+warp2+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0747 + 0.0926 * presence + 0.5058 * pattern + 0.1097 * (1.0 - deepTrans), 0.8276);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2704), 0.8276);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4609 + 0.5391 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
