...
// v8 realism: refr 0.7498+0.9209*fres/dist (cap 0.1123) | energy 0.3371+0.4165*p | flow 0.091667 c/s | soft 0.7261m
...
void main() {
    ...
    float refrAmp = min((0.7498 + 0.9209 * fresnel) / max(length(worldPos), 1.0), 0.1123);
