...
// stack: deep=caustic x4 taps | mid=voronoi+curl+scroll | rim=graze_sparkle | flourish=glint | tex=worley_cells
// fbm: turb x5 octaves | seed b2174018bbccb09f
// v8 realism: refr 0.5206+0.5068*fres/dist (cap 0.1128) | energy 0.4132+0.5478*p | flow 0.054167 c/s | soft 0.6762m
...
void main() {
    ...
    float refrAmp = min((0.5206 + 0.5068 * fresnel) / max(length(worldPos), 1.0), 0.1128);
