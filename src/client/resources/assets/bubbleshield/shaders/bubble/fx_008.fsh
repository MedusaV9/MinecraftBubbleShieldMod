...
// stack: deep=caustic x4 taps | mid=voronoi+curl+scroll | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0726 + 0.2890 * presence + 0.3439 * pattern + 0.1081 * (1.0 - deepTrans), 0.8288);
