...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6166, 0.0, 1.0);
    ...
    deepCol += 0.4213 * dp * mix(baseCol, deepStop, 0.2166);
    deepPat += 0.4213 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 3.5471) + par * 0.1310, time);
    deepCol += 0.1775 * dp * mix(baseCol, deepStop, 0.4332);
    deepPat += 0.1775 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 4.4056) + par * 0.1965, time);
    deepCol += 0.0748 * dp * mix(baseCol, deepStop, 0.6498);
    deepPat += 0.0748 * dp;
    deepCol *= 0.7208;
    deepPat = pow(clamp(deepPat * 0.5975, 0.0, 1.0), 1.5373);
    ...
    rgb += hotStop * 0.2016 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0726 + 0.2890 * presence + 0.3439 * pattern, 0.8288);
