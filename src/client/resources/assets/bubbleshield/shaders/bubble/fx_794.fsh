...
// stack: deep=caustic x4 taps | mid=deepice+warp2+rotate | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0785 + 0.3879 * presence + 0.3738 * pattern + 0.1113 * (1.0 - deepTrans), 0.8658);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2149), 0.8658);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4885 + 0.5115 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
