...
// stack: deep=caustic x4 taps | mid=deepice+warp2+rotate | rim=lat | flourish=echo | tex=cracked_glass
// fbm: turb x3 octaves | seed a9e5cb8ed41d4858
// v8 realism: refr 0.9208+1.0624*fres/dist (cap 0.1142) | energy 0.2613+0.4645*p | flow 0.097500 c/s | soft 0.5892m
...
void main() {
    ...
    float refrAmp = min((0.9208 + 1.0624 * fresnel) / max(length(worldPos), 1.0), 0.1142);
