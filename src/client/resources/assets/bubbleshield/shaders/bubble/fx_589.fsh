...
// stack: deep=ridge x4 taps | mid=stainedglass+none+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0403 + 0.3438 * presence + 0.4505 * pattern + 0.1045 * (1.0 - deepTrans), 0.8804);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2540), 0.8804);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5264 + 0.4736 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
