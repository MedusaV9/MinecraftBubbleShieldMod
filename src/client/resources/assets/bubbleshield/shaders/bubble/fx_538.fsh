...
// stack: deep=caustic x4 taps | mid=ectoplasm+warp2+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0751 + 0.1455 * presence + 0.4120 * pattern + 0.0812 * (1.0 - deepTrans), 0.7925);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1643), 0.7925);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4977 + 0.5023 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
