...
// stack: deep=ridge x3 taps | mid=holoparallax+warp2+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0733 + 0.1415 * presence + 0.5641 * pattern + 0.1368 * (1.0 - deepTrans), 0.8560);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1724), 0.8560);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4596 + 0.5404 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
