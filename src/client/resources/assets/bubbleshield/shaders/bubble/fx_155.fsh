...
// stack: deep=ridge x3 taps | mid=interference+none+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0724 + 0.3158 * presence + 0.4695 * pattern + 0.0964 * (1.0 - deepTrans), 0.8462);
