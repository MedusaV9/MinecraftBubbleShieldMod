...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6698, 0.0, 1.0);
    ...
    deepCol += 0.4400 * dp * mix(baseCol, deepStop, 0.3702);
    deepPat += 0.4400 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 2.8443) + par * 0.0755, time);
    deepCol += 0.1936 * dp * mix(baseCol, deepStop, 0.7404);
    deepPat += 0.1936 * dp;
    deepCol *= 0.6811;
    deepPat = pow(clamp(deepPat * 0.6121, 0.0, 1.0), 1.2700);
    ...
    rgb += hotStop * 0.2542 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0724 + 0.3158 * presence + 0.4695 * pattern, 0.8462);
