...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8395, 0.0, 1.0);
    ...
    deepCol += 0.4423 * dp * mix(baseCol, deepStop, 0.4274);
    deepPat += 0.4423 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 3.2274) + par * 0.1590, time);
    deepCol += 0.1957 * dp * mix(baseCol, deepStop, 0.8548);
    deepPat += 0.1957 * dp;
    deepCol *= 0.5820;
    deepPat = pow(clamp(deepPat * 0.6105, 0.0, 1.0), 1.3785);
    ...
    rgb += hotStop * 0.1888 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0460 + 0.3506 * presence + 0.3626 * pattern, 0.8562);
