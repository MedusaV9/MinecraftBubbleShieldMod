...
// stack: deep=voro x3 taps | mid=emberstorm+none+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0460 + 0.2080 * presence + 0.4855 * pattern + 0.1197 * (1.0 - deepTrans), 0.8562);
