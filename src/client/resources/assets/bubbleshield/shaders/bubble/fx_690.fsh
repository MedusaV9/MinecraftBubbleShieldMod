...
// stack: deep=fbm x4 taps | mid=phantomecho+none+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0499 + 0.1288 * presence + 0.6066 * pattern + 0.1525 * (1.0 - deepTrans), 0.7416);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3294), 0.7416);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5448 + 0.4552 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
