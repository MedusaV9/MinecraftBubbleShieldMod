...
// stack: deep=caustic x3 taps | mid=interference+curl+pulse | rim=graze_film | flourish=swirl | tex=caustic_web
// fbm: ridged x5 octaves | seed 345fa8b89bce26aa
// v8 realism: refr 1.0192+1.2213*fres/dist (cap 0.1498) | energy 0.1825+0.4610*p | flow 0.065833 c/s | soft 0.7658m
...
void main() {
    ...
    float refrAmp = min((1.0192 + 1.2213 * fresnel) / max(length(worldPos), 1.0), 0.1498);
