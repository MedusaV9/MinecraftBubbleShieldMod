...
// stack: deep=caustic x3 taps | mid=interference+curl+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0499 + 0.3533 * presence + 0.4055 * pattern + 0.1545 * (1.0 - deepTrans), 0.8143);
