...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6002, 0.0, 1.0);
    ...
    deepCol += 0.5661 * dp * mix(baseCol, deepStop, 0.3660);
    deepPat += 0.5661 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 4.0169) + par * 0.0854, time);
    deepCol += 0.3204 * dp * mix(baseCol, deepStop, 0.7319);
    deepPat += 0.3204 * dp;
    deepCol *= 0.5634;
    deepPat = pow(clamp(deepPat * 0.5301, 0.0, 1.0), 1.0844);
    ...
    rgb += hotStop * 0.2438 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0499 + 0.3533 * presence + 0.4055 * pattern, 0.8143);
