...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.329867);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.016667, -0.042500) * time, time);
    deep += 0.4646 * deepField(duvBase + rimDir * 0.0762 + vec2(-0.025000, -0.065000) * time, time);
    deep += 0.2158 * deepField(duvBase + rimDir * 0.1525 + vec2(-0.035000, -0.087500) * time, time);
    deep = pow(clamp(deep * 0.5951, 0.0, 1.0), 1.6690);
