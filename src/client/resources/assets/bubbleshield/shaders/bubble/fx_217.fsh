...
void main() {
    ...
    mid = clamp(mid * (0.6497 + 0.5428 * texDetail) + 0.2734 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3871), 0.0, 1.0);
    float emit = atlas.a * (0.6000 + 0.2916 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1128 * (0.5 + 0.5 * sin(time * 0.225147)));
    ...
    float alpha = vertexColor.a * min(0.2818 + 0.3144 * presence + 0.5681 * pattern + 0.1198 * (1.0 - deepTrans) + 0.2140 * emit, 0.8571);
