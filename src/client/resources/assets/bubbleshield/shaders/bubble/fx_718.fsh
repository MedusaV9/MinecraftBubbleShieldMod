...
// stack: deep=caustic x3 taps | mid=ectoplasm+curl+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0720 + 0.1903 * presence + 0.5075 * pattern + 0.1011 * (1.0 - deepTrans), 0.8161);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2993), 0.8161);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4108 + 0.5892 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
