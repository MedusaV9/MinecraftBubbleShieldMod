...
// stack: deep=ridge x3 taps | mid=gravlens+warp1+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0774 + 0.1030 * presence + 0.4902 * pattern + 0.1097 * (1.0 - deepTrans), 0.7855);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3190), 0.7855);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5062 + 0.4938 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
