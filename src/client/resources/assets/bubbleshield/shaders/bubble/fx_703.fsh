...
// stack: deep=voro x4 taps | mid=holoparallax+curl+flicker | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0665 + 0.1295 * presence + 0.5697 * pattern + 0.1446 * (1.0 - deepTrans), 0.8526);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1555), 0.8526);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5109 + 0.4891 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
