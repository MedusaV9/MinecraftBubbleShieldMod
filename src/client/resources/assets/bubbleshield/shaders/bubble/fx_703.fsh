...
void main() {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        hpAcc += (hpGrid * 0.6999 + hpScan * 0.1666) * (1.0 - fi * 0.1720);
    }
    ...
    float mid = clamp(hpAcc * hpFlick + hpSync * 0.5088, 0.0, 1.25);
    ...
    float flourish = 0.3428 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
