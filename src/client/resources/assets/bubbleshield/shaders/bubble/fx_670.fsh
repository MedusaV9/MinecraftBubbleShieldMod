...
// stack: deep=fbm x4 taps | mid=phantomecho+warp1+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0583 + 0.1370 * presence + 0.5586 * pattern + 0.1446 * (1.0 - deepTrans), 0.7879);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3148), 0.7879);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3849 + 0.6151 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
