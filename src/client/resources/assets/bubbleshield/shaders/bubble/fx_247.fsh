...
// stack: deep=caustic x3 taps | mid=lightning+warp1+scroll | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0697 + 0.3437 * presence + 0.4328 * pattern + 0.1209 * (1.0 - deepTrans), 0.7845);
