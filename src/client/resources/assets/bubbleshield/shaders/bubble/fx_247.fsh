...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.040000, 0.015000) * time, time);
    deep += 0.3914 * deepField(duvBase + rimDir * 0.0623 + vec2(0.061667, 0.025000) * time, time);
    deep = pow(clamp(deep * 0.7187, 0.0, 1.0), 1.2814);
    ...
    float n = fbm2(wuv + vec2(0.0, time * 0.691667), midPer);
