...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6049, 0.0, 1.0);
    ...
    deepCol += 0.3914 * dp * mix(baseCol, deepStop, 0.4059);
    deepPat += 0.3914 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 3.7064) + par * 0.1246, time);
    deepCol += 0.1532 * dp * mix(baseCol, deepStop, 0.8118);
    deepPat += 0.1532 * dp;
    deepCol *= 0.8266;
    deepPat = pow(clamp(deepPat * 0.6474, 0.0, 1.0), 1.2814);
    ...
    rgb += hotStop * 0.3313 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0697 + 0.3437 * presence + 0.4328 * pattern, 0.7845);
