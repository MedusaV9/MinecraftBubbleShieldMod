...
void main() {
    ...
    mid = clamp(mid * (0.6323 + 0.6736 * texDetail) + 0.1991 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7648 + 0.4764 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0882 * (0.5 + 0.5 * sin(time * 0.115192)));
    rgb += emit * 0.8325 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4160 + 0.4837 * presence + 0.4328 * pattern + 0.1209 * (1.0 - deepTrans) + 0.1893 * emit, 0.8445);
