...
// stack: deep=ridge x4 taps | mid=voidtendril+none+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0794 + 0.2566 * presence + 0.4362 * pattern + 0.1180 * (1.0 - deepTrans), 0.7992);
