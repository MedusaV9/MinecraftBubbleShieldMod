...
void main() {
    ...
    mid = clamp(mid * (0.7367 + 0.5821 * texDetail) + 0.2511 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6164 + 0.3484 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1294 * (0.5 + 0.5 * sin(time * 0.125664)));
    rgb += emit * 0.7950 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4115 + 0.4290 * presence + 0.3644 * pattern + 0.1085 * (1.0 - deepTrans) + 0.1654 * emit, 0.8911);
