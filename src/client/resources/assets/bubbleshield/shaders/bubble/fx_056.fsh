...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8341, 0.0, 1.0);
    ...
    deepCol += 0.5206 * dp * mix(baseCol, deepStop, 0.3988);
    deepPat += 0.5206 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 3.9126) + par * 0.0990, time);
    deepCol += 0.2711 * dp * mix(baseCol, deepStop, 0.7975);
    deepPat += 0.2711 * dp;
    deepCol *= 0.5802;
    deepPat = pow(clamp(deepPat * 0.5581, 0.0, 1.0), 1.2020);
    ...
    rgb += hotStop * 0.2151 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0722 + 0.2907 * presence + 0.4588 * pattern, 0.8110);
