...
void main() {
    ...
    mid = clamp(mid * (0.6455 + 0.6088 * texDetail) + 0.2696 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4397), 0.0, 1.0);
    float emit = atlas.a * (0.6185 + 0.4969 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1237 * (0.5 + 0.5 * sin(time * 0.115192)));
    ...
    float alpha = vertexColor.a * min(0.4234 + 0.4307 * presence + 0.4588 * pattern + 0.0895 * (1.0 - deepTrans) + 0.1704 * emit, 0.8710);
