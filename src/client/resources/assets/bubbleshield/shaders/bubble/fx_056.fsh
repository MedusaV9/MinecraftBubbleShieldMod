...
// stack: deep=fbm x3 taps | mid=plasma+none+rotate | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0722 + 0.2907 * presence + 0.4588 * pattern + 0.0895 * (1.0 - deepTrans), 0.8110);
