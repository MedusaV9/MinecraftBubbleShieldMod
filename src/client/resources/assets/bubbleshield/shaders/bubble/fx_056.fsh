...
// stack: deep=fbm x3 taps | mid=plasma+none+rotate | rim=graze_film | flourish=shimmer | tex=nebula
// fbm: standard x5 octaves | seed 2a91c35829df3c28
// v8 realism: refr 0.6004+0.5502*fres/dist (cap 0.1345) | energy 0.4117+0.4894*p | flow 0.068333 c/s | soft 0.7596m
...
void main() {
    ...
    float refrAmp = min((0.6004 + 0.5502 * fresnel) / max(length(worldPos), 1.0), 0.1345);
