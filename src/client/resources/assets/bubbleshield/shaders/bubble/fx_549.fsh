...
// stack: deep=voro x3 taps | mid=stainedglass+curl+pulse | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0657 + 0.3110 * presence + 0.3610 * pattern + 0.1284 * (1.0 - deepTrans), 0.8965);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2744), 0.8965);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4155 + 0.5845 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
