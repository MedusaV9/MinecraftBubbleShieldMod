...
// stack: deep=ridge x4 taps | mid=spectralveil+none+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0409 + 0.1055 * presence + 0.4527 * pattern + 0.1546 * (1.0 - deepTrans), 0.8016);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2283), 0.8016);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4913 + 0.5087 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
