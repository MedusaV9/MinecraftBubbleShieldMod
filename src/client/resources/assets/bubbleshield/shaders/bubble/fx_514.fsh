...
// stack: deep=voro x4 taps | mid=deepice+none+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0678 + 0.3423 * presence + 0.4482 * pattern + 0.1341 * (1.0 - deepTrans), 0.8813);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2045), 0.8813);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5174 + 0.4826 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
