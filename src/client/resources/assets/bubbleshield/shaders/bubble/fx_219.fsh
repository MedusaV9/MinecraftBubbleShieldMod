...
// stack: deep=voro x4 taps | mid=truchet+warp1+scroll | rim=graze_film | flourish=echo | tex=runes
// fbm: turb x3 octaves | seed 2bc4d10ae8c57bdb
// v8 realism: refr 0.4585+0.5369*fres/dist (cap 0.1532) | energy 0.3615+0.4937*p | flow 0.097500 c/s | soft 0.5776m
...
void main() {
    ...
    float refrAmp = min((0.4585 + 0.5369 * fresnel) / max(length(worldPos), 1.0), 0.1532);
