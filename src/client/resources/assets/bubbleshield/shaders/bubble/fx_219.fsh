...
void main() {
    ...
    mid = clamp(mid * (0.7327 + 0.4670 * texDetail) + 0.3115 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.5271), 0.0, 1.0);
    float emit = atlas.a * (0.6723 + 0.4350 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1623 * (0.5 + 0.5 * sin(time * 0.183260)));
    rgb += emit * 0.6576 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3997 + 0.4164 * presence + 0.3412 * pattern + 0.1010 * (1.0 - deepTrans) + 0.1423 * emit, 0.8671);
