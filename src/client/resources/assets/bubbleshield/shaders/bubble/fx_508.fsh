...
// stack: deep=caustic x3 taps | mid=aethersmoke+none+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0545 + 0.2202 * presence + 0.3889 * pattern + 0.1389 * (1.0 - deepTrans), 0.7903);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2614), 0.7903);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3838 + 0.6162 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
