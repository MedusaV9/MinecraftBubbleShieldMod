...
// stack: deep=fbm x3 taps | mid=spectralveil+warp2+flicker | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0748 + 0.1638 * presence + 0.4819 * pattern + 0.1227 * (1.0 - deepTrans), 0.7343);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2082), 0.7343);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5036 + 0.4964 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
