...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7573, 0.0, 1.0);
    ...
    deepCol += 0.4915 * dp * mix(baseCol, deepStop, 0.3673);
    deepPat += 0.4915 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 3.9693) + par * 0.1187, time);
    deepCol += 0.2415 * dp * mix(baseCol, deepStop, 0.7347);
    deepPat += 0.2415 * dp;
    deepCol *= 0.6505;
    deepPat = pow(clamp(deepPat * 0.5770, 0.0, 1.0), 1.3845);
    ...
    rgb += hotStop * 0.2088 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0487 + 0.2422 * presence + 0.4653 * pattern, 0.8276);
