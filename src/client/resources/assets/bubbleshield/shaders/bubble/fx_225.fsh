...
// stack: deep=caustic x3 taps | mid=starfield+none+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0487 + 0.1013 * presence + 0.5710 * pattern + 0.1554 * (1.0 - deepTrans), 0.8276);
