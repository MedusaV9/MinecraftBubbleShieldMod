...
void main() {
    ...
    mid = clamp(mid * (0.6165 + 0.5555 * texDetail) + 0.3324 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7032 + 0.3452 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1046 * (0.5 + 0.5 * sin(time * 0.240855)));
    rgb += emit * 0.7106 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.2859 + 0.2413 * presence + 0.5710 * pattern + 0.1554 * (1.0 - deepTrans) + 0.1419 * emit, 0.8876);
