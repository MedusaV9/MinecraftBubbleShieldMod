...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.006667, 0.020000) * time, time);
    deep += 0.4915 * deepField(duvBase + rimDir * 0.0594 + vec2(-0.010000, 0.030000) * time, time);
    deep = pow(clamp(deep * 0.6705, 0.0, 1.0), 1.3845);
