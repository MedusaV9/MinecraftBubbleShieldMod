...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7778, 0.0, 1.0);
    ...
    deepCol += 0.4191 * dp * mix(baseCol, deepStop, 0.3687);
    deepPat += 0.4191 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.3664) + par * 0.0777, time);
    deepCol += 0.1756 * dp * mix(baseCol, deepStop, 0.7375);
    deepPat += 0.1756 * dp;
    deepCol *= 0.7712;
    deepPat = pow(clamp(deepPat * 0.6271, 0.0, 1.0), 1.1024);
    ...
    float alpha = vertexColor.a * min(0.0552 + 0.2857 * presence + 0.4135 * pattern, 0.8066);
