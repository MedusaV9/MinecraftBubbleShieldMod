...
void main() {
    ...
    mid = clamp(mid * (0.6554 + 0.4906 * texDetail) + 0.3437 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3960), 0.0, 1.0);
    float emit = atlas.a * (0.7351 + 0.2753 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1275 * (0.5 + 0.5 * sin(time * 0.188496)));
    ...
    float alpha = vertexColor.a * min(0.3730 + 0.4257 * presence + 0.4135 * pattern + 0.1374 * (1.0 - deepTrans) + 0.1882 * emit, 0.8666);
