...
// stack: deep=fbm x3 taps | mid=triweave+none+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0552 + 0.2857 * presence + 0.4135 * pattern + 0.1374 * (1.0 - deepTrans), 0.8066);
