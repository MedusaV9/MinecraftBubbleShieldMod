...
// stack: deep=fbm x4 taps | mid=moire+curl+rotate | rim=graze_sparkle | flourish=shimmer | tex=chrome
// fbm: standard x6 octaves | seed e5fad80f4f5e183b
// v8 realism: refr 0.9241+1.4834*fres/dist (cap 0.1418) | energy 0.2104+0.4027*p | flow 0.097500 c/s | soft 1.0620m
...
void main() {
    ...
    float refrAmp = min((0.9241 + 1.4834 * fresnel) / max(length(worldPos), 1.0), 0.1418);
