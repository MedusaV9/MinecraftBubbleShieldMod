...
void main() {
    ...
    mid = clamp(mid * (0.6466 + 0.4558 * texDetail) + 0.2710 * texDetail, 0.0, 1.5);
    ...
    rim = clamp(rim + 0.7014 * rimLine, 0.0, 1.4);
    ...
    float emit = atlas.a * (0.7010 + 0.4508 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0870 * (0.5 + 0.5 * sin(time * 0.293215)));
    rgb += emit * 0.7624 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3951 + 0.4265 * presence + 0.3614 * pattern + 0.0837 * (1.0 - deepTrans) + 0.2157 * emit, 0.8432);
