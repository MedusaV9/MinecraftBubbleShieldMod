...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.471239);
...
void main() {
    ...
    deep += 0.4753 * deepField(duvBase + rimDir * 0.0746 + vec2(-0.065000, 0.070000) * time, time);
    deep += 0.2259 * deepField(duvBase + rimDir * 0.1491 + vec2(-0.086667, 0.095000) * time, time);
    deep += 0.1074 * deepField(duvBase + rimDir * 0.2237 + vec2(-0.110000, 0.120000) * time, time);
    deep = pow(clamp(deep * 0.5529, 0.0, 1.0), 1.6481);
