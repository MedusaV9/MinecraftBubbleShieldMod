...
// stack: deep=voro x4 taps | mid=rings+curl+scroll | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0404 + 0.3040 * presence + 0.4569 * pattern + 0.1322 * (1.0 - deepTrans), 0.8209);
