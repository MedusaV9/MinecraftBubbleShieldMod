...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5962, 0.0, 1.0);
    ...
    deepCol += 0.4753 * dp * mix(baseCol, deepStop, 0.2311);
    deepPat += 0.4753 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 3.7270) + par * 0.1491, time);
    deepCol += 0.2259 * dp * mix(baseCol, deepStop, 0.4622);
    deepPat += 0.2259 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 4.5999) + par * 0.2237, time);
    deepCol += 0.1074 * dp * mix(baseCol, deepStop, 0.6932);
    deepPat += 0.1074 * dp;
    deepCol *= 0.6189;
    deepPat = pow(clamp(deepPat * 0.5529, 0.0, 1.0), 1.6481);
    ...
    float alpha = vertexColor.a * min(0.0404 + 0.3040 * presence + 0.4569 * pattern, 0.8209);
