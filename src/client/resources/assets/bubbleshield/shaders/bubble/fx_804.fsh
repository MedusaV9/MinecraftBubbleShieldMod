...
// stack: deep=voro x3 taps | mid=orbittrap+curl+scroll | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0471 + 0.1899 * presence + 0.4664 * pattern + 0.0989 * (1.0 - deepTrans), 0.8503);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1688), 0.8503);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4400 + 0.5600 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
