...
// stack: deep=fbm x3 taps | mid=gravlens+warp2+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0623 + 0.1366 * presence + 0.5263 * pattern + 0.1034 * (1.0 - deepTrans), 0.8384);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2410), 0.8384);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4817 + 0.5183 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
