...
// stack: deep=caustic x4 taps | mid=sparkle+warp1+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0784 + 0.3470 * presence + 0.3545 * pattern + 0.1008 * (1.0 - deepTrans), 0.8529);
