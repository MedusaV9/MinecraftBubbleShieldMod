...
// stack: deep=fbm x4 taps | mid=ridged+curl+rotate | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0592 + 0.2948 * presence + 0.3517 * pattern + 0.1000 * (1.0 - deepTrans), 0.7884);
