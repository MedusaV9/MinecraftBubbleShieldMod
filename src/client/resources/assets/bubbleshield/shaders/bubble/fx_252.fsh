...
// stack: deep=fbm x4 taps | mid=ridged+curl+rotate | rim=graze | flourish=glint | tex=ridged
// fbm: standard x6 octaves | seed d1077637023a5c3b
// v8 realism: refr 0.5331+0.7965*fres/dist (cap 0.1085) | energy 0.3215+0.4976*p | flow 0.110833 c/s | soft 0.5504m
...
void main() {
    ...
    float refrAmp = min((0.5331 + 0.7965 * fresnel) / max(length(worldPos), 1.0), 0.1085);
