...
void main() {
    ...
    mid = clamp(mid * (0.6165 + 0.4836 * texDetail) + 0.2525 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6200 + 0.4255 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1560 * (0.5 + 0.5 * sin(time * 0.272271)));
    rgb += emit * 0.9746 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3850 + 0.4348 * presence + 0.3517 * pattern + 0.1000 * (1.0 - deepTrans) + 0.1651 * emit, 0.8484);
