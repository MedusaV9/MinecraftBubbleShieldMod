...
// stack: deep=caustic x3 taps | mid=prismdisperse+warp1+rotate | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0543 + 0.2626 * presence + 0.3927 * pattern + 0.0826 * (1.0 - deepTrans), 0.8174);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3181), 0.8174);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3940 + 0.6060 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
