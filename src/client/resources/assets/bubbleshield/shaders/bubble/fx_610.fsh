...
// stack: deep=fbm x4 taps | mid=phantomecho+warp1+flicker | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0681 + 0.1422 * presence + 0.5934 * pattern + 0.1254 * (1.0 - deepTrans), 0.8345);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2896), 0.8345);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5393 + 0.4607 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
