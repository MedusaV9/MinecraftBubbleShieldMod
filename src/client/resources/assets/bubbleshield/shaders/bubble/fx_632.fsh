...
// stack: deep=caustic x3 taps | mid=mycelia+curl+rotate | rim=lat | flourish=swirl | tex=filaments
// fbm: standard x6 octaves | seed 2d24a817d21cc8a5
// v8 realism: refr 0.3922+0.4906*fres/dist (cap 0.1381) | energy 0.5290+0.3978*p | flow 0.070000 c/s | soft 0.7164m
...
void main() {
    ...
    float refrAmp = min((0.3922 + 0.4906 * fresnel) / max(length(worldPos), 1.0), 0.1381);
