...
// stack: deep=caustic x4 taps | mid=deepice+curl+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0469 + 0.2956 * presence + 0.3210 * pattern + 0.1530 * (1.0 - deepTrans), 0.8580);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1742), 0.8580);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4158 + 0.5842 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
