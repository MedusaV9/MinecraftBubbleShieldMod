...
// stack: deep=fbm x4 taps | mid=petals+curl+rotate | rim=lat | flourish=glint | tex=scales
// fbm: ridged x5 octaves | seed 293f3d945144486a
// v8 realism: refr 0.6320+0.8528*fres/dist (cap 0.1425) | energy 0.4140+0.4891*p | flow 0.063333 c/s | soft 0.9845m
...
void main() {
    ...
    float refrAmp = min((0.6320 + 0.8528 * fresnel) / max(length(worldPos), 1.0), 0.1425);
