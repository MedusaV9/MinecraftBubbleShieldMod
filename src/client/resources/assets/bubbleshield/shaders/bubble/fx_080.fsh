...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6913, 0.0, 1.0);
    ...
    deepCol += 0.5538 * dp * mix(baseCol, deepStop, 0.2738);
    deepPat += 0.5538 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 3.6851) + par * 0.1555, time);
    deepCol += 0.3067 * dp * mix(baseCol, deepStop, 0.5475);
    deepPat += 0.3067 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 4.6704) + par * 0.2332, time);
    deepCol += 0.1698 * dp * mix(baseCol, deepStop, 0.8213);
    deepPat += 0.1698 * dp;
    deepCol *= 0.4728;
    deepPat = pow(clamp(deepPat * 0.4925, 0.0, 1.0), 1.1249);
    ...
    float alpha = vertexColor.a * min(0.0661 + 0.3658 * presence + 0.3477 * pattern, 0.8562);
