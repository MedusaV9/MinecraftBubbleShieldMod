...
// stack: deep=fbm x4 taps | mid=voronoi+warp2+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0689 + 0.3261 * presence + 0.4243 * pattern + 0.1361 * (1.0 - deepTrans), 0.8394);
