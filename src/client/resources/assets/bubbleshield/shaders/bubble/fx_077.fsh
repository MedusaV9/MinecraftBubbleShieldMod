...
void main() {
    ...
    mid = clamp(mid * (0.6394 + 0.5737 * texDetail) + 0.2559 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6870 + 0.4218 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1537 * (0.5 + 0.5 * sin(time * 0.136136)));
    rgb += emit * 0.7919 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4135 + 0.4661 * presence + 0.4243 * pattern + 0.1361 * (1.0 - deepTrans) + 0.1286 * emit, 0.8994);
