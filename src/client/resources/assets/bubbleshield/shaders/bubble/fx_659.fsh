...
// stack: deep=fbm x4 taps | mid=voidrift+warp1+pulse | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0704 + 0.2279 * presence + 0.4975 * pattern + 0.1179 * (1.0 - deepTrans), 0.8055);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2458), 0.8055);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3802 + 0.6198 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
