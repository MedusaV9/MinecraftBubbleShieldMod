...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6077, 0.0, 1.0);
    ...
    deepCol += 0.5510 * dp * mix(baseCol, deepStop, 0.3992);
    deepPat += 0.5510 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 4.6552) + par * 0.1463, time);
    deepCol += 0.3036 * dp * mix(baseCol, deepStop, 0.7985);
    deepPat += 0.3036 * dp;
    deepCol *= 0.5216;
    deepPat = pow(clamp(deepPat * 0.5392, 0.0, 1.0), 1.0074);
    ...
    float alpha = vertexColor.a * min(0.0666 + 0.3512 * presence + 0.3475 * pattern, 0.8578);
