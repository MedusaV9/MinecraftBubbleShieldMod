...
// stack: deep=ridge x3 taps | mid=thinfilm+none+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0666 + 0.3512 * presence + 0.3475 * pattern + 0.0815 * (1.0 - deepTrans), 0.8578);
