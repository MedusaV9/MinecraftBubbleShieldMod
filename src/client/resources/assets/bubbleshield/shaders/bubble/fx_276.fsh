...
void main() {
    ...
    mid = clamp(mid * (0.7144 + 0.7142 * texDetail) + 0.2188 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7767 + 0.3147 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1476 * (0.5 + 0.5 * sin(time * 0.183260)));
    rgb += emit * 0.8762 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4069 + 0.4912 * presence + 0.3475 * pattern + 0.0815 * (1.0 - deepTrans) + 0.1502 * emit, 0.9178);
