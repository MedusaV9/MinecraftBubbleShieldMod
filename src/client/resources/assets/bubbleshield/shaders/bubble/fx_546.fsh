...
// stack: deep=caustic x4 taps | mid=fluidink+curl+rotate | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0775 + 0.2218 * presence + 0.3470 * pattern + 0.1404 * (1.0 - deepTrans), 0.7896);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2599), 0.7896);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4331 + 0.5669 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
