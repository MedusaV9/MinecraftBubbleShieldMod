...
// stack: deep=fbm x4 taps | mid=portalvoid+curl+pulse | rim=graze_sparkle | flourish=glint | tex=nebula
// fbm: ridged x6 octaves | seed 4b9bfc94a9462d9d
// v8 realism: refr 0.4098+0.3628*fres/dist (cap 0.1548) | energy 0.4336+0.4535*p | flow 0.102500 c/s | soft 0.9930m
...
void main() {
    ...
    float refrAmp = min((0.4098 + 0.3628 * fresnel) / max(length(worldPos), 1.0), 0.1548);
