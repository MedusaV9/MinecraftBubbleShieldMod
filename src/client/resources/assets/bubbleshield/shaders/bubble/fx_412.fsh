...
// stack: deep=fbm x4 taps | mid=portalvoid+curl+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0634 + 0.1498 * presence + 0.5009 * pattern + 0.1315 * (1.0 - deepTrans), 0.8565);
