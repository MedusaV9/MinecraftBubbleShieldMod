...
void main() {
    ...
    float mid = clamp(rfLight * 1.1259 + (1.0 - rfTrans) * 0.1640, 0.0, 1.15);
    ...
    float alpha = vertexColor.a * min(0.0783 + 0.3235 * presence + 0.3585 * pattern + 0.0829 * (1.0 - deepTrans), 0.8313);
    // [layer:v5:backface]
