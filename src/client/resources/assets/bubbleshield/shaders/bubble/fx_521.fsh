...
// stack: deep=ridge x3 taps | mid=raymarchfog+warp1+flicker | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0783 + 0.2435 * presence + 0.3585 * pattern + 0.0829 * (1.0 - deepTrans), 0.8313);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2955), 0.8313);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5313 + 0.4687 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
