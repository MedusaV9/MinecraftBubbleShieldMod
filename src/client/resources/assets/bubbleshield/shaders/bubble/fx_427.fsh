...
// stack: deep=ridge x4 taps | mid=irisfilm+curl+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0478 + 0.2160 * presence + 0.4205 * pattern + 0.0939 * (1.0 - deepTrans), 0.7768);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2989), 0.7768);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4110 + 0.5890 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
