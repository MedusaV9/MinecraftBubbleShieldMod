...
// stack: deep=ridge x4 taps | mid=irisfilm+curl+flicker | rim=lat | flourish=shimmer | tex=chrome
// fbm: standard x4 octaves | seed 152a79e666bc0d68
// v8 realism: refr 0.8834+0.9944*fres/dist (cap 0.1165) | energy 0.2543+0.4145*p | flow 0.107500 c/s | soft 1.0115m
...
void main() {
    ...
    float refrAmp = min((0.8834 + 0.9944 * fresnel) / max(length(worldPos), 1.0), 0.1165);
