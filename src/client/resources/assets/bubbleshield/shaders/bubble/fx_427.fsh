...
void main() {
    ...
    mid = clamp(mid * (0.7008 + 0.5703 * texDetail) + 0.3009 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5600 + 0.4471 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1094 * (0.5 + 0.5 * sin(time * 0.172788)));
    rgb += emit * 0.8565 * emitCol;
    // [layer:v5:softknee]
    ...
    float alpha = vertexColor.a * min(0.3125 + 0.3560 * presence + 0.4205 * pattern + 0.0939 * (1.0 - deepTrans) + 0.1824 * emit, 0.8368);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2989), 0.8368);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.6492 + 0.3508 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
