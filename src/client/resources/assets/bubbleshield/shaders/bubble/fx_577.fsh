...
// stack: deep=fbm x3 taps | mid=plasmaglobe+curl+pulse | rim=graze_sparkle | flourish=swirl | tex=filaments
// fbm: standard x3 octaves | seed 5893d182d5b8f627
// v8 realism: refr 0.4742+0.5884*fres/dist (cap 0.1465) | energy 0.3299+0.4499*p | flow 0.059167 c/s | soft 0.8571m
...
void main() {
    ...
    float refrAmp = min((0.4742 + 0.5884 * fresnel) / max(length(worldPos), 1.0), 0.1465);
