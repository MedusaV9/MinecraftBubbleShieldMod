...
// stack: deep=fbm x3 taps | mid=plasmaglobe+curl+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0671 + 0.0645 * presence + 0.5687 * pattern + 0.1223 * (1.0 - deepTrans), 0.8381);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1908), 0.8381);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4565 + 0.5435 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
