...
void main() {
    ...
    float flourish = 0.2532 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
    ...
    float alpha = vertexColor.a * min(0.0716 + 0.2543 * presence + 0.4203 * pattern + 0.1539 * (1.0 - deepTrans), 0.8331);
    // [layer:v5:backface]
