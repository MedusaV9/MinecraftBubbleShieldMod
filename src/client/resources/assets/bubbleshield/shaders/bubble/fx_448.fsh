...
// stack: deep=ridge x3 taps | mid=aethersmoke+warp2+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0716 + 0.1943 * presence + 0.4203 * pattern + 0.1539 * (1.0 - deepTrans), 0.8331);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3035), 0.8331);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4270 + 0.5730 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
