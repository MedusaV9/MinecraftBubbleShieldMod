...
// stack: deep=voro x4 taps | mid=phantomecho+curl+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0445 + 0.1541 * presence + 0.6002 * pattern + 0.0928 * (1.0 - deepTrans), 0.8151);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3369), 0.8151);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4839 + 0.5161 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
