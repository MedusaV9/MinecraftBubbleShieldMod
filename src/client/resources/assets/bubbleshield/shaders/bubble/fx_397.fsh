...
// stack: deep=ridge x4 taps | mid=biolume+warp1+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0747 + 0.1434 * presence + 0.5137 * pattern + 0.1449 * (1.0 - deepTrans), 0.8792);
