...
// stack: deep=ridge x4 taps | mid=aethersmoke+curl+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0479 + 0.2369 * presence + 0.3631 * pattern + 0.1581 * (1.0 - deepTrans), 0.7809);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2790), 0.7809);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4371 + 0.5629 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
