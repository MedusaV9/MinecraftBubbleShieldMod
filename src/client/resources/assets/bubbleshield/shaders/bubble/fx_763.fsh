...
// stack: deep=fbm x4 taps | mid=holoparallax+warp2+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0573 + 0.1134 * presence + 0.5667 * pattern + 0.1103 * (1.0 - deepTrans), 0.8247);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3422), 0.8247);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4815 + 0.5185 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
