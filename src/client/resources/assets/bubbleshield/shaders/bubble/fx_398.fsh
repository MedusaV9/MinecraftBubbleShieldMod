...
// stack: deep=ridge x4 taps | mid=hologrid+warp1+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0545 + 0.1760 * presence + 0.6076 * pattern + 0.0985 * (1.0 - deepTrans), 0.7851);
