...
// stack: deep=fbm x3 taps | mid=deepice+none+pulse | rim=graze_sparkle | flourish=glint | tex=cracked_glass
// fbm: ridged x3 octaves | seed c5d2122b974e1e17
// v8 realism: refr 0.9211+1.0289*fres/dist (cap 0.1047) | energy 0.2264+0.4314*p | flow 0.114167 c/s | soft 0.6490m
...
void main() {
    ...
    float refrAmp = min((0.9211 + 1.0289 * fresnel) / max(length(worldPos), 1.0), 0.1047);
