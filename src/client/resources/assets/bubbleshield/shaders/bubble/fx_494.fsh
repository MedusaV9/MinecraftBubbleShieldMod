...
// stack: deep=fbm x3 taps | mid=deepice+none+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0431 + 0.3133 * presence + 0.3605 * pattern + 0.0824 * (1.0 - deepTrans), 0.8258);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2256), 0.8258);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5271 + 0.4729 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
