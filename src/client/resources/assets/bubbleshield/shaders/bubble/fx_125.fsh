...
void main() {
    ...
    mid = clamp(mid * (0.6416 + 0.6053 * texDetail) + 0.2430 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6856 + 0.3088 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1734 * (0.5 + 0.5 * sin(time * 0.104720)));
    rgb += emit * 0.6890 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4069 + 0.4019 * presence + 0.3320 * pattern + 0.1377 * (1.0 - deepTrans) + 0.1625 * emit, 0.8636);
