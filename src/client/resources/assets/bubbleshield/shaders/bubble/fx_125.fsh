...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6053, 0.0, 1.0);
    ...
    deepCol += 0.4648 * dp * mix(baseCol, deepStop, 0.3503);
    deepPat += 0.4648 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 5.0241) + par * 0.1553, time);
    deepCol += 0.2160 * dp * mix(baseCol, deepStop, 0.7006);
    deepPat += 0.2160 * dp;
    deepCol *= 0.6168;
    deepPat = pow(clamp(deepPat * 0.5950, 0.0, 1.0), 1.6433);
    ...
    rgb += hotStop * 0.3445 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0666 + 0.2619 * presence + 0.3320 * pattern, 0.8036);
