...
// stack: deep=caustic x4 taps | mid=irisfilm+warp1+rotate | rim=graze_sparkle | flourish=glint | tex=chrome
// fbm: ridged x4 octaves | seed d49cf1def53037ce
// v8 realism: refr 0.7424+1.0585*fres/dist (cap 0.1350) | energy 0.2257+0.4241*p | flow 0.117500 c/s | soft 1.0636m
...
void main() {
    ...
    float refrAmp = min((0.7424 + 1.0585 * fresnel) / max(length(worldPos), 1.0), 0.1350);
