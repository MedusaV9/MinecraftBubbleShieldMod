...
// stack: deep=caustic x4 taps | mid=irisfilm+warp1+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0653 + 0.1869 * presence + 0.4678 * pattern + 0.0952 * (1.0 - deepTrans), 0.8260);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2420), 0.8260);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4904 + 0.5096 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
