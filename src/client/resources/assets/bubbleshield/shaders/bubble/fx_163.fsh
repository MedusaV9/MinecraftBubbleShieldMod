...
// stack: deep=caustic x3 taps | mid=arcs+warp1+scroll | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0638 + 0.3252 * presence + 0.3261 * pattern + 0.1124 * (1.0 - deepTrans), 0.8290);
