...
// v8 realism: refr 0.5362+0.7159*fres/dist (cap 0.1119) | energy 0.3799+0.5216*p | flow 0.089167 c/s | soft 0.6023m
...
void main() {
    ...
    float refrAmp = min((0.5362 + 0.7159 * fresnel) / max(length(worldPos), 1.0), 0.1119);
