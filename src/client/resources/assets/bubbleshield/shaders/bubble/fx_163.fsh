...
void main() {
    ...
    mid = clamp(mid * (0.6384 + 0.4557 * texDetail) + 0.2053 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4388), 0.0, 1.0);
    float emit = atlas.a * (0.6436 + 0.3751 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1340 * (0.5 + 0.5 * sin(time * 0.256563)));
    ...
    float alpha = vertexColor.a * min(0.3985 + 0.4652 * presence + 0.3261 * pattern + 0.1124 * (1.0 - deepTrans) + 0.1383 * emit, 0.8890);
