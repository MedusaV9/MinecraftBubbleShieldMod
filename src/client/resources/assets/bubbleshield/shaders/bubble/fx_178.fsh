...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6270, 0.0, 1.0);
    ...
    deepCol += 0.4697 * dp * mix(baseCol, deepStop, 0.2022);
    deepPat += 0.4697 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.4415) + par * 0.1190, time);
    deepCol += 0.2206 * dp * mix(baseCol, deepStop, 0.4045);
    deepPat += 0.2206 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 4.1235) + par * 0.1785, time);
    deepCol += 0.1036 * dp * mix(baseCol, deepStop, 0.6067);
    deepPat += 0.1036 * dp;
    deepCol *= 0.6451;
    deepPat = pow(clamp(deepPat * 0.5574, 0.0, 1.0), 1.1312);
    ...
    rgb += hotStop * 0.2775 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0483 + 0.2714 * presence + 0.3511 * pattern, 0.7891);
