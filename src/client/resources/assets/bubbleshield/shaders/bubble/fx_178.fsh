...
void main() {
    ...
    mid = clamp(mid * (0.7275 + 0.6796 * texDetail) + 0.2941 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6956 + 0.2607 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1736 * (0.5 + 0.5 * sin(time * 0.162316)));
    rgb += emit * 0.6546 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3525 + 0.4114 * presence + 0.3511 * pattern + 0.1494 * (1.0 - deepTrans) + 0.1448 * emit, 0.8491);
