...
// stack: deep=voro x4 taps | mid=triweave+none+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0483 + 0.2714 * presence + 0.3511 * pattern + 0.1494 * (1.0 - deepTrans), 0.7891);
