...
// stack: deep=voro x3 taps | mid=solarflare+curl+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0593 + 0.1470 * presence + 0.5931 * pattern + 0.0872 * (1.0 - deepTrans), 0.8231);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2528), 0.8231);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4668 + 0.5332 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
