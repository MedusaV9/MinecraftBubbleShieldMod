...
// stack: deep=caustic x3 taps | mid=orbittrap+warp2+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0407 + 0.1545 * presence + 0.5291 * pattern + 0.1352 * (1.0 - deepTrans), 0.8329);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2761), 0.8329);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4753 + 0.5247 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
