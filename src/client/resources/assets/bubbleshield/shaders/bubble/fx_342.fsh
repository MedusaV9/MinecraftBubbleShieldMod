...
// stack: deep=ridge x4 taps | mid=petals+curl+rotate | rim=lat | flourish=shimmer | tex=scales
// fbm: standard x3 octaves | seed 7b40d186e4b8b7c0
// v8 realism: refr 0.5910+0.6930*fres/dist (cap 0.1031) | energy 0.3011+0.4887*p | flow 0.077500 c/s | soft 0.5910m
...
void main() {
    ...
    float refrAmp = min((0.5910 + 0.6930 * fresnel) / max(length(worldPos), 1.0), 0.1031);
