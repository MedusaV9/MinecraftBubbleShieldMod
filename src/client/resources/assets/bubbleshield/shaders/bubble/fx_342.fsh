...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6884, 0.0, 1.0);
    ...
    deepCol += 0.4162 * dp * mix(baseCol, deepStop, 0.2144);
    deepPat += 0.4162 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.0278) + par * 0.1543, time);
    deepCol += 0.1732 * dp * mix(baseCol, deepStop, 0.4287);
    deepPat += 0.1732 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 4.8255) + par * 0.2314, time);
    deepCol += 0.0721 * dp * mix(baseCol, deepStop, 0.6431);
    deepPat += 0.0721 * dp;
    deepCol *= 0.7663;
    deepPat = pow(clamp(deepPat * 0.6019, 0.0, 1.0), 1.1487);
    ...
    float alpha = vertexColor.a * min(0.0741 + 0.3644 * presence + 0.4567 * pattern, 0.7852);
