...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.486947);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.015000, 0.032500) * time, time);
    deep += 0.3916 * deepField(duvBase + rimDir * 0.0703 + vec2(0.025000, 0.052500) * time, time);
    deep += 0.1533 * deepField(duvBase + rimDir * 0.1406 + vec2(0.033333, 0.070000) * time, time);
    deep += 0.0600 * deepField(duvBase + rimDir * 0.2109 + vec2(0.041667, 0.090000) * time, time);
    deep = pow(clamp(deep * 0.6231, 0.0, 1.0), 1.7859);
