...
// stack: deep=caustic x4 taps | mid=runecircuit+warp1+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0536 + 0.1147 * presence + 0.5434 * pattern + 0.1034 * (1.0 - deepTrans), 0.8455);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2115), 0.8455);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5379 + 0.4621 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
