...
// stack: deep=caustic x4 taps | mid=runecircuit+warp1+flicker | rim=graze | flourish=echo | tex=runes
// fbm: ridged x6 octaves | seed 7f77fc940a43cc9b
// v8 realism: refr 0.3636+0.4920*fres/dist (cap 0.1455) | energy 0.5341+0.4633*p | flow 0.075833 c/s | soft 0.9958m
...
void main() {
    ...
    float refrAmp = min((0.3636 + 0.4920 * fresnel) / max(length(worldPos), 1.0), 0.1455);
