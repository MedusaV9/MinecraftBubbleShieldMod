...
// stack: deep=ridge x3 taps | mid=raymarchfog+warp2+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0727 + 0.3035 * presence + 0.3798 * pattern + 0.1223 * (1.0 - deepTrans), 0.8661);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3186), 0.8661);
    // [layer:v5:ghostalpha]
