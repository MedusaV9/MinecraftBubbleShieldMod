...
void main() {
    ...
    float mid = clamp(rfLight * 1.1250 + (1.0 - rfTrans) * 0.1642, 0.0, 1.15);
    ...
    float alpha = vertexColor.a * min(0.0727 + 0.3835 * presence + 0.3798 * pattern + 0.1223 * (1.0 - deepTrans), 0.8661);
    // [layer:v5:backface]
