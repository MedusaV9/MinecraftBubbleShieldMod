...
// stack: deep=ridge x3 taps | mid=irisfilm+warp1+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0594 + 0.2494 * presence + 0.5119 * pattern + 0.1265 * (1.0 - deepTrans), 0.7714);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3061), 0.7714);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4762 + 0.5238 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
