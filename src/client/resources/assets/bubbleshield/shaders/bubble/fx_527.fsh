...
// stack: deep=voro x3 taps | mid=irisfilm+curl+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0486 + 0.2519 * presence + 0.4116 * pattern + 0.0887 * (1.0 - deepTrans), 0.7698);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2604), 0.7698);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4860 + 0.5140 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
