...
// stack: deep=voro x3 taps | mid=irisfilm+curl+scroll | rim=graze_film | flourish=swirl | tex=chrome
// fbm: turb x4 octaves | seed 9975ec76b2a705c9
// v8 realism: refr 0.7103+1.1994*fres/dist (cap 0.1192) | energy 0.2782+0.4483*p | flow 0.064167 c/s | soft 0.9349m
...
void main() {
    ...
    float refrAmp = min((0.7103 + 1.1994 * fresnel) / max(length(worldPos), 1.0), 0.1192);
