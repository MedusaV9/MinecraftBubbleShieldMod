...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.025833, 0.046667) * time, time);
    deep += 0.5479 * deepField(duvBase + rimDir * 0.0627 + vec2(0.040833, 0.071667) * time, time);
    deep += 0.3002 * deepField(duvBase + rimDir * 0.1255 + vec2(0.055000, 0.096667) * time, time);
    deep = pow(clamp(deep * 0.5411, 0.0, 1.0), 1.0325);
