...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6693, 0.0, 1.0);
    ...
    deepCol += 0.5479 * dp * mix(baseCol, deepStop, 0.4302);
    deepPat += 0.5479 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 4.8813) + par * 0.1255, time);
    deepCol += 0.3002 * dp * mix(baseCol, deepStop, 0.8603);
    deepPat += 0.3002 * dp;
    deepCol *= 0.6350;
    deepPat = pow(clamp(deepPat * 0.5411, 0.0, 1.0), 1.0325);
    ...
    float alpha = vertexColor.a * min(0.0537 + 0.2759 * presence + 0.3490 * pattern, 0.8007);
