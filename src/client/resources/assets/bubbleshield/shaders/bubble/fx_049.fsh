...
// stack: deep=caustic x4 taps | mid=arcs+warp1+flicker | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.3191 * presence + 0.4639 * pattern + 0.1455 * (1.0 - deepTrans), 0.8262);
