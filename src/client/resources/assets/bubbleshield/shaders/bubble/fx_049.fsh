...
// stack: deep=caustic x4 taps | mid=arcs+warp1+flicker | rim=graze_sparkle | flourish=echo | tex=filaments
// fbm: standard x3 octaves | seed 767016c5d5a20cca
// v8 realism: refr 0.7119+0.8337*fres/dist (cap 0.1181) | energy 0.3425+0.3935*p | flow 0.075833 c/s | soft 0.5222m
...
void main() {
    ...
    float refrAmp = min((0.7119 + 0.8337 * fresnel) / max(length(worldPos), 1.0), 0.1181);
