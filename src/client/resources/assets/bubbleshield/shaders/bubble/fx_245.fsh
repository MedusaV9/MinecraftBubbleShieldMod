...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.006667, 0.050000) * time, time);
    deep += 0.4342 * deepField(duvBase + rimDir * 0.0617 + vec2(-0.011667, 0.077500) * time, time);
    deep += 0.1885 * deepField(duvBase + rimDir * 0.1233 + vec2(-0.015000, 0.102500) * time, time);
    deep += 0.0819 * deepField(duvBase + rimDir * 0.1850 + vec2(-0.018333, 0.130000) * time, time);
    deep = pow(clamp(deep * 0.5866, 0.0, 1.0), 1.2601);
