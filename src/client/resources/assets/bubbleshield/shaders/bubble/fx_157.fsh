...
void main() {
    ...
    mid = clamp(mid * (0.7306 + 0.6852 * texDetail) + 0.2589 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3956), 0.0, 1.0);
    float emit = atlas.a * (0.7741 + 0.3906 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1224 * (0.5 + 0.5 * sin(time * 0.178024)));
    ...
    float alpha = vertexColor.a * min(0.3937 + 0.4422 * presence + 0.3616 * pattern + 0.1014 * (1.0 - deepTrans) + 0.1634 * emit, 0.9138);
