...
// stack: deep=ridge x4 taps | mid=moire+curl+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0622 + 0.3022 * presence + 0.3616 * pattern + 0.1014 * (1.0 - deepTrans), 0.8538);
