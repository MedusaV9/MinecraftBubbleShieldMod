...
// v8 realism: refr 0.7541+0.9404*fres/dist (cap 0.1352) | energy 0.2457+0.3474*p | flow 0.050000 c/s | soft 0.6751m
...
void main() {
    ...
    float refrAmp = min((0.7541 + 0.9404 * fresnel) / max(length(worldPos), 1.0), 0.1352);
