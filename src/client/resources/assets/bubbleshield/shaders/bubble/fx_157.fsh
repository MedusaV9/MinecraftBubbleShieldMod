...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6080, 0.0, 1.0);
    ...
    deepCol += 0.4929 * dp * mix(baseCol, deepStop, 0.1939);
    deepPat += 0.4929 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 5.2632) + par * 0.1218, time);
    deepCol += 0.2429 * dp * mix(baseCol, deepStop, 0.3878);
    deepPat += 0.2429 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 6.5307) + par * 0.1827, time);
    deepCol += 0.1197 * dp * mix(baseCol, deepStop, 0.5817);
    deepPat += 0.1197 * dp;
    deepCol *= 0.6956;
    deepPat = pow(clamp(deepPat * 0.5389, 0.0, 1.0), 1.7888);
    ...
    float alpha = vertexColor.a * min(0.0622 + 0.3022 * presence + 0.3616 * pattern, 0.8538);
