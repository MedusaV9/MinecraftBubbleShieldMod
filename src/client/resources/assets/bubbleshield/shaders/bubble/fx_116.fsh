...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8009, 0.0, 1.0);
    ...
    deepCol += 0.4173 * dp * mix(baseCol, deepStop, 0.1886);
    deepPat += 0.4173 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 3.5789) + par * 0.1287, time);
    deepCol += 0.1741 * dp * mix(baseCol, deepStop, 0.3771);
    deepPat += 0.1741 * dp;
    dp = deepField(rotA(spinAxis, time * 0.020944) * (sdir * 4.4142) + par * 0.1931, time);
    deepCol += 0.0727 * dp * mix(baseCol, deepStop, 0.5657);
    deepPat += 0.0727 * dp;
    deepCol *= 0.6288;
    deepPat = pow(clamp(deepPat * 0.6009, 0.0, 1.0), 1.1382);
    ...
    rgb += hotStop * 0.2260 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0457 + 0.2715 * presence + 0.4003 * pattern, 0.8439);
