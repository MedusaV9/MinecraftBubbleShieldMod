...
// stack: deep=voro x4 taps | mid=plasma+warp1+flicker | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0457 + 0.2715 * presence + 0.4003 * pattern + 0.0926 * (1.0 - deepTrans), 0.8439);
