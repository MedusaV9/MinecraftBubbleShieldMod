...
// stack: deep=voro x4 taps | mid=aurora+warp1+scroll | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0722 + 0.2993 * presence + 0.3321 * pattern + 0.1004 * (1.0 - deepTrans), 0.8229);
