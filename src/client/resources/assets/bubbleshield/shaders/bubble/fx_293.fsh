...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8349, 0.0, 1.0);
    ...
    deepCol += 0.4678 * dp * mix(baseCol, deepStop, 0.3377);
    deepPat += 0.4678 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 4.6820) + par * 0.1223, time);
    deepCol += 0.2188 * dp * mix(baseCol, deepStop, 0.6754);
    deepPat += 0.2188 * dp;
    deepCol *= 0.6544;
    deepPat = pow(clamp(deepPat * 0.5929, 0.0, 1.0), 1.6359);
    ...
    rgb += hotStop * 0.2660 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.3048 * presence + 0.4034 * pattern, 0.8006);
