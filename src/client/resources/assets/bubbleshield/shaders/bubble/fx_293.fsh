...
void main() {
    ...
    mid = clamp(mid * (0.7432 + 0.6526 * texDetail) + 0.2323 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7394 + 0.3689 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1419 * (0.5 + 0.5 * sin(time * 0.178024)));
    rgb += emit * 0.9953 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3452 + 0.4448 * presence + 0.4034 * pattern + 0.1048 * (1.0 - deepTrans) + 0.1635 * emit, 0.8606);
