...
// stack: deep=fbm x3 taps | mid=caustic+warp1+scroll | rim=graze | flourish=glint | tex=caustic_web
// fbm: standard x3 octaves | seed d61fc423cc236919
// v8 realism: refr 0.9018+1.5503*fres/dist (cap 0.1436) | energy 0.2609+0.4184*p | flow 0.105833 c/s | soft 0.6283m
...
void main() {
    ...
    float refrAmp = min((0.9018 + 1.5503 * fresnel) / max(length(worldPos), 1.0), 0.1436);
