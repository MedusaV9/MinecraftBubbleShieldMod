...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5583, 0.0, 1.0);
    ...
    deepCol += 0.4063 * dp * mix(baseCol, deepStop, 0.4404);
    deepPat += 0.4063 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 4.7569) + par * 0.0861, time);
    deepCol += 0.1650 * dp * mix(baseCol, deepStop, 0.8809);
    deepPat += 0.1650 * dp;
    deepCol *= 0.7222;
    deepPat = pow(clamp(deepPat * 0.6364, 0.0, 1.0), 1.6452);
    ...
    rgb += hotStop * 0.1956 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0546 + 0.2762 * presence + 0.3790 * pattern, 0.8172);
