...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.011667, 0.040000) * time, time);
    deep += 0.5624 * deepField(duvBase + rimDir * 0.0347 + vec2(-0.018333, 0.060000) * time, time);
    deep += 0.3163 * deepField(duvBase + rimDir * 0.0694 + vec2(-0.025000, 0.082500) * time, time);
    deep = pow(clamp(deep * 0.5323, 0.0, 1.0), 1.1509);
