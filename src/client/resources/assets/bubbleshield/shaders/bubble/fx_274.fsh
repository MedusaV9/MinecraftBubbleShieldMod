...
// stack: deep=voro x4 taps | mid=waves+warp1+pulse | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0409 + 0.3127 * presence + 0.4580 * pattern + 0.1506 * (1.0 - deepTrans), 0.8542);
