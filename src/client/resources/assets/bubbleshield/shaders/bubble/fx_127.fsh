...
// stack: deep=caustic x3 taps | mid=lightning+warp1+rotate | rim=lat | flourish=glint | tex=filaments
// fbm: ridged x5 octaves | seed 70bab874e9d04a30
// v8 realism: refr 0.5588+0.7440*fres/dist (cap 0.1126) | energy 0.3314+0.4122*p | flow 0.110833 c/s | soft 0.9073m
...
void main() {
    ...
    float refrAmp = min((0.5588 + 0.7440 * fresnel) / max(length(worldPos), 1.0), 0.1126);
