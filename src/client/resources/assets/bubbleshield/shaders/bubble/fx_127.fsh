...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6462, 0.0, 1.0);
    ...
    deepCol += 0.4807 * dp * mix(baseCol, deepStop, 0.2963);
    deepPat += 0.4807 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 3.4819) + par * 0.1102, time);
    deepCol += 0.2311 * dp * mix(baseCol, deepStop, 0.5927);
    deepPat += 0.2311 * dp;
    deepCol *= 0.7464;
    deepPat = pow(clamp(deepPat * 0.5842, 0.0, 1.0), 1.3318);
    ...
    rgb += hotStop * 0.2349 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0540 + 0.3424 * presence + 0.3468 * pattern, 0.8185);
