...
// stack: deep=caustic x3 taps | mid=oilslick+curl+pulse | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0643 + 0.2707 * presence + 0.3464 * pattern + 0.0876 * (1.0 - deepTrans), 0.8393);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2369), 0.8393);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5096 + 0.4904 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
