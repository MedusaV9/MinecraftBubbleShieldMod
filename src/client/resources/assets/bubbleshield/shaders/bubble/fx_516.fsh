...
// stack: deep=caustic x3 taps | mid=oilslick+curl+pulse | rim=lat | flourish=swirl | tex=chrome
// fbm: standard x3 octaves | seed 76476c5ebe05ca96
// v8 realism: refr 0.8419+1.2831*fres/dist (cap 0.1430) | energy 0.2553+0.4363*p | flow 0.075833 c/s | soft 0.8365m
...
void main() {
    ...
    float refrAmp = min((0.8419 + 1.2831 * fresnel) / max(length(worldPos), 1.0), 0.1430);
