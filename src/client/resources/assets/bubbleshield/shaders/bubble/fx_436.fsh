...
// stack: deep=fbm x4 taps | mid=oilslick+curl+scroll | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0516 + 0.2600 * presence + 0.3339 * pattern + 0.0856 * (1.0 - deepTrans), 0.8160);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3368), 0.8160);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4232 + 0.5768 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
