...
// stack: deep=voro x3 taps | mid=plasmaglobe+curl+pulse | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0672 + 0.0895 * presence + 0.5972 * pattern + 0.1029 * (1.0 - deepTrans), 0.8534);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2180), 0.8534);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4981 + 0.5019 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
