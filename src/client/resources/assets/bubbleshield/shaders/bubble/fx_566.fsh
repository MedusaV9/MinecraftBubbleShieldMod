...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.6549 + fiR.y * 0.5582)), 0.2735);
    ...
    float alpha = vertexColor.a * min(0.0701 + 0.3543 * presence + 0.4331 * pattern + 0.1065 * (1.0 - deepTrans), 0.8123);
    // [layer:v5:backface]
