...
// stack: deep=voro x3 taps | mid=fluidink+curl+scroll | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0701 + 0.2943 * presence + 0.4331 * pattern + 0.1065 * (1.0 - deepTrans), 0.8123);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2614), 0.8123);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5485 + 0.4515 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
