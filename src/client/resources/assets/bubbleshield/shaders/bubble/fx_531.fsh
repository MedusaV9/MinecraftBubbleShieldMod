...
// stack: deep=ridge x4 taps | mid=gravlens+none+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0629 + 0.1136 * presence + 0.5721 * pattern + 0.1170 * (1.0 - deepTrans), 0.8349);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2067), 0.8349);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4202 + 0.5798 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
