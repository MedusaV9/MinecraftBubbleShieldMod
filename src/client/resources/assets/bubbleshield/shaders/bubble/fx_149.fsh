...
// v8 realism: refr 0.8843+1.4313*fres/dist (cap 0.1152) | energy 0.2465+0.4727*p | flow 0.101667 c/s | soft 1.0220m
...
void main() {
    ...
    float refrAmp = min((0.8843 + 1.4313 * fresnel) / max(length(worldPos), 1.0), 0.1152);
