...
// stack: deep=caustic x4 taps | mid=moire+warp1+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0621 + 0.2593 * presence + 0.3509 * pattern + 0.1568 * (1.0 - deepTrans), 0.8341);
