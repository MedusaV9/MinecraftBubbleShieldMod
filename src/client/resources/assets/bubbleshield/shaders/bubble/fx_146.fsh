...
// stack: deep=caustic x4 taps | mid=voronoi+warp2+flicker | rim=graze | flourish=glint | tex=worley_cells
// fbm: turb x5 octaves | seed a7da517b49c926ff
// v8 realism: refr 0.6368+0.9549*fres/dist (cap 0.1403) | energy 0.3102+0.4360*p | flow 0.082500 c/s | soft 0.5778m
...
void main() {
    ...
    float refrAmp = min((0.6368 + 0.9549 * fresnel) / max(length(worldPos), 1.0), 0.1403);
