...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7329, 0.0, 1.0);
    ...
    deepCol += 0.5511 * dp * mix(baseCol, deepStop, 0.2038);
    deepPat += 0.5511 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.5808) + par * 0.1119, time);
    deepCol += 0.3037 * dp * mix(baseCol, deepStop, 0.4075);
    deepPat += 0.3037 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.5076) + par * 0.1679, time);
    deepCol += 0.1674 * dp * mix(baseCol, deepStop, 0.6113);
    deepPat += 0.1674 * dp;
    deepCol *= 0.4925;
    deepPat = pow(clamp(deepPat * 0.4945, 0.0, 1.0), 1.1389);
    ...
    rgb += hotStop * 0.1929 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0437 + 0.2486 * presence + 0.3811 * pattern, 0.8174);
