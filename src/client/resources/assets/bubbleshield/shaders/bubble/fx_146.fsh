...
// stack: deep=caustic x4 taps | mid=voronoi+warp2+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0437 + 0.2486 * presence + 0.3811 * pattern + 0.0823 * (1.0 - deepTrans), 0.8174);
