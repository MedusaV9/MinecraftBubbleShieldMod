...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.035000, -0.050000) * time, time);
    deep += 0.5511 * deepField(duvBase + rimDir * 0.0560 + vec2(-0.055000, -0.077500) * time, time);
    deep += 0.3037 * deepField(duvBase + rimDir * 0.1119 + vec2(-0.075000, -0.105000) * time, time);
    deep += 0.1674 * deepField(duvBase + rimDir * 0.1679 + vec2(-0.093333, -0.132500) * time, time);
    deep = pow(clamp(deep * 0.4945, 0.0, 1.0), 1.1389);
    ...
    float pattern = clamp(0.4730 * deep + 0.9757 * mid + 0.6205 * rim + flourish + grain, 0.0, 1.5);
    vec3 accent = accentPalette(0.1638 + pattern * 0.3872);
    vec3 rgb = vertexColor.rgb * (0.3581 + 0.8765 * pattern);
    ...
    float alpha = vertexColor.a * clamp(0.1592 + 0.7047 * pattern, 0.0, 1.0);
