...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.6158 + fiR.y * 0.4157)), 0.3929);
    ...
    float alpha = vertexColor.a * min(0.0440 + 0.3463 * presence + 0.3468 * pattern + 0.1541 * (1.0 - deepTrans), 0.7852);
    // [layer:v5:backface]
