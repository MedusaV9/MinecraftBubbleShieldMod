...
// stack: deep=caustic x3 taps | mid=fluidink+none+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0440 + 0.2863 * presence + 0.3468 * pattern + 0.1541 * (1.0 - deepTrans), 0.7852);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1666), 0.7852);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5181 + 0.4819 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
