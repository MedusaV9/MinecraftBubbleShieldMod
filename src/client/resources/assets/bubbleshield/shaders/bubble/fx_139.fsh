...
void main() {
    ...
    mid = clamp(mid * (0.6638 + 0.7410 * texDetail) + 0.2122 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4485), 0.0, 1.0);
    float emit = atlas.a * (0.7550 + 0.4804 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1617 * (0.5 + 0.5 * sin(time * 0.209440)));
    rgb += emit * 0.9153 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4238 + 0.5064 * presence + 0.3728 * pattern + 0.1183 * (1.0 - deepTrans) + 0.1663 * emit, 0.8882);
