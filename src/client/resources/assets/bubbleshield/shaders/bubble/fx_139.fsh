...
// stack: deep=caustic x4 taps | mid=interference+warp1+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.3664 * presence + 0.3728 * pattern + 0.1183 * (1.0 - deepTrans), 0.8282);
