...
// stack: deep=fbm x3 taps | mid=aurora+warp2+pulse | rim=graze | flourish=shimmer | tex=filaments
// fbm: standard x6 octaves | seed 1d1b23fb2974abbb
// v8 realism: refr 0.7116+0.8894*fres/dist (cap 0.1438) | energy 0.3546+0.4404*p | flow 0.101667 c/s | soft 0.9400m
...
void main() {
    ...
    float refrAmp = min((0.7116 + 0.8894 * fresnel) / max(length(worldPos), 1.0), 0.1438);
