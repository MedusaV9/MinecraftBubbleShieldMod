...
// stack: deep=fbm x3 taps | mid=aurora+warp2+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0549 + 0.2679 * presence + 0.4231 * pattern + 0.1360 * (1.0 - deepTrans), 0.7827);
