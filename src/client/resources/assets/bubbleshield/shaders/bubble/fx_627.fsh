...
// stack: deep=caustic x4 taps | mid=irisfilm+curl+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0620 + 0.2443 * presence + 0.5341 * pattern + 0.1185 * (1.0 - deepTrans), 0.8063);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3141), 0.8063);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5392 + 0.4608 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
