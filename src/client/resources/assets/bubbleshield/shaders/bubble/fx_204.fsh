...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8111, 0.0, 1.0);
    ...
    deepCol += 0.3977 * dp * mix(baseCol, deepStop, 0.4388);
    deepPat += 0.3977 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 3.1932) + par * 0.1479, time);
    deepCol += 0.1582 * dp * mix(baseCol, deepStop, 0.8776);
    deepPat += 0.1582 * dp;
    deepCol *= 0.6904;
    deepPat = pow(clamp(deepPat * 0.6427, 0.0, 1.0), 1.1958);
    ...
    rgb += hotStop * 0.1991 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.2724 * presence + 0.3607 * pattern, 0.8291);
