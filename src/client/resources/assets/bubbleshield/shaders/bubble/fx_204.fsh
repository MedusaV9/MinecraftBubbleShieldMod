...
// stack: deep=voro x3 taps | mid=sparkle+curl+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.2724 * presence + 0.3607 * pattern + 0.1082 * (1.0 - deepTrans), 0.8291);
