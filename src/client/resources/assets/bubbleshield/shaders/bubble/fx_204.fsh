...
void main() {
    ...
    mid = clamp(mid * (0.6264 + 0.4940 * texDetail) + 0.3333 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5668 + 0.4821 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1119 * (0.5 + 0.5 * sin(time * 0.277507)));
    ...
    float alpha = vertexColor.a * min(0.3451 + 0.4124 * presence + 0.3607 * pattern + 0.1082 * (1.0 - deepTrans) + 0.1843 * emit, 0.8891);
