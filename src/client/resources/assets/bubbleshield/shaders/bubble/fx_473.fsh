...
// stack: deep=ridge x3 taps | mid=solarflare+warp1+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0530 + 0.1728 * presence + 0.5900 * pattern + 0.1300 * (1.0 - deepTrans), 0.7947);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2683), 0.7947);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3893 + 0.6107 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
