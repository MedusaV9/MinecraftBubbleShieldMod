...
// stack: deep=voro x3 taps | mid=plasmaglobe+warp2+pulse | rim=graze_sparkle | flourish=shimmer | tex=filaments
// fbm: turb x5 octaves | seed fb81760759565ecd
// v8 realism: refr 0.4525+0.5664*fres/dist (cap 0.1252) | energy 0.3882+0.4581*p | flow 0.051667 c/s | soft 1.0611m
...
void main() {
    ...
    float refrAmp = min((0.4525 + 0.5664 * fresnel) / max(length(worldPos), 1.0), 0.1252);
