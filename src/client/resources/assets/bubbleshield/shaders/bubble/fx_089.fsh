...
void main() {
    ...
    mid = clamp(mid * (0.6673 + 0.4672 * texDetail) + 0.3167 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6067 + 0.3928 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0838 * (0.5 + 0.5 * sin(time * 0.246091)));
    ...
    float alpha = vertexColor.a * min(0.3937 + 0.4939 * presence + 0.4110 * pattern + 0.1344 * (1.0 - deepTrans) + 0.1937 * emit, 0.8481);
