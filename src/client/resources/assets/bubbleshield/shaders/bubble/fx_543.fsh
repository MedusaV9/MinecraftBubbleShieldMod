...
// stack: deep=ridge x3 taps | mid=holoparallax+none+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0501 + 0.1691 * presence + 0.5476 * pattern + 0.1485 * (1.0 - deepTrans), 0.8073);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1904), 0.8073);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4448 + 0.5552 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
