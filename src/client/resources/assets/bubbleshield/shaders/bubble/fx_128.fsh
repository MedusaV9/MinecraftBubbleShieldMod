...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7920, 0.0, 1.0);
    ...
    deepCol += 0.4163 * dp * mix(baseCol, deepStop, 0.4451);
    deepPat += 0.4163 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 4.8695) + par * 0.1091, time);
    deepCol += 0.1733 * dp * mix(baseCol, deepStop, 0.8902);
    deepPat += 0.1733 * dp;
    deepCol *= 0.6169;
    deepPat = pow(clamp(deepPat * 0.6291, 0.0, 1.0), 1.0145);
    ...
    float alpha = vertexColor.a * min(0.0542 + 0.2891 * presence + 0.4614 * pattern, 0.7888);
