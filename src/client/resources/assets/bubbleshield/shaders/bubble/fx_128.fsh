...
// stack: deep=ridge x3 taps | mid=ridged+warp2+scroll | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0542 + 0.2891 * presence + 0.4614 * pattern + 0.1366 * (1.0 - deepTrans), 0.7888);
