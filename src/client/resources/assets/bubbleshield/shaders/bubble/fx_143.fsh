...
// stack: deep=ridge x4 taps | mid=interference+warp1+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0485 + 0.2509 * presence + 0.3691 * pattern + 0.1387 * (1.0 - deepTrans), 0.8522);
