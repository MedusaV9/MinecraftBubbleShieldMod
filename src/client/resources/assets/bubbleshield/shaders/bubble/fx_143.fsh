...
void main() {
    ...
    mid = clamp(mid * (0.6213 + 0.7115 * texDetail) + 0.2443 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6379 + 0.3514 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0969 * (0.5 + 0.5 * sin(time * 0.130900)));
    rgb += emit * 0.9780 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3530 + 0.3909 * presence + 0.3691 * pattern + 0.1387 * (1.0 - deepTrans) + 0.1915 * emit, 0.9122);
