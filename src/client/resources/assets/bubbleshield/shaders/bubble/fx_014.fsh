...
// stack: deep=ridge x3 taps | mid=interference+warp2+rotate | rim=graze_film | flourish=glint | tex=caustic_web
// fbm: standard x5 octaves | seed bed9453b215550d7
// v8 realism: refr 0.8379+1.0231*fres/dist (cap 0.1136) | energy 0.2382+0.3692*p | flow 0.056667 c/s | soft 0.7305m
...
void main() {
    ...
    float refrAmp = min((0.8379 + 1.0231 * fresnel) / max(length(worldPos), 1.0), 0.1136);
