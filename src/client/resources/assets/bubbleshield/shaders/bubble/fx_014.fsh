...
// stack: deep=ridge x3 taps | mid=interference+warp2+rotate | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0719 + 0.2934 * presence + 0.3983 * pattern + 0.0845 * (1.0 - deepTrans), 0.7990);
