...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6354, 0.0, 1.0);
    ...
    deepCol += 0.5713 * dp * mix(baseCol, deepStop, 0.3057);
    deepPat += 0.5713 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 4.3461) + par * 0.0972, time);
    deepCol += 0.3264 * dp * mix(baseCol, deepStop, 0.6114);
    deepPat += 0.3264 * dp;
    deepCol *= 0.6370;
    deepPat = pow(clamp(deepPat * 0.5270, 0.0, 1.0), 1.6602);
    ...
    rgb += hotStop * 0.1845 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0719 + 0.2934 * presence + 0.3983 * pattern, 0.7990);
