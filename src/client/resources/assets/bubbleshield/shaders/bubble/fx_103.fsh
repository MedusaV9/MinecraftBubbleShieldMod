...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(3.0000, 4.0000), t * 0.555015);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.020000, 0.033333) * time, time);
    deep += 0.4319 * deepField(duvBase + rimDir * 0.0686 + vec2(-0.032500, 0.053333) * time, time);
    deep += 0.1865 * deepField(duvBase + rimDir * 0.1371 + vec2(-0.042500, 0.073333) * time, time);
    deep = pow(clamp(deep * 0.6179, 0.0, 1.0), 1.0003);
