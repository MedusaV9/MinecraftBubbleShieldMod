...
// stack: deep=voro x4 taps | mid=circuit+warp2+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0517 + 0.3282 * presence + 0.4703 * pattern + 0.0884 * (1.0 - deepTrans), 0.8194);
