...
// stack: deep=caustic x4 taps | mid=scales+warp1+rotate | rim=graze | flourish=shimmer | tex=scales
// fbm: ridged x3 octaves | seed 124b3bae23280ac9
// v8 realism: refr 0.6000+0.7338*fres/dist (cap 0.1298) | energy 0.3987+0.4790*p | flow 0.100833 c/s | soft 1.0854m
...
void main() {
    ...
    float refrAmp = min((0.6000 + 0.7338 * fresnel) / max(length(worldPos), 1.0), 0.1298);
