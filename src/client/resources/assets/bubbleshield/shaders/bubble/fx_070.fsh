...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.026667, -0.040000) * time, time);
    deep += 0.4898 * deepField(duvBase + rimDir * 0.0648 + vec2(0.040000, -0.062500) * time, time);
    deep += 0.2399 * deepField(duvBase + rimDir * 0.1295 + vec2(0.055000, -0.085000) * time, time);
    deep = pow(clamp(deep * 0.5782, 0.0, 1.0), 1.3003);
