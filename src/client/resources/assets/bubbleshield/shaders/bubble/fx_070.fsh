...
// stack: deep=caustic x4 taps | mid=scales+warp1+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0731 + 0.2783 * presence + 0.3403 * pattern + 0.0882 * (1.0 - deepTrans), 0.8190);
