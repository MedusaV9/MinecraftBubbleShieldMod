...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6938, 0.0, 1.0);
    ...
    deepCol += 0.4059 * dp * mix(baseCol, deepStop, 0.2926);
    deepPat += 0.4059 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 6.2163) + par * 0.1341, time);
    deepCol += 0.1648 * dp * mix(baseCol, deepStop, 0.5853);
    deepPat += 0.1648 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 7.8365) + par * 0.2011, time);
    deepCol += 0.0669 * dp * mix(baseCol, deepStop, 0.8779);
    deepPat += 0.0669 * dp;
    deepCol *= 0.7626;
    deepPat = pow(clamp(deepPat * 0.6107, 0.0, 1.0), 1.2797);
    ...
    rgb += hotStop * 0.2774 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0511 + 0.3290 * presence + 0.3356 * pattern, 0.8560);
