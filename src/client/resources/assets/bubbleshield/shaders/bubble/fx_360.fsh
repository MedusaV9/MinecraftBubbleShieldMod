...
// stack: deep=fbm x4 taps | mid=shardtess+curl+pulse | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0511 + 0.3290 * presence + 0.3356 * pattern + 0.0874 * (1.0 - deepTrans), 0.8560);
