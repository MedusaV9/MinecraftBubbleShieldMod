...
void main() {
    ...
    mid = clamp(mid * (0.7122 + 0.7417 * texDetail) + 0.2856 * texDetail, 0.0, 1.5);
    ...
    rim = clamp(rim + 0.5474 * rimLine, 0.0, 1.4);
    ...
    float emit = atlas.a * (0.7584 + 0.3446 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1043 * (0.5 + 0.5 * sin(time * 0.130900)));
    rgb += emit * 0.7078 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3608 + 0.4690 * presence + 0.3356 * pattern + 0.0874 * (1.0 - deepTrans) + 0.1510 * emit, 0.9160);
