...
// stack: deep=fbm x4 taps | mid=shardtess+curl+pulse | rim=lat | flourish=echo | tex=cracked_glass
// fbm: turb x3 octaves | seed 7dc97b50f083d863
// v8 realism: refr 0.8960+1.4633*fres/dist (cap 0.1250) | energy 0.1865+0.4554*p | flow 0.050833 c/s | soft 0.8230m
...
void main() {
    ...
    float refrAmp = min((0.8960 + 1.4633 * fresnel) / max(length(worldPos), 1.0), 0.1250);
