...
// stack: deep=caustic x3 taps | mid=voidrift+warp2+pulse | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0475 + 0.2341 * presence + 0.4931 * pattern + 0.1387 * (1.0 - deepTrans), 0.8432);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2797), 0.8432);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4462 + 0.5538 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
