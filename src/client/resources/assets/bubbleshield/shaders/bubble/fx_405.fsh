...
// stack: deep=caustic x3 taps | mid=chrome+none+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0582 + 0.3497 * presence + 0.3945 * pattern + 0.1044 * (1.0 - deepTrans), 0.8461);
