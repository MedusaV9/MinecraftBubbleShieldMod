...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7642, 0.0, 1.0);
    ...
    deepCol += 0.5418 * dp * mix(baseCol, deepStop, 0.4329);
    deepPat += 0.5418 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 3.5297) + par * 0.0989, time);
    deepCol += 0.2936 * dp * mix(baseCol, deepStop, 0.8659);
    deepPat += 0.2936 * dp;
    deepCol *= 0.6371;
    deepPat = pow(clamp(deepPat * 0.5448, 0.0, 1.0), 1.2270);
    ...
    rgb += hotStop * 0.2262 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0657 + 0.3013 * presence + 0.3548 * pattern, 0.7917);
