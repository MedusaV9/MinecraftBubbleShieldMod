...
// stack: deep=ridge x3 taps | mid=waves+warp2+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0657 + 0.3013 * presence + 0.3548 * pattern + 0.1304 * (1.0 - deepTrans), 0.7917);
