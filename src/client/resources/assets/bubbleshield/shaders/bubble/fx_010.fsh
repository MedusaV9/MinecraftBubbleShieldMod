...
// stack: deep=ridge x3 taps | mid=waves+warp2+pulse | rim=graze | flourish=glint | tex=caustic_web
// fbm: ridged x6 octaves | seed 27be25311c733244
// v8 realism: refr 1.0348+1.7831*fres/dist (cap 0.1477) | energy 0.2082+0.3654*p | flow 0.057500 c/s | soft 1.0477m
...
void main() {
    ...
    float refrAmp = min((1.0348 + 1.7831 * fresnel) / max(length(worldPos), 1.0), 0.1477);
