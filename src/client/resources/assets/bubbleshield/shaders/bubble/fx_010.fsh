...
void main() {
    ...
    mid = clamp(mid * (0.6361 + 0.4881 * texDetail) + 0.2851 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6848 + 0.4265 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1182 * (0.5 + 0.5 * sin(time * 0.162316)));
    rgb += emit * 0.9182 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4040 + 0.4413 * presence + 0.3548 * pattern + 0.1304 * (1.0 - deepTrans) + 0.1668 * emit, 0.8517);
