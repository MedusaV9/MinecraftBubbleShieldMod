...
// stack: deep=caustic x3 taps | mid=waves+none+rotate | rim=graze_film | flourish=echo | tex=caustic_web
// fbm: standard x5 octaves | seed ae27d2963daf4a16
// v8 realism: refr 0.7163+0.8804*fres/dist (cap 0.1580) | energy 0.2470+0.3974*p | flow 0.100000 c/s | soft 0.7294m
...
void main() {
    ...
    float refrAmp = min((0.7163 + 0.8804 * fresnel) / max(length(worldPos), 1.0), 0.1580);
