...
void main() {
    ...
    mid = clamp(mid * (0.6362 + 0.6834 * texDetail) + 0.1807 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6657 + 0.4862 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1357 * (0.5 + 0.5 * sin(time * 0.240855)));
    rgb += emit * 0.9566 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4238 + 0.4094 * presence + 0.4248 * pattern + 0.1141 * (1.0 - deepTrans) + 0.1211 * emit, 0.9012);
