...
// stack: deep=caustic x3 taps | mid=waves+none+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.2694 * presence + 0.4248 * pattern + 0.1141 * (1.0 - deepTrans), 0.8412);
