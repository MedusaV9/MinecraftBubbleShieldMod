...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7162, 0.0, 1.0);
    ...
    deepCol += 0.3880 * dp * mix(baseCol, deepStop, 0.3480);
    deepPat += 0.3880 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 3.3646) + par * 0.0915, time);
    deepCol += 0.1505 * dp * mix(baseCol, deepStop, 0.6961);
    deepPat += 0.1505 * dp;
    deepCol *= 0.8274;
    deepPat = pow(clamp(deepPat * 0.6500, 0.0, 1.0), 1.5906);
    ...
    rgb += hotStop * 0.2273 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.2694 * presence + 0.4248 * pattern, 0.8412);
