...
void main() {
    ...
    mid = clamp(mid * (0.6916 + 0.5586 * texDetail) + 0.2035 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6725 + 0.3596 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1514 * (0.5 + 0.5 * sin(time * 0.151844)));
    rgb += emit * 0.8368 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4492 + 0.5013 * presence + 0.4426 * pattern + 0.1508 * (1.0 - deepTrans) + 0.1669 * emit, 0.8950);
