...
// stack: deep=fbm x3 taps | mid=petals+warp1+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0614 + 0.3351 * presence + 0.4047 * pattern + 0.0892 * (1.0 - deepTrans), 0.7826);
