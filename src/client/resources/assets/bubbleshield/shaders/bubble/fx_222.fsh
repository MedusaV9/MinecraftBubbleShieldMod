...
// stack: deep=fbm x3 taps | mid=petals+warp1+pulse | rim=graze_sparkle | flourish=swirl | tex=scales
// fbm: turb x3 octaves | seed 460308b635c174ad
// v8 realism: refr 0.5778+0.7296*fres/dist (cap 0.1012) | energy 0.3578+0.4395*p | flow 0.075833 c/s | soft 0.5527m
...
void main() {
    ...
    float refrAmp = min((0.5778 + 0.7296 * fresnel) / max(length(worldPos), 1.0), 0.1012);
