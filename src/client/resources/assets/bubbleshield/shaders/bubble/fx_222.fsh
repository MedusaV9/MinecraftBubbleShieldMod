...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.006667, 0.022500) * time, time);
    deep += 0.4903 * deepField(duvBase + rimDir * 0.0503 + vec2(-0.010000, 0.032500) * time, time);
    deep = pow(clamp(deep * 0.6710, 0.0, 1.0), 1.0224);
