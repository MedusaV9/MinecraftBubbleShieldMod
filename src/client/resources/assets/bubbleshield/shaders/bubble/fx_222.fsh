...
void main() {
    ...
    mid = clamp(mid * (0.6959 + 0.4810 * texDetail) + 0.3012 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5897 + 0.2563 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1172 * (0.5 + 0.5 * sin(time * 0.256563)));
    ...
    float alpha = vertexColor.a * min(0.3915 + 0.4751 * presence + 0.4047 * pattern + 0.0892 * (1.0 - deepTrans) + 0.1958 * emit, 0.8426);
