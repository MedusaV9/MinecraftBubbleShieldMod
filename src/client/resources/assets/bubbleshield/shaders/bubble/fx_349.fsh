...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8316, 0.0, 1.0);
    ...
    deepCol += 0.4869 * dp * mix(baseCol, deepStop, 0.4283);
    deepPat += 0.4869 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.9319) + par * 0.1256, time);
    deepCol += 0.2371 * dp * mix(baseCol, deepStop, 0.8566);
    deepPat += 0.2371 * dp;
    deepCol *= 0.6097;
    deepPat = pow(clamp(deepPat * 0.5800, 0.0, 1.0), 1.7086);
    ...
    float alpha = vertexColor.a * min(0.0545 + 0.2946 * presence + 0.3569 * pattern, 0.8510);
