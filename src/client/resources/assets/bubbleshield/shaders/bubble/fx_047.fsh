...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8131, 0.0, 1.0);
    ...
    deepCol += 0.4767 * dp * mix(baseCol, deepStop, 0.3214);
    deepPat += 0.4767 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 5.0586) + par * 0.1301, time);
    deepCol += 0.2272 * dp * mix(baseCol, deepStop, 0.6428);
    deepPat += 0.2272 * dp;
    deepCol *= 0.6238;
    deepPat = pow(clamp(deepPat * 0.5869, 0.0, 1.0), 1.7322);
    ...
    rgb += hotStop * 0.2666 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0706 + 0.3060 * presence + 0.3885 * pattern, 0.8543);
