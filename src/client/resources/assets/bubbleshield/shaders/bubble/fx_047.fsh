...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.043333, 0.002500) * time, time);
    deep += 0.4767 * deepField(duvBase + rimDir * 0.0650 + vec2(-0.066667, 0.005000) * time, time);
    deep = pow(clamp(deep * 0.6772, 0.0, 1.0), 1.7322);
