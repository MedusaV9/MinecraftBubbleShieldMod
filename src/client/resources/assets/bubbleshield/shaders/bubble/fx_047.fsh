...
// stack: deep=fbm x3 taps | mid=rings+none+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0706 + 0.3060 * presence + 0.3885 * pattern + 0.0857 * (1.0 - deepTrans), 0.8543);
