...
void main() {
    ...
    mid = clamp(mid * (0.7346 + 0.7033 * texDetail) + 0.3445 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6689 + 0.3792 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0872 * (0.5 + 0.5 * sin(time * 0.235619)));
    rgb += emit * 0.6634 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4186 + 0.4460 * presence + 0.3885 * pattern + 0.0857 * (1.0 - deepTrans) + 0.1578 * emit, 0.9143);
