...
// stack: deep=fbm x3 taps | mid=deepice+none+pulse | rim=graze | flourish=glint | tex=cracked_glass
// fbm: ridged x5 octaves | seed 5ade3705e8c95fff
// v8 realism: refr 0.8036+1.3293*fres/dist (cap 0.1342) | energy 0.2648+0.3504*p | flow 0.115000 c/s | soft 0.7766m
...
void main() {
    ...
    float refrAmp = min((0.8036 + 1.3293 * fresnel) / max(length(worldPos), 1.0), 0.1342);
