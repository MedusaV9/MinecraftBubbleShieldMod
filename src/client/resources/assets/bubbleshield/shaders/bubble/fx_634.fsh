...
// stack: deep=fbm x3 taps | mid=deepice+none+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0742 + 0.3806 * presence + 0.3598 * pattern + 0.1577 * (1.0 - deepTrans), 0.8978);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2451), 0.8978);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5154 + 0.4846 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
