...
// stack: deep=ridge x4 taps | mid=arcs+curl+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0788 + 0.3044 * presence + 0.4581 * pattern + 0.0804 * (1.0 - deepTrans), 0.7826);
