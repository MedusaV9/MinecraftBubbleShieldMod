...
// stack: deep=ridge x3 taps | mid=deepice+none+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0496 + 0.3083 * presence + 0.3431 * pattern + 0.0995 * (1.0 - deepTrans), 0.8293);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3318), 0.8293);
    // [layer:v5:ghostalpha]
