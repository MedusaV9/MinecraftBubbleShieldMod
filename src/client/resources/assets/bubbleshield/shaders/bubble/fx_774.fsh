...
// stack: deep=ridge x3 taps | mid=deepice+none+pulse | rim=graze | flourish=glint | tex=cracked_glass
// fbm: standard x3 octaves | seed 951d5d979b7a6941
// v8 realism: refr 0.9720+1.2817*fres/dist (cap 0.1467) | energy 0.1809+0.3850*p | flow 0.103333 c/s | soft 0.8711m
...
void main() {
    ...
    float refrAmp = min((0.9720 + 1.2817 * fresnel) / max(length(worldPos), 1.0), 0.1467);
