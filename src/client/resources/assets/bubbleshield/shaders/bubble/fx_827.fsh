...
// stack: deep=voro x4 taps | mid=irisfilm+warp1+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0461 + 0.1691 * presence + 0.4557 * pattern + 0.0956 * (1.0 - deepTrans), 0.8091);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2158), 0.8091);
    // [layer:v5:ghostalpha]
