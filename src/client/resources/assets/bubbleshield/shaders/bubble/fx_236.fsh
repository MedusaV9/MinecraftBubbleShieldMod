...
// stack: deep=fbm x4 taps | mid=plasma+none+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0737 + 0.3697 * presence + 0.4408 * pattern + 0.1583 * (1.0 - deepTrans), 0.8069);
