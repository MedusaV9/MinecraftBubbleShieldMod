...
void main() {
    ...
    mid = clamp(mid * (0.6709 + 0.7332 * texDetail) + 0.2261 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6744 + 0.3150 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1695 * (0.5 + 0.5 * sin(time * 0.130900)));
    rgb += emit * 0.8077 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4279 + 0.5097 * presence + 0.4408 * pattern + 0.1583 * (1.0 - deepTrans) + 0.2063 * emit, 0.8669);
