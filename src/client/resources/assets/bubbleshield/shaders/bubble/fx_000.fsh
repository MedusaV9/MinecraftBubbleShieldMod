...
// v8 realism: refr 0.4521+0.5777*fres/dist (cap 0.1399) | energy 0.3131+0.5409*p | flow 0.100000 c/s | soft 0.6573m
...
void main() {
    ...
    float refrAmp = min((0.4521 + 0.5777 * fresnel) / max(length(worldPos), 1.0), 0.1399);
