...
void main() {
    ...
    mid = clamp(mid * (0.7313 + 0.6179 * texDetail) + 0.3080 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5934 + 0.3110 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1238 * (0.5 + 0.5 * sin(time * 0.120428)));
    rgb += emit * 0.7847 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3719 + 0.5058 * presence + 0.4790 * pattern + 0.1458 * (1.0 - deepTrans) + 0.1505 * emit, 0.8883);
