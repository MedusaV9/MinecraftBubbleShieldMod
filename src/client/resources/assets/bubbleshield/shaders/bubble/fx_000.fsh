...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.356047);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.008333, 0.015000) * time, time);
    deep += 0.5197 * deepField(duvBase + rimDir * 0.0604 + vec2(0.013333, 0.022500) * time, time);
    deep += 0.2700 * deepField(duvBase + rimDir * 0.1209 + vec2(0.016667, 0.030000) * time, time);
    deep = pow(clamp(deep * 0.5588, 0.0, 1.0), 1.3371);
