...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.8679 + fiR.y * 0.7215)), 0.3713);
    ...
    float alpha = vertexColor.a * min(0.0720 + 0.3165 * presence + 0.3647 * pattern + 0.0824 * (1.0 - deepTrans), 0.8504);
    // [layer:v5:backface]
