...
// stack: deep=caustic x3 taps | mid=fluidink+none+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0720 + 0.2565 * presence + 0.3647 * pattern + 0.0824 * (1.0 - deepTrans), 0.8504);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1694), 0.8504);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4247 + 0.5753 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
