...
// stack: deep=caustic x3 taps | mid=fluidink+none+rotate | rim=graze_sparkle | flourish=swirl | tex=marble_ink
// fbm: turb x6 octaves | seed 4a43c898c0babcff
// v8 realism: refr 0.6809+0.6633*fres/dist (cap 0.1265) | energy 0.4140+0.4342*p | flow 0.077500 c/s | soft 0.9159m
...
void main() {
    ...
    float refrAmp = min((0.6809 + 0.6633 * fresnel) / max(length(worldPos), 1.0), 0.1265);
