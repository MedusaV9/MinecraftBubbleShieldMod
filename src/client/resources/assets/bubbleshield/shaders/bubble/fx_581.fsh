...
void main() {
    ...
    float mid = clamp(rfLight * 1.2439 + (1.0 - rfTrans) * 0.1577, 0.0, 1.15);
    ...
    float alpha = vertexColor.a * min(0.0759 + 0.3512 * presence + 0.3539 * pattern + 0.0922 * (1.0 - deepTrans), 0.8492);
    // [layer:v5:backface]
