...
// stack: deep=fbm x3 taps | mid=raymarchfog+curl+rotate | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0759 + 0.2712 * presence + 0.3539 * pattern + 0.0922 * (1.0 - deepTrans), 0.8492);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1636), 0.8492);
    // [layer:v5:ghostalpha]
