...
// stack: deep=fbm x3 taps | mid=truchet+curl+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0496 + 0.2668 * presence + 0.4169 * pattern + 0.1015 * (1.0 - deepTrans), 0.8413);
