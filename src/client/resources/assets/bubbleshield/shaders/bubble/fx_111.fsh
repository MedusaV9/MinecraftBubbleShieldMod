...
// stack: deep=fbm x3 taps | mid=truchet+curl+flicker | rim=graze | flourish=shimmer | tex=runes
// fbm: turb x4 octaves | seed 1f9d6333f5e7b2a7
// v8 realism: refr 0.5961+0.6103*fres/dist (cap 0.1111) | energy 0.4112+0.4673*p | flow 0.063333 c/s | soft 0.8680m
...
void main() {
    ...
    float refrAmp = min((0.5961 + 0.6103 * fresnel) / max(length(worldPos), 1.0), 0.1111);
