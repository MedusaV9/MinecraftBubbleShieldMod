...
void main() {
    ...
    mid = clamp(mid * (0.6567 + 0.6336 * texDetail) + 0.2767 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7573 + 0.3767 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1024 * (0.5 + 0.5 * sin(time * 0.162316)));
    ...
    float alpha = vertexColor.a * min(0.3564 + 0.4068 * presence + 0.4169 * pattern + 0.1015 * (1.0 - deepTrans) + 0.1807 * emit, 0.9013);
