...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6161, 0.0, 1.0);
    ...
    deepCol += 0.3990 * dp * mix(baseCol, deepStop, 0.2993);
    deepPat += 0.3990 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.9216) + par * 0.0679, time);
    deepCol += 0.1592 * dp * mix(baseCol, deepStop, 0.5987);
    deepPat += 0.1592 * dp;
    deepCol *= 0.6545;
    deepPat = pow(clamp(deepPat * 0.6418, 0.0, 1.0), 1.0856);
    ...
    float alpha = vertexColor.a * min(0.0496 + 0.2668 * presence + 0.4169 * pattern, 0.8413);
