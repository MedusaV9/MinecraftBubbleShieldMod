...
// stack: deep=caustic x4 taps | mid=irisfilm+curl+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0675 + 0.2352 * presence + 0.4882 * pattern + 0.0849 * (1.0 - deepTrans), 0.7983);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2483), 0.7983);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5240 + 0.4760 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
