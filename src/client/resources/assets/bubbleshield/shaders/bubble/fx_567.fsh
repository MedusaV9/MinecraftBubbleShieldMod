...
// stack: deep=caustic x4 taps | mid=irisfilm+curl+scroll | rim=lat | flourish=glint | tex=chrome
// fbm: standard x5 octaves | seed a458ba8c548a74f0
// v8 realism: refr 0.9747+1.2491*fres/dist (cap 0.1341) | energy 0.2518+0.3869*p | flow 0.085000 c/s | soft 0.5830m
...
void main() {
    ...
    float refrAmp = min((0.9747 + 1.2491 * fresnel) / max(length(worldPos), 1.0), 0.1341);
