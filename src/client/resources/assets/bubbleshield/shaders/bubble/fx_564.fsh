...
// stack: deep=caustic x4 taps | mid=orbittrap+warp1+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0524 + 0.1967 * presence + 0.5437 * pattern + 0.1438 * (1.0 - deepTrans), 0.8484);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2989), 0.8484);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4820 + 0.5180 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
