...
// stack: deep=caustic x3 taps | mid=holoparallax+warp2+pulse | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0655 + 0.1582 * presence + 0.6072 * pattern + 0.1087 * (1.0 - deepTrans), 0.8530);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1623), 0.8530);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4131 + 0.5869 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
