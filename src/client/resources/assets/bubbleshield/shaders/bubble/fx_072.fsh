...
// stack: deep=voro x4 taps | mid=aurora+warp2+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0625 + 0.2839 * presence + 0.4175 * pattern + 0.1280 * (1.0 - deepTrans), 0.8482);
