...
void main() {
    ...
    mid = clamp(mid * (0.6761 + 0.7081 * texDetail) + 0.2694 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7115 + 0.4675 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1734 * (0.5 + 0.5 * sin(time * 0.287979)));
    rgb += emit * 0.7931 * emitCol;
    // [layer:v5:softknee]
    ...
    float alpha = vertexColor.a * min(0.3931 + 0.3872 * presence + 0.4148 * pattern + 0.1270 * (1.0 - deepTrans) + 0.1874 * emit, 0.9150);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1946), 0.9150);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.6296 + 0.3704 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
