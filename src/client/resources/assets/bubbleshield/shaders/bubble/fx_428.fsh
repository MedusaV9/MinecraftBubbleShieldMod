...
void main() {
    ...
    float flourish = 0.2416 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
    ...
    float alpha = vertexColor.a * min(0.0415 + 0.2814 * presence + 0.3870 * pattern + 0.1344 * (1.0 - deepTrans), 0.8297);
    // [layer:v5:backface]
