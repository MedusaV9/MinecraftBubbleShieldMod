...
// stack: deep=fbm x3 taps | mid=aethersmoke+warp1+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0415 + 0.2214 * presence + 0.3870 * pattern + 0.1344 * (1.0 - deepTrans), 0.8297);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2613), 0.8297);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5184 + 0.4816 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
