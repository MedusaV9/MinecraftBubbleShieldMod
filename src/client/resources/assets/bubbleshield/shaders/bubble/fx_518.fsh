...
// stack: deep=voro x3 taps | mid=ectoplasm+curl+flicker | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0617 + 0.2066 * presence + 0.5054 * pattern + 0.0863 * (1.0 - deepTrans), 0.8421);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2432), 0.8421);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4393 + 0.5607 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
