...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5542, 0.0, 1.0);
    ...
    deepCol += 0.5326 * dp * mix(baseCol, deepStop, 0.3101);
    deepPat += 0.5326 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 5.6993) + par * 0.1361, time);
    deepCol += 0.2836 * dp * mix(baseCol, deepStop, 0.6202);
    deepPat += 0.2836 * dp;
    deepCol *= 0.5262;
    deepPat = pow(clamp(deepPat * 0.5506, 0.0, 1.0), 1.1005);
    ...
    rgb += hotStop * 0.2189 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.3206 * presence + 0.4823 * pattern, 0.8517);
