...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.308923);
...
void main() {
    ...
    deep += 0.5326 * deepField(duvBase + rimDir * 0.0681 + vec2(0.005000, -0.050000) * time, time);
    deep = pow(clamp(deep * 0.6525, 0.0, 1.0), 1.1005);
