...
// stack: deep=voro x3 taps | mid=sparkle+none+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.3206 * presence + 0.4823 * pattern + 0.1317 * (1.0 - deepTrans), 0.8517);
