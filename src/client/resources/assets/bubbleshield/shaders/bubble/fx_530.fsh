...
// stack: deep=fbm x4 taps | mid=phantomecho+warp1+scroll | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0490 + 0.1036 * presence + 0.5850 * pattern + 0.1259 * (1.0 - deepTrans), 0.7810);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3255), 0.7810);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4814 + 0.5186 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
