...
void main() {
    ...
    float flourish = 0.2600 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
    ...
    rgb = mix(rgb, hotStop, clamp(ecEdge, 0.0, 1.0) * 0.2540);
    ...
    float alpha = vertexColor.a * min(0.0641 + 0.2636 * presence + 0.4169 * pattern + 0.1156 * (1.0 - deepTrans), 0.8444);
    // [layer:v5:backface]
