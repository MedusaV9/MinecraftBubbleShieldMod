...
// stack: deep=fbm x3 taps | mid=ectoplasm+warp2+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0641 + 0.2069 * presence + 0.4169 * pattern + 0.1156 * (1.0 - deepTrans), 0.8444);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3072), 0.8444);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5006 + 0.4994 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
