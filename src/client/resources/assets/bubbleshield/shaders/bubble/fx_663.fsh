...
// stack: deep=caustic x3 taps | mid=holoparallax+none+scroll | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0741 + 0.1148 * presence + 0.5860 * pattern + 0.1230 * (1.0 - deepTrans), 0.8010);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2700), 0.8010);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4701 + 0.5299 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
