...
// stack: deep=fbm x3 taps | mid=plasmaglobe+curl+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0707 + 0.0660 * presence + 0.6525 * pattern + 0.1005 * (1.0 - deepTrans), 0.8775);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2024), 0.8775);
    // [layer:v5:ghostalpha]
