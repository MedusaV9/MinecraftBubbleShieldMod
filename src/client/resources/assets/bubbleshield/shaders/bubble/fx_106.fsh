...
// stack: deep=fbm x3 taps | mid=petals+curl+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0755 + 0.3235 * presence + 0.4579 * pattern + 0.1260 * (1.0 - deepTrans), 0.8013);
