...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7200, 0.0, 1.0);
    ...
    deepCol += 0.4594 * dp * mix(baseCol, deepStop, 0.3520);
    deepPat += 0.4594 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 4.9913) + par * 0.1273, time);
    deepCol += 0.2111 * dp * mix(baseCol, deepStop, 0.7040);
    deepPat += 0.2111 * dp;
    deepCol *= 0.6011;
    deepPat = pow(clamp(deepPat * 0.5986, 0.0, 1.0), 1.2837);
    ...
    rgb += hotStop * 0.2005 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0755 + 0.3235 * presence + 0.4579 * pattern, 0.8013);
