...
// stack: deep=fbm x3 taps | mid=petals+curl+flicker | rim=graze_sparkle | flourish=shimmer | tex=scales
// fbm: turb x6 octaves | seed 4dbc6c250a73d7b5
// v8 realism: refr 0.7336+0.8418*fres/dist (cap 0.1069) | energy 0.4171+0.3996*p | flow 0.104167 c/s | soft 0.8818m
...
void main() {
    ...
    float refrAmp = min((0.7336 + 0.8418 * fresnel) / max(length(worldPos), 1.0), 0.1069);
