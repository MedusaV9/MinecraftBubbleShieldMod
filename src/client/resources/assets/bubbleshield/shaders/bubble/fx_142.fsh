...
// v8 realism: refr 0.6599+0.7155*fres/dist (cap 0.1124) | energy 0.3599+0.4717*p | flow 0.086667 c/s | soft 0.7586m
...
void main() {
    ...
    float refrAmp = min((0.6599 + 0.7155 * fresnel) / max(length(worldPos), 1.0), 0.1124);
