...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.040833, -0.048333) * time, time);
    deep += 0.3979 * deepField(duvBase + rimDir * 0.0733 + vec2(0.063333, -0.075000) * time, time);
    deep = pow(clamp(deep * 0.7154, 0.0, 1.0), 1.3365);
