...
// stack: deep=fbm x3 taps | mid=scales+warp1+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0561 + 0.2544 * presence + 0.4155 * pattern + 0.1597 * (1.0 - deepTrans), 0.7906);
