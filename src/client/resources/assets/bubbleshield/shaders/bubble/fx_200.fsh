...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8070, 0.0, 1.0);
    ...
    deepCol += 0.3979 * dp * mix(baseCol, deepStop, 0.3931);
    deepPat += 0.3979 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 4.6372) + par * 0.1466, time);
    deepCol += 0.1583 * dp * mix(baseCol, deepStop, 0.7862);
    deepPat += 0.1583 * dp;
    deepCol *= 0.7306;
    deepPat = pow(clamp(deepPat * 0.6426, 0.0, 1.0), 1.3365);
    ...
    rgb += hotStop * 0.1846 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0561 + 0.2544 * presence + 0.4155 * pattern, 0.7906);
