...
// stack: deep=ridge x4 taps | mid=irisfilm+warp1+rotate | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0442 + 0.2219 * presence + 0.4784 * pattern + 0.1168 * (1.0 - deepTrans), 0.7452);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3476), 0.7452);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4389 + 0.5611 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
