...
// stack: deep=ridge x4 taps | mid=irisfilm+warp1+rotate | rim=lat | flourish=glint | tex=chrome
// fbm: standard x3 octaves | seed 0c97fdfaf6f7ef51
// v8 realism: refr 0.7607+1.1239*fres/dist (cap 0.1451) | energy 0.2143+0.4524*p | flow 0.077500 c/s | soft 0.5839m
...
void main() {
    ...
    float refrAmp = min((0.7607 + 1.1239 * fresnel) / max(length(worldPos), 1.0), 0.1451);
