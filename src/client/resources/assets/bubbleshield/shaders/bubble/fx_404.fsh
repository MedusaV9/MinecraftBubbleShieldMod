...
// stack: deep=ridge x4 taps | mid=kaliset+warp2+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0583 + 0.1876 * presence + 0.4421 * pattern + 0.1358 * (1.0 - deepTrans), 0.8361);
