...
// stack: deep=ridge x4 taps | mid=kaliset+warp2+rotate | rim=graze | flourish=shimmer | tex=nebula
// fbm: standard x3 octaves | seed 7ced0286d864caba
// v8 realism: refr 0.4141+0.5244*fres/dist (cap 0.1025) | energy 0.4465+0.3947*p | flow 0.080833 c/s | soft 1.0448m
...
void main() {
    ...
    float refrAmp = min((0.4141 + 0.5244 * fresnel) / max(length(worldPos), 1.0), 0.1025);
