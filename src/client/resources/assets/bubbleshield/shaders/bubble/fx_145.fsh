...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6168, 0.0, 1.0);
    ...
    deepCol += 0.4125 * dp * mix(baseCol, deepStop, 0.3343);
    deepPat += 0.4125 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 2.9955) + par * 0.1078, time);
    deepCol += 0.1701 * dp * mix(baseCol, deepStop, 0.6686);
    deepPat += 0.1701 * dp;
    deepCol *= 0.8001;
    deepPat = pow(clamp(deepPat * 0.6319, 0.0, 1.0), 1.0096);
    ...
    rgb += hotStop * 0.2544 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0712 + 0.2699 * presence + 0.3995 * pattern, 0.7985);
