...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(1.0000, 2.0000), t * 0.664970);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.005833, -0.005000) * time, time);
    deep += 0.4125 * deepField(duvBase + rimDir * 0.0539 + vec2(-0.009167, -0.006667) * time, time);
    deep += 0.1701 * deepField(duvBase + rimDir * 0.1078 + vec2(-0.012500, -0.010000) * time, time);
    deep = pow(clamp(deep * 0.6319, 0.0, 1.0), 1.0096);
