...
void main() {
    ...
    mid = clamp(mid * (0.6132 + 0.7420 * texDetail) + 0.2197 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6508 + 0.4038 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1603 * (0.5 + 0.5 * sin(time * 0.277507)));
    rgb += emit * 0.7769 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4203 + 0.4099 * presence + 0.3995 * pattern + 0.1004 * (1.0 - deepTrans) + 0.1797 * emit, 0.8585);
