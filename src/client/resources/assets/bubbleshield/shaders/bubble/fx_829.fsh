...
// stack: deep=ridge x3 taps | mid=stainedglass+warp1+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0617 + 0.3392 * presence + 0.4723 * pattern + 0.1466 * (1.0 - deepTrans), 0.8683);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2221), 0.8683);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4298 + 0.5702 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
