...
// stack: deep=ridge x3 taps | mid=stainedglass+warp1+pulse | rim=graze_film | flourish=swirl | tex=worley_cells
// fbm: ridged x4 octaves | seed 95ae5c257d370f9f
// v8 realism: refr 0.7805+0.8294*fres/dist (cap 0.1363) | energy 0.2273+0.4143*p | flow 0.063333 c/s | soft 0.9311m
...
void main() {
    ...
    float refrAmp = min((0.7805 + 0.8294 * fresnel) / max(length(worldPos), 1.0), 0.1363);
