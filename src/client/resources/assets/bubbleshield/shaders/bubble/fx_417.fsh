...
void main() {
    ...
    mid = clamp(mid * (0.6320 + 0.7238 * texDetail) + 0.3136 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7512 + 0.4375 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1267 * (0.5 + 0.5 * sin(time * 0.141372)));
    rgb += emit * 0.8849 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3735 + 0.3338 * presence + 0.5647 * pattern + 0.1464 * (1.0 - deepTrans) + 0.1273 * emit, 0.8831);
