...
// stack: deep=fbm x3 taps | mid=kaliset+none+rotate | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0777 + 0.1938 * presence + 0.5647 * pattern + 0.1464 * (1.0 - deepTrans), 0.8231);
