...
// stack: deep=ridge x3 taps | mid=oilslick+warp2+scroll | rim=graze_film | flourish=echo | tex=chrome
// fbm: standard x3 octaves | seed 2ca71b4bd4f3194b
// v8 realism: refr 0.9229+1.0997*fres/dist (cap 0.1170) | energy 0.2479+0.4716*p | flow 0.072500 c/s | soft 0.8614m
...
void main() {
    ...
    float refrAmp = min((0.9229 + 1.0997 * fresnel) / max(length(worldPos), 1.0), 0.1170);
