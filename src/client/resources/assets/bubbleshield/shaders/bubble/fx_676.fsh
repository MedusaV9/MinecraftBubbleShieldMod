...
// stack: deep=ridge x3 taps | mid=oilslick+warp2+scroll | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0541 + 0.2793 * presence + 0.4580 * pattern + 0.1296 * (1.0 - deepTrans), 0.8414);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1777), 0.8414);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4047 + 0.5953 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
