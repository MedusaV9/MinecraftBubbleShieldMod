...
// stack: deep=voro x4 taps | mid=irisfilm+warp1+rotate | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0632 + 0.1960 * presence + 0.3964 * pattern + 0.1575 * (1.0 - deepTrans), 0.7418);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3019), 0.7418);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4407 + 0.5593 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
