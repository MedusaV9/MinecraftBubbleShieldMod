...
// stack: deep=voro x3 taps | mid=mycelia+warp1+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0531 + 0.1711 * presence + 0.5260 * pattern + 0.0917 * (1.0 - deepTrans), 0.7848);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2757), 0.7848);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4986 + 0.5014 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
