...
void main() {
    ...
    mid = clamp(mid * (0.7143 + 0.4781 * texDetail) + 0.2642 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6131 + 0.4527 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1646 * (0.5 + 0.5 * sin(time * 0.125664)));
    ...
    float alpha = vertexColor.a * min(0.3096 + 0.2764 * presence + 0.4937 * pattern + 0.1526 * (1.0 - deepTrans) + 0.1253 * emit, 0.8998);
