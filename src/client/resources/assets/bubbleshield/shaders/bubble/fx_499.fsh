...
// stack: deep=ridge x3 taps | mid=voidrift+none+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0517 + 0.2099 * presence + 0.4914 * pattern + 0.1229 * (1.0 - deepTrans), 0.7917);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1518), 0.7917);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5404 + 0.4596 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
