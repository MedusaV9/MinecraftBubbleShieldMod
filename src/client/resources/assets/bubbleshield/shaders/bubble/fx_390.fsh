...
void main() {
    ...
    mid = clamp(mid * (0.6074 + 0.4762 * texDetail) + 0.2345 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3731), 0.0, 1.0);
    float emit = atlas.a * (0.6828 + 0.4064 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1375 * (0.5 + 0.5 * sin(time * 0.267035)));
    ...
    float alpha = vertexColor.a * min(0.3464 + 0.3223 * presence + 0.5660 * pattern + 0.0936 * (1.0 - deepTrans) + 0.2160 * emit, 0.9148);
