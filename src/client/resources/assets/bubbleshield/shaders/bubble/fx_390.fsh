...
// stack: deep=voro x4 taps | mid=kaliset+warp2+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0664 + 0.1823 * presence + 0.5660 * pattern + 0.0936 * (1.0 - deepTrans), 0.8548);
