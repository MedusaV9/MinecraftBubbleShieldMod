...
// stack: deep=ridge x3 taps | mid=prismdisperse+warp2+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0478 + 0.3351 * presence + 0.4584 * pattern + 0.1386 * (1.0 - deepTrans), 0.8382);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1533), 0.8382);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5290 + 0.4710 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
