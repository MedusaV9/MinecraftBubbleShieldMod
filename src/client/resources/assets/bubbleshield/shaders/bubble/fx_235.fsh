...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6709, 0.0, 1.0);
    ...
    deepCol += 0.5350 * dp * mix(baseCol, deepStop, 0.2916);
    deepPat += 0.5350 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 3.1893) + par * 0.0957, time);
    deepCol += 0.2862 * dp * mix(baseCol, deepStop, 0.5832);
    deepPat += 0.2862 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 3.9248) + par * 0.1435, time);
    deepCol += 0.1531 * dp * mix(baseCol, deepStop, 0.8748);
    deepPat += 0.1531 * dp;
    deepCol *= 0.5244;
    deepPat = pow(clamp(deepPat * 0.5065, 0.0, 1.0), 1.3183);
    ...
    rgb += hotStop * 0.2015 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0482 + 0.3627 * presence + 0.4030 * pattern, 0.8508);
