...
void main() {
    ...
    mid = clamp(mid * (0.6145 + 0.5283 * texDetail) + 0.2903 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.5276), 0.0, 1.0);
    float emit = atlas.a * (0.6666 + 0.4720 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1314 * (0.5 + 0.5 * sin(time * 0.256563)));
    rgb += emit * 0.7440 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3523 + 0.5027 * presence + 0.4030 * pattern + 0.1146 * (1.0 - deepTrans) + 0.1900 * emit, 0.9108);
