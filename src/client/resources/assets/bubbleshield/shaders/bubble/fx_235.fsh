...
// stack: deep=ridge x4 taps | mid=truchet+curl+scroll | rim=graze_sparkle | flourish=shimmer | tex=runes
// fbm: ridged x6 octaves | seed 941fd8a2dcf59329
// v8 realism: refr 0.4762+0.6005*fres/dist (cap 0.1519) | energy 0.4138+0.5023*p | flow 0.080000 c/s | soft 0.6392m
...
void main() {
    ...
    float refrAmp = min((0.4762 + 0.6005 * fresnel) / max(length(worldPos), 1.0), 0.1519);
