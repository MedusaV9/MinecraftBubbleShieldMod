...
// stack: deep=voro x3 taps | mid=scales+curl+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0610 + 0.3441 * presence + 0.3985 * pattern + 0.1261 * (1.0 - deepTrans), 0.7896);
