...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5797, 0.0, 1.0);
    ...
    deepCol += 0.5499 * dp * mix(baseCol, deepStop, 0.2896);
    deepPat += 0.5499 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.8555) + par * 0.0668, time);
    deepCol += 0.3024 * dp * mix(baseCol, deepStop, 0.5792);
    deepPat += 0.3024 * dp;
    deepCol *= 0.6710;
    deepPat = pow(clamp(deepPat * 0.5399, 0.0, 1.0), 1.6589);
    ...
    rgb += hotStop * 0.3307 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0610 + 0.3441 * presence + 0.3985 * pattern, 0.7896);
