...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(3.0000, 4.0000), t * 0.638791);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.000000, -0.023333) * time, time);
    deep += 0.5499 * deepField(duvBase + rimDir * 0.0334 + vec2(-0.002500, -0.036667) * time, time);
    deep = pow(clamp(deep * 0.6452, 0.0, 1.0), 1.6589);
