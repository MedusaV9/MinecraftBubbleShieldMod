...
void main() {
    ...
    mid = clamp(mid * (0.7082 + 0.5154 * texDetail) + 0.2475 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6970 + 0.3829 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1415 * (0.5 + 0.5 * sin(time * 0.267035)));
    rgb += emit * 0.7353 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3902 + 0.4841 * presence + 0.3985 * pattern + 0.1261 * (1.0 - deepTrans) + 0.1777 * emit, 0.8496);
