...
// stack: deep=ridge x4 taps | mid=petals+curl+scroll | rim=lat | flourish=echo | tex=scales
// fbm: ridged x3 octaves | seed fe39ffeab81c90ab
// v8 realism: refr 0.6284+0.8174*fres/dist (cap 0.1113) | energy 0.3631+0.4655*p | flow 0.066667 c/s | soft 0.5529m
...
void main() {
    ...
    float refrAmp = min((0.6284 + 0.8174 * fresnel) / max(length(worldPos), 1.0), 0.1113);
