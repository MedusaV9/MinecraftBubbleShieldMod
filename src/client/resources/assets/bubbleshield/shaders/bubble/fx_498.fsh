...
// stack: deep=voro x4 taps | mid=ectoplasm+warp2+pulse | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0583 + 0.1799 * presence + 0.5408 * pattern + 0.1436 * (1.0 - deepTrans), 0.7901);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1813), 0.7901);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4994 + 0.5006 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
