...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6240, 0.0, 1.0);
    ...
    deepCol += 0.5202 * dp * mix(baseCol, deepStop, 0.2643);
    deepPat += 0.5202 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.6780) + par * 0.0938, time);
    deepCol += 0.2706 * dp * mix(baseCol, deepStop, 0.5286);
    deepPat += 0.2706 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 4.6751) + par * 0.1408, time);
    deepCol += 0.1407 * dp * mix(baseCol, deepStop, 0.7928);
    deepPat += 0.1407 * dp;
    deepCol *= 0.5935;
    deepPat = pow(clamp(deepPat * 0.5177, 0.0, 1.0), 1.3024);
    ...
    float alpha = vertexColor.a * min(0.0742 + 0.3621 * presence + 0.3228 * pattern, 0.7828);
