...
void main() {
    ...
    deep += 0.5202 * deepField(duvBase + rimDir * 0.0469 + vec2(-0.026667, 0.065000) * time, time);
    deep += 0.2706 * deepField(duvBase + rimDir * 0.0938 + vec2(-0.036667, 0.087500) * time, time);
    deep += 0.1407 * deepField(duvBase + rimDir * 0.1408 + vec2(-0.045000, 0.110000) * time, time);
    deep = pow(clamp(deep * 0.5177, 0.0, 1.0), 1.3024);
