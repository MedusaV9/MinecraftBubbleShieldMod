...
// stack: deep=caustic x4 taps | mid=stainedglass+warp1+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0509 + 0.3374 * presence + 0.4613 * pattern + 0.1254 * (1.0 - deepTrans), 0.8682);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3279), 0.8682);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3976 + 0.6024 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
