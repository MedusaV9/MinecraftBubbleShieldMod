...
// stack: deep=fbm x4 taps | mid=voronoi+curl+flicker | rim=graze | flourish=echo | tex=worley_cells
// fbm: turb x4 octaves | seed 871e3aa50570a7db
// v8 realism: refr 0.5747+0.6202*fres/dist (cap 0.1493) | energy 0.4121+0.5108*p | flow 0.077500 c/s | soft 0.7344m
...
void main() {
    ...
    float refrAmp = min((0.5747 + 0.6202 * fresnel) / max(length(worldPos), 1.0), 0.1493);
