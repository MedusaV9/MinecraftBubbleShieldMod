...
void main() {
    ...
    mid = clamp(mid * (0.6459 + 0.6634 * texDetail) + 0.1952 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7846 + 0.3823 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1768 * (0.5 + 0.5 * sin(time * 0.272271)));
    rgb += emit * 0.6757 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3592 + 0.4432 * presence + 0.4329 * pattern + 0.1235 * (1.0 - deepTrans) + 0.1630 * emit, 0.8604);
