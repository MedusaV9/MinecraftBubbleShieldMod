...
// stack: deep=fbm x4 taps | mid=voronoi+curl+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0505 + 0.3032 * presence + 0.4329 * pattern + 0.1235 * (1.0 - deepTrans), 0.8004);
