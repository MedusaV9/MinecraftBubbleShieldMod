...
// stack: deep=caustic x3 taps | mid=arcs+none+flicker | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0664 + 0.3491 * presence + 0.4546 * pattern + 0.0999 * (1.0 - deepTrans), 0.8246);
