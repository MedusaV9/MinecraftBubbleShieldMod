...
// stack: deep=caustic x4 taps | mid=kaleido+warp2+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0488 + 0.3238 * presence + 0.3880 * pattern + 0.1357 * (1.0 - deepTrans), 0.8366);
