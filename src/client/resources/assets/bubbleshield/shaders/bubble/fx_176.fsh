...
void main() {
    ...
    mid = clamp(mid * (0.7094 + 0.7290 * texDetail) + 0.2684 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7770 + 0.3908 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1781 * (0.5 + 0.5 * sin(time * 0.251327)));
    rgb += emit * 0.6626 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3872 + 0.4638 * presence + 0.3880 * pattern + 0.1357 * (1.0 - deepTrans) + 0.1913 * emit, 0.8966);
