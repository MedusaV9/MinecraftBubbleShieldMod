...
// stack: deep=caustic x4 taps | mid=kaleido+warp2+pulse | rim=graze_sparkle | flourish=glint | tex=cracked_glass
// fbm: standard x5 octaves | seed 98de5386f5a34a76
// v8 realism: refr 0.9587+1.6874*fres/dist (cap 0.1124) | energy 0.2732+0.3476*p | flow 0.105000 c/s | soft 0.7180m
...
void main() {
    ...
    float refrAmp = min((0.9587 + 1.6874 * fresnel) / max(length(worldPos), 1.0), 0.1124);
