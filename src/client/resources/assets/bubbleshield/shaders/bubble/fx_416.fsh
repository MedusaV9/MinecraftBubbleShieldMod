...
// stack: deep=fbm x4 taps | mid=crystalrefract+warp1+rotate | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0488 + 0.2556 * presence + 0.4341 * pattern + 0.0911 * (1.0 - deepTrans), 0.8199);
