...
void main() {
    ...
    mid = clamp(mid * (0.7375 + 0.5951 * texDetail) + 0.2508 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7967 + 0.4876 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1154 * (0.5 + 0.5 * sin(time * 0.225147)));
    rgb += emit * 0.8218 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3541 + 0.3956 * presence + 0.4341 * pattern + 0.0911 * (1.0 - deepTrans) + 0.1256 * emit, 0.8799);
