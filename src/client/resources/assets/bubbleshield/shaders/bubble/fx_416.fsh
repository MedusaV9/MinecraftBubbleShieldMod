...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5591, 0.0, 1.0);
    ...
    deepCol += 0.4446 * dp * mix(baseCol, deepStop, 0.2797);
    deepPat += 0.4446 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 5.0338) + par * 0.0874, time);
    deepCol += 0.1976 * dp * mix(baseCol, deepStop, 0.5594);
    deepPat += 0.1976 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 6.2919) + par * 0.1312, time);
    deepCol += 0.0879 * dp * mix(baseCol, deepStop, 0.8391);
    deepPat += 0.0879 * dp;
    deepCol *= 0.7242;
    deepPat = pow(clamp(deepPat * 0.5780, 0.0, 1.0), 1.4896);
    ...
    rgb += hotStop * 0.2768 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0488 + 0.2556 * presence + 0.4341 * pattern, 0.8199);
