...
// stack: deep=fbm x4 taps | mid=crystalrefract+warp1+rotate | rim=lat | flourish=glint | tex=worley_cells
// fbm: standard x4 octaves | seed 21996a59a7f3904f
// v8 realism: refr 0.8599+1.3638*fres/dist (cap 0.1183) | energy 0.1924+0.4672*p | flow 0.105833 c/s | soft 0.7750m
...
void main() {
    ...
    float refrAmp = min((0.8599 + 1.3638 * fresnel) / max(length(worldPos), 1.0), 0.1183);
