...
// stack: deep=caustic x3 taps | mid=chrome+warp2+rotate | rim=graze_sparkle | flourish=echo | tex=chrome
// fbm: standard x3 octaves | seed eda59d9bba269a3c
// v8 realism: refr 0.9928+1.6727*fres/dist (cap 0.1595) | energy 0.1957+0.3612*p | flow 0.075000 c/s | soft 1.0109m
...
void main() {
    ...
    float refrAmp = min((0.9928 + 1.6727 * fresnel) / max(length(worldPos), 1.0), 0.1595);
