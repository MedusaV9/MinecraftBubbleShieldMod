...
// stack: deep=caustic x3 taps | mid=solarflare+warp1+scroll | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0449 + 0.1457 * presence + 0.4944 * pattern + 0.1458 * (1.0 - deepTrans), 0.8250);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2390), 0.8250);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4658 + 0.5342 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
