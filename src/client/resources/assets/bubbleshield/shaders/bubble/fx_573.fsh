...
// stack: deep=caustic x3 taps | mid=solarflare+warp1+scroll | rim=graze_sparkle | flourish=swirl | tex=worley_cells
// fbm: standard x3 octaves | seed f1abd5c04dab58af
// v8 realism: refr 0.5201+0.7400*fres/dist (cap 0.1055) | energy 0.4054+0.3840*p | flow 0.081667 c/s | soft 0.9542m
...
void main() {
    ...
    float refrAmp = min((0.5201 + 0.7400 * fresnel) / max(length(worldPos), 1.0), 0.1055);
