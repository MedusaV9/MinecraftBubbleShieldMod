...
// stack: deep=fbm x3 taps | mid=prismdisperse+curl+pulse | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0653 + 0.3057 * presence + 0.4329 * pattern + 0.1436 * (1.0 - deepTrans), 0.8432);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1753), 0.8432);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4449 + 0.5551 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
