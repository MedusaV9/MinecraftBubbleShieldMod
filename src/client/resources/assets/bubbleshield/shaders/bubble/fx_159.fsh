...
// stack: deep=fbm x3 taps | mid=arcs+none+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0797 + 0.2988 * presence + 0.3688 * pattern + 0.0973 * (1.0 - deepTrans), 0.8254);
