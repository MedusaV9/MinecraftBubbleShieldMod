...
// stack: deep=fbm x3 taps | mid=arcs+none+rotate | rim=graze_sparkle | flourish=swirl | tex=filaments
// fbm: turb x5 octaves | seed 3b280951d619e12a
// v8 realism: refr 0.5795+0.6722*fres/dist (cap 0.1310) | energy 0.3402+0.4382*p | flow 0.063333 c/s | soft 0.9885m
...
void main() {
    ...
    float refrAmp = min((0.5795 + 0.6722 * fresnel) / max(length(worldPos), 1.0), 0.1310);
