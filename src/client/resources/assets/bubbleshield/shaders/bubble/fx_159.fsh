...
void main() {
    ...
    mid = clamp(mid * (0.6474 + 0.7493 * texDetail) + 0.1803 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5664 + 0.2614 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0818 * (0.5 + 0.5 * sin(time * 0.178024)));
    rgb += emit * 0.9642 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4457 + 0.4388 * presence + 0.3688 * pattern + 0.0973 * (1.0 - deepTrans) + 0.1843 * emit, 0.8854);
