...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8380, 0.0, 1.0);
    ...
    deepCol += 0.3910 * dp * mix(baseCol, deepStop, 0.3173);
    deepPat += 0.3910 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.4326) + par * 0.1545, time);
    deepCol += 0.1529 * dp * mix(baseCol, deepStop, 0.6346);
    deepPat += 0.1529 * dp;
    deepCol *= 0.6754;
    deepPat = pow(clamp(deepPat * 0.6477, 0.0, 1.0), 1.3417);
    ...
    rgb += hotStop * 0.3401 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0797 + 0.2988 * presence + 0.3688 * pattern, 0.8254);
