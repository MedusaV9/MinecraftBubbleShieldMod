...
void main() {
    ...
    vec2 tileUV = (vec2(3.0000, 0.0000) + clamp(fract(texUV), 0.004, 0.996)) * 0.25;
    ...
    rim = clamp(rim + 0.6002 * rimLine, 0.0, 1.4);
    ...
    float alpha = clamp(bodyAlpha, 0.0, 0.8475) * vertexColor.a;
