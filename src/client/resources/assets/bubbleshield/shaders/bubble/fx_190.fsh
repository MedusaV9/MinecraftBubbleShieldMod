...
// stack: deep=caustic x4 taps | mid=triweave+warp1+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0689 + 0.3416 * presence + 0.4357 * pattern + 0.1426 * (1.0 - deepTrans), 0.7875);
