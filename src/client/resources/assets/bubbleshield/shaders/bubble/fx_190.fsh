...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6339, 0.0, 1.0);
    ...
    deepCol += 0.4837 * dp * mix(baseCol, deepStop, 0.1892);
    deepPat += 0.4837 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 5.1997) + par * 0.1046, time);
    deepCol += 0.2339 * dp * mix(baseCol, deepStop, 0.3785);
    deepPat += 0.2339 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 6.4019) + par * 0.1568, time);
    deepCol += 0.1132 * dp * mix(baseCol, deepStop, 0.5677);
    deepPat += 0.1132 * dp;
    deepCol *= 0.6487;
    deepPat = pow(clamp(deepPat * 0.5462, 0.0, 1.0), 1.2500);
    ...
    rgb += hotStop * 0.3480 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0689 + 0.3416 * presence + 0.4357 * pattern, 0.7875);
