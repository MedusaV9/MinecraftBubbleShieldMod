...
void main() {
    ...
    mid = clamp(mid * (0.7209 + 0.6131 * texDetail) + 0.2025 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6919 + 0.4597 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0970 * (0.5 + 0.5 * sin(time * 0.219911)));
    rgb += emit * 0.7044 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4137 + 0.4816 * presence + 0.4357 * pattern + 0.1426 * (1.0 - deepTrans) + 0.1248 * emit, 0.8475);
