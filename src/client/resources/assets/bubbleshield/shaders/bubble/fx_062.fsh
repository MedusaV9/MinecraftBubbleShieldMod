...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.466003);
...
void main() {
    ...
    deep += 0.4029 * deepField(duvBase + rimDir * 0.0548 + vec2(0.066667, 0.055000) * time, time);
    deep += 0.1623 * deepField(duvBase + rimDir * 0.1097 + vec2(0.090000, 0.075000) * time, time);
    deep += 0.0654 * deepField(duvBase + rimDir * 0.1645 + vec2(0.113333, 0.092500) * time, time);
    deep = pow(clamp(deep * 0.6132, 0.0, 1.0), 1.2532);
