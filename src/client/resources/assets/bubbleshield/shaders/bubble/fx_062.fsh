...
void main() {
    ...
    mid = clamp(mid * (0.6546 + 0.5302 * texDetail) + 0.2104 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6411 + 0.4996 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1620 * (0.5 + 0.5 * sin(time * 0.282743)));
    rgb += emit * 0.8079 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4149 + 0.4380 * presence + 0.4666 * pattern + 0.1504 * (1.0 - deepTrans) + 0.2092 * emit, 0.8705);
