...
void main() {
    ...
    deepCol += 0.4029 * dp * mix(baseCol, deepStop, 0.1965);
    deepPat += 0.4029 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 3.8639) + par * 0.1097, time);
    deepCol += 0.1623 * dp * mix(baseCol, deepStop, 0.3931);
    deepPat += 0.1623 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 4.7529) + par * 0.1645, time);
    deepCol += 0.0654 * dp * mix(baseCol, deepStop, 0.5896);
    deepPat += 0.0654 * dp;
    deepCol *= 0.6679;
    deepPat = pow(clamp(deepPat * 0.6132, 0.0, 1.0), 1.2532);
    ...
    rgb += hotStop * 0.2314 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0693 + 0.2980 * presence + 0.4666 * pattern, 0.8105);
