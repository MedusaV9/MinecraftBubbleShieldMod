...
// stack: deep=ridge x3 taps | mid=mycelia+curl+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0778 + 0.1726 * presence + 0.4679 * pattern + 0.1580 * (1.0 - deepTrans), 0.8168);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3154), 0.8168);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4926 + 0.5074 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
