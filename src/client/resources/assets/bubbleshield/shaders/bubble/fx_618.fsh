...
// stack: deep=voro x4 taps | mid=ectoplasm+none+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0769 + 0.2114 * presence + 0.4677 * pattern + 0.1442 * (1.0 - deepTrans), 0.7855);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2980), 0.7855);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4840 + 0.5160 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
