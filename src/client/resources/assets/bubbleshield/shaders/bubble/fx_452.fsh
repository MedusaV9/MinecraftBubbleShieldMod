...
// stack: deep=fbm x4 taps | mid=mycelia+curl+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0736 + 0.1362 * presence + 0.4978 * pattern + 0.1132 * (1.0 - deepTrans), 0.8536);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2746), 0.8536);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3992 + 0.6008 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
