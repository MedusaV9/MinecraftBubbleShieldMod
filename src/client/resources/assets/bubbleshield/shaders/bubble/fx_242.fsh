...
// stack: deep=fbm x4 taps | mid=vortex+warp2+rotate | rim=lat | flourish=shimmer | tex=marble_ink
// fbm: turb x6 octaves | seed 2e705d65bcfe6b8c
// v8 realism: refr 0.6416+0.6045*fres/dist (cap 0.1105) | energy 0.4062+0.4564*p | flow 0.119167 c/s | soft 0.8348m
...
void main() {
    ...
    float refrAmp = min((0.6416 + 0.6045 * fresnel) / max(length(worldPos), 1.0), 0.1105);
