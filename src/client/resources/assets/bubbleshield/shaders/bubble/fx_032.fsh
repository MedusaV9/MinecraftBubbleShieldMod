...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6946, 0.0, 1.0);
    ...
    deepCol += 0.5763 * dp * mix(baseCol, deepStop, 0.3670);
    deepPat += 0.5763 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 4.7008) + par * 0.1469, time);
    deepCol += 0.3321 * dp * mix(baseCol, deepStop, 0.7339);
    deepPat += 0.3321 * dp;
    deepCol *= 0.5215;
    deepPat = pow(clamp(deepPat * 0.5240, 0.0, 1.0), 1.0267);
    ...
    rgb += hotStop * 0.3088 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0565 + 0.3360 * presence + 0.4344 * pattern, 0.8162);
