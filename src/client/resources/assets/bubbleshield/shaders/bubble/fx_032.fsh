...
void main() {
    ...
    mid = clamp(mid * (0.6036 + 0.6322 * texDetail) + 0.1914 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6734 + 0.4030 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0921 * (0.5 + 0.5 * sin(time * 0.293215)));
    rgb += emit * 0.7731 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3769 + 0.4760 * presence + 0.4344 * pattern + 0.1483 * (1.0 - deepTrans) + 0.1581 * emit, 0.8762);
