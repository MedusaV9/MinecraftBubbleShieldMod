...
// stack: deep=fbm x4 taps | mid=interference+curl+rotate | rim=graze_sparkle | flourish=glint | tex=caustic_web
// fbm: ridged x3 octaves | seed ed789db6f21f624a
// v8 realism: refr 0.9537+1.6499*fres/dist (cap 0.1139) | energy 0.2403+0.4153*p | flow 0.070833 c/s | soft 0.7384m
...
void main() {
    ...
    float refrAmp = min((0.9537 + 1.6499 * fresnel) / max(length(worldPos), 1.0), 0.1139);
