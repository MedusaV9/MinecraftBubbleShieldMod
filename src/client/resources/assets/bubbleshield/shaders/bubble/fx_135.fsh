...
void main() {
    ...
    mid = clamp(mid * (0.7420 + 0.4982 * texDetail) + 0.1940 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4488), 0.0, 1.0);
    float emit = atlas.a * (0.6934 + 0.3087 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1278 * (0.5 + 0.5 * sin(time * 0.172788)));
    rgb += emit * 0.8748 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3949 + 0.4267 * presence + 0.4534 * pattern + 0.1505 * (1.0 - deepTrans) + 0.2078 * emit, 0.8516);
