...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6423, 0.0, 1.0);
    ...
    deepCol += 0.4276 * dp * mix(baseCol, deepStop, 0.4452);
    deepPat += 0.4276 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 4.5160) + par * 0.1118, time);
    deepCol += 0.1828 * dp * mix(baseCol, deepStop, 0.8903);
    deepPat += 0.1828 * dp;
    deepCol *= 0.7335;
    deepPat = pow(clamp(deepPat * 0.6209, 0.0, 1.0), 1.0050);
    ...
    rgb += hotStop * 0.2000 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0626 + 0.2867 * presence + 0.4534 * pattern, 0.7916);
