...
// stack: deep=voro x3 taps | mid=spectralveil+none+flicker | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0486 + 0.1176 * presence + 0.5124 * pattern + 0.1123 * (1.0 - deepTrans), 0.7518);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3272), 0.7518);
    // [layer:v5:ghostalpha]
