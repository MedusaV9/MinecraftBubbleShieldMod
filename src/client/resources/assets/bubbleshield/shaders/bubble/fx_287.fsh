...
// stack: deep=fbm x4 taps | mid=arcs+warp1+scroll | rim=graze_film | flourish=echo | tex=filaments
// fbm: standard x4 octaves | seed 6df81b48377c9cba
// v8 realism: refr 0.5529+0.6246*fres/dist (cap 0.1406) | energy 0.4116+0.4402*p | flow 0.061667 c/s | soft 0.6118m
...
void main() {
    ...
    float refrAmp = min((0.5529 + 0.6246 * fresnel) / max(length(worldPos), 1.0), 0.1406);
