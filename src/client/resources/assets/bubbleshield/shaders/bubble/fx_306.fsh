...
// stack: deep=ridge x3 taps | mid=triweave+warp1+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0478 + 0.2656 * presence + 0.4817 * pattern + 0.1517 * (1.0 - deepTrans), 0.8165);
