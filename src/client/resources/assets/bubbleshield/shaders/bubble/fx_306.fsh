...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7970, 0.0, 1.0);
    ...
    deepCol += 0.4504 * dp * mix(baseCol, deepStop, 0.3962);
    deepPat += 0.4504 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 4.6090) + par * 0.1512, time);
    deepCol += 0.2029 * dp * mix(baseCol, deepStop, 0.7923);
    deepPat += 0.2029 * dp;
    deepCol *= 0.7356;
    deepPat = pow(clamp(deepPat * 0.6049, 0.0, 1.0), 1.2927);
    ...
    rgb += hotStop * 0.1834 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0478 + 0.2656 * presence + 0.4817 * pattern, 0.8165);
