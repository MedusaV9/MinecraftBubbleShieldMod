...
// stack: deep=ridge x3 taps | mid=mycelia+warp2+pulse | rim=graze_film | flourish=swirl | tex=filaments
// fbm: turb x5 octaves | seed 65f9fdc2bd7e8810
// v8 realism: refr 0.3545+0.4248*fres/dist (cap 0.1489) | energy 0.5462+0.3468*p | flow 0.093333 c/s | soft 0.6003m
...
void main() {
    ...
    float refrAmp = min((0.3545 + 0.4248 * fresnel) / max(length(worldPos), 1.0), 0.1489);
