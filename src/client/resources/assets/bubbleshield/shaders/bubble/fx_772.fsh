...
// stack: deep=ridge x3 taps | mid=mycelia+warp2+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0411 + 0.1713 * presence + 0.4978 * pattern + 0.0849 * (1.0 - deepTrans), 0.7979);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2436), 0.7979);
    // [layer:v5:ghostalpha]
