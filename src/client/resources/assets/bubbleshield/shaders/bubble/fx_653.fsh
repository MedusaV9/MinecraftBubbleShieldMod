...
// stack: deep=caustic x4 taps | mid=solarflare+warp2+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0759 + 0.1815 * presence + 0.5258 * pattern + 0.1197 * (1.0 - deepTrans), 0.8415);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1792), 0.8415);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4041 + 0.5959 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
