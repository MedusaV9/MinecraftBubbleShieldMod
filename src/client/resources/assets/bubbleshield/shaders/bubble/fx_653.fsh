...
// stack: deep=caustic x4 taps | mid=solarflare+warp2+rotate | rim=graze | flourish=shimmer | tex=worley_cells
// fbm: standard x6 octaves | seed 5da183d29ef5126a
// v8 realism: refr 0.5060+0.6965*fres/dist (cap 0.1184) | energy 0.3262+0.5329*p | flow 0.052500 c/s | soft 0.7523m
...
void main() {
    ...
    float refrAmp = min((0.5060 + 0.6965 * fresnel) / max(length(worldPos), 1.0), 0.1184);
