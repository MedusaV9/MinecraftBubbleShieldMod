...
// stack: deep=ridge x4 taps | mid=plasmaglobe+curl+rotate | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0534 + 0.0836 * presence + 0.5489 * pattern + 0.1581 * (1.0 - deepTrans), 0.8197);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1979), 0.8197);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4205 + 0.5795 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
