...
// stack: deep=ridge x3 taps | mid=holoparallax+warp1+scroll | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0678 + 0.1736 * presence + 0.4818 * pattern + 0.0933 * (1.0 - deepTrans), 0.8597);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1764), 0.8597);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4832 + 0.5168 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
