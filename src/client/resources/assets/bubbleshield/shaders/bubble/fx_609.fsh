...
// stack: deep=fbm x3 taps | mid=stainedglass+none+pulse | rim=graze_sparkle | flourish=shimmer | tex=worley_cells
// fbm: standard x5 octaves | seed 62b26f1315f81ec9
// v8 realism: refr 0.7638+1.0476*fres/dist (cap 0.1346) | energy 0.2388+0.4260*p | flow 0.106667 c/s | soft 0.8467m
...
void main() {
    ...
    float refrAmp = min((0.7638 + 1.0476 * fresnel) / max(length(worldPos), 1.0), 0.1346);
