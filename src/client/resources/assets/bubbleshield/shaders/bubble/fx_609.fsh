...
// stack: deep=fbm x3 taps | mid=stainedglass+none+pulse | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0681 + 0.3046 * presence + 0.4414 * pattern + 0.1110 * (1.0 - deepTrans), 0.8907);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2260), 0.8907);
    // [layer:v5:ghostalpha]
