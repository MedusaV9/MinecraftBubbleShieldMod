...
// stack: deep=fbm x4 taps | mid=nebula+warp2+scroll | rim=graze_film | flourish=glint | tex=nebula
// fbm: standard x4 octaves | seed c636dbd42d388d7e
// v8 realism: refr 0.2872+0.4276*fres/dist (cap 0.1167) | energy 0.5487+0.3915*p | flow 0.079167 c/s | soft 0.6638m
...
void main() {
    ...
    float refrAmp = min((0.2872 + 0.4276 * fresnel) / max(length(worldPos), 1.0), 0.1167);
