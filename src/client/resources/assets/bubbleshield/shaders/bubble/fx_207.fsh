...
// stack: deep=fbm x4 taps | mid=nebula+warp2+scroll | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0695 + 0.3475 * presence + 0.3606 * pattern + 0.0927 * (1.0 - deepTrans), 0.8535);
