...
// stack: deep=fbm x4 taps | mid=aethersmoke+warp2+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0451 + 0.3370 * presence + 0.4152 * pattern + 0.1353 * (1.0 - deepTrans), 0.8495);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3164), 0.8495);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4665 + 0.5335 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
