...
// stack: deep=fbm x4 taps | mid=aethersmoke+curl+pulse | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0495 + 0.3320 * presence + 0.3116 * pattern + 0.0898 * (1.0 - deepTrans), 0.8392);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2876), 0.8392);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4196 + 0.5804 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
