...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.591667);
...
void main() {
    ...
    deep += 0.4512 * deepField(duvBase + rimDir * 0.0748 + vec2(0.045000, -0.035000) * time, time);
    deep += 0.2036 * deepField(duvBase + rimDir * 0.1496 + vec2(0.061667, -0.047500) * time, time);
    deep = pow(clamp(deep * 0.6043, 0.0, 1.0), 1.6094);
