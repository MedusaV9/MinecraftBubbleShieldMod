...
// v8 realism: refr 0.9113+0.9214*fres/dist (cap 0.1187) | energy 0.1966+0.3701*p | flow 0.069167 c/s | soft 0.8171m
...
void main() {
    ...
    float refrAmp = min((0.9113 + 0.9214 * fresnel) / max(length(worldPos), 1.0), 0.1187);
