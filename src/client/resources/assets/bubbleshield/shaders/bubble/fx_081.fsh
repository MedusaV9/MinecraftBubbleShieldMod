...
// stack: deep=voro x4 taps | mid=kaleido+warp1+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0672 + 0.3569 * presence + 0.4611 * pattern + 0.0925 * (1.0 - deepTrans), 0.8629);
