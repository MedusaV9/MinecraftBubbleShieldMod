...
// stack: deep=caustic x3 taps | mid=waves+curl+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0641 + 0.2746 * presence + 0.3262 * pattern + 0.0845 * (1.0 - deepTrans), 0.8379);
