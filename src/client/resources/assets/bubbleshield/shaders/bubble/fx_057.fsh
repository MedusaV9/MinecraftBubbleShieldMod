...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6313, 0.0, 1.0);
    ...
    deepCol += 0.3904 * dp * mix(baseCol, deepStop, 0.3244);
    deepPat += 0.3904 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 3.6202) + par * 0.0910, time);
    deepCol += 0.1524 * dp * mix(baseCol, deepStop, 0.6488);
    deepPat += 0.1524 * dp;
    deepCol *= 0.6831;
    deepPat = pow(clamp(deepPat * 0.6482, 0.0, 1.0), 1.7146);
    ...
    rgb += hotStop * 0.2874 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0641 + 0.2746 * presence + 0.3262 * pattern, 0.8379);
