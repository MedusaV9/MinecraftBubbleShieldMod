...
// stack: deep=caustic x3 taps | mid=waves+curl+pulse | rim=graze_film | flourish=shimmer | tex=caustic_web
// fbm: standard x4 octaves | seed 3dc06c1f625f2305
// v8 realism: refr 0.8702+0.9777*fres/dist (cap 0.1293) | energy 0.2098+0.3586*p | flow 0.062500 c/s | soft 0.5433m
...
void main() {
    ...
    float refrAmp = min((0.8702 + 0.9777 * fresnel) / max(length(worldPos), 1.0), 0.1293);
