...
void main() {
    ...
    mid = clamp(mid * (0.7153 + 0.6401 * texDetail) + 0.3252 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6360 + 0.3729 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1453 * (0.5 + 0.5 * sin(time * 0.287979)));
    rgb += emit * 0.7294 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3994 + 0.4146 * presence + 0.3262 * pattern + 0.0845 * (1.0 - deepTrans) + 0.2171 * emit, 0.8979);
