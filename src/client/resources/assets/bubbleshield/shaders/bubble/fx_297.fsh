...
// stack: deep=caustic x4 taps | mid=caustic+none+scroll | rim=graze_sparkle | flourish=shimmer | tex=caustic_web
// fbm: turb x5 octaves | seed 76f88591defc589a
// v8 realism: refr 0.7111+1.1910*fres/dist (cap 0.1516) | energy 0.2409+0.4580*p | flow 0.114167 c/s | soft 0.6894m
...
void main() {
    ...
    float refrAmp = min((0.7111 + 1.1910 * fresnel) / max(length(worldPos), 1.0), 0.1516);
