...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.018333, 0.002500) * time, time);
    deep += 0.5343 * deepField(duvBase + rimDir * 0.0764 + vec2(-0.028333, 0.005000) * time, time);
    deep = pow(clamp(deep * 0.6518, 0.0, 1.0), 1.4534);
