...
// stack: deep=fbm x3 taps | mid=truchet+warp2+flicker | rim=lat | flourish=swirl | tex=runes
// fbm: standard x5 octaves | seed c9f820b99c3dc2df
// v8 realism: refr 0.5865+0.8331*fres/dist (cap 0.1067) | energy 0.3048+0.4525*p | flow 0.092500 c/s | soft 0.8334m
...
void main() {
    ...
    float refrAmp = min((0.5865 + 0.8331 * fresnel) / max(length(worldPos), 1.0), 0.1067);
