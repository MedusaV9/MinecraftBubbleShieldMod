...
// stack: deep=ridge x3 taps | mid=curlsmoke+warp1+rotate | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0764 + 0.3063 * presence + 0.4602 * pattern + 0.1351 * (1.0 - deepTrans), 0.8044);
