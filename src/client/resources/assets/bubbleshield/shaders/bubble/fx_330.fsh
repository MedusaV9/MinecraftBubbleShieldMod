...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8079, 0.0, 1.0);
    ...
    deepCol += 0.3888 * dp * mix(baseCol, deepStop, 0.3874);
    deepPat += 0.3888 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 3.6829) + par * 0.1309, time);
    deepCol += 0.1512 * dp * mix(baseCol, deepStop, 0.7747);
    deepPat += 0.1512 * dp;
    deepCol *= 0.6396;
    deepPat = pow(clamp(deepPat * 0.6493, 0.0, 1.0), 1.2015);
    ...
    rgb += hotStop * 0.3015 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0764 + 0.3063 * presence + 0.4602 * pattern, 0.8044);
