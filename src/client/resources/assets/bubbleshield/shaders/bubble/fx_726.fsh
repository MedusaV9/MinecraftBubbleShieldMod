...
// stack: deep=caustic x3 taps | mid=fluidink+warp2+pulse | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0429 + 0.3146 * presence + 0.4528 * pattern + 0.0999 * (1.0 - deepTrans), 0.8025);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2369), 0.8025);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5196 + 0.4804 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
