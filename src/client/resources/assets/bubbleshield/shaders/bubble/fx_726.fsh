...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.7929 + fiR.y * 0.6241)), 0.3399);
    ...
    float alpha = vertexColor.a * min(0.0429 + 0.3746 * presence + 0.4528 * pattern + 0.0999 * (1.0 - deepTrans), 0.8025);
    // [layer:v5:backface]
