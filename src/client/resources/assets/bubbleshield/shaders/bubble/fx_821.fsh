...
void main() {
    ...
    float mid = clamp(rfLight * 1.1164 + (1.0 - rfTrans) * 0.2180, 0.0, 1.15);
    ...
    float alpha = vertexColor.a * min(0.0423 + 0.3730 * presence + 0.3701 * pattern + 0.0897 * (1.0 - deepTrans), 0.8234);
    // [layer:v5:backface]
