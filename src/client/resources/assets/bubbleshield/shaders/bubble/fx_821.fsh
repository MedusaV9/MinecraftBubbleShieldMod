...
// stack: deep=caustic x4 taps | mid=raymarchfog+none+scroll | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0423 + 0.2930 * presence + 0.3701 * pattern + 0.0897 * (1.0 - deepTrans), 0.8234);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2059), 0.8234);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4415 + 0.5585 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
