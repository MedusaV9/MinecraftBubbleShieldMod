...
// stack: deep=caustic x3 taps | mid=deepice+none+flicker | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0664 + 0.3884 * presence + 0.3548 * pattern + 0.1146 * (1.0 - deepTrans), 0.8258);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1653), 0.8258);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4708 + 0.5292 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
