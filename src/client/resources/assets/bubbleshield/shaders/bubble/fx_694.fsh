...
// stack: deep=caustic x3 taps | mid=deepice+none+flicker | rim=graze_film | flourish=shimmer | tex=cracked_glass
// fbm: standard x5 octaves | seed 869b8757c138333b
// v8 realism: refr 0.9849+1.5939*fres/dist (cap 0.1455) | energy 0.2346+0.4751*p | flow 0.066667 c/s | soft 1.0095m
...
void main() {
    ...
    float refrAmp = min((0.9849 + 1.5939 * fresnel) / max(length(worldPos), 1.0), 0.1455);
