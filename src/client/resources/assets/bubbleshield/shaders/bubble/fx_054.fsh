...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5814, 0.0, 1.0);
    ...
    deepCol += 0.3975 * dp * mix(baseCol, deepStop, 0.3737);
    deepPat += 0.3975 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 5.6748) + par * 0.1420, time);
    deepCol += 0.1580 * dp * mix(baseCol, deepStop, 0.7474);
    deepPat += 0.1580 * dp;
    deepCol *= 0.6605;
    deepPat = pow(clamp(deepPat * 0.6429, 0.0, 1.0), 1.0571);
    ...
    rgb += hotStop * 0.3286 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0794 + 0.3176 * presence + 0.4440 * pattern, 0.8268);
