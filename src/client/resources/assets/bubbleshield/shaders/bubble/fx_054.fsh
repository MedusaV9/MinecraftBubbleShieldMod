...
void main() {
    ...
    mid = clamp(mid * (0.6835 + 0.4549 * texDetail) + 0.3159 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7071 + 0.4051 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1255 * (0.5 + 0.5 * sin(time * 0.225147)));
    rgb += emit * 0.8096 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4447 + 0.4576 * presence + 0.4440 * pattern + 0.1499 * (1.0 - deepTrans) + 0.1382 * emit, 0.8868);
