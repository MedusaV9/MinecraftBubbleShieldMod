...
// stack: deep=voro x3 taps | mid=sparkle+curl+rotate | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0794 + 0.3176 * presence + 0.4440 * pattern + 0.1499 * (1.0 - deepTrans), 0.8268);
