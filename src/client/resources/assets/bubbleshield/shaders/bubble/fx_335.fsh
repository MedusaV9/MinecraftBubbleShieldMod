...
// stack: deep=ridge x4 taps | mid=nebula+none+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0730 + 0.3137 * presence + 0.3868 * pattern + 0.0941 * (1.0 - deepTrans), 0.8296);
