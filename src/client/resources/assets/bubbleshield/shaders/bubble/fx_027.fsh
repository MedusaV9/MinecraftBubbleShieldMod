...
// stack: deep=ridge x4 taps | mid=scales+warp2+rotate | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0512 + 0.3071 * presence + 0.4267 * pattern + 0.1082 * (1.0 - deepTrans), 0.7812);
