...
// stack: deep=ridge x4 taps | mid=scales+warp2+rotate | rim=lat | flourish=glint | tex=scales
// fbm: standard x3 octaves | seed c1da0db73abb35ba
// v8 realism: refr 0.5437+0.6714*fres/dist (cap 0.1162) | energy 0.3568+0.5348*p | flow 0.060833 c/s | soft 0.5923m
...
void main() {
    ...
    float refrAmp = min((0.5437 + 0.6714 * fresnel) / max(length(worldPos), 1.0), 0.1162);
