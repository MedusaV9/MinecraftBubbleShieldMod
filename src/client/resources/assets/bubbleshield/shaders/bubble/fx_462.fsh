...
// stack: deep=voro x3 taps | mid=prismdisperse+warp1+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0565 + 0.3193 * presence + 0.4688 * pattern + 0.1539 * (1.0 - deepTrans), 0.8163);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2713), 0.8163);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5098 + 0.4902 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
