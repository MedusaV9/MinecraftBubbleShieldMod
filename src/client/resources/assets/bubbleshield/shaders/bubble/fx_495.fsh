...
// stack: deep=fbm x4 taps | mid=runecircuit+warp1+rotate | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0572 + 0.1668 * presence + 0.5611 * pattern + 0.1530 * (1.0 - deepTrans), 0.8273);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2731), 0.8273);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5416 + 0.4584 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
