...
// stack: deep=caustic x3 taps | mid=voidrift+curl+scroll | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0772 + 0.2272 * presence + 0.5295 * pattern + 0.1409 * (1.0 - deepTrans), 0.8576);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3391), 0.8576);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5124 + 0.4876 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
