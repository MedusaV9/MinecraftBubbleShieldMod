...
void main() {
    ...
    mid = clamp(mid * (0.6077 + 0.6776 * texDetail) + 0.1994 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4471), 0.0, 1.0);
    float emit = atlas.a * (0.6508 + 0.3352 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0831 * (0.5 + 0.5 * sin(time * 0.115192)));
    rgb += emit * 0.9678 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4393 + 0.4578 * presence + 0.4847 * pattern + 0.0870 * (1.0 - deepTrans) + 0.1558 * emit, 0.9176);
