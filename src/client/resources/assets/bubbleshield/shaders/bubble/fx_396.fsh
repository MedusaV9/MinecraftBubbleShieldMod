...
// stack: deep=ridge x4 taps | mid=frostfern+none+rotate | rim=graze_film | flourish=echo | tex=cracked_glass
// fbm: turb x4 octaves | seed a0a127fc73e39599
// v8 realism: refr 0.9252+1.1806*fres/dist (cap 0.1491) | energy 0.2117+0.3754*p | flow 0.100833 c/s | soft 0.6141m
...
void main() {
    ...
    float refrAmp = min((0.9252 + 1.1806 * fresnel) / max(length(worldPos), 1.0), 0.1491);
