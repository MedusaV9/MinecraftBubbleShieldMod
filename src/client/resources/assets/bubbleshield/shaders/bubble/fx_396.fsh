...
// stack: deep=ridge x4 taps | mid=frostfern+none+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0776 + 0.3178 * presence + 0.4847 * pattern + 0.0870 * (1.0 - deepTrans), 0.8576);
