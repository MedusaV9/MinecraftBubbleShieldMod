...
// stack: deep=caustic x4 taps | mid=vortex+warp1+rotate | rim=graze_sparkle | flourish=glint | tex=marble_ink
// fbm: ridged x3 octaves | seed 8b41ed36852e28a7
// v8 realism: refr 0.5320+0.7816*fres/dist (cap 0.1487) | energy 0.3230+0.4850*p | flow 0.079167 c/s | soft 0.9084m
...
void main() {
    ...
    float refrAmp = min((0.5320 + 0.7816 * fresnel) / max(length(worldPos), 1.0), 0.1487);
