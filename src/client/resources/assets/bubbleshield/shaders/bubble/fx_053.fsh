...
void main() {
    ...
    mid = clamp(mid * (0.6255 + 0.5284 * texDetail) + 0.1866 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7989 + 0.2736 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0923 * (0.5 + 0.5 * sin(time * 0.282743)));
    rgb += emit * 0.7191 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3454 + 0.4169 * presence + 0.4408 * pattern + 0.0960 * (1.0 - deepTrans) + 0.1409 * emit, 0.8817);
