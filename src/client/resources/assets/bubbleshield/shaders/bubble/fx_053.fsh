...
// stack: deep=caustic x3 taps | mid=vortex+curl+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0459 + 0.2769 * presence + 0.4408 * pattern + 0.0960 * (1.0 - deepTrans), 0.8217);
