...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8437, 0.0, 1.0);
    ...
    deepCol += 0.5624 * dp * mix(baseCol, deepStop, 0.3194);
    deepPat += 0.5624 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 2.7286) + par * 0.0782, time);
    deepCol += 0.3162 * dp * mix(baseCol, deepStop, 0.6388);
    deepPat += 0.3162 * dp;
    deepCol *= 0.6122;
    deepPat = pow(clamp(deepPat * 0.5323, 0.0, 1.0), 1.7073);
    ...
    rgb += hotStop * 0.3066 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0459 + 0.2769 * presence + 0.4408 * pattern, 0.8217);
