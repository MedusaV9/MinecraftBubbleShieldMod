...
// stack: deep=caustic x3 taps | mid=vortex+curl+rotate | rim=graze | flourish=swirl | tex=marble_ink
// fbm: ridged x3 octaves | seed 19419d2b9ca7dfcb
// v8 realism: refr 0.5115+0.7159*fres/dist (cap 0.1147) | energy 0.3366+0.4792*p | flow 0.071667 c/s | soft 1.0318m
...
void main() {
    ...
    float refrAmp = min((0.5115 + 0.7159 * fresnel) / max(length(worldPos), 1.0), 0.1147);
