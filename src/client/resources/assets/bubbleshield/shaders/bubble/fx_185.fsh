...
// stack: deep=caustic x4 taps | mid=caustic+none+pulse | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0489 + 0.3013 * presence + 0.3425 * pattern + 0.0908 * (1.0 - deepTrans), 0.8212);
