...
// stack: deep=voro x4 taps | mid=voidrift+curl+rotate | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.1678 * presence + 0.4682 * pattern + 0.1370 * (1.0 - deepTrans), 0.8275);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2074), 0.8275);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5403 + 0.4597 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
