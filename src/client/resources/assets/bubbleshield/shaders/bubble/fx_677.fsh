...
// stack: deep=fbm x3 taps | mid=plasmaglobe+none+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0567 + 0.0855 * presence + 0.6484 * pattern + 0.0927 * (1.0 - deepTrans), 0.8082);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2500), 0.8082);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5019 + 0.4981 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
