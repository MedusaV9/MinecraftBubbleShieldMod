...
// stack: deep=fbm x3 taps | mid=plasmaglobe+none+scroll | rim=graze | flourish=glint | tex=filaments
// fbm: ridged x6 octaves | seed 5754e03924e1960a
// v8 realism: refr 0.6791+0.9681*fres/dist (cap 0.1597) | energy 0.3477+0.5246*p | flow 0.120000 c/s | soft 0.6173m
...
void main() {
    ...
    float refrAmp = min((0.6791 + 0.9681 * fresnel) / max(length(worldPos), 1.0), 0.1597);
