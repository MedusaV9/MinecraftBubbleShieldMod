...
// stack: deep=voro x4 taps | mid=waves+curl+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0789 + 0.2907 * presence + 0.4833 * pattern + 0.1485 * (1.0 - deepTrans), 0.8427);
