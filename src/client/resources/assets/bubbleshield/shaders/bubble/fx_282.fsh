...
void main() {
    ...
    mid = clamp(mid * (0.6410 + 0.6387 * texDetail) + 0.3360 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4364), 0.0, 1.0);
    float emit = atlas.a * (0.6111 + 0.4269 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1690 * (0.5 + 0.5 * sin(time * 0.125664)));
    rgb += emit * 0.7534 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4432 + 0.4307 * presence + 0.4833 * pattern + 0.1485 * (1.0 - deepTrans) + 0.1761 * emit, 0.9027);
