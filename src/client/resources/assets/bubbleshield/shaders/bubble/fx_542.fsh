...
// stack: deep=fbm x3 taps | mid=prismdisperse+curl+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0567 + 0.2678 * presence + 0.3865 * pattern + 0.1123 * (1.0 - deepTrans), 0.7954);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2488), 0.7954);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4550 + 0.5450 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
