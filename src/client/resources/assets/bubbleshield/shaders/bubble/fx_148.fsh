...
// stack: deep=caustic x3 taps | mid=thinfilm+warp2+rotate | rim=graze | flourish=shimmer | tex=chrome
// fbm: standard x5 octaves | seed 94bb7bf4641277f4
// v8 realism: refr 1.0160+1.0410*fres/dist (cap 0.1047) | energy 0.2749+0.3493*p | flow 0.117500 c/s | soft 1.0653m
...
void main() {
    ...
    float refrAmp = min((1.0160 + 1.0410 * fresnel) / max(length(worldPos), 1.0), 0.1047);
