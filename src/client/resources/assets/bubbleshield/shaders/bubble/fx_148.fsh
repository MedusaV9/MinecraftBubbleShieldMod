...
void main() {
    ...
    mid = clamp(mid * (0.6655 + 0.6707 * texDetail) + 0.2196 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7395 + 0.3439 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1097 * (0.5 + 0.5 * sin(time * 0.167552)));
    rgb += emit * 0.9269 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3810 + 0.4833 * presence + 0.4850 * pattern + 0.1414 * (1.0 - deepTrans) + 0.2006 * emit, 0.8617);
