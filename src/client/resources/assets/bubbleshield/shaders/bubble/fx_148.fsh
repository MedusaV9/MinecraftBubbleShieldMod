...
// stack: deep=caustic x3 taps | mid=thinfilm+warp2+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0579 + 0.3433 * presence + 0.4850 * pattern + 0.1414 * (1.0 - deepTrans), 0.8017);
