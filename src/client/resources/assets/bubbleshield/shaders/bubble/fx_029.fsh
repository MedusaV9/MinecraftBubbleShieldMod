...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8102, 0.0, 1.0);
    ...
    deepCol += 0.5631 * dp * mix(baseCol, deepStop, 0.2798);
    deepPat += 0.5631 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.5403) + par * 0.1514, time);
    deepCol += 0.3170 * dp * mix(baseCol, deepStop, 0.5597);
    deepPat += 0.3170 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.6394) + par * 0.2272, time);
    deepCol += 0.1785 * dp * mix(baseCol, deepStop, 0.8395);
    deepPat += 0.1785 * dp;
    deepCol *= 0.5031;
    deepPat = pow(clamp(deepPat * 0.4858, 0.0, 1.0), 1.2122);
    ...
    float alpha = vertexColor.a * min(0.0405 + 0.2439 * presence + 0.3821 * pattern, 0.8349);
