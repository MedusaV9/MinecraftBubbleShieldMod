...
// stack: deep=caustic x4 taps | mid=plasma+warp1+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0405 + 0.2439 * presence + 0.3821 * pattern + 0.1081 * (1.0 - deepTrans), 0.8349);
