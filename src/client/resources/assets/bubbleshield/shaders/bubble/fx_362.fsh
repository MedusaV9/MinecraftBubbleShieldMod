...
void main() {
    ...
    mid = clamp(mid * (0.6788 + 0.5715 * texDetail) + 0.2126 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5761 + 0.3362 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1689 * (0.5 + 0.5 * sin(time * 0.298451)));
    rgb += emit * 0.9118 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3165 + 0.3183 * presence + 0.4282 * pattern + 0.1180 * (1.0 - deepTrans) + 0.1622 * emit, 0.8831);
