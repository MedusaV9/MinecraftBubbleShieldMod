...
// stack: deep=ridge x3 taps | mid=voidtendril+warp2+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0493 + 0.1783 * presence + 0.4282 * pattern + 0.1180 * (1.0 - deepTrans), 0.8231);
