...
// stack: deep=voro x3 taps | mid=solarflare+warp2+rotate | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0772 + 0.1636 * presence + 0.4823 * pattern + 0.1552 * (1.0 - deepTrans), 0.7977);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1568), 0.7977);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5203 + 0.4797 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
