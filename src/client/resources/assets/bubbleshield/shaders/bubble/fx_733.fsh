...
// v8 realism: refr 0.4556+0.6262*fres/dist (cap 0.1021) | energy 0.3618+0.4879*p | flow 0.062500 c/s | soft 1.0113m
...
void main() {
    ...
    float refrAmp = min((0.4556 + 0.6262 * fresnel) / max(length(worldPos), 1.0), 0.1021);
