...
// stack: deep=ridge x3 taps | mid=gravlens+warp2+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0533 + 0.1044 * presence + 0.5170 * pattern + 0.1550 * (1.0 - deepTrans), 0.7859);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2418), 0.7859);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4638 + 0.5362 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
