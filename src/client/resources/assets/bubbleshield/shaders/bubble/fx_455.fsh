...
// stack: deep=voro x3 taps | mid=runecircuit+curl+rotate | rim=graze_film | flourish=echo | tex=runes
// fbm: ridged x4 octaves | seed 436c5eeef8ef3956
// v8 realism: refr 0.3994+0.5974*fres/dist (cap 0.1113) | energy 0.4468+0.4756*p | flow 0.056667 c/s | soft 1.0570m
...
void main() {
    ...
    float refrAmp = min((0.3994 + 0.5974 * fresnel) / max(length(worldPos), 1.0), 0.1113);
