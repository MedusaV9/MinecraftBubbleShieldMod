...
// stack: deep=voro x3 taps | mid=runecircuit+curl+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0666 + 0.1310 * presence + 0.4842 * pattern + 0.1097 * (1.0 - deepTrans), 0.8460);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1977), 0.8460);
    // [layer:v5:ghostalpha]
