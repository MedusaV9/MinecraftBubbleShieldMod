...
// stack: deep=ridge x3 taps | mid=petals+warp2+scroll | rim=graze | flourish=shimmer | tex=scales
// fbm: ridged x6 octaves | seed 0483ae07804e969b
// v8 realism: refr 0.5501+0.6087*fres/dist (cap 0.1145) | energy 0.3065+0.5444*p | flow 0.117500 c/s | soft 0.8428m
...
void main() {
    ...
    float refrAmp = min((0.5501 + 0.6087 * fresnel) / max(length(worldPos), 1.0), 0.1145);
