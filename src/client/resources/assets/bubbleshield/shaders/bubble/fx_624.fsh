...
// stack: deep=caustic x3 taps | mid=orbittrap+warp1+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0557 + 0.1760 * presence + 0.4572 * pattern + 0.0956 * (1.0 - deepTrans), 0.8459);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2353), 0.8459);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4537 + 0.5463 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
