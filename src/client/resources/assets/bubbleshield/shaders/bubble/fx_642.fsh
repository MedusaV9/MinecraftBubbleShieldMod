...
// stack: deep=voro x3 taps | mid=prismdisperse+warp1+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0724 + 0.3233 * presence + 0.4227 * pattern + 0.1434 * (1.0 - deepTrans), 0.7874);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2434), 0.7874);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5358 + 0.4642 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
