...
// stack: deep=ridge x4 taps | mid=plasmaglobe+curl+pulse | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0799 + 0.0995 * presence + 0.6321 * pattern + 0.1253 * (1.0 - deepTrans), 0.8742);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3021), 0.8742);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4543 + 0.5457 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
