...
// stack: deep=caustic x4 taps | mid=voidrift+warp1+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0525 + 0.2288 * presence + 0.4639 * pattern + 0.0806 * (1.0 - deepTrans), 0.8249);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2075), 0.8249);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4318 + 0.5682 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
