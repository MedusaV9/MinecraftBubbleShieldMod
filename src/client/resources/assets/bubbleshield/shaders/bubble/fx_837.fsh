...
// stack: deep=fbm x3 taps | mid=plasmaglobe+warp1+flicker | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0678 + 0.1101 * presence + 0.6133 * pattern + 0.1562 * (1.0 - deepTrans), 0.8036);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2025), 0.8036);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5377 + 0.4623 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
