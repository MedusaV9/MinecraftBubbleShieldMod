...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6888, 0.0, 1.0);
    ...
    deepCol += 0.4276 * dp * mix(baseCol, deepStop, 0.3733);
    deepPat += 0.4276 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 4.2507) + par * 0.1088, time);
    deepCol += 0.1829 * dp * mix(baseCol, deepStop, 0.7466);
    deepPat += 0.1829 * dp;
    deepCol *= 0.6691;
    deepPat = pow(clamp(deepPat * 0.6209, 0.0, 1.0), 1.0381);
    ...
    rgb += hotStop * 0.3042 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0739 + 0.3443 * presence + 0.4760 * pattern, 0.8540);
