...
// stack: deep=voro x3 taps | mid=petals+warp1+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0739 + 0.3443 * presence + 0.4760 * pattern + 0.0972 * (1.0 - deepTrans), 0.8540);
