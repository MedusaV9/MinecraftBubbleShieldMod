...
// v8 realism: refr 0.7449+0.9679*fres/dist (cap 0.1466) | energy 0.3753+0.5419*p | flow 0.079167 c/s | soft 0.5266m
...
void main() {
    ...
    float refrAmp = min((0.7449 + 0.9679 * fresnel) / max(length(worldPos), 1.0), 0.1466);
