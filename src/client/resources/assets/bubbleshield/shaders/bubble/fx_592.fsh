...
// stack: deep=fbm x3 taps | mid=mycelia+warp2+scroll | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0476 + 0.1901 * presence + 0.5832 * pattern + 0.0979 * (1.0 - deepTrans), 0.8415);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1643), 0.8415);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5129 + 0.4871 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
