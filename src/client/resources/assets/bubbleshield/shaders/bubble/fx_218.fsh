...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.675442);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.020000, -0.030000) * time, time);
    deep += 0.4734 * deepField(duvBase + rimDir * 0.0520 + vec2(0.031667, -0.045000) * time, time);
    deep = pow(clamp(deep * 0.6787, 0.0, 1.0), 1.5615);
