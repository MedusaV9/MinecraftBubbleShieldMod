...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8417, 0.0, 1.0);
    ...
    deepCol += 0.4734 * dp * mix(baseCol, deepStop, 0.3725);
    deepPat += 0.4734 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 5.5418) + par * 0.1041, time);
    deepCol += 0.2241 * dp * mix(baseCol, deepStop, 0.7449);
    deepPat += 0.2241 * dp;
    deepCol *= 0.7325;
    deepPat = pow(clamp(deepPat * 0.5891, 0.0, 1.0), 1.5615);
    ...
    rgb += hotStop * 0.2551 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0703 + 0.2660 * presence + 0.4869 * pattern, 0.8189);
