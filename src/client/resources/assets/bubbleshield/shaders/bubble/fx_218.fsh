...
// stack: deep=voro x3 taps | mid=petals+warp1+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0703 + 0.2660 * presence + 0.4869 * pattern + 0.1563 * (1.0 - deepTrans), 0.8189);
