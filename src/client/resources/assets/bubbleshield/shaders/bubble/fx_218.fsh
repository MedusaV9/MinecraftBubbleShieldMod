...
// stack: deep=voro x3 taps | mid=petals+warp1+scroll | rim=graze | flourish=echo | tex=scales
// fbm: standard x4 octaves | seed e4f5e016f4f183b9
// v8 realism: refr 0.7103+0.6285*fres/dist (cap 0.1310) | energy 0.3639+0.5458*p | flow 0.107500 c/s | soft 0.6497m
...
void main() {
    ...
    float refrAmp = min((0.7103 + 0.6285 * fresnel) / max(length(worldPos), 1.0), 0.1310);
