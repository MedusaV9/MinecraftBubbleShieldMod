...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6910, 0.0, 1.0);
    ...
    deepCol += 0.5263 * dp * mix(baseCol, deepStop, 0.2940);
    deepPat += 0.5263 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 3.4663) + par * 0.1019, time);
    deepCol += 0.2770 * dp * mix(baseCol, deepStop, 0.5881);
    deepPat += 0.2770 * dp;
    deepCol *= 0.5779;
    deepPat = pow(clamp(deepPat * 0.5545, 0.0, 1.0), 1.6520);
    ...
    rgb += hotStop * 0.1813 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0578 + 0.3673 * presence + 0.3924 * pattern, 0.8516);
