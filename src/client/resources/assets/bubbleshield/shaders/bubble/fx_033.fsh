...
// stack: deep=fbm x3 taps | mid=sparkle+warp2+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0578 + 0.3673 * presence + 0.3924 * pattern + 0.1559 * (1.0 - deepTrans), 0.8516);
