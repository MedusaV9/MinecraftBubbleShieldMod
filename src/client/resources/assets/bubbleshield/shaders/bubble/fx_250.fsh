...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7383, 0.0, 1.0);
    ...
    deepCol += 0.5040 * dp * mix(baseCol, deepStop, 0.3731);
    deepPat += 0.5040 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 3.7237) + par * 0.1192, time);
    deepCol += 0.2540 * dp * mix(baseCol, deepStop, 0.7461);
    deepPat += 0.2540 * dp;
    deepCol *= 0.5640;
    deepPat = pow(clamp(deepPat * 0.5688, 0.0, 1.0), 1.1726);
    ...
    rgb += hotStop * 0.2927 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0726 + 0.2460 * presence + 0.4936 * pattern, 0.7994);
