...
void main() {
    ...
    mid = clamp(mid * (0.6806 + 0.6273 * texDetail) + 0.1963 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4608), 0.0, 1.0);
    float emit = atlas.a * (0.7413 + 0.4498 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1321 * (0.5 + 0.5 * sin(time * 0.230383)));
    ...
    float alpha = vertexColor.a * min(0.4246 + 0.3860 * presence + 0.4936 * pattern + 0.1478 * (1.0 - deepTrans) + 0.1574 * emit, 0.8594);
