...
// stack: deep=fbm x3 taps | mid=vortex+curl+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0726 + 0.2460 * presence + 0.4936 * pattern + 0.1478 * (1.0 - deepTrans), 0.7994);
