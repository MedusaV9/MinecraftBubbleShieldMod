...
// stack: deep=fbm x3 taps | mid=vortex+curl+pulse | rim=graze | flourish=shimmer | tex=marble_ink
// fbm: ridged x4 octaves | seed 79042e3c5a00283a
// v8 realism: refr 0.6634+0.9469*fres/dist (cap 0.1551) | energy 0.3362+0.4937*p | flow 0.096667 c/s | soft 0.9879m
...
void main() {
    ...
    float refrAmp = min((0.6634 + 0.9469 * fresnel) / max(length(worldPos), 1.0), 0.1551);
