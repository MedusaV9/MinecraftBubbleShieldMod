...
// stack: deep=voro x4 taps | mid=petals+warp1+flicker | rim=graze | flourish=echo | tex=scales
// fbm: ridged x6 octaves | seed f6355f567173d3b7
// v8 realism: refr 0.5280+0.7619*fres/dist (cap 0.1504) | energy 0.3092+0.4799*p | flow 0.056667 c/s | soft 1.0960m
...
void main() {
    ...
    float refrAmp = min((0.5280 + 0.7619 * fresnel) / max(length(worldPos), 1.0), 0.1504);
