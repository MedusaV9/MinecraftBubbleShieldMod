...
// stack: deep=voro x4 taps | mid=petals+warp1+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0483 + 0.2782 * presence + 0.3843 * pattern + 0.1440 * (1.0 - deepTrans), 0.8075);
