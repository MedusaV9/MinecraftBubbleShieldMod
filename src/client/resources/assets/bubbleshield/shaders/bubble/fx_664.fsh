...
// stack: deep=fbm x3 taps | mid=orbittrap+warp2+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0750 + 0.1812 * presence + 0.5434 * pattern + 0.1014 * (1.0 - deepTrans), 0.8309);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1918), 0.8309);
    // [layer:v5:ghostalpha]
