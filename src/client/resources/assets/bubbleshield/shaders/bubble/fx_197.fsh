...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7976, 0.0, 1.0);
    ...
    deepCol += 0.4979 * dp * mix(baseCol, deepStop, 0.4178);
    deepPat += 0.4979 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 5.2866) + par * 0.1250, time);
    deepCol += 0.2479 * dp * mix(baseCol, deepStop, 0.8357);
    deepPat += 0.2479 * dp;
    deepCol *= 0.6395;
    deepPat = pow(clamp(deepPat * 0.5728, 0.0, 1.0), 1.1421);
    ...
    rgb += hotStop * 0.1800 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0744 + 0.2494 * presence + 0.3324 * pattern, 0.8164);
