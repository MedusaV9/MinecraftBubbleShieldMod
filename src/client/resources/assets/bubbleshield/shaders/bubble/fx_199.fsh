...
// stack: deep=voro x3 taps | mid=nebula+warp1+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0737 + 0.3295 * presence + 0.4435 * pattern + 0.1597 * (1.0 - deepTrans), 0.8853);
