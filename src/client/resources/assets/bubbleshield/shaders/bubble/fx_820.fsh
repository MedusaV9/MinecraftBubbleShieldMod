...
// stack: deep=voro x4 taps | mid=spectralveil+warp2+scroll | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0766 + 0.1314 * presence + 0.3945 * pattern + 0.0918 * (1.0 - deepTrans), 0.7745);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2000), 0.7745);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4700 + 0.5300 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
