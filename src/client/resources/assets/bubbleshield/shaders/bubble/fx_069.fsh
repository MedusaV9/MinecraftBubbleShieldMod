...
float fbm2(vec2 p, vec2 per) {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        p = vec2(p.x * 2.0, p.y * 2.0534) + vec2(17.7, 9.2);
        per = vec2(per.x * 2.0, per.y * 2.0534);
        amplitude *= 0.5;
    }
    return value;
}
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.016667, 0.040000) * time, time);
    deep += 0.4839 * deepField(duvBase + rimDir * 0.0580 + vec2(0.025000, 0.062500) * time, time);
    deep += 0.2342 * deepField(duvBase + rimDir * 0.1159 + vec2(0.033333, 0.082500) * time, time);
    deep = pow(clamp(deep * 0.5820, 0.0, 1.0), 1.0736);
