...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5856, 0.0, 1.0);
    ...
    deepCol += 0.4839 * dp * mix(baseCol, deepStop, 0.3815);
    deepPat += 0.4839 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 3.7465) + par * 0.1159, time);
    deepCol += 0.2342 * dp * mix(baseCol, deepStop, 0.7630);
    deepPat += 0.2342 * dp;
    deepCol *= 0.6969;
    deepPat = pow(clamp(deepPat * 0.5820, 0.0, 1.0), 1.0736);
    ...
    float alpha = vertexColor.a * min(0.0617 + 0.2853 * presence + 0.4649 * pattern, 0.8182);
