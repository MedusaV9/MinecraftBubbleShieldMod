...
// stack: deep=fbm x3 taps | mid=nebula+none+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0614 + 0.3725 * presence + 0.4260 * pattern + 0.1373 * (1.0 - deepTrans), 0.8993);
