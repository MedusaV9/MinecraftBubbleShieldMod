...
// stack: deep=ridge x3 taps | mid=gravlens+curl+pulse | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0641 + 0.0946 * presence + 0.5796 * pattern + 0.1514 * (1.0 - deepTrans), 0.8083);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3200), 0.8083);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4017 + 0.5983 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
