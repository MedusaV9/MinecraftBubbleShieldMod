...
// stack: deep=fbm x3 taps | mid=prismdisperse+curl+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0569 + 0.3349 * presence + 0.3560 * pattern + 0.1228 * (1.0 - deepTrans), 0.8359);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1804), 0.8359);
    // [layer:v5:ghostalpha]
