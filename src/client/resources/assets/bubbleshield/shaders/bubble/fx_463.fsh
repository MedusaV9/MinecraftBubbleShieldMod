...
// stack: deep=fbm x4 taps | mid=holoparallax+none+flicker | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0601 + 0.1714 * presence + 0.5325 * pattern + 0.1101 * (1.0 - deepTrans), 0.7844);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1648), 0.7844);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4025 + 0.5975 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
