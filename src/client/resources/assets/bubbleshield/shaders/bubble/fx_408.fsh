...
// stack: deep=caustic x3 taps | mid=galaxyswirl+none+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0699 + 0.1644 * presence + 0.5501 * pattern + 0.1031 * (1.0 - deepTrans), 0.7942);
