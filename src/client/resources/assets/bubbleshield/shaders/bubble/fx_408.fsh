...
void main() {
    ...
    mid = clamp(mid * (0.6840 + 0.6318 * texDetail) + 0.3451 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6444 + 0.4377 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1683 * (0.5 + 0.5 * sin(time * 0.183260)));
    rgb += emit * 0.9437 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3456 + 0.3044 * presence + 0.5501 * pattern + 0.1031 * (1.0 - deepTrans) + 0.1230 * emit, 0.8542);
