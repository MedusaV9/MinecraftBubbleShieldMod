...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7158, 0.0, 1.0);
    ...
    deepCol += 0.4100 * dp * mix(baseCol, deepStop, 0.2791);
    deepPat += 0.4100 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 4.2620) + par * 0.0711, time);
    deepCol += 0.1681 * dp * mix(baseCol, deepStop, 0.5582);
    deepPat += 0.1681 * dp;
    deepCol *= 0.6135;
    deepPat = pow(clamp(deepPat * 0.6337, 0.0, 1.0), 1.5962);
    ...
    rgb += hotStop * 0.2129 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0583 + 0.3663 * presence + 0.4892 * pattern, 0.8488);
