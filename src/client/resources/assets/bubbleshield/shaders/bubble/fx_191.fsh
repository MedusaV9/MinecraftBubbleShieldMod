...
// stack: deep=fbm x3 taps | mid=aurora+warp2+scroll | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0583 + 0.3663 * presence + 0.4892 * pattern + 0.0885 * (1.0 - deepTrans), 0.8488);
