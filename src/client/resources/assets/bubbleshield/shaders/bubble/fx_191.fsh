...
// stack: deep=fbm x3 taps | mid=aurora+warp2+scroll | rim=lat | flourish=echo | tex=filaments
// fbm: ridged x4 octaves | seed 6eaf50f8b30b8f56
// v8 realism: refr 0.5567+0.6242*fres/dist (cap 0.1167) | energy 0.3979+0.3888*p | flow 0.076667 c/s | soft 0.6884m
...
void main() {
    ...
    float refrAmp = min((0.5567 + 0.6242 * fresnel) / max(length(worldPos), 1.0), 0.1167);
