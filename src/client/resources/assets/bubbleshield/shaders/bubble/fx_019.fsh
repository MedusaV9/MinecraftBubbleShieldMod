...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6575, 0.0, 1.0);
    ...
    deepCol += 0.3879 * dp * mix(baseCol, deepStop, 0.3041);
    deepPat += 0.3879 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 3.6360) + par * 0.1457, time);
    deepCol += 0.1505 * dp * mix(baseCol, deepStop, 0.6083);
    deepPat += 0.1505 * dp;
    deepCol *= 0.7055;
    deepPat = pow(clamp(deepPat * 0.6500, 0.0, 1.0), 1.7634);
    ...
    rgb += hotStop * 0.3079 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0768 + 0.3066 * presence + 0.3609 * pattern, 0.8535);
