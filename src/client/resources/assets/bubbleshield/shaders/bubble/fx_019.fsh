...
// stack: deep=ridge x3 taps | mid=sparkle+warp1+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0768 + 0.3066 * presence + 0.3609 * pattern + 0.1316 * (1.0 - deepTrans), 0.8535);
