...
// stack: deep=voro x4 taps | mid=circuit+none+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0784 + 0.2696 * presence + 0.4498 * pattern + 0.1582 * (1.0 - deepTrans), 0.8501);
