...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6027, 0.0, 1.0);
    ...
    deepCol += 0.4223 * dp * mix(baseCol, deepStop, 0.3952);
    deepPat += 0.4223 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 3.9155) + par * 0.0860, time);
    deepCol += 0.1783 * dp * mix(baseCol, deepStop, 0.7904);
    deepPat += 0.1783 * dp;
    deepCol *= 0.5945;
    deepPat = pow(clamp(deepPat * 0.6248, 0.0, 1.0), 1.1155);
    ...
    rgb += hotStop * 0.3143 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0476 + 0.2576 * presence + 0.4278 * pattern, 0.8354);
