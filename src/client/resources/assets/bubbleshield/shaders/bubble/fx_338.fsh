...
// stack: deep=ridge x3 taps | mid=petals+warp2+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0476 + 0.2576 * presence + 0.4278 * pattern + 0.1530 * (1.0 - deepTrans), 0.8354);
