...
// stack: deep=ridge x3 taps | mid=petals+warp2+rotate | rim=graze_sparkle | flourish=echo | tex=scales
// fbm: standard x3 octaves | seed bddea1e2dfd4ce8b
// v8 realism: refr 0.5488+0.7236*fres/dist (cap 0.1576) | energy 0.3414+0.4662*p | flow 0.096667 c/s | soft 0.9910m
...
void main() {
    ...
    float refrAmp = min((0.5488 + 0.7236 * fresnel) / max(length(worldPos), 1.0), 0.1576);
