...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.035000, -0.016667) * time, time);
    deep += 0.4669 * deepField(duvBase + rimDir * 0.0453 + vec2(0.055000, -0.026667) * time, time);
    deep += 0.2180 * deepField(duvBase + rimDir * 0.0907 + vec2(0.074167, -0.036667) * time, time);
    deep += 0.1018 * deepField(duvBase + rimDir * 0.1360 + vec2(0.094167, -0.046667) * time, time);
    deep = pow(clamp(deep * 0.5597, 0.0, 1.0), 1.1379);
