...
// stack: deep=fbm x4 taps | mid=kaleido+warp2+rotate | rim=lat | flourish=glint | tex=cracked_glass
// fbm: turb x6 octaves | seed 6d2348b3dcf6771f
// v8 realism: refr 0.9424+1.1462*fres/dist (cap 0.1033) | energy 0.1955+0.3664*p | flow 0.090833 c/s | soft 0.9181m
...
void main() {
    ...
    float refrAmp = min((0.9424 + 1.1462 * fresnel) / max(length(worldPos), 1.0), 0.1033);
