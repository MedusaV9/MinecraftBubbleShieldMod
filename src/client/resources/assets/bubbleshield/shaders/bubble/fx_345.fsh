...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7690, 0.0, 1.0);
    ...
    deepCol += 0.5551 * dp * mix(baseCol, deepStop, 0.4320);
    deepPat += 0.5551 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 3.9859) + par * 0.1002, time);
    deepCol += 0.3081 * dp * mix(baseCol, deepStop, 0.8640);
    deepPat += 0.3081 * dp;
    deepCol *= 0.5267;
    deepPat = pow(clamp(deepPat * 0.5367, 0.0, 1.0), 1.2759);
    ...
    rgb += hotStop * 0.2461 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0727 + 0.3185 * presence + 0.4779 * pattern, 0.8170);
