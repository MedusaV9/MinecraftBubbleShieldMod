...
// stack: deep=voro x3 taps | mid=starfield+warp2+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0727 + 0.1483 * presence + 0.5816 * pattern + 0.0973 * (1.0 - deepTrans), 0.8170);
