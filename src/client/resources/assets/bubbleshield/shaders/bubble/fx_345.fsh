...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.555015);
...
void main() {
    ...
    deep += 0.5551 * deepField(duvBase + rimDir * 0.0501 + vec2(-0.055000, -0.077500) * time, time);
    deep = pow(clamp(deep * 0.6431, 0.0, 1.0), 1.2759);
