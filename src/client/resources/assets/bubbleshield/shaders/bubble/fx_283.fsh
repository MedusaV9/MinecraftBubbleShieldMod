...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6014, 0.0, 1.0);
    ...
    deepCol += 0.4587 * dp * mix(baseCol, deepStop, 0.3041);
    deepPat += 0.4587 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 3.0787) + par * 0.1226, time);
    deepCol += 0.2104 * dp * mix(baseCol, deepStop, 0.6081);
    deepPat += 0.2104 * dp;
    deepCol *= 0.7604;
    deepPat = pow(clamp(deepPat * 0.5991, 0.0, 1.0), 1.2742);
    ...
    rgb += hotStop * 0.3086 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0437 + 0.2920 * presence + 0.4790 * pattern, 0.8279);
