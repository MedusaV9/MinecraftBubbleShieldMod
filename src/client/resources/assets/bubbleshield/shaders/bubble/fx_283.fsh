...
void main() {
    ...
    mid = clamp(mid * (0.6704 + 0.5369 * texDetail) + 0.2033 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3857), 0.0, 1.0);
    float emit = atlas.a * (0.6144 + 0.3190 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1646 * (0.5 + 0.5 * sin(time * 0.298451)));
    ...
    float alpha = vertexColor.a * min(0.3390 + 0.4320 * presence + 0.4790 * pattern + 0.1435 * (1.0 - deepTrans) + 0.1654 * emit, 0.8879);
