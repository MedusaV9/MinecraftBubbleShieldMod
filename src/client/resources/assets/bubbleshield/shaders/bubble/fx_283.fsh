...
// stack: deep=fbm x3 taps | mid=arcs+curl+flicker | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0437 + 0.2920 * presence + 0.4790 * pattern + 0.1435 * (1.0 - deepTrans), 0.8279);
