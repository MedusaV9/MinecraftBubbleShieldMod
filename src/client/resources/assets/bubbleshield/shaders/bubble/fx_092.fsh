...
// stack: deep=fbm x3 taps | mid=waves+warp1+flicker | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.2788 * presence + 0.3913 * pattern + 0.1335 * (1.0 - deepTrans), 0.8139);
