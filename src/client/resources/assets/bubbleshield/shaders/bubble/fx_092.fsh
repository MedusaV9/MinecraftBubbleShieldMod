...
// stack: deep=fbm x3 taps | mid=waves+warp1+flicker | rim=graze_film | flourish=swirl | tex=caustic_web
// fbm: ridged x6 octaves | seed c3ae668eaccbf4d5
// v8 realism: refr 0.8793+1.4035*fres/dist (cap 0.1142) | energy 0.1907+0.3794*p | flow 0.103333 c/s | soft 0.9447m
...
void main() {
    ...
    float refrAmp = min((0.8793 + 1.4035 * fresnel) / max(length(worldPos), 1.0), 0.1142);
