...
void main() {
    ...
    mid = clamp(mid * (0.6142 + 0.7064 * texDetail) + 0.2163 * texDetail, 0.0, 1.5);
    ...
    rim = clamp(rim + 0.5109 * rimLine, 0.0, 1.4);
    ...
    float emit = atlas.a * (0.6324 + 0.4455 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1321 * (0.5 + 0.5 * sin(time * 0.261799)));
    rgb += emit * 0.9061 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3295 + 0.3533 * presence + 0.4232 * pattern + 0.0883 * (1.0 - deepTrans) + 0.1966 * emit, 0.8976);
