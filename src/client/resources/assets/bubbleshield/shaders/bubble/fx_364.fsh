...
// stack: deep=voro x3 taps | mid=portalvoid+warp1+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0594 + 0.2133 * presence + 0.4232 * pattern + 0.0883 * (1.0 - deepTrans), 0.8376);
