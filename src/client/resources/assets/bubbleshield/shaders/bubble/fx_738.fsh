...
// stack: deep=voro x3 taps | mid=ectoplasm+none+scroll | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0792 + 0.1666 * presence + 0.4871 * pattern + 0.1226 * (1.0 - deepTrans), 0.8302);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1728), 0.8302);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4553 + 0.5447 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
