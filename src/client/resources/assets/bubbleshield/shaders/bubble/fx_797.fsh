...
// stack: deep=caustic x4 taps | mid=plasmaglobe+none+scroll | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0578 + 0.0921 * presence + 0.6314 * pattern + 0.1090 * (1.0 - deepTrans), 0.8278);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2674), 0.8278);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4655 + 0.5345 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
