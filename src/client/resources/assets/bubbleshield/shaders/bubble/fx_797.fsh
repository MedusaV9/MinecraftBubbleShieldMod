...
// stack: deep=caustic x4 taps | mid=plasmaglobe+none+scroll | rim=graze_sparkle | flourish=swirl | tex=filaments
// fbm: ridged x5 octaves | seed b47397cc1e1370db
// v8 realism: refr 0.6849+0.8721*fres/dist (cap 0.1433) | energy 0.3903+0.5193*p | flow 0.113333 c/s | soft 1.0620m
...
void main() {
    ...
    float refrAmp = min((0.6849 + 0.8721 * fresnel) / max(length(worldPos), 1.0), 0.1433);
