...
// stack: deep=ridge x4 taps | mid=deepice+warp2+scroll | rim=graze_sparkle | flourish=shimmer | tex=cracked_glass
// fbm: standard x3 octaves | seed f452701cc173cd3a
// v8 realism: refr 0.9023+1.0718*fres/dist (cap 0.1237) | energy 0.2300+0.4166*p | flow 0.095833 c/s | soft 0.8540m
...
void main() {
    ...
    float refrAmp = min((0.9023 + 1.0718 * fresnel) / max(length(worldPos), 1.0), 0.1237);
