...
// stack: deep=ridge x4 taps | mid=deepice+warp2+scroll | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0434 + 0.3288 * presence + 0.3654 * pattern + 0.1108 * (1.0 - deepTrans), 0.8970);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1903), 0.8970);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4916 + 0.5084 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
