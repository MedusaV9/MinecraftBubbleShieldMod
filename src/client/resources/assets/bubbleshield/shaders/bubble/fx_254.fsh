...
void main() {
    ...
    mid = clamp(mid * (0.6151 + 0.7451 * texDetail) + 0.2392 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7259 + 0.3261 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1352 * (0.5 + 0.5 * sin(time * 0.261799)));
    rgb += emit * 0.8463 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3428 + 0.4858 * presence + 0.4391 * pattern + 0.1479 * (1.0 - deepTrans) + 0.1300 * emit, 0.8524);
