...
void main() {
    ...
    deepCol += 0.4985 * dp * mix(baseCol, deepStop, 0.2268);
    deepPat += 0.4985 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 3.4936) + par * 0.0931, time);
    deepCol += 0.2485 * dp * mix(baseCol, deepStop, 0.4535);
    deepPat += 0.2485 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.3120) + par * 0.1397, time);
    deepCol += 0.1239 * dp * mix(baseCol, deepStop, 0.6803);
    deepPat += 0.1239 * dp;
    deepCol *= 0.5357;
    deepPat = pow(clamp(deepPat * 0.5345, 0.0, 1.0), 1.3850);
    ...
    rgb += hotStop * 0.1657 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0450 + 0.3458 * presence + 0.4391 * pattern, 0.7924);
