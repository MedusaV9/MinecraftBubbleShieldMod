...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6315, 0.0, 1.0);
    ...
    deepCol += 0.4674 * dp * mix(baseCol, deepStop, 0.2950);
    deepPat += 0.4674 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 3.2484) + par * 0.1218, time);
    deepCol += 0.2185 * dp * mix(baseCol, deepStop, 0.5899);
    deepPat += 0.2185 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 4.0212) + par * 0.1827, time);
    deepCol += 0.1021 * dp * mix(baseCol, deepStop, 0.8849);
    deepPat += 0.1021 * dp;
    deepCol *= 0.5476;
    deepPat = pow(clamp(deepPat * 0.5593, 0.0, 1.0), 1.2204);
    ...
    rgb += hotStop * 0.2517 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0517 + 0.2773 * presence + 0.4361 * pattern, 0.8339);
