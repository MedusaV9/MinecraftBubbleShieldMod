...
// stack: deep=voro x4 taps | mid=truchet+warp2+pulse | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0517 + 0.2773 * presence + 0.4361 * pattern + 0.1278 * (1.0 - deepTrans), 0.8339);
