...
// stack: deep=voro x4 taps | mid=truchet+warp2+pulse | rim=graze | flourish=echo | tex=runes
// fbm: turb x5 octaves | seed 077bf59371f19080
// v8 realism: refr 0.5374+0.6981*fres/dist (cap 0.1080) | energy 0.4006+0.4921*p | flow 0.089167 c/s | soft 1.0623m
...
void main() {
    ...
    float refrAmp = min((0.5374 + 0.6981 * fresnel) / max(length(worldPos), 1.0), 0.1080);
