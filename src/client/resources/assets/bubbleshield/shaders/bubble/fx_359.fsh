...
// stack: deep=ridge x3 taps | mid=emberstorm+warp2+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0577 + 0.1954 * presence + 0.5998 * pattern + 0.0909 * (1.0 - deepTrans), 0.8058);
