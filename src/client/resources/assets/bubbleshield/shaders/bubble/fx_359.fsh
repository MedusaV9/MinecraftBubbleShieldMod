...
// stack: deep=ridge x3 taps | mid=emberstorm+warp2+scroll | rim=lat | flourish=glint | tex=fbm_turbulence
// fbm: turb x3 octaves | seed b75d0bc678c7392e
// v8 realism: refr 0.3570+0.3995*fres/dist (cap 0.1155) | energy 0.4716+0.4696*p | flow 0.084167 c/s | soft 1.0537m
...
void main() {
    ...
    float refrAmp = min((0.3570 + 0.3995 * fresnel) / max(length(worldPos), 1.0), 0.1155);
