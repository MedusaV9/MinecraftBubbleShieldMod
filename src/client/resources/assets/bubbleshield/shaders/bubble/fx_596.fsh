...
// stack: deep=ridge x4 taps | mid=oilslick+curl+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0611 + 0.2892 * presence + 0.4582 * pattern + 0.0904 * (1.0 - deepTrans), 0.8432);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2671), 0.8432);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4236 + 0.5764 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
