...
// stack: deep=caustic x4 taps | mid=vortex+warp2+rotate | rim=lat | flourish=shimmer | tex=marble_ink
// fbm: standard x3 octaves | seed abfde1dbadd2a681
// v8 realism: refr 0.5370+0.7271*fres/dist (cap 0.1286) | energy 0.3901+0.3820*p | flow 0.069167 c/s | soft 0.9338m
...
void main() {
    ...
    float refrAmp = min((0.5370 + 0.7271 * fresnel) / max(length(worldPos), 1.0), 0.1286);
