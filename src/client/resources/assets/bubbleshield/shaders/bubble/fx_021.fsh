...
void main() {
    ...
    deepCol += 0.4149 * dp * mix(baseCol, deepStop, 0.2656);
    deepPat += 0.4149 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 4.7738) + par * 0.0836, time);
    deepCol += 0.1722 * dp * mix(baseCol, deepStop, 0.5313);
    deepPat += 0.1722 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 5.6805) + par * 0.1254, time);
    deepCol += 0.0714 * dp * mix(baseCol, deepStop, 0.7969);
    deepPat += 0.0714 * dp;
    deepCol *= 0.6280;
    deepPat = pow(clamp(deepPat * 0.6029, 0.0, 1.0), 1.6286);
    ...
    rgb += hotStop * 0.1984 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0462 + 0.3004 * presence + 0.4964 * pattern, 0.8459);
