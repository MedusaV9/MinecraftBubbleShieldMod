...
// stack: deep=caustic x4 taps | mid=vortex+warp2+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0462 + 0.3004 * presence + 0.4964 * pattern + 0.0913 * (1.0 - deepTrans), 0.8459);
