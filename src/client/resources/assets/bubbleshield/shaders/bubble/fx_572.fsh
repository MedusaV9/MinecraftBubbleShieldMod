...
// stack: deep=caustic x4 taps | mid=mycelia+warp2+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0471 + 0.1652 * presence + 0.4917 * pattern + 0.0819 * (1.0 - deepTrans), 0.8354);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1619), 0.8354);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5336 + 0.4664 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
