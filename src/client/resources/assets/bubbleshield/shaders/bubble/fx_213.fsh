...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7014, 0.0, 1.0);
    ...
    deepCol += 0.4241 * dp * mix(baseCol, deepStop, 0.2263);
    deepPat += 0.4241 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 4.5786) + par * 0.0927, time);
    deepCol += 0.1799 * dp * mix(baseCol, deepStop, 0.4526);
    deepPat += 0.1799 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 5.7706) + par * 0.1390, time);
    deepCol += 0.0763 * dp * mix(baseCol, deepStop, 0.6789);
    deepPat += 0.0763 * dp;
    deepCol *= 0.7249;
    deepPat = pow(clamp(deepPat * 0.5951, 0.0, 1.0), 1.2181);
    ...
    float alpha = vertexColor.a * min(0.0629 + 0.3490 * presence + 0.4779 * pattern, 0.8326);
