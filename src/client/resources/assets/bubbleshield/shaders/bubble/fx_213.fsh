...
// stack: deep=fbm x4 taps | mid=starfield+warp1+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0629 + 0.1671 * presence + 0.5816 * pattern + 0.1327 * (1.0 - deepTrans), 0.8326);
