...
// stack: deep=fbm x4 taps | mid=starfield+warp1+scroll | rim=graze | flourish=shimmer | tex=starfield
// fbm: standard x6 octaves | seed bc0f236f3c3b0594
// v8 realism: refr 0.3417+0.3469*fres/dist (cap 0.1099) | energy 0.4698+0.4609*p | flow 0.073333 c/s | soft 1.0714m
...
void main() {
    ...
    float refrAmp = min((0.3417 + 0.3469 * fresnel) / max(length(worldPos), 1.0), 0.1099);
