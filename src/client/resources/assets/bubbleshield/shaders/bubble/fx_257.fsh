...
void main() {
    ...
    deep += 0.4895 * deepField(duvBase + rimDir * 0.0539 + vec2(0.068333, -0.002500) * time, time);
    deep += 0.2396 * deepField(duvBase + rimDir * 0.1078 + vec2(0.093333, -0.002500) * time, time);
    deep = pow(clamp(deep * 0.5783, 0.0, 1.0), 1.4487);
