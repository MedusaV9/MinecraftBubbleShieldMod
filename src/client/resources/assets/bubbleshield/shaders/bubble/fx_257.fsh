...
void main() {
    ...
    deepCol += 0.4895 * dp * mix(baseCol, deepStop, 0.2921);
    deepPat += 0.4895 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.4482) + par * 0.1078, time);
    deepCol += 0.2396 * dp * mix(baseCol, deepStop, 0.5842);
    deepPat += 0.2396 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.3796) + par * 0.1618, time);
    deepCol += 0.1173 * dp * mix(baseCol, deepStop, 0.8763);
    deepPat += 0.1173 * dp;
    deepCol *= 0.7003;
    deepPat = pow(clamp(deepPat * 0.5416, 0.0, 1.0), 1.4487);
    ...
    rgb += hotStop * 0.1512 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0486 + 0.3525 * presence + 0.4840 * pattern, 0.8034);
