...
void main() {
    ...
    mid = clamp(mid * (0.6235 + 0.5304 * texDetail) + 0.2173 * texDetail, 0.0, 1.5);
    ...
    rim = clamp(rim + 0.7980 * rimLine, 0.0, 1.4);
    ...
    float emit = atlas.a * (0.7923 + 0.3845 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0809 * (0.5 + 0.5 * sin(time * 0.136136)));
    ...
    float alpha = vertexColor.a * min(0.3535 + 0.4925 * presence + 0.4840 * pattern + 0.1475 * (1.0 - deepTrans) + 0.2174 * emit, 0.8634);
