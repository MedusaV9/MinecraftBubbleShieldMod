...
// stack: deep=voro x4 taps | mid=lightning+warp2+pulse | rim=graze | flourish=glint | tex=filaments
// fbm: turb x5 octaves | seed 7df1fad4bdae5f89
// v8 realism: refr 0.6697+0.6198*fres/dist (cap 0.1378) | energy 0.3780+0.3859*p | flow 0.097500 c/s | soft 0.9764m
...
void main() {
    ...
    float refrAmp = min((0.6697 + 0.6198 * fresnel) / max(length(worldPos), 1.0), 0.1378);
