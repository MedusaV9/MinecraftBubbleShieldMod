...
void main() {
    ...
    mid = clamp(mid * (0.6369 + 0.5339 * texDetail) + 0.2021 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5792 + 0.2585 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1348 * (0.5 + 0.5 * sin(time * 0.256563)));
    rgb += emit * 0.6874 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3618 + 0.4844 * presence + 0.4156 * pattern + 0.1588 * (1.0 - deepTrans) + 0.1403 * emit, 0.8836);
