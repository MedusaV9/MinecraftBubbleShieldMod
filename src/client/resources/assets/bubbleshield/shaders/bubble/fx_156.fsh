...
// stack: deep=fbm x3 taps | mid=thinfilm+warp2+flicker | rim=graze_sparkle | flourish=shimmer | tex=chrome
// fbm: standard x5 octaves | seed 17a67a2c051a20f8
// v8 realism: refr 0.7097+1.1151*fres/dist (cap 0.1037) | energy 0.1920+0.3527*p | flow 0.075833 c/s | soft 0.7928m
...
void main() {
    ...
    float refrAmp = min((0.7097 + 1.1151 * fresnel) / max(length(worldPos), 1.0), 0.1037);
