...
// stack: deep=fbm x3 taps | mid=thinfilm+warp2+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0538 + 0.3300 * presence + 0.3615 * pattern + 0.1381 * (1.0 - deepTrans), 0.8271);
