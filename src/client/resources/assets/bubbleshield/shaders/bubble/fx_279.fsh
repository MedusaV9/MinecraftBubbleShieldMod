...
// stack: deep=ridge x4 taps | mid=arcs+none+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0441 + 0.2722 * presence + 0.3990 * pattern + 0.1168 * (1.0 - deepTrans), 0.8420);
