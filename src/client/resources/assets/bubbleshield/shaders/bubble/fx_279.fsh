...
void main() {
    ...
    deepCol += 0.5258 * dp * mix(baseCol, deepStop, 0.2004);
    deepPat += 0.5258 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 4.3851) + par * 0.1256, time);
    deepCol += 0.2765 * dp * mix(baseCol, deepStop, 0.4008);
    deepPat += 0.2765 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 5.5275) + par * 0.1884, time);
    deepCol += 0.1454 * dp * mix(baseCol, deepStop, 0.6012);
    deepPat += 0.1454 * dp;
    deepCol *= 0.5834;
    deepPat = pow(clamp(deepPat * 0.5134, 0.0, 1.0), 1.3944);
    ...
    rgb += hotStop * 0.1620 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0441 + 0.2722 * presence + 0.3990 * pattern, 0.8420);
