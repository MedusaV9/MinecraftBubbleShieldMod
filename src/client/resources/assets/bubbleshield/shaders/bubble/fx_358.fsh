...
// stack: deep=voro x3 taps | mid=hologrid+curl+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0434 + 0.1084 * presence + 0.5529 * pattern + 0.1364 * (1.0 - deepTrans), 0.7992);
