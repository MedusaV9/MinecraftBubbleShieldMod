...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7929, 0.0, 1.0);
    ...
    deepCol += 0.4040 * dp * mix(baseCol, deepStop, 0.2357);
    deepPat += 0.4040 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 4.2273) + par * 0.1422, time);
    deepCol += 0.1632 * dp * mix(baseCol, deepStop, 0.4714);
    deepPat += 0.1632 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 5.1659) + par * 0.2133, time);
    deepCol += 0.0659 * dp * mix(baseCol, deepStop, 0.7071);
    deepPat += 0.0659 * dp;
    deepCol *= 0.6192;
    deepPat = pow(clamp(deepPat * 0.6123, 0.0, 1.0), 1.5088);
    ...
    rgb += hotStop * 0.2817 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0467 + 0.3006 * presence + 0.3283 * pattern, 0.8268);
