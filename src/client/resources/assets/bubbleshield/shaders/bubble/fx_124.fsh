...
void main() {
    ...
    mid = clamp(mid * (0.6288 + 0.6799 * texDetail) + 0.3114 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.5034), 0.0, 1.0);
    float emit = atlas.a * (0.5894 + 0.4570 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1797 * (0.5 + 0.5 * sin(time * 0.099484)));
    rgb += emit * 0.9375 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3479 + 0.4406 * presence + 0.3283 * pattern + 0.1172 * (1.0 - deepTrans) + 0.1733 * emit, 0.8868);
