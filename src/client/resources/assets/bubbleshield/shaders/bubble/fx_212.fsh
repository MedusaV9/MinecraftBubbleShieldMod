...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7293, 0.0, 1.0);
    ...
    deepCol += 0.5275 * dp * mix(baseCol, deepStop, 0.4347);
    deepPat += 0.5275 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.9814) + par * 0.0770, time);
    deepCol += 0.2783 * dp * mix(baseCol, deepStop, 0.8694);
    deepPat += 0.2783 * dp;
    deepCol *= 0.5534;
    deepPat = pow(clamp(deepPat * 0.5538, 0.0, 1.0), 1.1405);
    ...
    rgb += hotStop * 0.2586 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0579 + 0.3540 * presence + 0.4492 * pattern, 0.8239);
