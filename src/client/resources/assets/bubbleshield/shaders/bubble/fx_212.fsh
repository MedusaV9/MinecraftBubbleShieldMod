...
// stack: deep=caustic x3 taps | mid=sparkle+curl+flicker | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0579 + 0.3540 * presence + 0.4492 * pattern + 0.1244 * (1.0 - deepTrans), 0.8239);
