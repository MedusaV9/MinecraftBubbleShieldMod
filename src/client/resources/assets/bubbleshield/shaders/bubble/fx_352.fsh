...
void main() {
    ...
    mid = clamp(mid * (0.6934 + 0.5025 * texDetail) + 0.2501 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5954 + 0.4360 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1503 * (0.5 + 0.5 * sin(time * 0.204204)));
    rgb += emit * 0.8903 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3950 + 0.5116 * presence + 0.3518 * pattern + 0.1592 * (1.0 - deepTrans) + 0.1720 * emit, 0.9525);
