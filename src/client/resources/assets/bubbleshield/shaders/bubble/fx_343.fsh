...
// stack: deep=caustic x4 taps | mid=truchet+warp1+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0736 + 0.3626 * presence + 0.4058 * pattern + 0.1202 * (1.0 - deepTrans), 0.8189);
