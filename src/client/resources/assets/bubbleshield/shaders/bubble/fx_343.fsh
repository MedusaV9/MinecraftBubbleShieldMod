...
// stack: deep=caustic x4 taps | mid=truchet+warp1+rotate | rim=graze | flourish=shimmer | tex=runes
// fbm: turb x4 octaves | seed 45bfd328317b260a
// v8 realism: refr 0.4867+0.4059*fres/dist (cap 0.1578) | energy 0.3581+0.4678*p | flow 0.073333 c/s | soft 0.8615m
...
void main() {
    ...
    float refrAmp = min((0.4867 + 0.4059 * fresnel) / max(length(worldPos), 1.0), 0.1578);
