...
// stack: deep=caustic x3 taps | mid=vortex+warp1+rotate | rim=lat | flourish=shimmer | tex=marble_ink
// fbm: standard x4 octaves | seed 8d37fd5be86a2364
// v8 realism: refr 0.4660+0.5209*fres/dist (cap 0.1403) | energy 0.4072+0.4360*p | flow 0.055833 c/s | soft 1.0032m
...
void main() {
    ...
    float refrAmp = min((0.4660 + 0.5209 * fresnel) / max(length(worldPos), 1.0), 0.1403);
