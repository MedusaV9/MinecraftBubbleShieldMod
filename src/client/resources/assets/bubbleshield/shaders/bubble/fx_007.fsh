...
// stack: deep=caustic x3 taps | mid=vortex+warp1+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0402 + 0.2817 * presence + 0.3618 * pattern + 0.1453 * (1.0 - deepTrans), 0.8600);
