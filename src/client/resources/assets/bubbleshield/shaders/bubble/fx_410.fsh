...
// stack: deep=fbm x4 taps | mid=biolume+curl+rotate | rim=lat | flourish=glint | tex=honeycomb
// fbm: turb x6 octaves | seed ba1081545922463a
// v8 realism: refr 0.2551+0.3277*fres/dist (cap 0.1336) | energy 0.5153+0.4345*p | flow 0.085833 c/s | soft 1.0332m
...
void main() {
    ...
    float refrAmp = min((0.2551 + 0.3277 * fresnel) / max(length(worldPos), 1.0), 0.1336);
