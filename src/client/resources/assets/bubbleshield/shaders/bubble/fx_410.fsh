...
void main() {
    ...
    mid = clamp(mid * (0.6070 + 0.6525 * texDetail) + 0.2789 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6524 + 0.2772 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1516 * (0.5 + 0.5 * sin(time * 0.162316)));
    rgb += emit * 0.7969 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3578 + 0.2736 * presence + 0.5710 * pattern + 0.0891 * (1.0 - deepTrans) + 0.1278 * emit, 0.8744);
