...
// stack: deep=fbm x3 taps | mid=holoparallax+warp2+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0776 + 0.1508 * presence + 0.4983 * pattern + 0.1483 * (1.0 - deepTrans), 0.8418);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1769), 0.8418);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4868 + 0.5132 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
