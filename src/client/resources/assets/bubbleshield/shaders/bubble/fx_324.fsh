...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.026667, -0.010000) * time, time);
    deep += 0.5390 * deepField(duvBase + rimDir * 0.0319 + vec2(-0.040000, -0.015000) * time, time);
    deep += 0.2905 * deepField(duvBase + rimDir * 0.0638 + vec2(-0.055000, -0.020000) * time, time);
    deep += 0.1566 * deepField(duvBase + rimDir * 0.0956 + vec2(-0.068333, -0.025000) * time, time);
    deep = pow(clamp(deep * 0.5035, 0.0, 1.0), 1.3266);
