...
// stack: deep=caustic x4 taps | mid=prismdisperse+warp1+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0586 + 0.2867 * presence + 0.4328 * pattern + 0.1573 * (1.0 - deepTrans), 0.8531);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2612), 0.8531);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3864 + 0.6136 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
