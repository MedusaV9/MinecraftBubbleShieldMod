...
// stack: deep=voro x3 taps | mid=runecircuit+warp1+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0520 + 0.1741 * presence + 0.4817 * pattern + 0.0978 * (1.0 - deepTrans), 0.8109);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1802), 0.8109);
    // [layer:v5:ghostalpha]
