...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7896, 0.0, 1.0);
    ...
    deepCol += 0.4727 * dp * mix(baseCol, deepStop, 0.3548);
    deepPat += 0.4727 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 3.4406) + par * 0.0698, time);
    deepCol += 0.2234 * dp * mix(baseCol, deepStop, 0.7096);
    deepPat += 0.2234 * dp;
    deepCol *= 0.5602;
    deepPat = pow(clamp(deepPat * 0.5896, 0.0, 1.0), 1.4308);
    ...
    float alpha = vertexColor.a * min(0.0640 + 0.2810 * presence + 0.4348 * pattern, 0.8022);
