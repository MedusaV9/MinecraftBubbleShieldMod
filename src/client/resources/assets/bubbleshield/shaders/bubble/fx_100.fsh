...
// stack: deep=fbm x3 taps | mid=lightning+curl+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0640 + 0.2810 * presence + 0.4348 * pattern + 0.1114 * (1.0 - deepTrans), 0.8022);
