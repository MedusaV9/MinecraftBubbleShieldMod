...
// stack: deep=caustic x3 taps | mid=kaleido+warp2+pulse | rim=graze | flourish=glint | tex=cracked_glass
// fbm: ridged x3 octaves | seed 91fc24213481b450
// v8 realism: refr 1.0087+1.3193*fres/dist (cap 0.1382) | energy 0.2776+0.4212*p | flow 0.089167 c/s | soft 0.8948m
...
void main() {
    ...
    float refrAmp = min((1.0087 + 1.3193 * fresnel) / max(length(worldPos), 1.0), 0.1382);
