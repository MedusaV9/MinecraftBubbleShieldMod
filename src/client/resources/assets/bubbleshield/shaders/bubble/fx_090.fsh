...
// stack: deep=caustic x3 taps | mid=kaleido+warp2+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0477 + 0.4065 * presence + 0.3814 * pattern + 0.0933 * (1.0 - deepTrans), 0.8868);
