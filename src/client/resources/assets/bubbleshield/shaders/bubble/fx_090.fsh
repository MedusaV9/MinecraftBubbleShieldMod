...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.025000, 0.022500) * time, time);
    deep += 0.4171 * deepField(duvBase + rimDir * 0.0742 + vec2(0.038333, 0.035000) * time, time);
    deep = pow(clamp(deep * 0.7056, 0.0, 1.0), 1.6344);
