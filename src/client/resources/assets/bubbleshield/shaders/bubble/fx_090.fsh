...
void main() {
    ...
    mid = clamp(mid * (0.6326 + 0.5413 * texDetail) + 0.2488 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7707 + 0.4520 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0897 * (0.5 + 0.5 * sin(time * 0.272271)));
    rgb += emit * 0.9527 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3843 + 0.5465 * presence + 0.3814 * pattern + 0.0933 * (1.0 - deepTrans) + 0.1752 * emit, 0.9468);
