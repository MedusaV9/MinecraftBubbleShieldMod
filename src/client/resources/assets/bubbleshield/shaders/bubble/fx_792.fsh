...
// stack: deep=caustic x3 taps | mid=mycelia+curl+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0643 + 0.1882 * presence + 0.5314 * pattern + 0.0887 * (1.0 - deepTrans), 0.8029);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2487), 0.8029);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4198 + 0.5802 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
