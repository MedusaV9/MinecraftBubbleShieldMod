...
// stack: deep=voro x4 taps | mid=interference+none+scroll | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0415 + 0.2954 * presence + 0.4711 * pattern + 0.1158 * (1.0 - deepTrans), 0.8331);
