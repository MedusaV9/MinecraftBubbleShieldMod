...
// stack: deep=ridge x4 taps | mid=truchet+curl+rotate | rim=lat | flourish=swirl | tex=runes
// fbm: standard x5 octaves | seed 9e68886dc31429e0
// v8 realism: refr 0.5675+0.7563*fres/dist (cap 0.1221) | energy 0.4070+0.4412*p | flow 0.092500 c/s | soft 0.5893m
...
void main() {
    ...
    float refrAmp = min((0.5675 + 0.7563 * fresnel) / max(length(worldPos), 1.0), 0.1221);
