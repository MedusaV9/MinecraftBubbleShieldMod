...
void main() {
    ...
    mid = clamp(mid * (0.6168 + 0.6306 * texDetail) + 0.3187 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6692 + 0.4441 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1214 * (0.5 + 0.5 * sin(time * 0.136136)));
    rgb += emit * 0.7435 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3822 + 0.4550 * presence + 0.4481 * pattern + 0.1096 * (1.0 - deepTrans) + 0.1350 * emit, 0.8669);
