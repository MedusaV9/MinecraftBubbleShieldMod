...
// stack: deep=fbm x4 taps | mid=deepice+warp2+scroll | rim=graze_sparkle | flourish=swirl | tex=cracked_glass
// fbm: turb x4 octaves | seed 7c74a1a06bc84a93
// v8 realism: refr 0.9394+1.2063*fres/dist (cap 0.1472) | energy 0.2575+0.4117*p | flow 0.051667 c/s | soft 0.9444m
...
void main() {
    ...
    float refrAmp = min((0.9394 + 1.2063 * fresnel) / max(length(worldPos), 1.0), 0.1472);
