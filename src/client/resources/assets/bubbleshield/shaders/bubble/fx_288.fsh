...
void main() {
    ...
    mid = clamp(mid * (0.7076 + 0.5904 * texDetail) + 0.3476 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6622 + 0.2615 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1256 * (0.5 + 0.5 * sin(time * 0.104720)));
    rgb += emit * 0.9725 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4643 + 0.5522 * presence + 0.4236 * pattern + 0.1284 * (1.0 - deepTrans) + 0.2180 * emit, 0.9052);
