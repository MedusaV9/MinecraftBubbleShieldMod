...
// stack: deep=fbm x4 taps | mid=kaleido+curl+pulse | rim=graze | flourish=swirl | tex=cracked_glass
// fbm: turb x5 octaves | seed 554ecc35816457d8
// v8 realism: refr 0.9835+1.3846*fres/dist (cap 0.1499) | energy 0.2206+0.4494*p | flow 0.100833 c/s | soft 0.7003m
...
void main() {
    ...
    float refrAmp = min((0.9835 + 1.3846 * fresnel) / max(length(worldPos), 1.0), 0.1499);
