...
// stack: deep=fbm x3 taps | mid=interference+warp2+rotate | rim=lat | flourish=glint | tex=caustic_web
// fbm: turb x3 octaves | seed 5d3e39c60e549637
// v8 realism: refr 0.9329+1.1500*fres/dist (cap 0.1131) | energy 0.2534+0.3989*p | flow 0.060000 c/s | soft 0.7288m
...
void main() {
    ...
    float refrAmp = min((0.9329 + 1.1500 * fresnel) / max(length(worldPos), 1.0), 0.1131);
