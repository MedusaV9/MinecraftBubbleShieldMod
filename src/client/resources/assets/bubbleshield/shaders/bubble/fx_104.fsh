...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8126, 0.0, 1.0);
    ...
    deepCol += 0.3870 * dp * mix(baseCol, deepStop, 0.4058);
    deepPat += 0.3870 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 5.3142) + par * 0.0865, time);
    deepCol += 0.1498 * dp * mix(baseCol, deepStop, 0.8116);
    deepPat += 0.1498 * dp;
    deepCol *= 0.7337;
    deepPat = pow(clamp(deepPat * 0.6507, 0.0, 1.0), 1.7962);
    ...
    rgb += hotStop * 0.2319 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0449 + 0.3315 * presence + 0.3337 * pattern, 0.7973);
