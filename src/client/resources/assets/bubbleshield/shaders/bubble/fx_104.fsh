...
// stack: deep=fbm x3 taps | mid=interference+warp2+rotate | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0449 + 0.3315 * presence + 0.3337 * pattern + 0.1536 * (1.0 - deepTrans), 0.7973);
