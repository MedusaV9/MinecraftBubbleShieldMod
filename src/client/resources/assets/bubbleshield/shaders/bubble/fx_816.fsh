...
// stack: deep=caustic x3 taps | mid=oilslick+warp2+pulse | rim=lat | flourish=echo | tex=chrome
// fbm: standard x5 octaves | seed ad072bc929fd4bdd
// v8 realism: refr 0.7849+1.1231*fres/dist (cap 0.1583) | energy 0.2081+0.4595*p | flow 0.102500 c/s | soft 0.5557m
...
void main() {
    ...
    float refrAmp = min((0.7849 + 1.1231 * fresnel) / max(length(worldPos), 1.0), 0.1583);
