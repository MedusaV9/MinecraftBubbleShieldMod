...
// stack: deep=caustic x3 taps | mid=oilslick+warp2+pulse | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0633 + 0.2740 * presence + 0.3350 * pattern + 0.1465 * (1.0 - deepTrans), 0.8312);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3187), 0.8312);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4327 + 0.5673 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
