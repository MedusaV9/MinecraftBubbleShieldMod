...
void main() {
    ...
    mid = clamp(mid * (0.6408 + 0.4983 * texDetail) + 0.2317 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6891 + 0.4606 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1318 * (0.5 + 0.5 * sin(time * 0.188496)));
    rgb += emit * 0.9768 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3682 + 0.4932 * presence + 0.3312 * pattern + 0.1237 * (1.0 - deepTrans) + 0.1957 * emit, 0.9100);
