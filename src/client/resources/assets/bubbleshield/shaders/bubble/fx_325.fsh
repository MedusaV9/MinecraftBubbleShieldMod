...
// stack: deep=fbm x3 taps | mid=circuit+curl+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0536 + 0.3532 * presence + 0.3312 * pattern + 0.1237 * (1.0 - deepTrans), 0.8500);
