...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8284, 0.0, 1.0);
    ...
    deepCol += 0.4137 * dp * mix(baseCol, deepStop, 0.3001);
    deepPat += 0.4137 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 5.1609) + par * 0.0971, time);
    deepCol += 0.1712 * dp * mix(baseCol, deepStop, 0.6003);
    deepPat += 0.1712 * dp;
    deepCol *= 0.7879;
    deepPat = pow(clamp(deepPat * 0.6309, 0.0, 1.0), 1.1817);
    ...
    float alpha = vertexColor.a * min(0.0536 + 0.3532 * presence + 0.3312 * pattern, 0.8500);
