...
// stack: deep=fbm x3 taps | mid=circuit+curl+rotate | rim=graze_sparkle | flourish=echo | tex=circuit
// fbm: standard x5 octaves | seed 31f297531e4db535
// v8 realism: refr 0.4948+0.4289*fres/dist (cap 0.1282) | energy 0.3980+0.4294*p | flow 0.051667 c/s | soft 0.5570m
...
void main() {
    ...
    float refrAmp = min((0.4948 + 0.4289 * fresnel) / max(length(worldPos), 1.0), 0.1282);
