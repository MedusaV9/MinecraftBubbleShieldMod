...
// stack: deep=fbm x4 taps | mid=oilslick+none+rotate | rim=graze_sparkle | flourish=swirl | tex=chrome
// fbm: ridged x5 octaves | seed 6ed73888e59b944a
// v8 realism: refr 0.8475+1.0834*fres/dist (cap 0.1447) | energy 0.2492+0.4015*p | flow 0.050000 c/s | soft 0.8250m
...
void main() {
    ...
    float refrAmp = min((0.8475 + 1.0834 * fresnel) / max(length(worldPos), 1.0), 0.1447);
