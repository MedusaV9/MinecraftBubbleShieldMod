...
// stack: deep=fbm x4 taps | mid=oilslick+none+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0513 + 0.2721 * presence + 0.4477 * pattern + 0.1289 * (1.0 - deepTrans), 0.7845);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3106), 0.7845);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4685 + 0.5315 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
