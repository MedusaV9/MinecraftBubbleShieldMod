...
// stack: deep=fbm x3 taps | mid=prismdisperse+warp1+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0722 + 0.2651 * presence + 0.4362 * pattern + 0.0809 * (1.0 - deepTrans), 0.8168);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2473), 0.8168);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5135 + 0.4865 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
