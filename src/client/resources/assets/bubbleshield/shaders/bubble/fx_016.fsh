...
void main() {
    ...
    mid = clamp(mid * (0.6174 + 0.7294 * texDetail) + 0.3331 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6351 + 0.4951 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1492 * (0.5 + 0.5 * sin(time * 0.188496)));
    rgb += emit * 0.7656 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3887 + 0.4212 * presence + 0.4696 * pattern + 0.0958 * (1.0 - deepTrans) + 0.1996 * emit, 0.8998);
