...
// stack: deep=caustic x4 taps | mid=orbittrap+none+pulse | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0718 + 0.1373 * presence + 0.4981 * pattern + 0.1311 * (1.0 - deepTrans), 0.8338);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2849), 0.8338);
    // [layer:v5:ghostalpha]
