...
// stack: deep=voro x4 taps | mid=fluidink+warp1+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0675 + 0.2556 * presence + 0.3458 * pattern + 0.1373 * (1.0 - deepTrans), 0.8235);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3087), 0.8235);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4774 + 0.5226 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
