...
// stack: deep=fbm x3 taps | mid=sparkle+warp2+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0455 + 0.3252 * presence + 0.4475 * pattern + 0.1115 * (1.0 - deepTrans), 0.8062);
