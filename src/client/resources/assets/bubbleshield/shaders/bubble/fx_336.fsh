...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5880, 0.0, 1.0);
    ...
    deepCol += 0.4086 * dp * mix(baseCol, deepStop, 0.4123);
    deepPat += 0.4086 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 3.5588) + par * 0.1208, time);
    deepCol += 0.1669 * dp * mix(baseCol, deepStop, 0.8245);
    deepPat += 0.1669 * dp;
    deepCol *= 0.8135;
    deepPat = pow(clamp(deepPat * 0.6347, 0.0, 1.0), 1.2857);
    ...
    rgb += hotStop * 0.2327 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0455 + 0.3252 * presence + 0.4475 * pattern, 0.8062);
