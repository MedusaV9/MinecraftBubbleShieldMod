...
// stack: deep=fbm x4 taps | mid=interference+curl+rotate | rim=graze | flourish=swirl | tex=caustic_web
// fbm: ridged x6 octaves | seed 1508ed018e2377e0
// v8 realism: refr 0.9061+1.1098*fres/dist (cap 0.1481) | energy 0.2287+0.3801*p | flow 0.096667 c/s | soft 0.9605m
...
void main() {
    ...
    float refrAmp = min((0.9061 + 1.1098 * fresnel) / max(length(worldPos), 1.0), 0.1481);
