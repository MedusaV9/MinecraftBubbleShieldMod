...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6090, 0.0, 1.0);
    ...
    deepCol += 0.5043 * dp * mix(baseCol, deepStop, 0.3795);
    deepPat += 0.5043 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 4.0545) + par * 0.0727, time);
    deepCol += 0.2543 * dp * mix(baseCol, deepStop, 0.7590);
    deepPat += 0.2543 * dp;
    deepCol *= 0.5541;
    deepPat = pow(clamp(deepPat * 0.5686, 0.0, 1.0), 1.1121);
    ...
    rgb += hotStop * 0.1540 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0533 + 0.3632 * presence + 0.4927 * pattern, 0.8247);
