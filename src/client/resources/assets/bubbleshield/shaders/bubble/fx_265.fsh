...
// stack: deep=ridge x3 taps | mid=hex+warp2+scroll | rim=graze | flourish=shimmer | tex=hex_lattice
// fbm: ridged x4 octaves | seed f67beb0300a976a1
// v8 realism: refr 0.5129+0.4492*fres/dist (cap 0.1100) | energy 0.4109+0.4925*p | flow 0.058333 c/s | soft 0.8454m
...
void main() {
    ...
    float refrAmp = min((0.5129 + 0.4492 * fresnel) / max(length(worldPos), 1.0), 0.1100);
