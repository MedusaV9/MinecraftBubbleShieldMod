...
// stack: deep=fbm x4 taps | mid=arcs+curl+rotate | rim=lat | flourish=echo | tex=filaments
// fbm: turb x5 octaves | seed 23f85d75252e211b
// v8 realism: refr 0.5287+0.7638*fres/dist (cap 0.1545) | energy 0.3749+0.3833*p | flow 0.109167 c/s | soft 0.8084m
...
void main() {
    ...
    float refrAmp = min((0.5287 + 0.7638 * fresnel) / max(length(worldPos), 1.0), 0.1545);
