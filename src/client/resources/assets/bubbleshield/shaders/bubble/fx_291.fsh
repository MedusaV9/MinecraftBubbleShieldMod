...
// stack: deep=fbm x4 taps | mid=arcs+curl+rotate | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0607 + 0.2639 * presence + 0.3889 * pattern + 0.1323 * (1.0 - deepTrans), 0.8235);
