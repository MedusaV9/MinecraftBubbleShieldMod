...
// stack: deep=fbm x3 taps | mid=waves+warp1+scroll | rim=graze_film | flourish=swirl | tex=caustic_web
// fbm: turb x4 octaves | seed 29d61768475ba3ed
// v8 realism: refr 1.0347+1.2929*fres/dist (cap 0.1322) | energy 0.2617+0.4447*p | flow 0.106667 c/s | soft 0.9444m
...
void main() {
    ...
    float refrAmp = min((1.0347 + 1.2929 * fresnel) / max(length(worldPos), 1.0), 0.1322);
