...
// stack: deep=fbm x3 taps | mid=waves+warp1+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0539 + 0.3281 * presence + 0.3724 * pattern + 0.0813 * (1.0 - deepTrans), 0.7907);
