...
// stack: deep=voro x3 taps | mid=phantomecho+warp1+scroll | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0610 + 0.1239 * presence + 0.5875 * pattern + 0.1256 * (1.0 - deepTrans), 0.7839);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2963), 0.7839);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4091 + 0.5909 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
