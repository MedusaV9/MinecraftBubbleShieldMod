...
void main() {
    ...
    mid = clamp(mid * (0.6654 + 0.6389 * texDetail) + 0.3469 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6062 + 0.4094 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1016 * (0.5 + 0.5 * sin(time * 0.141372)));
    rgb += emit * 0.6875 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4312 + 0.4968 * presence + 0.4644 * pattern + 0.0969 * (1.0 - deepTrans) + 0.1344 * emit, 0.8918);
