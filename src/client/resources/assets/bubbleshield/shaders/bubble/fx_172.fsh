...
// stack: deep=voro x3 taps | mid=kaleido+curl+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0656 + 0.3568 * presence + 0.4644 * pattern + 0.0969 * (1.0 - deepTrans), 0.8318);
