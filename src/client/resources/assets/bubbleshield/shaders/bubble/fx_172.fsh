...
// stack: deep=voro x3 taps | mid=kaleido+curl+scroll | rim=graze | flourish=swirl | tex=cracked_glass
// fbm: turb x3 octaves | seed d3e5a7a6b49cd825
// v8 realism: refr 0.7724+1.3393*fres/dist (cap 0.1460) | energy 0.2016+0.3481*p | flow 0.078333 c/s | soft 0.6823m
...
void main() {
    ...
    float refrAmp = min((0.7724 + 1.3393 * fresnel) / max(length(worldPos), 1.0), 0.1460);
