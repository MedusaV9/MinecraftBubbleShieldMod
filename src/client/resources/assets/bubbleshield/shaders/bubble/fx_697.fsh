...
// stack: deep=ridge x3 taps | mid=plasmaglobe+warp1+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0516 + 0.0989 * presence + 0.5482 * pattern + 0.1011 * (1.0 - deepTrans), 0.8024);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2008), 0.8024);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4526 + 0.5474 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
