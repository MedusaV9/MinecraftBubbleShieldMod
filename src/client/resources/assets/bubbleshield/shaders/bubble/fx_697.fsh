...
// stack: deep=ridge x3 taps | mid=plasmaglobe+warp1+rotate | rim=graze_film | flourish=echo | tex=filaments
// fbm: turb x5 octaves | seed 103e1ab87bcfbd5b
// v8 realism: refr 0.5263+0.4927*fres/dist (cap 0.1582) | energy 0.4144+0.4133*p | flow 0.095833 c/s | soft 1.0581m
...
void main() {
    ...
    float refrAmp = min((0.5263 + 0.4927 * fresnel) / max(length(worldPos), 1.0), 0.1582);
