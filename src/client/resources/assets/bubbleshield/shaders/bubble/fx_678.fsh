...
// stack: deep=fbm x3 taps | mid=ectoplasm+warp1+rotate | rim=lat | flourish=swirl | tex=foam
// fbm: standard x6 octaves | seed 3f46875065b85bab
// v8 realism: refr 0.4103+0.3464*fres/dist (cap 0.1237) | energy 0.3566+0.4172*p | flow 0.060833 c/s | soft 1.6128m
...
void main() {
    ...
    float refrAmp = min((0.4103 + 0.3464 * fresnel) / max(length(worldPos), 1.0), 0.1237);
