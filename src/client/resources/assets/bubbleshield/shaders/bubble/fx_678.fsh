...
// stack: deep=fbm x3 taps | mid=ectoplasm+warp1+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3340), 0.7988);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5304 + 0.4696 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
