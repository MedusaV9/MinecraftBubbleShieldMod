...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8085, 0.0, 1.0);
    ...
    deepCol += 0.4080 * dp * mix(baseCol, deepStop, 0.4261);
    deepPat += 0.4080 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 5.9149) + par * 0.0798, time);
    deepCol += 0.1665 * dp * mix(baseCol, deepStop, 0.8522);
    deepPat += 0.1665 * dp;
    deepCol *= 0.8210;
    deepPat = pow(clamp(deepPat * 0.6351, 0.0, 1.0), 1.2257);
    ...
    rgb += hotStop * 0.2134 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0710 + 0.3616 * presence + 0.4124 * pattern, 0.8463);
