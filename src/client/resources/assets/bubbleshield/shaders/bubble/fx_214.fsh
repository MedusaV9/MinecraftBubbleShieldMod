...
void main() {
    ...
    mid = clamp(mid * (0.6631 + 0.6784 * texDetail) + 0.2892 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5859 + 0.3316 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1290 * (0.5 + 0.5 * sin(time * 0.151844)));
    rgb += emit * 0.7590 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4198 + 0.5016 * presence + 0.4124 * pattern + 0.1028 * (1.0 - deepTrans) + 0.2009 * emit, 0.9063);
