...
// stack: deep=voro x3 taps | mid=petals+warp1+rotate | rim=lat | flourish=swirl | tex=scales
// fbm: ridged x6 octaves | seed b8ae8a4c2d62c942
// v8 realism: refr 0.6023+0.4861*fres/dist (cap 0.1116) | energy 0.3369+0.5325*p | flow 0.073333 c/s | soft 0.9181m
...
void main() {
    ...
    float refrAmp = min((0.6023 + 0.4861 * fresnel) / max(length(worldPos), 1.0), 0.1116);
