...
// stack: deep=ridge x3 taps | mid=ectoplasm+curl+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0677 + 0.1967 * presence + 0.4029 * pattern + 0.1217 * (1.0 - deepTrans), 0.8227);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1924), 0.8227);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4185 + 0.5815 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
