...
// stack: deep=fbm x4 taps | mid=runecircuit+warp1+rotate | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0606 + 0.1669 * presence + 0.5987 * pattern + 0.1574 * (1.0 - deepTrans), 0.8053);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2389), 0.8053);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5223 + 0.4777 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
