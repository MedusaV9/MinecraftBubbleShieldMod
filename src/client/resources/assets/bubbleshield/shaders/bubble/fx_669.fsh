...
// stack: deep=caustic x4 taps | mid=stainedglass+curl+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0673 + 0.4152 * presence + 0.3682 * pattern + 0.1171 * (1.0 - deepTrans), 0.8871);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2502), 0.8871);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4460 + 0.5540 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
