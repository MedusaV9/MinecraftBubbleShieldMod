...
// stack: deep=caustic x4 taps | mid=stainedglass+none+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0435 + 0.3181 * presence + 0.3926 * pattern + 0.1040 * (1.0 - deepTrans), 0.8763);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1906), 0.8763);
    // [layer:v5:ghostalpha]
