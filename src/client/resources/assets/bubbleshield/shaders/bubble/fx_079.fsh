...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7623, 0.0, 1.0);
    ...
    deepCol += 0.5460 * dp * mix(baseCol, deepStop, 0.3359);
    deepPat += 0.5460 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.4597) + par * 0.1298, time);
    deepCol += 0.2981 * dp * mix(baseCol, deepStop, 0.6719);
    deepPat += 0.2981 * dp;
    deepCol *= 0.6660;
    deepPat = pow(clamp(deepPat * 0.5423, 0.0, 1.0), 1.3731);
    ...
    rgb += hotStop * 0.3189 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.3673 * presence + 0.3345 * pattern, 0.8474);
