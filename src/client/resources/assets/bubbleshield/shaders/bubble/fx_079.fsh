...
// stack: deep=fbm x3 taps | mid=rings+curl+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.3673 * presence + 0.3345 * pattern + 0.1166 * (1.0 - deepTrans), 0.8474);
