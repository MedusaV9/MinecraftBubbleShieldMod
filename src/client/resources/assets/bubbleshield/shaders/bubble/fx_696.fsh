...
// stack: deep=ridge x4 taps | mid=oilslick+warp1+rotate | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0438 + 0.2601 * presence + 0.4015 * pattern + 0.1380 * (1.0 - deepTrans), 0.7965);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2310), 0.7965);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3860 + 0.6140 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
