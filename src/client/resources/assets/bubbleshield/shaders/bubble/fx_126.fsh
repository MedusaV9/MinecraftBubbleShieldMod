...
// stack: deep=fbm x3 taps | mid=vortex+curl+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0635 + 0.3063 * presence + 0.4062 * pattern + 0.1441 * (1.0 - deepTrans), 0.8510);
