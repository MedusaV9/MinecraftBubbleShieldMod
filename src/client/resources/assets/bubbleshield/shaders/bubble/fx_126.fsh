...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8136, 0.0, 1.0);
    ...
    deepCol += 0.4148 * dp * mix(baseCol, deepStop, 0.3607);
    deepPat += 0.4148 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 3.4840) + par * 0.0717, time);
    deepCol += 0.1720 * dp * mix(baseCol, deepStop, 0.7214);
    deepPat += 0.1720 * dp;
    deepCol *= 0.7450;
    deepPat = pow(clamp(deepPat * 0.6302, 0.0, 1.0), 1.5785);
    ...
    rgb += hotStop * 0.2762 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0635 + 0.3063 * presence + 0.4062 * pattern, 0.8510);
