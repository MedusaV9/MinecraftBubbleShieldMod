...
// stack: deep=fbm x3 taps | mid=vortex+curl+flicker | rim=graze_sparkle | flourish=shimmer | tex=marble_ink
// fbm: ridged x6 octaves | seed 329c9cc2aad85983
// v8 realism: refr 0.6751+0.9203*fres/dist (cap 0.1476) | energy 0.3459+0.4632*p | flow 0.055833 c/s | soft 0.8107m
...
void main() {
    ...
    float refrAmp = min((0.6751 + 0.9203 * fresnel) / max(length(worldPos), 1.0), 0.1476);
