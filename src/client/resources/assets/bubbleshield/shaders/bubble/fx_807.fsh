...
// stack: deep=voro x3 taps | mid=irisfilm+warp2+scroll | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0684 + 0.2264 * presence + 0.4356 * pattern + 0.1322 * (1.0 - deepTrans), 0.8334);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2706), 0.8334);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4669 + 0.5331 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
