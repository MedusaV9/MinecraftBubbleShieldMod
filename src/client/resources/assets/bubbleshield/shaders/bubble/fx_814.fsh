...
// stack: deep=caustic x3 taps | mid=deepice+warp2+flicker | rim=lat | flourish=shimmer | tex=cracked_glass
// fbm: turb x6 octaves | seed 58bbf608caa09348
// v8 realism: refr 0.9356+1.4439*fres/dist (cap 0.1127) | energy 0.1986+0.3802*p | flow 0.081667 c/s | soft 0.9524m
...
void main() {
    ...
    float refrAmp = min((0.9356 + 1.4439 * fresnel) / max(length(worldPos), 1.0), 0.1127);
