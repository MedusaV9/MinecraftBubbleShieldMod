...
// stack: deep=ridge x4 taps | mid=arcs+warp1+rotate | rim=graze | flourish=echo | tex=filaments
// fbm: ridged x5 octaves | seed 8bd71427affea4ac
// v8 realism: refr 0.5188+0.6500*fres/dist (cap 0.1566) | energy 0.4152+0.4460*p | flow 0.107500 c/s | soft 0.7236m
...
void main() {
    ...
    float refrAmp = min((0.5188 + 0.6500 * fresnel) / max(length(worldPos), 1.0), 0.1566);
