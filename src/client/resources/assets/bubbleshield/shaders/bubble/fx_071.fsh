...
// stack: deep=ridge x4 taps | mid=arcs+warp1+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0678 + 0.3569 * presence + 0.4289 * pattern + 0.1579 * (1.0 - deepTrans), 0.7974);
