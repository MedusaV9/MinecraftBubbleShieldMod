...
// v8 realism: refr 0.6995+0.9358*fres/dist (cap 0.1585) | energy 0.3282+0.5072*p | flow 0.065833 c/s | soft 0.5930m
...
void main() {
    ...
    float refrAmp = min((0.6995 + 0.9358 * fresnel) / max(length(worldPos), 1.0), 0.1585);
