...
// stack: deep=caustic x3 taps | mid=solarflare+curl+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0553 + 0.1442 * presence + 0.5957 * pattern + 0.1329 * (1.0 - deepTrans), 0.8425);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3078), 0.8425);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3911 + 0.6089 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
