...
void main() {
    ...
    mid = clamp(mid * (0.6263 + 0.5913 * texDetail) + 0.2927 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6962 + 0.4855 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1103 * (0.5 + 0.5 * sin(time * 0.287979)));
    ...
    float alpha = vertexColor.a * min(0.4324 + 0.4747 * presence + 0.3610 * pattern + 0.1468 * (1.0 - deepTrans) + 0.2019 * emit, 0.9163);
