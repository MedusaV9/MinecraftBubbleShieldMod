...
// stack: deep=voro x4 taps | mid=ridged+warp2+scroll | rim=graze | flourish=echo | tex=ridged
// fbm: standard x4 octaves | seed 1ebd9df5203dbaf9
// v8 realism: refr 0.6590+0.8916*fres/dist (cap 0.1105) | energy 0.3297+0.4424*p | flow 0.060833 c/s | soft 0.7789m
...
void main() {
    ...
    float refrAmp = min((0.6590 + 0.8916 * fresnel) / max(length(worldPos), 1.0), 0.1105);
