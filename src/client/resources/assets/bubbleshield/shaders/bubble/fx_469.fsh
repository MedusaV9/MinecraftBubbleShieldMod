...
// stack: deep=voro x3 taps | mid=stainedglass+warp1+flicker | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0480 + 0.3242 * presence + 0.4400 * pattern + 0.0942 * (1.0 - deepTrans), 0.8555);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1895), 0.8555);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4716 + 0.5284 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
