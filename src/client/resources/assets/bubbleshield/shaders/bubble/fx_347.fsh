...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5847, 0.0, 1.0);
    ...
    deepCol += 0.5507 * dp * mix(baseCol, deepStop, 0.2177);
    deepPat += 0.5507 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 3.7544) + par * 0.0996, time);
    deepCol += 0.3032 * dp * mix(baseCol, deepStop, 0.4353);
    deepPat += 0.3032 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 4.7699) + par * 0.1493, time);
    deepCol += 0.1670 * dp * mix(baseCol, deepStop, 0.6530);
    deepPat += 0.1670 * dp;
    deepCol *= 0.5730;
    deepPat = pow(clamp(deepPat * 0.4948, 0.0, 1.0), 1.7962);
    ...
    float alpha = vertexColor.a * min(0.0488 + 0.3255 * presence + 0.3737 * pattern, 0.8429);
