...
// stack: deep=fbm x4 taps | mid=truchet+warp2+scroll | rim=graze | flourish=shimmer | tex=runes
// fbm: turb x5 octaves | seed d22916147b9c5a75
// v8 realism: refr 0.5689+0.5510*fres/dist (cap 0.1137) | energy 0.3455+0.4232*p | flow 0.090000 c/s | soft 0.9190m
...
void main() {
    ...
    float refrAmp = min((0.5689 + 0.5510 * fresnel) / max(length(worldPos), 1.0), 0.1137);
