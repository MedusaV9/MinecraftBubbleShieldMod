...
// stack: deep=fbm x4 taps | mid=truchet+warp2+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0488 + 0.3255 * presence + 0.3737 * pattern + 0.1413 * (1.0 - deepTrans), 0.8429);
