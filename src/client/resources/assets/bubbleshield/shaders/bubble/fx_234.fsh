...
void main() {
    ...
    mid = clamp(mid * (0.6358 + 0.6074 * texDetail) + 0.2793 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6105 + 0.2644 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1406 * (0.5 + 0.5 * sin(time * 0.167552)));
    rgb += emit * 0.9993 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4276 + 0.4975 * presence + 0.4781 * pattern + 0.1580 * (1.0 - deepTrans) + 0.2101 * emit, 0.8683);
