...
// stack: deep=fbm x3 taps | mid=vortex+curl+scroll | rim=graze | flourish=glint | tex=marble_ink
// fbm: turb x5 octaves | seed 8c605489ae422cd1
// v8 realism: refr 0.6209+0.8155*fres/dist (cap 0.1437) | energy 0.3133+0.4427*p | flow 0.085833 c/s | soft 1.0926m
...
void main() {
    ...
    float refrAmp = min((0.6209 + 0.8155 * fresnel) / max(length(worldPos), 1.0), 0.1437);
