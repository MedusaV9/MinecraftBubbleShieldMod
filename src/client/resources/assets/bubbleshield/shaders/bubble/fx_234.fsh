...
// stack: deep=fbm x3 taps | mid=vortex+curl+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0736 + 0.3575 * presence + 0.4781 * pattern + 0.1580 * (1.0 - deepTrans), 0.8083);
