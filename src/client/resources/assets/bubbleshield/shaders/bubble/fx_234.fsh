...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7558, 0.0, 1.0);
    ...
    deepCol += 0.4697 * dp * mix(baseCol, deepStop, 0.4195);
    deepPat += 0.4697 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 4.0809) + par * 0.1037, time);
    deepCol += 0.2206 * dp * mix(baseCol, deepStop, 0.8390);
    deepPat += 0.2206 * dp;
    deepCol *= 0.6155;
    deepPat = pow(clamp(deepPat * 0.5916, 0.0, 1.0), 1.4894);
    ...
    rgb += hotStop * 0.1711 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0736 + 0.3575 * presence + 0.4781 * pattern, 0.8083);
