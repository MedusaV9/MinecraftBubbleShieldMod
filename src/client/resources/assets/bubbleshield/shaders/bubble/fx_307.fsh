...
// stack: deep=fbm x4 taps | mid=aurora+curl+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0638 + 0.3523 * presence + 0.4825 * pattern + 0.1252 * (1.0 - deepTrans), 0.7861);
