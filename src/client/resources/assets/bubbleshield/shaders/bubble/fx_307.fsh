...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7356, 0.0, 1.0);
    ...
    deepCol += 0.5243 * dp * mix(baseCol, deepStop, 0.1939);
    deepPat += 0.5243 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 4.9177) + par * 0.1599, time);
    deepCol += 0.2749 * dp * mix(baseCol, deepStop, 0.3877);
    deepPat += 0.2749 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 6.1187) + par * 0.2398, time);
    deepCol += 0.1441 * dp * mix(baseCol, deepStop, 0.5816);
    deepPat += 0.1441 * dp;
    deepCol *= 0.5170;
    deepPat = pow(clamp(deepPat * 0.5146, 0.0, 1.0), 1.5752);
    ...
    float alpha = vertexColor.a * min(0.0638 + 0.3523 * presence + 0.4825 * pattern, 0.7861);
