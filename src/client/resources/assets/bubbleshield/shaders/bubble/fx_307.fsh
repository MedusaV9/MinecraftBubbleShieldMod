...
// stack: deep=fbm x4 taps | mid=aurora+curl+rotate | rim=lat | flourish=swirl | tex=filaments
// fbm: turb x5 octaves | seed bf05a317b8a391b5
// v8 realism: refr 0.5790+0.6285*fres/dist (cap 0.1027) | energy 0.3831+0.4626*p | flow 0.066667 c/s | soft 0.7808m
...
void main() {
    ...
    float refrAmp = min((0.5790 + 0.6285 * fresnel) / max(length(worldPos), 1.0), 0.1027);
