...
// stack: deep=caustic x4 taps | mid=aurora+none+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0743 + 0.3254 * presence + 0.3302 * pattern + 0.0892 * (1.0 - deepTrans), 0.7864);
