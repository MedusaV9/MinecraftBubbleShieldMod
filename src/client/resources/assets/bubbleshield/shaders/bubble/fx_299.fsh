...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.035000, -0.040000) * time, time);
    deep += 0.4532 * deepField(duvBase + rimDir * 0.0666 + vec2(0.055000, -0.065000) * time, time);
    deep += 0.2054 * deepField(duvBase + rimDir * 0.1332 + vec2(0.073333, -0.087500) * time, time);
    deep = pow(clamp(deep * 0.6029, 0.0, 1.0), 1.2087);
