...
// stack: deep=caustic x4 taps | mid=aurora+none+pulse | rim=graze_sparkle | flourish=swirl | tex=filaments
// fbm: standard x4 octaves | seed 5343812285b653a9
// v8 realism: refr 0.6781+0.8808*fres/dist (cap 0.1587) | energy 0.3088+0.3804*p | flow 0.055833 c/s | soft 0.5926m
...
void main() {
    ...
    float refrAmp = min((0.6781 + 0.8808 * fresnel) / max(length(worldPos), 1.0), 0.1587);
