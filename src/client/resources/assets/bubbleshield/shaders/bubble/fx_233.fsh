...
// stack: deep=ridge x4 taps | mid=rings+warp1+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0491 + 0.2788 * presence + 0.4688 * pattern + 0.1566 * (1.0 - deepTrans), 0.8491);
