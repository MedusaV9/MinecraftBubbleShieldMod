...
// stack: deep=ridge x3 taps | mid=waves+warp2+scroll | rim=graze | flourish=echo | tex=caustic_web
// fbm: turb x6 octaves | seed 104844792f7d84db
// v8 realism: refr 0.8371+1.2045*fres/dist (cap 0.1083) | energy 0.2174+0.4579*p | flow 0.070833 c/s | soft 0.6537m
...
void main() {
    ...
    float refrAmp = min((0.8371 + 1.2045 * fresnel) / max(length(worldPos), 1.0), 0.1083);
