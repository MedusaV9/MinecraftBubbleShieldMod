...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8427, 0.0, 1.0);
    ...
    deepCol += 0.3960 * dp * mix(baseCol, deepStop, 0.3793);
    deepPat += 0.3960 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 2.8401) + par * 0.1193, time);
    deepCol += 0.1568 * dp * mix(baseCol, deepStop, 0.7585);
    deepPat += 0.1568 * dp;
    deepCol *= 0.7850;
    deepPat = pow(clamp(deepPat * 0.6440, 0.0, 1.0), 1.4910);
    ...
    rgb += hotStop * 0.1518 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0752 + 0.2408 * presence + 0.3316 * pattern, 0.7906);
