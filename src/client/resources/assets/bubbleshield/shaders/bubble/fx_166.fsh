...
// stack: deep=ridge x3 taps | mid=waves+warp2+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0752 + 0.2408 * presence + 0.3316 * pattern + 0.1090 * (1.0 - deepTrans), 0.7906);
