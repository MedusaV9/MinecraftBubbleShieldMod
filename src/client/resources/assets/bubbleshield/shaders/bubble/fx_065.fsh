...
// stack: deep=ridge x4 taps | mid=vortex+curl+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0786 + 0.3441 * presence + 0.3856 * pattern + 0.1423 * (1.0 - deepTrans), 0.8195);
