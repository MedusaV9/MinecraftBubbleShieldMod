...
// stack: deep=ridge x4 taps | mid=vortex+curl+rotate | rim=graze_film | flourish=swirl | tex=marble_ink
// fbm: turb x3 octaves | seed b8c01f92a5f42c9a
// v8 realism: refr 0.6263+0.6624*fres/dist (cap 0.1333) | energy 0.4171+0.5496*p | flow 0.052500 c/s | soft 0.8782m
...
void main() {
    ...
    float refrAmp = min((0.6263 + 0.6624 * fresnel) / max(length(worldPos), 1.0), 0.1333);
