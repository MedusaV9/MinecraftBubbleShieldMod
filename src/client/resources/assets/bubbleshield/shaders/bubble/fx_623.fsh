...
// stack: deep=ridge x3 taps | mid=holoparallax+none+scroll | rim=lat | flourish=glint | tex=circuit
// fbm: turb x3 octaves | seed 435585c590578108
// v8 realism: refr 0.5171+0.5579*fres/dist (cap 0.1087) | energy 0.3950+0.4060*p | flow 0.107500 c/s | soft 0.9228m
...
void main() {
    ...
    float refrAmp = min((0.5171 + 0.5579 * fresnel) / max(length(worldPos), 1.0), 0.1087);
