...
// stack: deep=ridge x3 taps | mid=holoparallax+none+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0707 + 0.1114 * presence + 0.5012 * pattern + 0.1549 * (1.0 - deepTrans), 0.8432);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2594), 0.8432);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4928 + 0.5072 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
