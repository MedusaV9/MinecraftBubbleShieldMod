...
// stack: deep=ridge x3 taps | mid=stainedglass+warp2+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0786 + 0.3209 * presence + 0.3987 * pattern + 0.1010 * (1.0 - deepTrans), 0.8610);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1800), 0.8610);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3931 + 0.6069 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
