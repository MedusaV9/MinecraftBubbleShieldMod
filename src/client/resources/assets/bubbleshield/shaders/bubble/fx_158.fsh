...
void main() {
    ...
    deep += 0.4190 * deepField(duvBase + rimDir * 0.0323 + vec2(0.066667, 0.000000) * time, time);
    deep += 0.1756 * deepField(duvBase + rimDir * 0.0645 + vec2(0.090000, 0.000000) * time, time);
    deep = pow(clamp(deep * 0.6271, 0.0, 1.0), 1.0859);
