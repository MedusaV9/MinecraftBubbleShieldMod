...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7586, 0.0, 1.0);
    ...
    deepCol += 0.4190 * dp * mix(baseCol, deepStop, 0.2742);
    deepPat += 0.4190 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 3.5404) + par * 0.0645, time);
    deepCol += 0.1756 * dp * mix(baseCol, deepStop, 0.5485);
    deepPat += 0.1756 * dp;
    dp = deepField(rotA(spinAxis, time * 0.020944) * (sdir * 4.3541) + par * 0.0968, time);
    deepCol += 0.0736 * dp * mix(baseCol, deepStop, 0.8227);
    deepPat += 0.0736 * dp;
    deepCol *= 0.7389;
    deepPat = pow(clamp(deepPat * 0.5995, 0.0, 1.0), 1.0859);
    ...
    rgb += hotStop * 0.2202 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0522 + 0.3678 * presence + 0.3239 * pattern, 0.7860);
