...
// stack: deep=fbm x4 taps | mid=waves+curl+pulse | rim=graze_sparkle | flourish=swirl | tex=caustic_web
// fbm: standard x5 octaves | seed 6b5bd9da0e24aeb7
// v8 realism: refr 1.0285+1.5932*fres/dist (cap 0.1293) | energy 0.1909+0.4413*p | flow 0.060000 c/s | soft 1.0381m
...
void main() {
    ...
    float refrAmp = min((1.0285 + 1.5932 * fresnel) / max(length(worldPos), 1.0), 0.1293);
