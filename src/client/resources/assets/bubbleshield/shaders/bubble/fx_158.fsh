...
// stack: deep=fbm x4 taps | mid=waves+curl+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0522 + 0.3678 * presence + 0.3239 * pattern + 0.0965 * (1.0 - deepTrans), 0.7860);
