...
// stack: deep=voro x3 taps | mid=stainedglass+warp2+pulse | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0799 + 0.3859 * presence + 0.4091 * pattern + 0.1315 * (1.0 - deepTrans), 0.8724);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2141), 0.8724);
    // [layer:v5:ghostalpha]
