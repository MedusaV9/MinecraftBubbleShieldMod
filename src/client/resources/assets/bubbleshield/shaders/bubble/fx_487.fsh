...
// stack: deep=voro x4 taps | mid=irisfilm+warp2+pulse | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0692 + 0.1769 * presence + 0.4511 * pattern + 0.1276 * (1.0 - deepTrans), 0.8270);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2539), 0.8270);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5305 + 0.4695 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
