...
// stack: deep=ridge x4 taps | mid=gravlens+curl+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0778 + 0.0945 * presence + 0.5475 * pattern + 0.1359 * (1.0 - deepTrans), 0.7960);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2921), 0.7960);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3930 + 0.6070 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
