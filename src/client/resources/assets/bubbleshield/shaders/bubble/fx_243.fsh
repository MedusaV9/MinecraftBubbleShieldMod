...
void main() {
    ...
    mid = clamp(mid * (0.6481 + 0.5348 * texDetail) + 0.2885 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6950 + 0.2668 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1122 * (0.5 + 0.5 * sin(time * 0.225147)));
    rgb += emit * 0.6851 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4243 + 0.4484 * presence + 0.3467 * pattern + 0.1147 * (1.0 - deepTrans) + 0.1796 * emit, 0.9082);
