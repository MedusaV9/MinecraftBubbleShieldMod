...
// stack: deep=caustic x3 taps | mid=stainedglass+warp2+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0558 + 0.4057 * presence + 0.4183 * pattern + 0.1368 * (1.0 - deepTrans), 0.8558);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3311), 0.8558);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4806 + 0.5194 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
