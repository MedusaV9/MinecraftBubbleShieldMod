...
// stack: deep=ridge x3 taps | mid=spectralveil+warp2+pulse | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0661 + 0.1347 * presence + 0.4619 * pattern + 0.1594 * (1.0 - deepTrans), 0.7336);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2905), 0.7336);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5345 + 0.4655 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
