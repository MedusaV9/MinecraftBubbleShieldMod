...
// stack: deep=caustic x4 taps | mid=triweave+warp1+scroll | rim=graze_sparkle | flourish=shimmer | tex=hex_lattice
// fbm: turb x5 octaves | seed 04979c846d205fb9
// v8 realism: refr 0.5970+0.8158*fres/dist (cap 0.1204) | energy 0.3273+0.4421*p | flow 0.095833 c/s | soft 0.5120m
...
void main() {
    ...
    float refrAmp = min((0.5970 + 0.8158 * fresnel) / max(length(worldPos), 1.0), 0.1204);
