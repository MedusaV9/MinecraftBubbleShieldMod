...
// stack: deep=voro x3 taps | mid=orbittrap+curl+scroll | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0740 + 0.1515 * presence + 0.5553 * pattern + 0.1345 * (1.0 - deepTrans), 0.8068);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2442), 0.8068);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5058 + 0.4942 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
