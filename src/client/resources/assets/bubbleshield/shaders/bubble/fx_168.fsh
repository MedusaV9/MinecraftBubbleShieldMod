...
// stack: deep=voro x4 taps | mid=kaleido+curl+pulse | rim=graze | flourish=echo | tex=cracked_glass
// fbm: ridged x6 octaves | seed 16c3d93862858dec
// v8 realism: refr 0.7308+1.1826*fres/dist (cap 0.1092) | energy 0.2609+0.4071*p | flow 0.073333 c/s | soft 0.6859m
...
void main() {
    ...
    float refrAmp = min((0.7308 + 1.1826 * fresnel) / max(length(worldPos), 1.0), 0.1092);
