...
void main() {
    ...
    mid = clamp(mid * (0.6387 + 0.6382 * texDetail) + 0.2922 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6731 + 0.3067 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1597 * (0.5 + 0.5 * sin(time * 0.272271)));
    rgb += emit * 0.6972 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3767 + 0.4044 * presence + 0.3246 * pattern + 0.0938 * (1.0 - deepTrans) + 0.1287 * emit, 0.8793);
