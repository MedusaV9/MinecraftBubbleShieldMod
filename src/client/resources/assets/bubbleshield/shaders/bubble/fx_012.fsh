...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6062, 0.0, 1.0);
    ...
    deepCol += 0.4022 * dp * mix(baseCol, deepStop, 0.2895);
    deepPat += 0.4022 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 4.5554) + par * 0.0945, time);
    deepCol += 0.1618 * dp * mix(baseCol, deepStop, 0.5790);
    deepPat += 0.1618 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.7973) + par * 0.1418, time);
    deepCol += 0.0651 * dp * mix(baseCol, deepStop, 0.8684);
    deepPat += 0.0651 * dp;
    deepCol *= 0.7418;
    deepPat = pow(clamp(deepPat * 0.6138, 0.0, 1.0), 1.0325);
    ...
    rgb += hotStop * 0.2519 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0564 + 0.2644 * presence + 0.3246 * pattern, 0.8193);
