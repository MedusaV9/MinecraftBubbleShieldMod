...
// stack: deep=ridge x4 taps | mid=rings+none+flicker | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0564 + 0.2644 * presence + 0.3246 * pattern + 0.0938 * (1.0 - deepTrans), 0.8193);
