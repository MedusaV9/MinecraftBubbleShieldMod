...
// stack: deep=voro x3 taps | mid=aethersmoke+warp2+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0740 + 0.1842 * presence + 0.3293 * pattern + 0.1049 * (1.0 - deepTrans), 0.7825);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1826), 0.7825);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4381 + 0.5619 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
