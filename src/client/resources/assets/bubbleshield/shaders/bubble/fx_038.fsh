...
// stack: deep=fbm x4 taps | mid=hex+warp2+rotate | rim=lat | flourish=glint | tex=hex_lattice
// fbm: turb x4 octaves | seed 1e02a48b9de5b8de
// v8 realism: refr 0.5765+0.5890*fres/dist (cap 0.1294) | energy 0.3372+0.4650*p | flow 0.085833 c/s | soft 0.6290m
...
void main() {
    ...
    float refrAmp = min((0.5765 + 0.5890 * fresnel) / max(length(worldPos), 1.0), 0.1294);
