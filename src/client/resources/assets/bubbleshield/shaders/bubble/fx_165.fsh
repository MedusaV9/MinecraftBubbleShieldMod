...
// stack: deep=caustic x4 taps | mid=moire+curl+flicker | rim=graze_sparkle | flourish=echo | tex=chrome
// fbm: ridged x6 octaves | seed 08f7434b86c68e32
// v8 realism: refr 0.7233+1.1576*fres/dist (cap 0.1274) | energy 0.1989+0.4718*p | flow 0.094167 c/s | soft 0.5538m
...
void main() {
    ...
    float refrAmp = min((0.7233 + 1.1576 * fresnel) / max(length(worldPos), 1.0), 0.1274);
