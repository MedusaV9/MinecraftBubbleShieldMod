...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7739, 0.0, 1.0);
    ...
    deepCol += 0.5392 * dp * mix(baseCol, deepStop, 0.1978);
    deepPat += 0.5392 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 5.1425) + par * 0.1495, time);
    deepCol += 0.2908 * dp * mix(baseCol, deepStop, 0.3956);
    deepPat += 0.2908 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 6.4425) + par * 0.2243, time);
    deepCol += 0.1568 * dp * mix(baseCol, deepStop, 0.5934);
    deepPat += 0.1568 * dp;
    deepCol *= 0.5509;
    deepPat = pow(clamp(deepPat * 0.5033, 0.0, 1.0), 1.7479);
    ...
    float alpha = vertexColor.a * min(0.0639 + 0.2694 * presence + 0.4019 * pattern, 0.8375);
