...
// stack: deep=caustic x4 taps | mid=oilslick+warp2+pulse | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0775 + 0.2606 * presence + 0.4221 * pattern + 0.1312 * (1.0 - deepTrans), 0.8167);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2365), 0.8167);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5435 + 0.4565 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
