...
void main() {
    ...
    deepCol += 0.4006 * dp * mix(baseCol, deepStop, 0.2424);
    deepPat += 0.4006 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.5713) + par * 0.1265, time);
    deepCol += 0.1605 * dp * mix(baseCol, deepStop, 0.4848);
    deepPat += 0.1605 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 6.9105) + par * 0.1898, time);
    deepCol += 0.0643 * dp * mix(baseCol, deepStop, 0.7272);
    deepPat += 0.0643 * dp;
    deepCol *= 0.7830;
    deepPat = pow(clamp(deepPat * 0.6152, 0.0, 1.0), 1.5893);
    ...
    rgb += hotStop * 0.3396 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0692 + 0.3090 * presence + 0.4518 * pattern, 0.8473);
