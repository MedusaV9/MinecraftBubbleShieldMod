...
// stack: deep=caustic x3 taps | mid=arcs+warp1+pulse | rim=graze_sparkle | flourish=glint | tex=filaments
// fbm: standard x6 octaves | seed 798da9d1dc1b07fb
// v8 realism: refr 0.5817+0.5527*fres/dist (cap 0.1599) | energy 0.3921+0.5234*p | flow 0.065833 c/s | soft 0.9473m
...
void main() {
    ...
    float refrAmp = min((0.5817 + 0.5527 * fresnel) / max(length(worldPos), 1.0), 0.1599);
