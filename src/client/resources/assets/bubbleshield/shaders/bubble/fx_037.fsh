...
void main() {
    ...
    mid = clamp(mid * (0.6786 + 0.5849 * texDetail) + 0.2310 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4691), 0.0, 1.0);
    float emit = atlas.a * (0.6310 + 0.4425 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0889 * (0.5 + 0.5 * sin(time * 0.209440)));
    rgb += emit * 0.7634 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3314 + 0.4549 * presence + 0.4048 * pattern + 0.1509 * (1.0 - deepTrans) + 0.1236 * emit, 0.8455);
