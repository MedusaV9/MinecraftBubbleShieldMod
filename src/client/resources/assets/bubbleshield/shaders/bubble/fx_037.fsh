...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8361, 0.0, 1.0);
    ...
    deepCol += 0.4803 * dp * mix(baseCol, deepStop, 0.3947);
    deepPat += 0.4803 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 3.3083) + par * 0.1123, time);
    deepCol += 0.2307 * dp * mix(baseCol, deepStop, 0.7893);
    deepPat += 0.2307 * dp;
    deepCol *= 0.5913;
    deepPat = pow(clamp(deepPat * 0.5845, 0.0, 1.0), 1.1846);
    ...
    rgb += hotStop * 0.1771 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0412 + 0.3149 * presence + 0.4048 * pattern, 0.7855);
