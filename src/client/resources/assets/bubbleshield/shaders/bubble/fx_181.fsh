...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.314159);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.015000, -0.045000) * time, time);
    deep += 0.4376 * deepField(duvBase + rimDir * 0.0365 + vec2(0.023333, -0.070000) * time, time);
    deep += 0.1915 * deepField(duvBase + rimDir * 0.0729 + vec2(0.030000, -0.095000) * time, time);
    deep += 0.0838 * deepField(duvBase + rimDir * 0.1094 + vec2(0.038333, -0.120000) * time, time);
    deep = pow(clamp(deep * 0.5838, 0.0, 1.0), 1.2106);
