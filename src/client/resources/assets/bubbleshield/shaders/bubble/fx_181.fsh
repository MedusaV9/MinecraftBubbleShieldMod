...
// stack: deep=voro x4 taps | mid=caustic+warp2+rotate | rim=graze_film | flourish=echo | tex=caustic_web
// fbm: turb x6 octaves | seed b8c8d55287c47ab2
// v8 realism: refr 0.7782+1.2404*fres/dist (cap 0.1426) | energy 0.2799+0.4301*p | flow 0.097500 c/s | soft 0.8435m
...
void main() {
    ...
    float refrAmp = min((0.7782 + 1.2404 * fresnel) / max(length(worldPos), 1.0), 0.1426);
