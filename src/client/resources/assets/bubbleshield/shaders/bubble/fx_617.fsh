...
// stack: deep=voro x4 taps | mid=plasmaglobe+curl+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0551 + 0.1168 * presence + 0.5858 * pattern + 0.1221 * (1.0 - deepTrans), 0.8150);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3042), 0.8150);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3879 + 0.6121 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
