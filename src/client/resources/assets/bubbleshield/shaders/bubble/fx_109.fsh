...
void main() {
    ...
    mid = clamp(mid * (0.6835 + 0.4906 * texDetail) + 0.2780 * texDetail, 0.0, 1.5);
    ...
    rim = clamp(rim + 0.7091 * rimLine, 0.0, 1.4);
    ...
    float emit = atlas.a * (0.7930 + 0.3544 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1185 * (0.5 + 0.5 * sin(time * 0.277507)));
    rgb += emit * 0.8197 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3744 + 0.4542 * presence + 0.4777 * pattern + 0.1561 * (1.0 - deepTrans) + 0.2011 * emit, 0.8894);
