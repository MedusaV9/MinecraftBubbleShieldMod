...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.033333, 0.018333) * time, time);
    deep += 0.4376 * deepField(duvBase + rimDir * 0.0770 + vec2(0.051667, 0.030000) * time, time);
    deep += 0.1915 * deepField(duvBase + rimDir * 0.1540 + vec2(0.070000, 0.040000) * time, time);
    deep = pow(clamp(deep * 0.6139, 0.0, 1.0), 1.7850);
