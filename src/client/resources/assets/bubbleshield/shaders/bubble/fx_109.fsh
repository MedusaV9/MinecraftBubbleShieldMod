...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7382, 0.0, 1.0);
    ...
    deepCol += 0.4376 * dp * mix(baseCol, deepStop, 0.3912);
    deepPat += 0.4376 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.5994) + par * 0.1540, time);
    deepCol += 0.1915 * dp * mix(baseCol, deepStop, 0.7824);
    deepPat += 0.1915 * dp;
    deepCol *= 0.5832;
    deepPat = pow(clamp(deepPat * 0.6139, 0.0, 1.0), 1.7850);
    ...
    rgb += hotStop * 0.1870 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0556 + 0.3142 * presence + 0.4777 * pattern, 0.8294);
