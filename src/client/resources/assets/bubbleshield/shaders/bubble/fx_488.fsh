...
// stack: deep=ridge x3 taps | mid=aethersmoke+warp2+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0648 + 0.2415 * presence + 0.3291 * pattern + 0.1315 * (1.0 - deepTrans), 0.8296);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1953), 0.8296);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4798 + 0.5202 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
