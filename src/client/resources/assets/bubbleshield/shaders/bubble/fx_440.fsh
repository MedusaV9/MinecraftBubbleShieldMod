...
// stack: deep=voro x3 taps | mid=spectralveil+curl+scroll | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0720 + 0.1614 * presence + 0.4635 * pattern + 0.0876 * (1.0 - deepTrans), 0.8150);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1709), 0.8150);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5424 + 0.4576 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
