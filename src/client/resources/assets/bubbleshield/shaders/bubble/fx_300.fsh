...
// stack: deep=caustic x3 taps | mid=kaleido+warp1+pulse | rim=lat | flourish=glint | tex=cracked_glass
// fbm: standard x6 octaves | seed 512ebf76821b36d1
// v8 realism: refr 0.7041+0.8641*fres/dist (cap 0.1200) | energy 0.2324+0.4466*p | flow 0.110833 c/s | soft 0.9161m
...
void main() {
    ...
    float refrAmp = min((0.7041 + 0.8641 * fresnel) / max(length(worldPos), 1.0), 0.1200);
