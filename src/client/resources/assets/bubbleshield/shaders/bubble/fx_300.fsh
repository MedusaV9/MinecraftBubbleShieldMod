...
// stack: deep=caustic x3 taps | mid=kaleido+warp1+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0671 + 0.3814 * presence + 0.3539 * pattern + 0.1408 * (1.0 - deepTrans), 0.8206);
