...
void main() {
    ...
    mid = clamp(mid * (0.6341 + 0.7139 * texDetail) + 0.3058 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7948 + 0.3110 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1171 * (0.5 + 0.5 * sin(time * 0.225147)));
    rgb += emit * 0.7538 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3558 + 0.4701 * presence + 0.3387 * pattern + 0.1036 * (1.0 - deepTrans) + 0.1275 * emit, 0.8973);
