...
// stack: deep=fbm x4 taps | mid=vortex+warp1+scroll | rim=graze_film | flourish=swirl | tex=marble_ink
// fbm: turb x4 octaves | seed d9764107628e1415
// v8 realism: refr 0.5365+0.7114*fres/dist (cap 0.1121) | energy 0.3480+0.4126*p | flow 0.120000 c/s | soft 0.9839m
...
void main() {
    ...
    float refrAmp = min((0.5365 + 0.7114 * fresnel) / max(length(worldPos), 1.0), 0.1121);
