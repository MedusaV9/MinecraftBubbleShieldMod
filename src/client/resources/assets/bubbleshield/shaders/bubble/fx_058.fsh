...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7089, 0.0, 1.0);
    ...
    deepCol += 0.4674 * dp * mix(baseCol, deepStop, 0.2180);
    deepPat += 0.4674 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 3.2085) + par * 0.1476, time);
    deepCol += 0.2185 * dp * mix(baseCol, deepStop, 0.4360);
    deepPat += 0.2185 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.9729) + par * 0.2214, time);
    deepCol += 0.1021 * dp * mix(baseCol, deepStop, 0.6541);
    deepPat += 0.1021 * dp;
    deepCol *= 0.6202;
    deepPat = pow(clamp(deepPat * 0.5593, 0.0, 1.0), 1.3663);
    ...
    rgb += hotStop * 0.2380 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0494 + 0.3301 * presence + 0.3387 * pattern, 0.8373);
