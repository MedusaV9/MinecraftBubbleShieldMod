...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.050000, 0.005000) * time, time);
    deep += 0.4674 * deepField(duvBase + rimDir * 0.0738 + vec2(-0.076667, 0.010000) * time, time);
    deep += 0.2185 * deepField(duvBase + rimDir * 0.1476 + vec2(-0.103333, 0.012500) * time, time);
    deep += 0.1021 * deepField(duvBase + rimDir * 0.2214 + vec2(-0.130000, 0.017500) * time, time);
    deep = pow(clamp(deep * 0.5593, 0.0, 1.0), 1.3663);
