...
// stack: deep=fbm x4 taps | mid=mycelia+warp2+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0702 + 0.1794 * presence + 0.5224 * pattern + 0.1032 * (1.0 - deepTrans), 0.8055);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3325), 0.8055);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3937 + 0.6063 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
