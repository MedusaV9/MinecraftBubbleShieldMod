...
// stack: deep=fbm x4 taps | mid=mycelia+warp2+rotate | rim=graze_sparkle | flourish=echo | tex=filaments
// fbm: standard x4 octaves | seed 583db3783404fb1a
// v8 realism: refr 0.2927+0.3190*fres/dist (cap 0.1158) | energy 0.4788+0.3521*p | flow 0.116667 c/s | soft 0.6058m
...
void main() {
    ...
    float refrAmp = min((0.2927 + 0.3190 * fresnel) / max(length(worldPos), 1.0), 0.1158);
