...
// stack: deep=caustic x3 taps | mid=voidrift+warp1+pulse | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0409 + 0.1408 * presence + 0.5086 * pattern + 0.1111 * (1.0 - deepTrans), 0.7919);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1707), 0.7919);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3876 + 0.6124 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
