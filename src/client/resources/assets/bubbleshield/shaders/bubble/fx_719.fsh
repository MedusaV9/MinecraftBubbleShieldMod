...
// stack: deep=caustic x3 taps | mid=voidrift+warp1+pulse | rim=graze_film | flourish=glint | tex=cracked_glass
// fbm: standard x5 octaves | seed d51ae10c608aa988
// v8 realism: refr 0.2547+0.2735*fres/dist (cap 0.1069) | energy 0.4606+0.3860*p | flow 0.105833 c/s | soft 0.8420m
...
void main() {
    ...
    float refrAmp = min((0.2547 + 0.2735 * fresnel) / max(length(worldPos), 1.0), 0.1069);
