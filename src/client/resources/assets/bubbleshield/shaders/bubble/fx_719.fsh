...
void main() {
    ...
    float vrStar = step(0.7775, vrH) * invsmooth(0.08, 0.42, length(fract(vrS) - 0.5)) * (0.6 + 0.4 * sin(time * (1.5 + 2.0 * vrH) + vrH * 31.0));
    ...
    float flourish = 0.2336 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
