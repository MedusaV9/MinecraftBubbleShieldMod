...
// stack: deep=fbm x4 taps | mid=volumecloud+warp1+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0593 + 0.3387 * presence + 0.3695 * pattern + 0.0832 * (1.0 - deepTrans), 0.8711);
