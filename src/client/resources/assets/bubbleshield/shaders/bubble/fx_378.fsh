...
void main() {
    ...
    mid = clamp(mid * (0.6585 + 0.7142 * texDetail) + 0.3144 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3680), 0.0, 1.0);
    float emit = atlas.a * (0.6790 + 0.4479 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0906 * (0.5 + 0.5 * sin(time * 0.109956)));
    ...
    float alpha = vertexColor.a * min(0.4146 + 0.4787 * presence + 0.3695 * pattern + 0.0832 * (1.0 - deepTrans) + 0.1831 * emit, 0.9311);
