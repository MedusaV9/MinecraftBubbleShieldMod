...
void main() {
    ...
    mid = clamp(mid * (0.6828 + 0.7431 * texDetail) + 0.3437 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5783 + 0.3408 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1658 * (0.5 + 0.5 * sin(time * 0.099484)));
    rgb += emit * 0.7571 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3715 + 0.4596 * presence + 0.3389 * pattern + 0.1255 * (1.0 - deepTrans) + 0.1201 * emit, 0.8756);
