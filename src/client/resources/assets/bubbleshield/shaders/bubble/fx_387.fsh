...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5795, 0.0, 1.0);
    ...
    deepCol += 0.4941 * dp * mix(baseCol, deepStop, 0.4110);
    deepPat += 0.4941 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 5.2530) + par * 0.1128, time);
    deepCol += 0.2441 * dp * mix(baseCol, deepStop, 0.8220);
    deepPat += 0.2441 * dp;
    deepCol *= 0.6325;
    deepPat = pow(clamp(deepPat * 0.5753, 0.0, 1.0), 1.3485);
    ...
    rgb += hotStop * 0.2908 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0547 + 0.3196 * presence + 0.3389 * pattern, 0.8156);
