...
// stack: deep=fbm x3 taps | mid=shardtess+warp1+rotate | rim=graze_sparkle | flourish=glint | tex=cracked_glass
// fbm: turb x6 octaves | seed 57863c14c0076ac9
// v8 realism: refr 0.9625+1.5608*fres/dist (cap 0.1207) | energy 0.1801+0.4016*p | flow 0.083333 c/s | soft 0.9068m
...
void main() {
    ...
    float refrAmp = min((0.9625 + 1.5608 * fresnel) / max(length(worldPos), 1.0), 0.1207);
