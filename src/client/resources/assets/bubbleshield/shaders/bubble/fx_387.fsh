...
// stack: deep=fbm x3 taps | mid=shardtess+warp1+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0547 + 0.3196 * presence + 0.3389 * pattern + 0.1255 * (1.0 - deepTrans), 0.8156);
