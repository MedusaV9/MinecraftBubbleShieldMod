...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6853, 0.0, 1.0);
    ...
    deepCol += 0.5627 * dp * mix(baseCol, deepStop, 0.2705);
    deepPat += 0.5627 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.2203) + par * 0.0674, time);
    deepCol += 0.3167 * dp * mix(baseCol, deepStop, 0.5410);
    deepPat += 0.3167 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.0668) + par * 0.1011, time);
    deepCol += 0.1782 * dp * mix(baseCol, deepStop, 0.8115);
    deepPat += 0.1782 * dp;
    deepCol *= 0.6080;
    deepPat = pow(clamp(deepPat * 0.4860, 0.0, 1.0), 1.0563);
    ...
    float alpha = vertexColor.a * min(0.0531 + 0.3256 * presence + 0.4502 * pattern, 0.8548);
