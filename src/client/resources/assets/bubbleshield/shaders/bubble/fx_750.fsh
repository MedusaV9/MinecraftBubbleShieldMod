...
// stack: deep=ridge x4 taps | mid=phantomecho+warp1+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.1554 * presence + 0.4932 * pattern + 0.1070 * (1.0 - deepTrans), 0.7492);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2296), 0.7492);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4143 + 0.5857 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
