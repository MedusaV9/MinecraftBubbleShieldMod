...
// stack: deep=fbm x3 taps | mid=interference+warp1+pulse | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0792 + 0.3423 * presence + 0.4453 * pattern + 0.1152 * (1.0 - deepTrans), 0.8371);
