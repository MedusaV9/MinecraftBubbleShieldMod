...
// stack: deep=fbm x3 taps | mid=interference+warp1+pulse | rim=lat | flourish=echo | tex=caustic_web
// fbm: ridged x4 octaves | seed b1c3f048f387e6dc
// v8 realism: refr 1.0428+1.0484*fres/dist (cap 0.1292) | energy 0.2756+0.4514*p | flow 0.095000 c/s | soft 0.9260m
...
void main() {
    ...
    float refrAmp = min((1.0428 + 1.0484 * fresnel) / max(length(worldPos), 1.0), 0.1292);
