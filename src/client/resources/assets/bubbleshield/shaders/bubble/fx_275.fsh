...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7780, 0.0, 1.0);
    ...
    deepCol += 0.4032 * dp * mix(baseCol, deepStop, 0.3333);
    deepPat += 0.4032 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.8626) + par * 0.0725, time);
    deepCol += 0.1626 * dp * mix(baseCol, deepStop, 0.6667);
    deepPat += 0.1626 * dp;
    deepCol *= 0.7432;
    deepPat = pow(clamp(deepPat * 0.6387, 0.0, 1.0), 1.0440);
    ...
    rgb += hotStop * 0.1778 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0792 + 0.3423 * presence + 0.4453 * pattern, 0.8371);
