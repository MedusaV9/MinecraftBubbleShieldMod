...
// stack: deep=voro x4 taps | mid=runecircuit+curl+scroll | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0683 + 0.1290 * presence + 0.5847 * pattern + 0.1515 * (1.0 - deepTrans), 0.8102);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2872), 0.8102);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3963 + 0.6037 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
