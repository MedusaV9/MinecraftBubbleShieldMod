...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.000000, -0.020000) * time, time);
    deep += 0.4515 * deepField(duvBase + rimDir * 0.0459 + vec2(0.001667, -0.030000) * time, time);
    deep += 0.2039 * deepField(duvBase + rimDir * 0.0918 + vec2(0.001667, -0.040000) * time, time);
    deep = pow(clamp(deep * 0.6041, 0.0, 1.0), 1.5058);
