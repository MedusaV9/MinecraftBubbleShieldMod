...
// stack: deep=caustic x3 taps | mid=caustic+warp2+pulse | rim=graze_film | flourish=echo | tex=caustic_web
// fbm: standard x6 octaves | seed bf46031a6e99b8ff
// v8 realism: refr 0.7392+1.0338*fres/dist (cap 0.1277) | energy 0.2448+0.3614*p | flow 0.082500 c/s | soft 1.0496m
...
void main() {
    ...
    float refrAmp = min((0.7392 + 1.0338 * fresnel) / max(length(worldPos), 1.0), 0.1277);
