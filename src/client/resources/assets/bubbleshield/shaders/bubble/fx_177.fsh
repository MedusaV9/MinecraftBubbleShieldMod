...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5755, 0.0, 1.0);
    ...
    deepCol += 0.4515 * dp * mix(baseCol, deepStop, 0.3270);
    deepPat += 0.4515 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 5.8008) + par * 0.0918, time);
    deepCol += 0.2039 * dp * mix(baseCol, deepStop, 0.6539);
    deepPat += 0.2039 * dp;
    deepCol *= 0.6456;
    deepPat = pow(clamp(deepPat * 0.6041, 0.0, 1.0), 1.5058);
    ...
    rgb += hotStop * 0.1717 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0580 + 0.2720 * presence + 0.3909 * pattern, 0.8484);
