...
// stack: deep=voro x4 taps | mid=spectralveil+warp2+pulse | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0622 + 0.1329 * presence + 0.4601 * pattern + 0.1136 * (1.0 - deepTrans), 0.8183);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3136), 0.8183);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5218 + 0.4782 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
