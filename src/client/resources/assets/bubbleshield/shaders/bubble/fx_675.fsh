...
// stack: deep=caustic x3 taps | mid=runecircuit+warp2+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0744 + 0.1581 * presence + 0.5742 * pattern + 0.1144 * (1.0 - deepTrans), 0.7930);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3439), 0.7930);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4004 + 0.5996 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
