...
// stack: deep=fbm x4 taps | mid=orbittrap+warp2+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0654 + 0.1221 * presence + 0.4813 * pattern + 0.1460 * (1.0 - deepTrans), 0.8174);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1852), 0.8174);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4678 + 0.5322 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
