...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8127, 0.0, 1.0);
    ...
    deepCol += 0.5668 * dp * mix(baseCol, deepStop, 0.3108);
    deepPat += 0.5668 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 3.4375) + par * 0.0999, time);
    deepCol += 0.3213 * dp * mix(baseCol, deepStop, 0.6216);
    deepPat += 0.3213 * dp;
    deepCol *= 0.6285;
    deepPat = pow(clamp(deepPat * 0.5296, 0.0, 1.0), 1.4434);
    ...
    rgb += hotStop * 0.1614 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0475 + 0.3381 * presence + 0.4446 * pattern, 0.8038);
