...
// stack: deep=fbm x3 taps | mid=waves+warp1+flicker | rim=graze_sparkle | flourish=glint | tex=caustic_web
// fbm: standard x3 octaves | seed 1d849a64bffc7789
// v8 realism: refr 0.8859+1.2933*fres/dist (cap 0.1428) | energy 0.2540+0.4271*p | flow 0.117500 c/s | soft 0.6154m
...
void main() {
    ...
    float refrAmp = min((0.8859 + 1.2933 * fresnel) / max(length(worldPos), 1.0), 0.1428);
