...
// stack: deep=fbm x3 taps | mid=kaleido+warp1+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0684 + 0.3832 * presence + 0.4081 * pattern + 0.1594 * (1.0 - deepTrans), 0.8674);
