...
void main() {
    ...
    mid = clamp(mid * (0.6423 + 0.5003 * texDetail) + 0.2461 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6181 + 0.2614 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1265 * (0.5 + 0.5 * sin(time * 0.151844)));
    rgb += emit * 0.7013 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4386 + 0.5232 * presence + 0.4081 * pattern + 0.1594 * (1.0 - deepTrans) + 0.2161 * emit, 0.9274);
