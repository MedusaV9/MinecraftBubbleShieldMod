...
// stack: deep=fbm x3 taps | mid=kaleido+warp1+rotate | rim=lat | flourish=swirl | tex=cracked_glass
// fbm: standard x6 octaves | seed aefdbd4f2a8121ee
// v8 realism: refr 0.7699+0.7828*fres/dist (cap 0.1424) | energy 0.2507+0.4214*p | flow 0.063333 c/s | soft 0.6420m
...
void main() {
    ...
    float refrAmp = min((0.7699 + 0.7828 * fresnel) / max(length(worldPos), 1.0), 0.1424);
