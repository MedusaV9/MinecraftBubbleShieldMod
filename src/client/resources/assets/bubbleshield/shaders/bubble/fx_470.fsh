...
// stack: deep=caustic x3 taps | mid=phantomecho+curl+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0417 + 0.1087 * presence + 0.5126 * pattern + 0.1585 * (1.0 - deepTrans), 0.7888);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2941), 0.7888);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4263 + 0.5737 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
