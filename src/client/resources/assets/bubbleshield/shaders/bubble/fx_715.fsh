...
// stack: deep=fbm x4 taps | mid=runecircuit+warp1+scroll | rim=graze_sparkle | flourish=glint | tex=runes
// fbm: turb x3 octaves | seed e4717c4aa9fe7f03
// v8 realism: refr 0.3175+0.2609*fres/dist (cap 0.1105) | energy 0.4791+0.4312*p | flow 0.113333 c/s | soft 0.6828m
...
void main() {
    ...
    float refrAmp = min((0.3175 + 0.2609 * fresnel) / max(length(worldPos), 1.0), 0.1105);
