...
// stack: deep=fbm x4 taps | mid=runecircuit+warp1+scroll | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0547 + 0.1392 * presence + 0.4830 * pattern + 0.1122 * (1.0 - deepTrans), 0.7844);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3223), 0.7844);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4988 + 0.5012 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
