...
void main() {
    ...
    mid = clamp(mid * (0.7405 + 0.5311 * texDetail) + 0.2514 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6550 + 0.3721 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0826 * (0.5 + 0.5 * sin(time * 0.167552)));
    rgb += emit * 0.7586 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3655 + 0.2879 * presence + 0.4600 * pattern + 0.1543 * (1.0 - deepTrans) + 0.2068 * emit, 0.9121);
