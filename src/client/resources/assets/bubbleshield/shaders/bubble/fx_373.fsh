...
// stack: deep=ridge x3 taps | mid=kaliset+warp1+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0744 + 0.1479 * presence + 0.4600 * pattern + 0.1543 * (1.0 - deepTrans), 0.8521);
