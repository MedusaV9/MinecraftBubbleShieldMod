...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.005000, 0.016667) * time, time);
    deep += 0.5168 * deepField(duvBase + rimDir * 0.0403 + vec2(-0.007500, 0.026667) * time, time);
    deep = pow(clamp(deep * 0.6593, 0.0, 1.0), 1.0923);
