...
void main() {
    ...
    deepCol += 0.5168 * dp * mix(baseCol, deepStop, 0.4414);
    deepPat += 0.5168 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 3.5127) + par * 0.0806, time);
    deepCol += 0.2671 * dp * mix(baseCol, deepStop, 0.8828);
    deepPat += 0.2671 * dp;
    deepCol *= 0.6417;
    deepPat = pow(clamp(deepPat * 0.5606, 0.0, 1.0), 1.0923);
    ...
    rgb += hotStop * 0.1903 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0779 + 0.2718 * presence + 0.3497 * pattern, 0.8425);
