...
void main() {
    ...
    mid = clamp(mid * (0.6806 + 0.4811 * texDetail) + 0.2865 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7772 + 0.4407 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1413 * (0.5 + 0.5 * sin(time * 0.240855)));
    rgb += emit * 0.7623 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4402 + 0.4118 * presence + 0.3497 * pattern + 0.0936 * (1.0 - deepTrans) + 0.1369 * emit, 0.9025);
