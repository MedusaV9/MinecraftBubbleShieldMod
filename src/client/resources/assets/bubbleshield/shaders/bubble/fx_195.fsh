...
// stack: deep=ridge x3 taps | mid=aurora+none+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0779 + 0.2718 * presence + 0.3497 * pattern + 0.0936 * (1.0 - deepTrans), 0.8425);
