...
// stack: deep=caustic x4 taps | mid=voronoi+warp2+flicker | rim=graze_film | flourish=shimmer | tex=worley_cells
// fbm: standard x5 octaves | seed 8b180f2fb370635b
// v8 realism: refr 0.5517+0.4428*fres/dist (cap 0.1163) | energy 0.3923+0.5348*p | flow 0.116667 c/s | soft 1.0449m
...
void main() {
    ...
    float refrAmp = min((0.5517 + 0.4428 * fresnel) / max(length(worldPos), 1.0), 0.1163);
