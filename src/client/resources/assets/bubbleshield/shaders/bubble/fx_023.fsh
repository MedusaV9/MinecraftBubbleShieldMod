...
// stack: deep=caustic x4 taps | mid=voronoi+warp2+flicker | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0592 + 0.3666 * presence + 0.3805 * pattern + 0.1363 * (1.0 - deepTrans), 0.8596);
