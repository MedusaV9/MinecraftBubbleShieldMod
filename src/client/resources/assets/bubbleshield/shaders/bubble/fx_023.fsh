...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8180, 0.0, 1.0);
    ...
    deepCol += 0.3868 * dp * mix(baseCol, deepStop, 0.2119);
    deepPat += 0.3868 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 4.7917) + par * 0.1573, time);
    deepCol += 0.1496 * dp * mix(baseCol, deepStop, 0.4238);
    deepPat += 0.1496 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 6.0970) + par * 0.2359, time);
    deepCol += 0.0579 * dp * mix(baseCol, deepStop, 0.6358);
    deepPat += 0.0579 * dp;
    deepCol *= 0.7416;
    deepPat = pow(clamp(deepPat * 0.6272, 0.0, 1.0), 1.0875);
    ...
    rgb += hotStop * 0.1926 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0592 + 0.3666 * presence + 0.3805 * pattern, 0.8596);
