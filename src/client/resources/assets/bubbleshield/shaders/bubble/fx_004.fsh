...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7349, 0.0, 1.0);
    ...
    deepCol += 0.4535 * dp * mix(baseCol, deepStop, 0.3349);
    deepPat += 0.4535 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.7720) + par * 0.1284, time);
    deepCol += 0.2056 * dp * mix(baseCol, deepStop, 0.6697);
    deepPat += 0.2056 * dp;
    deepCol *= 0.7322;
    deepPat = pow(clamp(deepPat * 0.6027, 0.0, 1.0), 1.3120);
    ...
    rgb += hotStop * 0.2099 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0499 + 0.3531 * presence + 0.3667 * pattern, 0.8167);
