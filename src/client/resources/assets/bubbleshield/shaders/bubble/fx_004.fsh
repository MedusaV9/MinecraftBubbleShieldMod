...
// stack: deep=caustic x3 taps | mid=sparkle+warp1+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0499 + 0.3531 * presence + 0.3667 * pattern + 0.1442 * (1.0 - deepTrans), 0.8167);
