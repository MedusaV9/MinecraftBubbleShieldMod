...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.048333, 0.020000) * time, time);
    deep += 0.4535 * deepField(duvBase + rimDir * 0.0642 + vec2(-0.075000, 0.030000) * time, time);
    deep = pow(clamp(deep * 0.6880, 0.0, 1.0), 1.3120);
