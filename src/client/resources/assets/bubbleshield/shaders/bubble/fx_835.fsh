...
// stack: deep=fbm x4 taps | mid=runecircuit+warp2+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0638 + 0.1728 * presence + 0.5667 * pattern + 0.1551 * (1.0 - deepTrans), 0.8171);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2097), 0.8171);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4878 + 0.5122 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
