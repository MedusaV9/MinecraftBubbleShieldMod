...
// stack: deep=voro x3 taps | mid=plasmaglobe+curl+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0771 + 0.1015 * presence + 0.6236 * pattern + 0.1236 * (1.0 - deepTrans), 0.8659);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2555), 0.8659);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4644 + 0.5356 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
