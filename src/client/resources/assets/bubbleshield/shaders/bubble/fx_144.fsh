...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7468, 0.0, 1.0);
    ...
    deepCol += 0.4592 * dp * mix(baseCol, deepStop, 0.4059);
    deepPat += 0.4592 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 4.6560) + par * 0.0839, time);
    deepCol += 0.2109 * dp * mix(baseCol, deepStop, 0.8118);
    deepPat += 0.2109 * dp;
    deepCol *= 0.7494;
    deepPat = pow(clamp(deepPat * 0.5987, 0.0, 1.0), 1.2083);
    ...
    float alpha = vertexColor.a * min(0.0729 + 0.2411 * presence + 0.4628 * pattern, 0.7988);
