...
void main() {
    ...
    mid = clamp(mid * (0.6233 + 0.5971 * texDetail) + 0.3013 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4867), 0.0, 1.0);
    float emit = atlas.a * (0.5578 + 0.3023 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1378 * (0.5 + 0.5 * sin(time * 0.282743)));
    ...
    float alpha = vertexColor.a * min(0.4254 + 0.3811 * presence + 0.4628 * pattern + 0.1093 * (1.0 - deepTrans) + 0.1303 * emit, 0.8588);
