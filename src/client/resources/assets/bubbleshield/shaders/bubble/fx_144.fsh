...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.544543);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.023333, 0.037500) * time, time);
    deep += 0.4592 * deepField(duvBase + rimDir * 0.0420 + vec2(0.036667, 0.057500) * time, time);
    deep += 0.2109 * deepField(duvBase + rimDir * 0.0839 + vec2(0.048333, 0.077500) * time, time);
    deep = pow(clamp(deep * 0.5987, 0.0, 1.0), 1.2083);
