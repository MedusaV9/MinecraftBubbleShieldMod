...
// stack: deep=ridge x4 taps | mid=holoparallax+warp1+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0429 + 0.1258 * presence + 0.5604 * pattern + 0.1161 * (1.0 - deepTrans), 0.7915);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2863), 0.7915);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4675 + 0.5325 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
