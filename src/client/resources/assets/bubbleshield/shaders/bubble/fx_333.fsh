...
// stack: deep=voro x3 taps | mid=starfield+curl+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0800 + 0.1694 * presence + 0.5873 * pattern + 0.1523 * (1.0 - deepTrans), 0.8241);
