...
// stack: deep=caustic x3 taps | mid=voidrift+warp1+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0712 + 0.1888 * presence + 0.4835 * pattern + 0.0900 * (1.0 - deepTrans), 0.8198);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2903), 0.8198);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4311 + 0.5689 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
