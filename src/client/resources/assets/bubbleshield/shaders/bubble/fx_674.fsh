...
// stack: deep=voro x4 taps | mid=deepice+warp2+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0530 + 0.3307 * presence + 0.3760 * pattern + 0.1449 * (1.0 - deepTrans), 0.8826);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2921), 0.8826);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4113 + 0.5887 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
