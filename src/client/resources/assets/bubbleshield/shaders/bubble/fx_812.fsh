...
// stack: deep=caustic x3 taps | mid=mycelia+warp2+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0584 + 0.1507 * presence + 0.5529 * pattern + 0.0836 * (1.0 - deepTrans), 0.7991);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3057), 0.7991);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4459 + 0.5541 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
