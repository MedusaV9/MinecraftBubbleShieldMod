...
// stack: deep=caustic x3 taps | mid=mycelia+warp2+scroll | rim=graze | flourish=echo | tex=filaments
// fbm: ridged x5 octaves | seed 7a75321393f469ea
// v8 realism: refr 0.3711+0.4202*fres/dist (cap 0.1408) | energy 0.4694+0.4406*p | flow 0.056667 c/s | soft 0.6224m
...
void main() {
    ...
    float refrAmp = min((0.3711 + 0.4202 * fresnel) / max(length(worldPos), 1.0), 0.1408);
