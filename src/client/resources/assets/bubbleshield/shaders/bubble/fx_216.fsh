...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.011667, -0.045000) * time, time);
    deep += 0.3888 * deepField(duvBase + rimDir * 0.0561 + vec2(-0.018333, -0.067500) * time, time);
    deep += 0.1512 * deepField(duvBase + rimDir * 0.1123 + vec2(-0.025000, -0.092500) * time, time);
    deep = pow(clamp(deep * 0.6494, 0.0, 1.0), 1.1672);
