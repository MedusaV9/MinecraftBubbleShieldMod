...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5581, 0.0, 1.0);
    ...
    deepCol += 0.3888 * dp * mix(baseCol, deepStop, 0.4041);
    deepPat += 0.3888 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 4.9580) + par * 0.1123, time);
    deepCol += 0.1512 * dp * mix(baseCol, deepStop, 0.8081);
    deepPat += 0.1512 * dp;
    deepCol *= 0.8046;
    deepPat = pow(clamp(deepPat * 0.6494, 0.0, 1.0), 1.1672);
    ...
    rgb += hotStop * 0.2939 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0786 + 0.2966 * presence + 0.4277 * pattern, 0.8261);
