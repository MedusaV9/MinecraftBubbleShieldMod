...
// stack: deep=fbm x4 taps | mid=vortex+warp2+rotate | rim=graze_sparkle | flourish=shimmer | tex=marble_ink
// fbm: turb x5 octaves | seed 1dfc1f5b36cc4d07
// v8 realism: refr 0.5325+0.5042*fres/dist (cap 0.1484) | energy 0.4044+0.4378*p | flow 0.113333 c/s | soft 0.6689m
...
void main() {
    ...
    float refrAmp = min((0.5325 + 0.5042 * fresnel) / max(length(worldPos), 1.0), 0.1484);
