...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.003333, -0.015000) * time, time);
    deep += 0.4066 * deepField(duvBase + rimDir * 0.0373 + vec2(0.005000, -0.025000) * time, time);
    deep += 0.1653 * deepField(duvBase + rimDir * 0.0747 + vec2(0.006667, -0.032500) * time, time);
    deep += 0.0672 * deepField(duvBase + rimDir * 0.1120 + vec2(0.010000, -0.040000) * time, time);
    deep = pow(clamp(deep * 0.6101, 0.0, 1.0), 1.3074);
