...
// stack: deep=fbm x4 taps | mid=petals+warp2+pulse | rim=graze_sparkle | flourish=shimmer | tex=scales
// fbm: turb x5 octaves | seed fa558234772bdd80
// v8 realism: refr 0.6426+0.6092*fres/dist (cap 0.1290) | energy 0.4003+0.4314*p | flow 0.074167 c/s | soft 0.9825m
...
void main() {
    ...
    float refrAmp = min((0.6426 + 0.6092 * fresnel) / max(length(worldPos), 1.0), 0.1290);
