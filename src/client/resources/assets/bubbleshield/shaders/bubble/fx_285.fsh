...
void main() {
    ...
    mid = clamp(mid * (0.6857 + 0.6105 * texDetail) + 0.2400 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7586 + 0.3867 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1032 * (0.5 + 0.5 * sin(time * 0.256563)));
    rgb += emit * 0.8519 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4303 + 0.5063 * presence + 0.3687 * pattern + 0.1353 * (1.0 - deepTrans) + 0.1873 * emit, 0.8577);
