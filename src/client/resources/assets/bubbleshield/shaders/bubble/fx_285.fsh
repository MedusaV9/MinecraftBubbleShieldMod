...
// stack: deep=caustic x4 taps | mid=moire+curl+rotate | rim=graze_sparkle | flourish=swirl | tex=chrome
// fbm: ridged x4 octaves | seed a0c0c7ad490617ef
// v8 realism: refr 0.7951+0.8935*fres/dist (cap 0.1083) | energy 0.2252+0.4507*p | flow 0.070000 c/s | soft 0.5024m
...
void main() {
    ...
    float refrAmp = min((0.7951 + 0.8935 * fresnel) / max(length(worldPos), 1.0), 0.1083);
