...
// stack: deep=ridge x3 taps | mid=aethersmoke+warp2+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2184), 0.8450);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4373 + 0.5627 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
