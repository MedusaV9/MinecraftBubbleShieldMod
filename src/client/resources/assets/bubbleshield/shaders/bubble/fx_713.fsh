...
// stack: deep=voro x4 taps | mid=solarflare+curl+scroll | rim=graze | flourish=echo | tex=worley_cells
// fbm: standard x6 octaves | seed bbee78fe5f95601c
// v8 realism: refr 0.5108+0.5268*fres/dist (cap 0.1439) | energy 0.3871+0.5082*p | flow 0.090833 c/s | soft 0.7872m
...
void main() {
    ...
    float refrAmp = min((0.5108 + 0.5268 * fresnel) / max(length(worldPos), 1.0), 0.1439);
