...
// stack: deep=voro x4 taps | mid=solarflare+curl+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0563 + 0.1926 * presence + 0.5824 * pattern + 0.0812 * (1.0 - deepTrans), 0.8523);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2742), 0.8523);
    // [layer:v5:ghostalpha]
