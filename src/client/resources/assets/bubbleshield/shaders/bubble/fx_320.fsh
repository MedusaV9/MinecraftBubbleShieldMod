...
void main() {
    ...
    mid = clamp(mid * (0.6623 + 0.5319 * texDetail) + 0.1804 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5892 + 0.4239 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1475 * (0.5 + 0.5 * sin(time * 0.287979)));
    rgb += emit * 0.7141 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3763 + 0.4722 * presence + 0.3711 * pattern + 0.0832 * (1.0 - deepTrans) + 0.1968 * emit, 0.8891);
