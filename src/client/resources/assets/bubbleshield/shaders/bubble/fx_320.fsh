...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.048333, 0.025000) * time, time);
    deep += 0.5453 * deepField(duvBase + rimDir * 0.0510 + vec2(-0.075000, 0.037500) * time, time);
    deep += 0.2973 * deepField(duvBase + rimDir * 0.1020 + vec2(-0.101667, 0.050000) * time, time);
    deep = pow(clamp(deep * 0.5427, 0.0, 1.0), 1.2482);
