...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7306, 0.0, 1.0);
    ...
    deepCol += 0.5453 * dp * mix(baseCol, deepStop, 0.4385);
    deepPat += 0.5453 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 4.3320) + par * 0.1020, time);
    deepCol += 0.2973 * dp * mix(baseCol, deepStop, 0.8769);
    deepPat += 0.2973 * dp;
    deepCol *= 0.7046;
    deepPat = pow(clamp(deepPat * 0.5427, 0.0, 1.0), 1.2482);
    ...
    rgb += hotStop * 0.3190 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0563 + 0.3322 * presence + 0.3711 * pattern, 0.8291);
