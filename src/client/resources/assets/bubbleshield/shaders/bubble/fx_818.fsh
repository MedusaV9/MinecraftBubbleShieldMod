...
// stack: deep=voro x3 taps | mid=ectoplasm+none+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0450 + 0.1624 * presence + 0.5297 * pattern + 0.1195 * (1.0 - deepTrans), 0.8070);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1520), 0.8070);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4179 + 0.5821 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
