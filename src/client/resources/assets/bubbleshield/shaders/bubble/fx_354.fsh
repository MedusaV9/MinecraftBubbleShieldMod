...
// stack: deep=fbm x4 taps | mid=tendrilnet+curl+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0491 + 0.1515 * presence + 0.4817 * pattern + 0.1208 * (1.0 - deepTrans), 0.8234);
