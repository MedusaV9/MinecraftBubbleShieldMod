...
void main() {
    ...
    mid = clamp(mid * (0.6751 + 0.6176 * texDetail) + 0.1980 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3512), 0.0, 1.0);
    float emit = atlas.a * (0.7070 + 0.4815 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1069 * (0.5 + 0.5 * sin(time * 0.146608)));
    ...
    float alpha = vertexColor.a * min(0.2958 + 0.2915 * presence + 0.4817 * pattern + 0.1208 * (1.0 - deepTrans) + 0.2122 * emit, 0.8834);
