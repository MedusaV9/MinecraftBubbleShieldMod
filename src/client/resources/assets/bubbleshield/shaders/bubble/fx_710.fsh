...
// stack: deep=caustic x4 taps | mid=phantomecho+warp2+rotate | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0757 + 0.1044 * presence + 0.4844 * pattern + 0.1175 * (1.0 - deepTrans), 0.8033);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2718), 0.8033);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3836 + 0.6164 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
