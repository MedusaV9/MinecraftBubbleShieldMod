...
// stack: deep=fbm x4 taps | mid=waves+warp2+pulse | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0407 + 0.2922 * presence + 0.3357 * pattern + 0.1347 * (1.0 - deepTrans), 0.8261);
