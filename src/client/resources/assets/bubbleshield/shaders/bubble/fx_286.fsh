...
// stack: deep=fbm x4 taps | mid=waves+warp2+pulse | rim=lat | flourish=shimmer | tex=caustic_web
// fbm: turb x5 octaves | seed c9dcfb3c1952cb71
// v8 realism: refr 0.9792+1.0884*fres/dist (cap 0.1264) | energy 0.2290+0.3769*p | flow 0.118333 c/s | soft 0.6807m
...
void main() {
    ...
    float refrAmp = min((0.9792 + 1.0884 * fresnel) / max(length(worldPos), 1.0), 0.1264);
