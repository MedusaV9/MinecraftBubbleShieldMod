...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6796, 0.0, 1.0);
    ...
    deepCol += 0.4394 * dp * mix(baseCol, deepStop, 0.2253);
    deepPat += 0.4394 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 3.6407) + par * 0.0946, time);
    deepCol += 0.1931 * dp * mix(baseCol, deepStop, 0.4507);
    deepPat += 0.1931 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 4.3764) + par * 0.1419, time);
    deepCol += 0.0848 * dp * mix(baseCol, deepStop, 0.6760);
    deepPat += 0.0848 * dp;
    deepCol *= 0.6969;
    deepPat = pow(clamp(deepPat * 0.5823, 0.0, 1.0), 1.6017);
    ...
    float alpha = vertexColor.a * min(0.0407 + 0.2922 * presence + 0.3357 * pattern, 0.8261);
