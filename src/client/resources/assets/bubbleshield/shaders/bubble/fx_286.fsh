...
void main() {
    ...
    deep += 0.4394 * deepField(duvBase + rimDir * 0.0473 + vec2(0.048333, -0.025000) * time, time);
    deep += 0.1931 * deepField(duvBase + rimDir * 0.0946 + vec2(0.065000, -0.032500) * time, time);
    deep = pow(clamp(deep * 0.6126, 0.0, 1.0), 1.6017);
