...
void main() {
    ...
    float flourish = 0.3494 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.5984 + fiR.y * 0.5634)), 0.3538);
    ...
    float alpha = vertexColor.a * min(0.0762 + 0.3344 * presence + 0.4462 * pattern + 0.1114 * (1.0 - deepTrans), 0.8158);
    // [layer:v5:backface]
