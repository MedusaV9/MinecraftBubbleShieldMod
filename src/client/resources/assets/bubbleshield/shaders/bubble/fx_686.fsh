...
// stack: deep=fbm x3 taps | mid=fluidink+warp1+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0762 + 0.2744 * presence + 0.4462 * pattern + 0.1114 * (1.0 - deepTrans), 0.8158);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3482), 0.8158);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5004 + 0.4996 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
