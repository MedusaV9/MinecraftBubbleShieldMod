...
// stack: deep=fbm x3 taps | mid=biolume+none+pulse | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0441 + 0.1748 * presence + 0.5657 * pattern + 0.1172 * (1.0 - deepTrans), 0.8184);
