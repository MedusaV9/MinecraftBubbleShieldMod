...
// stack: deep=fbm x3 taps | mid=voronoi+curl+scroll | rim=graze | flourish=swirl | tex=worley_cells
// fbm: turb x4 octaves | seed d0d8931a95c01658
// v8 realism: refr 0.6141+0.5865*fres/dist (cap 0.1581) | energy 0.3704+0.5181*p | flow 0.095833 c/s | soft 0.5838m
...
void main() {
    ...
    float refrAmp = min((0.6141 + 0.5865 * fresnel) / max(length(worldPos), 1.0), 0.1581);
