...
// stack: deep=fbm x3 taps | mid=voronoi+curl+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0471 + 0.3438 * presence + 0.3529 * pattern + 0.1096 * (1.0 - deepTrans), 0.8474);
