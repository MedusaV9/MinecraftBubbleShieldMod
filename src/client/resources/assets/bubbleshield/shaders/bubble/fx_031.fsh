...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5792, 0.0, 1.0);
    ...
    deepCol += 0.4771 * dp * mix(baseCol, deepStop, 0.3499);
    deepPat += 0.4771 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 3.6663) + par * 0.0969, time);
    deepCol += 0.2276 * dp * mix(baseCol, deepStop, 0.6998);
    deepPat += 0.2276 * dp;
    deepCol *= 0.6348;
    deepPat = pow(clamp(deepPat * 0.5866, 0.0, 1.0), 1.7710);
    ...
    float alpha = vertexColor.a * min(0.0471 + 0.3438 * presence + 0.3529 * pattern, 0.8474);
