...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.023333, -0.036667) * time, time);
    deep += 0.4771 * deepField(duvBase + rimDir * 0.0485 + vec2(-0.035833, -0.058333) * time, time);
    deep = pow(clamp(deep * 0.6770, 0.0, 1.0), 1.7710);
