...
void main() {
    ...
    deepCol += 0.5741 * dp * mix(baseCol, deepStop, 0.2964);
    deepPat += 0.5741 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.3636) + par * 0.0979, time);
    deepCol += 0.3296 * dp * mix(baseCol, deepStop, 0.5928);
    deepPat += 0.3296 * dp;
    deepCol *= 0.5892;
    deepPat = pow(clamp(deepPat * 0.5253, 0.0, 1.0), 1.3205);
    ...
    rgb += hotStop * 0.3338 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0461 + 0.2586 * presence + 0.4072 * pattern, 0.7992);
