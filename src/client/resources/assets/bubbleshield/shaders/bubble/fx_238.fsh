...
// stack: deep=fbm x3 taps | mid=vortex+none+pulse | rim=graze_sparkle | flourish=glint | tex=marble_ink
// fbm: ridged x6 octaves | seed abeeaeccde1fa6df
// v8 realism: refr 0.7071+0.7459*fres/dist (cap 0.1050) | energy 0.3077+0.5483*p | flow 0.050833 c/s | soft 0.5604m
...
void main() {
    ...
    float refrAmp = min((0.7071 + 0.7459 * fresnel) / max(length(worldPos), 1.0), 0.1050);
