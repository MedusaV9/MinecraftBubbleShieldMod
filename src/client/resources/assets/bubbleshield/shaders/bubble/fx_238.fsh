...
// stack: deep=fbm x3 taps | mid=vortex+none+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0461 + 0.2586 * presence + 0.4072 * pattern + 0.0950 * (1.0 - deepTrans), 0.7992);
