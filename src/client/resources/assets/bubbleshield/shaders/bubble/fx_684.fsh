...
// stack: deep=fbm x4 taps | mid=orbittrap+warp1+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0746 + 0.1524 * presence + 0.5192 * pattern + 0.0831 * (1.0 - deepTrans), 0.8083);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2426), 0.8083);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4782 + 0.5218 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
