...
// stack: deep=caustic x4 taps | mid=solarflare+warp2+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0739 + 0.1913 * presence + 0.5560 * pattern + 0.1231 * (1.0 - deepTrans), 0.8436);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1628), 0.8436);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4906 + 0.5094 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
