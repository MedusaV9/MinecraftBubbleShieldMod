...
// stack: deep=caustic x4 taps | mid=solarflare+warp2+rotate | rim=graze_film | flourish=swirl | tex=worley_cells
// fbm: ridged x5 octaves | seed efac4a169239b4a2
// v8 realism: refr 0.6406+0.7129*fres/dist (cap 0.1593) | energy 0.3478+0.4032*p | flow 0.076667 c/s | soft 0.7203m
...
void main() {
    ...
    float refrAmp = min((0.6406 + 0.7129 * fresnel) / max(length(worldPos), 1.0), 0.1593);
