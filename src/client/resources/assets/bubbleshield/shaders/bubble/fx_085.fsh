...
float fbm2(vec2 p, vec2 per) {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        p = vec2(p.x * 2.0, p.y * 2.1027) + vec2(17.7, 9.2);
        per = vec2(per.x * 2.0, per.y * 2.1027);
        amplitude *= 0.5;
    }
    return value;
}
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.020833, -0.045000) * time, time);
    deep += 0.4095 * deepField(duvBase + rimDir * 0.0401 + vec2(-0.032500, -0.070000) * time, time);
    deep += 0.1677 * deepField(duvBase + rimDir * 0.0802 + vec2(-0.044167, -0.095000) * time, time);
    deep = pow(clamp(deep * 0.6340, 0.0, 1.0), 1.1163);
