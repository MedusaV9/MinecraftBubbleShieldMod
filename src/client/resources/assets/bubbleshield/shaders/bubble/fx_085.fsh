...
// stack: deep=fbm x4 taps | mid=circuit+curl+rotate | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0522 + 0.2409 * presence + 0.3648 * pattern + 0.0842 * (1.0 - deepTrans), 0.8444);
