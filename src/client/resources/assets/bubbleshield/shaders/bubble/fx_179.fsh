...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.047500, -0.013333) * time, time);
    deep += 0.5507 * deepField(duvBase + rimDir * 0.0433 + vec2(-0.073333, -0.020000) * time, time);
    deep += 0.3033 * deepField(duvBase + rimDir * 0.0865 + vec2(-0.100000, -0.026667) * time, time);
    deep = pow(clamp(deep * 0.5394, 0.0, 1.0), 1.5780);
    ...
    float pattern = clamp(0.3426 * deep + 0.9927 * mid + 0.8015 * rim + flourish + grain, 0.0, 1.5);
    vec3 accent = accentPalette(0.1408 + pattern * 0.5282);
    vec3 rgb = vertexColor.rgb * (0.4602 + 0.9213 * pattern);
    ...
    float alpha = vertexColor.a * clamp(0.2108 + 0.8090 * pattern, 0.0, 1.0);
