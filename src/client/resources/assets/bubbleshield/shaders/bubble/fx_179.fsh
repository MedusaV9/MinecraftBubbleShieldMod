...
// stack: deep=caustic x3 taps | mid=aurora+warp2+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0437 + 0.3357 * presence + 0.4783 * pattern + 0.1544 * (1.0 - deepTrans), 0.8440);
