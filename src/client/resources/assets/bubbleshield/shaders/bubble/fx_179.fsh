...
// stack: deep=caustic x3 taps | mid=aurora+warp2+rotate | rim=graze_sparkle | flourish=shimmer | tex=filaments
// fbm: standard x6 octaves | seed 0625298065b8829f
// v8 realism: refr 0.5061+0.6944*fres/dist (cap 0.1411) | energy 0.4087+0.5269*p | flow 0.058333 c/s | soft 0.6850m
...
void main() {
    ...
    float refrAmp = min((0.5061 + 0.6944 * fresnel) / max(length(worldPos), 1.0), 0.1411);
