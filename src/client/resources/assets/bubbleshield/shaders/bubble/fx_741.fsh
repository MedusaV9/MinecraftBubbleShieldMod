...
// stack: deep=fbm x4 taps | mid=raymarchfog+none+scroll | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0632 + 0.2591 * presence + 0.3891 * pattern + 0.0975 * (1.0 - deepTrans), 0.8486);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2702), 0.8486);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4255 + 0.5745 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
