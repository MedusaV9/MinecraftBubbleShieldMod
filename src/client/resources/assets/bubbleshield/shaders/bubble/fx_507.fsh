...
// stack: deep=fbm x4 taps | mid=irisfilm+warp1+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0651 + 0.2425 * presence + 0.4139 * pattern + 0.1455 * (1.0 - deepTrans), 0.7756);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1680), 0.7756);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5276 + 0.4724 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
