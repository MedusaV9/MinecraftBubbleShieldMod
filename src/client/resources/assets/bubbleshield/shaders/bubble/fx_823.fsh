...
// stack: deep=ridge x3 taps | mid=holoparallax+none+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0583 + 0.1016 * presence + 0.5950 * pattern + 0.1268 * (1.0 - deepTrans), 0.8441);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2419), 0.8441);
    // [layer:v5:ghostalpha]
