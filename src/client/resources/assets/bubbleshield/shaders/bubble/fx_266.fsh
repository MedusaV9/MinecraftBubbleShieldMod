...
// stack: deep=caustic x4 taps | mid=voronoi+curl+rotate | rim=lat | flourish=echo | tex=worley_cells
// fbm: standard x5 octaves | seed f35e731e63be2265
// v8 realism: refr 0.6299+0.8967*fres/dist (cap 0.1161) | energy 0.3022+0.5299*p | flow 0.112500 c/s | soft 0.6412m
...
void main() {
    ...
    float refrAmp = min((0.6299 + 0.8967 * fresnel) / max(length(worldPos), 1.0), 0.1161);
