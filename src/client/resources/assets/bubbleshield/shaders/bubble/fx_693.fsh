...
// stack: deep=caustic x3 taps | mid=solarflare+warp1+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0608 + 0.1527 * presence + 0.5976 * pattern + 0.1424 * (1.0 - deepTrans), 0.8020);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1619), 0.8020);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4435 + 0.5565 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
