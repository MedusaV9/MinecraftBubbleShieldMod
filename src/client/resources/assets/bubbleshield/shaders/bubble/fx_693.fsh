...
// v8 realism: refr 0.4736+0.3958*fres/dist (cap 0.1223) | energy 0.4013+0.4040*p | flow 0.078333 c/s | soft 0.5759m
...
void main() {
    ...
    float refrAmp = min((0.4736 + 0.3958 * fresnel) / max(length(worldPos), 1.0), 0.1223);
