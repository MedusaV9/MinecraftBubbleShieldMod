...
// stack: deep=fbm x3 taps | mid=plasmaglobe+warp1+scroll | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0472 + 0.1169 * presence + 0.6345 * pattern + 0.1102 * (1.0 - deepTrans), 0.8456);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3416), 0.8456);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4819 + 0.5181 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
