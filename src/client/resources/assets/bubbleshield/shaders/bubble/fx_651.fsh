...
// stack: deep=voro x4 taps | mid=gravlens+warp1+flicker | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0653 + 0.0909 * presence + 0.5590 * pattern + 0.0994 * (1.0 - deepTrans), 0.7955);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1597), 0.7955);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3898 + 0.6102 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
