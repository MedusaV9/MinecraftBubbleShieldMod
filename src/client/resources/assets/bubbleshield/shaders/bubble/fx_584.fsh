...
// stack: deep=voro x3 taps | mid=orbittrap+curl+pulse | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0476 + 0.1231 * presence + 0.4951 * pattern + 0.1421 * (1.0 - deepTrans), 0.8241);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3343), 0.8241);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4006 + 0.5994 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
