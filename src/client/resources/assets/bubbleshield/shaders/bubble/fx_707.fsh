...
// stack: deep=fbm x4 taps | mid=irisfilm+warp2+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0729 + 0.2581 * presence + 0.4288 * pattern + 0.0963 * (1.0 - deepTrans), 0.7502);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1811), 0.7502);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4911 + 0.5089 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
