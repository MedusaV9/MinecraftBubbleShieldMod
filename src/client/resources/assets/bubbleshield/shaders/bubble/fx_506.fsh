...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.8944 + fiR.y * 0.7529)), 0.3027);
    ...
    float alpha = vertexColor.a * min(0.0681 + 0.2853 * presence + 0.4403 * pattern + 0.1022 * (1.0 - deepTrans), 0.8338);
    // [layer:v5:backface]
