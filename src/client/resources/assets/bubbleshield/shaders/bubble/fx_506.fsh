...
// stack: deep=ridge x3 taps | mid=fluidink+curl+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0681 + 0.2253 * presence + 0.4403 * pattern + 0.1022 * (1.0 - deepTrans), 0.8338);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3285), 0.8338);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4530 + 0.5470 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
