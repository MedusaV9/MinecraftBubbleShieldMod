...
// stack: deep=voro x3 taps | mid=stainedglass+none+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.3847 * presence + 0.3850 * pattern + 0.1096 * (1.0 - deepTrans), 0.8537);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1841), 0.8537);
    // [layer:v5:ghostalpha]
