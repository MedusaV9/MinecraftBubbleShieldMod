...
void main() {
    ...
    mid = clamp(mid * (0.7018 + 0.5893 * texDetail) + 0.2794 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7784 + 0.3224 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1514 * (0.5 + 0.5 * sin(time * 0.193732)));
    rgb += emit * 0.9408 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3361 + 0.4070 * presence + 0.4614 * pattern + 0.1080 * (1.0 - deepTrans) + 0.1257 * emit, 0.9151);
