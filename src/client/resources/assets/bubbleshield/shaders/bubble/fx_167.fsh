...
// stack: deep=fbm x3 taps | mid=arcs+none+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0427 + 0.2670 * presence + 0.4614 * pattern + 0.1080 * (1.0 - deepTrans), 0.8551);
