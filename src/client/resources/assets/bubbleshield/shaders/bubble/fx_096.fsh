...
void main() {
    ...
    mid = clamp(mid * (0.6313 + 0.6976 * texDetail) + 0.2599 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7303 + 0.3041 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0911 * (0.5 + 0.5 * sin(time * 0.240855)));
    rgb += emit * 0.8957 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4014 + 0.4648 * presence + 0.3701 * pattern + 0.1401 * (1.0 - deepTrans) + 0.1976 * emit, 0.9109);
