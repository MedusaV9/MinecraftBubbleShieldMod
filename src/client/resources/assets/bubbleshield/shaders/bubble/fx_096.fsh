...
// stack: deep=fbm x4 taps | mid=waves+none+pulse | rim=graze_film | flourish=shimmer | tex=caustic_web
// fbm: turb x3 octaves | seed 022f0d13815b878f
// v8 realism: refr 0.9646+1.0493*fres/dist (cap 0.1246) | energy 0.1883+0.4751*p | flow 0.079167 c/s | soft 0.8576m
...
void main() {
    ...
    float refrAmp = min((0.9646 + 1.0493 * fresnel) / max(length(worldPos), 1.0), 0.1246);
