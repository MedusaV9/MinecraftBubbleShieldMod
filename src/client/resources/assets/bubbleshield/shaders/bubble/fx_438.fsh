...
// stack: deep=caustic x4 taps | mid=ectoplasm+none+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0413 + 0.1639 * presence + 0.4507 * pattern + 0.1244 * (1.0 - deepTrans), 0.8495);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2323), 0.8495);
    // [layer:v5:ghostalpha]
