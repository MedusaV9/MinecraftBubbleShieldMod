...
// stack: deep=ridge x4 taps | mid=starfield+none+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0490 + 0.1141 * presence + 0.5020 * pattern + 0.1557 * (1.0 - deepTrans), 0.8054);
