...
// stack: deep=ridge x3 taps | mid=plasma+warp2+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0672 + 0.2945 * presence + 0.3942 * pattern + 0.1459 * (1.0 - deepTrans), 0.8005);
