...
// stack: deep=voro x3 taps | mid=gravlens+warp1+rotate | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0725 + 0.1346 * presence + 0.5329 * pattern + 0.1149 * (1.0 - deepTrans), 0.8286);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2876), 0.8286);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4235 + 0.5765 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
