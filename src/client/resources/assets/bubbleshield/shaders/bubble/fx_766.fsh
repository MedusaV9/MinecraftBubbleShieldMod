...
// stack: deep=fbm x4 taps | mid=fluidink+warp1+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0799 + 0.2253 * presence + 0.3775 * pattern + 0.1371 * (1.0 - deepTrans), 0.7864);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2769), 0.7864);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4997 + 0.5003 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
