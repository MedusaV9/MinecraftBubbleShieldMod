...
// stack: deep=ridge x4 taps | mid=oilslick+none+flicker | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0637 + 0.2669 * presence + 0.3591 * pattern + 0.1179 * (1.0 - deepTrans), 0.8088);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2470), 0.8088);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5455 + 0.4545 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
