...
// stack: deep=caustic x3 taps | mid=gravlens+warp2+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0452 + 0.1342 * presence + 0.4837 * pattern + 0.1574 * (1.0 - deepTrans), 0.8450);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2024), 0.8450);
    // [layer:v5:ghostalpha]
