...
// stack: deep=fbm x4 taps | mid=voronoi+warp1+rotate | rim=graze | flourish=glint | tex=worley_cells
// fbm: turb x4 octaves | seed 803c8a044ce564b6
// v8 realism: refr 0.5716+0.8494*fres/dist (cap 0.1320) | energy 0.3630+0.4023*p | flow 0.104167 c/s | soft 0.6432m
...
void main() {
    ...
    float refrAmp = min((0.5716 + 0.8494 * fresnel) / max(length(worldPos), 1.0), 0.1320);
