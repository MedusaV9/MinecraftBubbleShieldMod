...
// stack: deep=fbm x4 taps | mid=voronoi+warp1+rotate | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0537 + 0.2405 * presence + 0.3411 * pattern + 0.1318 * (1.0 - deepTrans), 0.8213);
