...
// stack: deep=ridge x3 taps | mid=phantomecho+curl+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0682 + 0.0872 * presence + 0.5123 * pattern + 0.1041 * (1.0 - deepTrans), 0.7835);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3334), 0.7835);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5449 + 0.4551 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
