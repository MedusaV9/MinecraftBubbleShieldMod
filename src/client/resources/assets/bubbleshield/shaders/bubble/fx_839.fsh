...
// stack: deep=caustic x3 taps | mid=voidrift+none+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0769 + 0.1788 * presence + 0.4283 * pattern + 0.1040 * (1.0 - deepTrans), 0.7887);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1822), 0.7887);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3833 + 0.6167 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
