...
// stack: deep=caustic x4 taps | mid=voidrift+curl+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0722 + 0.2322 * presence + 0.4260 * pattern + 0.1449 * (1.0 - deepTrans), 0.8492);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1609), 0.8492);
    // [layer:v5:ghostalpha]
