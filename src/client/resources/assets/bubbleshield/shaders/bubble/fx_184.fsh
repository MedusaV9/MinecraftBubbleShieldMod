...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6677, 0.0, 1.0);
    ...
    deepCol += 0.3947 * dp * mix(baseCol, deepStop, 0.2210);
    deepPat += 0.3947 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 3.3892) + par * 0.1372, time);
    deepCol += 0.1557 * dp * mix(baseCol, deepStop, 0.4420);
    deepPat += 0.1557 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 4.2037) + par * 0.2058, time);
    deepCol += 0.0615 * dp * mix(baseCol, deepStop, 0.6630);
    deepPat += 0.0615 * dp;
    deepCol *= 0.7111;
    deepPat = pow(clamp(deepPat * 0.6204, 0.0, 1.0), 1.4019);
    ...
    rgb += hotStop * 0.3013 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0416 + 0.2842 * presence + 0.4149 * pattern, 0.8092);
