...
// stack: deep=caustic x4 taps | mid=scales+none+rotate | rim=graze_sparkle | flourish=swirl | tex=scales
// fbm: standard x3 octaves | seed a03121a0d1a852c6
// v8 realism: refr 0.6306+0.7647*fres/dist (cap 0.1423) | energy 0.3594+0.4560*p | flow 0.057500 c/s | soft 0.6779m
...
void main() {
    ...
    float refrAmp = min((0.6306 + 0.7647 * fresnel) / max(length(worldPos), 1.0), 0.1423);
