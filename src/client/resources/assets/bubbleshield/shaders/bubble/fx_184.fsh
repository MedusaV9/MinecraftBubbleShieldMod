...
void main() {
    ...
    mid = clamp(mid * (0.6110 + 0.5253 * texDetail) + 0.3216 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4787), 0.0, 1.0);
    float emit = atlas.a * (0.7809 + 0.3359 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1062 * (0.5 + 0.5 * sin(time * 0.157080)));
    ...
    float alpha = vertexColor.a * min(0.3327 + 0.4242 * presence + 0.4149 * pattern + 0.1347 * (1.0 - deepTrans) + 0.1284 * emit, 0.8692);
