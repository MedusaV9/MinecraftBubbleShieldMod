...
// stack: deep=ridge x4 taps | mid=irisfilm+curl+pulse | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0584 + 0.2024 * presence + 0.4331 * pattern + 0.0855 * (1.0 - deepTrans), 0.8229);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1864), 0.8229);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3871 + 0.6129 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
