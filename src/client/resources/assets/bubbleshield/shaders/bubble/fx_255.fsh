...
// stack: deep=caustic x3 taps | mid=lightning+warp1+flicker | rim=graze_film | flourish=shimmer | tex=filaments
// fbm: standard x6 octaves | seed 0b465183872a2d11
// v8 realism: refr 0.6892+0.6118*fres/dist (cap 0.1214) | energy 0.3131+0.4089*p | flow 0.081667 c/s | soft 0.5088m
...
void main() {
    ...
    float refrAmp = min((0.6892 + 0.6118 * fresnel) / max(length(worldPos), 1.0), 0.1214);
