...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6705, 0.0, 1.0);
    ...
    deepCol += 0.4380 * dp * mix(baseCol, deepStop, 0.3004);
    deepPat += 0.4380 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 3.7826) + par * 0.0931, time);
    deepCol += 0.1918 * dp * mix(baseCol, deepStop, 0.6009);
    deepPat += 0.1918 * dp;
    deepCol *= 0.7729;
    deepPat = pow(clamp(deepPat * 0.6136, 0.0, 1.0), 1.4464);
    ...
    rgb += hotStop * 0.1545 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0649 + 0.2722 * presence + 0.3346 * pattern, 0.8179);
