...
// stack: deep=voro x3 taps | mid=ridged+curl+flicker | rim=graze | flourish=echo | tex=ridged
// fbm: ridged x3 octaves | seed 7e9211b15694efb1
// v8 realism: refr 0.5845+0.5957*fres/dist (cap 0.1208) | energy 0.3534+0.4759*p | flow 0.052500 c/s | soft 0.5724m
...
void main() {
    ...
    float refrAmp = min((0.5845 + 0.5957 * fresnel) / max(length(worldPos), 1.0), 0.1208);
