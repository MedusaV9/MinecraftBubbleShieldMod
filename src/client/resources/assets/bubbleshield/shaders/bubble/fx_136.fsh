...
// stack: deep=voro x3 taps | mid=ridged+curl+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0649 + 0.2722 * presence + 0.3346 * pattern + 0.0861 * (1.0 - deepTrans), 0.8179);
