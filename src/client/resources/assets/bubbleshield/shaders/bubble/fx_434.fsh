...
// stack: deep=caustic x3 taps | mid=deepice+none+scroll | rim=graze_film | flourish=glint | tex=cracked_glass
// fbm: turb x6 octaves | seed 1667aaedd8c32be8
// v8 realism: refr 0.9021+1.2432*fres/dist (cap 0.1037) | energy 0.2643+0.4064*p | flow 0.075000 c/s | soft 0.9615m
...
void main() {
    ...
    float refrAmp = min((0.9021 + 1.2432 * fresnel) / max(length(worldPos), 1.0), 0.1037);
