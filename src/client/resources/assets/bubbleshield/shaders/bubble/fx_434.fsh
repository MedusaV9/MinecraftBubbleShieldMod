...
// stack: deep=caustic x3 taps | mid=deepice+none+scroll | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0685 + 0.2943 * presence + 0.3957 * pattern + 0.1288 * (1.0 - deepTrans), 0.8274);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2504), 0.8274);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5333 + 0.4667 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
