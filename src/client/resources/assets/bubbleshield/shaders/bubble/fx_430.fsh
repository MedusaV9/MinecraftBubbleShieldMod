...
// stack: deep=caustic x4 taps | mid=phantomecho+none+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0563 + 0.1130 * presence + 0.5722 * pattern + 0.1417 * (1.0 - deepTrans), 0.8375);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1519), 0.8375);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5285 + 0.4715 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
