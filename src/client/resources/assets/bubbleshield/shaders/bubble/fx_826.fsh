...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.6850 + fiR.y * 0.7545)), 0.3697);
    ...
    float alpha = vertexColor.a * min(0.0675 + 0.3468 * presence + 0.4560 * pattern + 0.1057 * (1.0 - deepTrans), 0.8169);
    // [layer:v5:backface]
