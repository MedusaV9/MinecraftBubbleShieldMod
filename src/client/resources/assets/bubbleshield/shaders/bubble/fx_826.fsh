...
// stack: deep=fbm x4 taps | mid=fluidink+curl+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0675 + 0.2868 * presence + 0.4560 * pattern + 0.1057 * (1.0 - deepTrans), 0.8169);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1955), 0.8169);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3853 + 0.6147 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
