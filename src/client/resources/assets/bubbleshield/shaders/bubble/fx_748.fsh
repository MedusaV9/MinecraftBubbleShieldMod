...
// stack: deep=voro x4 taps | mid=aethersmoke+warp2+scroll | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0563 + 0.3365 * presence + 0.3993 * pattern + 0.1369 * (1.0 - deepTrans), 0.7936);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1534), 0.7936);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3941 + 0.6059 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
