...
// stack: deep=voro x4 taps | mid=lavaflow+warp1+pulse | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0750 + 0.4253 * presence + 0.4435 * pattern + 0.1317 * (1.0 - deepTrans), 0.8969);
