...
// stack: deep=voro x3 taps | mid=holoparallax+none+scroll | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0423 + 0.1534 * presence + 0.5608 * pattern + 0.0999 * (1.0 - deepTrans), 0.8297);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1760), 0.8297);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5173 + 0.4827 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
