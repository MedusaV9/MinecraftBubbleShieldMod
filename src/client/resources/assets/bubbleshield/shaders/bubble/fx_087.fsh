...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8188, 0.0, 1.0);
    ...
    deepCol += 0.4009 * dp * mix(baseCol, deepStop, 0.3111);
    deepPat += 0.4009 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 3.3164) + par * 0.0681, time);
    deepCol += 0.1607 * dp * mix(baseCol, deepStop, 0.6222);
    deepPat += 0.1607 * dp;
    deepCol *= 0.8050;
    deepPat = pow(clamp(deepPat * 0.6404, 0.0, 1.0), 1.5467);
    ...
    rgb += hotStop * 0.1652 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0474 + 0.2910 * presence + 0.4302 * pattern, 0.8573);
