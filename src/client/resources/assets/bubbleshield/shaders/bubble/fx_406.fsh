...
// stack: deep=fbm x4 taps | mid=lavaflow+none+flicker | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0439 + 0.3481 * presence + 0.4772 * pattern + 0.1162 * (1.0 - deepTrans), 0.8990);
