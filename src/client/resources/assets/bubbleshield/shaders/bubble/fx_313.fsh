...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.001667, -0.025000) * time, time);
    deep += 0.4887 * deepField(duvBase + rimDir * 0.0453 + vec2(0.003333, -0.037500) * time, time);
    deep = pow(clamp(deep * 0.6717, 0.0, 1.0), 1.4011);
