...
// stack: deep=fbm x3 taps | mid=circuit+warp2+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0747 + 0.2511 * presence + 0.3407 * pattern + 0.0998 * (1.0 - deepTrans), 0.8599);
