...
void main() {
    ...
    deepCol += 0.4887 * dp * mix(baseCol, deepStop, 0.3066);
    deepPat += 0.4887 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 4.8305) + par * 0.0906, time);
    deepCol += 0.2388 * dp * mix(baseCol, deepStop, 0.6132);
    deepPat += 0.2388 * dp;
    deepCol *= 0.6120;
    deepPat = pow(clamp(deepPat * 0.5789, 0.0, 1.0), 1.4011);
    ...
    rgb += hotStop * 0.3044 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0747 + 0.2511 * presence + 0.3407 * pattern, 0.8599);
