...
// stack: deep=caustic x4 taps | mid=kaleido+warp2+scroll | rim=graze_sparkle | flourish=echo | tex=cracked_glass
// fbm: turb x4 octaves | seed 961023c7af5d5a1f
// v8 realism: refr 0.9196+0.9800*fres/dist (cap 0.1265) | energy 0.2363+0.3529*p | flow 0.103333 c/s | soft 1.0822m
...
void main() {
    ...
    float refrAmp = min((0.9196 + 0.9800 * fresnel) / max(length(worldPos), 1.0), 0.1265);
