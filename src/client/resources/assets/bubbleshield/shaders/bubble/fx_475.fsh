...
// stack: deep=ridge x4 taps | mid=runecircuit+curl+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0426 + 0.1423 * presence + 0.5235 * pattern + 0.1188 * (1.0 - deepTrans), 0.8277);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3004), 0.8277);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4755 + 0.5245 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
