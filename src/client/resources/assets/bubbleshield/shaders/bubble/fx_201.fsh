...
// stack: deep=ridge x3 taps | mid=circuit+warp2+scroll | rim=graze_film | flourish=shimmer | tex=circuit
// fbm: ridged x3 octaves | seed 3f8eaca94fd1b0f7
// v8 realism: refr 0.6457+0.9151*fres/dist (cap 0.1119) | energy 0.3227+0.5046*p | flow 0.110833 c/s | soft 0.9617m
...
void main() {
    ...
    float refrAmp = min((0.6457 + 0.9151 * fresnel) / max(length(worldPos), 1.0), 0.1119);
