...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.013333, -0.045000) * time, time);
    deep += 0.5449 * deepField(duvBase + rimDir * 0.0729 + vec2(-0.021667, -0.070000) * time, time);
    deep = pow(clamp(deep * 0.6473, 0.0, 1.0), 1.3970);
