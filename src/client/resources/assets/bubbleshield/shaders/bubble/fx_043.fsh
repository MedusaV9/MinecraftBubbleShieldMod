...
// v8 realism: refr 0.5135+0.6675*fres/dist (cap 0.1092) | energy 0.3396+0.4401*p | flow 0.075833 c/s | soft 0.7847m
...
void main() {
    ...
    float refrAmp = min((0.5135 + 0.6675 * fresnel) / max(length(worldPos), 1.0), 0.1092);
