...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8391, 0.0, 1.0);
    ...
    deepCol += 0.3875 * dp * mix(baseCol, deepStop, 0.4296);
    deepPat += 0.3875 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 5.1754) + par * 0.0728, time);
    deepCol += 0.1501 * dp * mix(baseCol, deepStop, 0.8591);
    deepPat += 0.1501 * dp;
    deepCol *= 0.7691;
    deepPat = pow(clamp(deepPat * 0.6504, 0.0, 1.0), 1.2382);
    ...
    rgb += hotStop * 0.3091 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0785 + 0.3614 * presence + 0.3385 * pattern, 0.8322);
