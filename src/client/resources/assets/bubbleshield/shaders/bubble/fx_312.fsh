...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.010000, 0.037500) * time, time);
    deep += 0.3875 * deepField(duvBase + rimDir * 0.0364 + vec2(0.015000, 0.057500) * time, time);
    deep = pow(clamp(deep * 0.7207, 0.0, 1.0), 1.2382);
