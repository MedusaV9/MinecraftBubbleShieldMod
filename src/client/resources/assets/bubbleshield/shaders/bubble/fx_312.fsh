...
// stack: deep=ridge x3 taps | mid=scales+warp1+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0785 + 0.3614 * presence + 0.3385 * pattern + 0.1277 * (1.0 - deepTrans), 0.8322);
