...
void main() {
    ...
    mid = clamp(mid * (0.6298 + 0.6989 * texDetail) + 0.1854 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7039 + 0.2553 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0992 * (0.5 + 0.5 * sin(time * 0.282743)));
    rgb += emit * 0.8809 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4420 + 0.5014 * presence + 0.3385 * pattern + 0.1277 * (1.0 - deepTrans) + 0.1469 * emit, 0.8922);
