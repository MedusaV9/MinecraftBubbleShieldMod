...
// stack: deep=voro x4 taps | mid=solarflare+warp1+scroll | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0551 + 0.1603 * presence + 0.5287 * pattern + 0.1568 * (1.0 - deepTrans), 0.7934);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2230), 0.7934);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4907 + 0.5093 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
