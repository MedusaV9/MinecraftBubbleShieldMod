...
void main() {
    ...
    deepCol += 0.3939 * dp * mix(baseCol, deepStop, 0.2413);
    deepPat += 0.3939 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 2.7329) + par * 0.1317, time);
    deepCol += 0.1552 * dp * mix(baseCol, deepStop, 0.4825);
    deepPat += 0.1552 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 3.2497) + par * 0.1975, time);
    deepCol += 0.0611 * dp * mix(baseCol, deepStop, 0.7238);
    deepPat += 0.0611 * dp;
    deepCol *= 0.6677;
    deepPat = pow(clamp(deepPat * 0.6210, 0.0, 1.0), 1.7149);
    ...
    rgb += hotStop * 0.1944 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0466 + 0.2740 * presence + 0.3657 * pattern, 0.8383);
