...
// stack: deep=voro x4 taps | mid=ectoplasm+warp1+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0569 + 0.1881 * presence + 0.5257 * pattern + 0.0979 * (1.0 - deepTrans), 0.8212);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1978), 0.8212);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4630 + 0.5370 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
