...
void main() {
    ...
    mid = clamp(mid * (0.6011 + 0.5257 * texDetail) + 0.3056 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4528), 0.0, 1.0);
    float emit = atlas.a * (0.7002 + 0.3897 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1570 * (0.5 + 0.5 * sin(time * 0.193732)));
    ...
    float alpha = vertexColor.a * min(0.3461 + 0.3161 * presence + 0.4987 * pattern + 0.0814 * (1.0 - deepTrans) + 0.1890 * emit, 0.8578);
