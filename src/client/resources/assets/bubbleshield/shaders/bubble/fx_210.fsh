...
// stack: deep=caustic x4 taps | mid=curlsmoke+warp2+rotate | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0470 + 0.3191 * presence + 0.3379 * pattern + 0.0813 * (1.0 - deepTrans), 0.8366);
