...
// stack: deep=voro x4 taps | mid=moire+warp1+rotate | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0666 + 0.2692 * presence + 0.3913 * pattern + 0.1409 * (1.0 - deepTrans), 0.8565);
