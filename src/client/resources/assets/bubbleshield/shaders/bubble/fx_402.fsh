...
void main() {
    ...
    mid = clamp(mid * (0.7208 + 0.5146 * texDetail) + 0.2639 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6576 + 0.4043 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1542 * (0.5 + 0.5 * sin(time * 0.136136)));
    rgb += emit * 0.7525 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3656 + 0.3940 * presence + 0.4749 * pattern + 0.1184 * (1.0 - deepTrans) + 0.2117 * emit, 0.8705);
