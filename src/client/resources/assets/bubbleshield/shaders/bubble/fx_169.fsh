...
// v8 realism: refr 0.9138+1.3770*fres/dist (cap 0.1162) | energy 0.2237+0.3904*p | flow 0.065833 c/s | soft 0.7246m
...
void main() {
    ...
    float refrAmp = min((0.9138 + 1.3770 * fresnel) / max(length(worldPos), 1.0), 0.1162);
