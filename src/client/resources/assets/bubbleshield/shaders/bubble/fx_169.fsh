...
// stack: deep=caustic x4 taps | mid=caustic+warp2+rotate | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0455 + 0.2935 * presence + 0.4740 * pattern + 0.0922 * (1.0 - deepTrans), 0.8310);
