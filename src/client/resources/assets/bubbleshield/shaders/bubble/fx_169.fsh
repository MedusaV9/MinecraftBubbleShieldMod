...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.043333, 0.007500) * time, time);
    deep += 0.4135 * deepField(duvBase + rimDir * 0.0701 + vec2(-0.068333, 0.010000) * time, time);
    deep += 0.1710 * deepField(duvBase + rimDir * 0.1403 + vec2(-0.093333, 0.015000) * time, time);
    deep = pow(clamp(deep * 0.6311, 0.0, 1.0), 1.6890);
