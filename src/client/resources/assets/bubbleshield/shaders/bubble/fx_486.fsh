...
// stack: deep=caustic x3 taps | mid=fluidink+curl+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0525 + 0.2341 * presence + 0.3683 * pattern + 0.0835 * (1.0 - deepTrans), 0.8425);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2300), 0.8425);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4397 + 0.5603 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
