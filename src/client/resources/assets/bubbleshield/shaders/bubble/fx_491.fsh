...
// stack: deep=voro x4 taps | mid=gravlens+warp2+pulse | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0595 + 0.1189 * presence + 0.5347 * pattern + 0.1278 * (1.0 - deepTrans), 0.8254);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2626), 0.8254);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3823 + 0.6177 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
