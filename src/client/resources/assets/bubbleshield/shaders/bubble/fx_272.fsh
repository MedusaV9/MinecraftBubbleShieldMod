...
// stack: deep=caustic x4 taps | mid=thinfilm+warp2+rotate | rim=graze_sparkle | flourish=glint | tex=chrome
// fbm: turb x4 octaves | seed 2d38d687b7aa9692
// v8 realism: refr 1.0416+1.5202*fres/dist (cap 0.1012) | energy 0.2144+0.4702*p | flow 0.060000 c/s | soft 0.5220m
...
void main() {
    ...
    float refrAmp = min((1.0416 + 1.5202 * fresnel) / max(length(worldPos), 1.0), 0.1012);
