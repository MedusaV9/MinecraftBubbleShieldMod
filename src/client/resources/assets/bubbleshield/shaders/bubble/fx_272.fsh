...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.025000, -0.035000) * time, time);
    deep += 0.5744 * deepField(duvBase + rimDir * 0.0415 + vec2(-0.040000, -0.052500) * time, time);
    deep += 0.3299 * deepField(duvBase + rimDir * 0.0829 + vec2(-0.053333, -0.072500) * time, time);
    deep += 0.1895 * deepField(duvBase + rimDir * 0.1244 + vec2(-0.068333, -0.092500) * time, time);
    deep = pow(clamp(deep * 0.4776, 0.0, 1.0), 1.1617);
