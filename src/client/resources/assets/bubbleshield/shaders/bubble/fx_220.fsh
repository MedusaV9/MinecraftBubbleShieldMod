...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.008333, 0.020000) * time, time);
    deep += 0.3988 * deepField(duvBase + rimDir * 0.0792 + vec2(-0.011667, 0.030000) * time, time);
    deep += 0.1590 * deepField(duvBase + rimDir * 0.1584 + vec2(-0.016667, 0.040000) * time, time);
    deep += 0.0634 * deepField(duvBase + rimDir * 0.2376 + vec2(-0.020000, 0.050000) * time, time);
    deep = pow(clamp(deep * 0.6168, 0.0, 1.0), 1.6513);
