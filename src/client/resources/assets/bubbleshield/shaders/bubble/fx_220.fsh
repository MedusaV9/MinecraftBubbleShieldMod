...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6775, 0.0, 1.0);
    ...
    deepCol += 0.3988 * dp * mix(baseCol, deepStop, 0.2907);
    deepPat += 0.3988 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.2864) + par * 0.1584, time);
    deepCol += 0.1590 * dp * mix(baseCol, deepStop, 0.5814);
    deepPat += 0.1590 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 6.7179) + par * 0.2376, time);
    deepCol += 0.0634 * dp * mix(baseCol, deepStop, 0.8721);
    deepPat += 0.0634 * dp;
    deepCol *= 0.6955;
    deepPat = pow(clamp(deepPat * 0.6168, 0.0, 1.0), 1.6513);
    ...
    rgb += hotStop * 0.1538 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0546 + 0.3395 * presence + 0.3533 * pattern, 0.8101);
