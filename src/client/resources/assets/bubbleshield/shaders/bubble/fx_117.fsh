...
// stack: deep=caustic x3 taps | mid=rings+none+pulse | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0529 + 0.3039 * presence + 0.4571 * pattern + 0.1171 * (1.0 - deepTrans), 0.8123);
