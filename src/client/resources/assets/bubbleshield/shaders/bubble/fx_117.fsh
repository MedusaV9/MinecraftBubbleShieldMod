...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.040000, 0.022500) * time, time);
    deep += 0.4578 * deepField(duvBase + rimDir * 0.0571 + vec2(0.063333, 0.035000) * time, time);
    deep = pow(clamp(deep * 0.6860, 0.0, 1.0), 1.4857);
