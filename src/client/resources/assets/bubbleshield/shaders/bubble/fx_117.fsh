...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5503, 0.0, 1.0);
    ...
    deepCol += 0.4578 * dp * mix(baseCol, deepStop, 0.4274);
    deepPat += 0.4578 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 4.1126) + par * 0.1142, time);
    deepCol += 0.2096 * dp * mix(baseCol, deepStop, 0.8549);
    deepPat += 0.2096 * dp;
    deepCol *= 0.6267;
    deepPat = pow(clamp(deepPat * 0.5997, 0.0, 1.0), 1.4857);
    ...
    rgb += hotStop * 0.1878 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0529 + 0.3039 * presence + 0.4571 * pattern, 0.8123);
