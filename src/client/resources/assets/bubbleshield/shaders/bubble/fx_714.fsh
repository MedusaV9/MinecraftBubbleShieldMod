...
// stack: deep=fbm x4 taps | mid=deepice+none+flicker | rim=graze_sparkle | flourish=swirl | tex=cracked_glass
// fbm: turb x6 octaves | seed 2ed20bb09607a741
// v8 realism: refr 0.9058+1.0174*fres/dist (cap 0.1357) | energy 0.2401+0.4799*p | flow 0.067500 c/s | soft 0.7543m
...
void main() {
    ...
    float refrAmp = min((0.9058 + 1.0174 * fresnel) / max(length(worldPos), 1.0), 0.1357);
