...
// stack: deep=fbm x4 taps | mid=deepice+none+flicker | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0433 + 0.3210 * presence + 0.4537 * pattern + 0.1283 * (1.0 - deepTrans), 0.8374);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1576), 0.8374);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5427 + 0.4573 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
