...
// stack: deep=fbm x3 taps | mid=phantomecho+warp2+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0619 + 0.0992 * presence + 0.6190 * pattern + 0.1499 * (1.0 - deepTrans), 0.8105);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3243), 0.8105);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4849 + 0.5151 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
