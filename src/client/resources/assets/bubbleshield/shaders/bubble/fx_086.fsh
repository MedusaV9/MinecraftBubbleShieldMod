...
void main() {
    ...
    mid = clamp(mid * (0.6502 + 0.5380 * texDetail) + 0.2301 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7020 + 0.3011 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1692 * (0.5 + 0.5 * sin(time * 0.298451)));
    rgb += emit * 0.8527 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3996 + 0.4414 * presence + 0.3314 * pattern + 0.0897 * (1.0 - deepTrans) + 0.1720 * emit, 0.9084);
