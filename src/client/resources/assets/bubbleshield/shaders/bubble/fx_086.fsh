...
// stack: deep=fbm x4 taps | mid=voronoi+curl+pulse | rim=graze_film | flourish=swirl | tex=worley_cells
// fbm: turb x3 octaves | seed d5b151224bab833b
// v8 realism: refr 0.6324+0.6746*fres/dist (cap 0.1182) | energy 0.3283+0.5376*p | flow 0.065000 c/s | soft 0.9149m
...
void main() {
    ...
    float refrAmp = min((0.6324 + 0.6746 * fresnel) / max(length(worldPos), 1.0), 0.1182);
