...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.016667, 0.047500) * time, time);
    deep += 0.4583 * deepField(duvBase + rimDir * 0.0643 + vec2(0.025000, 0.072500) * time, time);
    deep += 0.2100 * deepField(duvBase + rimDir * 0.1285 + vec2(0.035000, 0.097500) * time, time);
    deep += 0.0963 * deepField(duvBase + rimDir * 0.1928 + vec2(0.043333, 0.125000) * time, time);
    deep = pow(clamp(deep * 0.5667, 0.0, 1.0), 1.6025);
