...
// stack: deep=caustic x4 taps | mid=voidrift+curl+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0621 + 0.2099 * presence + 0.4812 * pattern + 0.1407 * (1.0 - deepTrans), 0.8287);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3269), 0.8287);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4939 + 0.5061 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
