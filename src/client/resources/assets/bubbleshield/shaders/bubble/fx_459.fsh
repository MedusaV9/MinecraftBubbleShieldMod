...
// stack: deep=caustic x4 taps | mid=voidrift+curl+pulse | rim=graze_film | flourish=shimmer | tex=cracked_glass
// fbm: standard x4 octaves | seed f2702c14a5d7ddf9
// v8 realism: refr 0.3077+0.4180*fres/dist (cap 0.1472) | energy 0.4278+0.3650*p | flow 0.088333 c/s | soft 0.8091m
...
void main() {
    ...
    float refrAmp = min((0.3077 + 0.4180 * fresnel) / max(length(worldPos), 1.0), 0.1472);
