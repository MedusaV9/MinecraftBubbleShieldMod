...
// stack: deep=caustic x3 taps | mid=aethersmoke+curl+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0453 + 0.3173 * presence + 0.4321 * pattern + 0.1513 * (1.0 - deepTrans), 0.8370);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2608), 0.8370);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4673 + 0.5327 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
