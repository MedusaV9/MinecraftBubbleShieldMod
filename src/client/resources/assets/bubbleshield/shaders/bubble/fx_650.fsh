...
// stack: deep=voro x4 taps | mid=phantomecho+warp1+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0456 + 0.1598 * presence + 0.6127 * pattern + 0.1070 * (1.0 - deepTrans), 0.8291);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2824), 0.8291);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4034 + 0.5966 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
