...
// stack: deep=fbm x3 taps | mid=runecircuit+none+flicker | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0593 + 0.1352 * presence + 0.6041 * pattern + 0.0815 * (1.0 - deepTrans), 0.8073);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3280), 0.8073);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5204 + 0.4796 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
