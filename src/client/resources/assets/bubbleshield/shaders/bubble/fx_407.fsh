...
// stack: deep=voro x3 taps | mid=tendrilnet+warp2+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0562 + 0.1246 * presence + 0.5892 * pattern + 0.0848 * (1.0 - deepTrans), 0.8182);
