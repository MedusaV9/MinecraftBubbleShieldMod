...
// stack: deep=fbm x3 taps | mid=starfield+warp1+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0672 + 0.1356 * presence + 0.4645 * pattern + 0.1237 * (1.0 - deepTrans), 0.7930);
