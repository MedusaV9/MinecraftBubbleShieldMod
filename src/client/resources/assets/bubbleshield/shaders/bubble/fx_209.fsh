...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.038333, 0.017500) * time, time);
    deep += 0.4802 * deepField(duvBase + rimDir * 0.0718 + vec2(-0.060000, 0.027500) * time, time);
    deep += 0.2306 * deepField(duvBase + rimDir * 0.1435 + vec2(-0.080000, 0.037500) * time, time);
    deep = pow(clamp(deep * 0.5845, 0.0, 1.0), 1.4934);
    ...
    float pattern = clamp(0.4747 * deep + 0.8436 * mid + 0.8623 * rim + flourish + grain, 0.0, 1.5);
    vec3 accent = accentPalette(0.1285 + pattern * 0.6432);
    vec3 rgb = vertexColor.rgb * (0.4775 + 0.5515 * pattern);
    ...
    float alpha = vertexColor.a * clamp(0.1595 + 0.6290 * pattern, 0.0, 1.0);
