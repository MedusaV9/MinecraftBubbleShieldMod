...
// stack: deep=voro x3 taps | mid=portalvoid+none+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0415 + 0.2145 * presence + 0.5433 * pattern + 0.0912 * (1.0 - deepTrans), 0.8331);
