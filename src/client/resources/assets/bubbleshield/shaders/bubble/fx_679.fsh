...
// stack: deep=fbm x3 taps | mid=voidrift+curl+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0427 + 0.1916 * presence + 0.5530 * pattern + 0.0944 * (1.0 - deepTrans), 0.8056);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3175), 0.8056);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4413 + 0.5587 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
