...
// stack: deep=caustic x4 taps | mid=prismdisperse+none+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0503 + 0.2678 * presence + 0.4201 * pattern + 0.1528 * (1.0 - deepTrans), 0.8157);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2519), 0.8157);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4879 + 0.5121 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
