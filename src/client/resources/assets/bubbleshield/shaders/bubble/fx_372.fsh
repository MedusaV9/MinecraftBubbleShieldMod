...
// stack: deep=ridge x3 taps | mid=portalvoid+warp1+scroll | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0428 + 0.1890 * presence + 0.4539 * pattern + 0.1409 * (1.0 - deepTrans), 0.8980);
