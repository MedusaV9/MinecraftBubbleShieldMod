...
// v8 realism: refr 0.2737+0.3629*fres/dist (cap 0.1376) | energy 0.5054+0.4511*p | flow 0.069167 c/s | soft 0.8159m
...
void main() {
    ...
    float refrAmp = min((0.2737 + 0.3629 * fresnel) / max(length(worldPos), 1.0), 0.1376);
