...
// stack: deep=voro x4 taps | mid=spectralveil+warp1+scroll | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0654 + 0.1652 * presence + 0.3863 * pattern + 0.1257 * (1.0 - deepTrans), 0.7216);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1529), 0.7216);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4375 + 0.5625 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
