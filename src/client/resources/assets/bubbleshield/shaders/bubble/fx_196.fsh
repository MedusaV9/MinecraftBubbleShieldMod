...
void main() {
    ...
    mid = clamp(mid * (0.7010 + 0.7497 * texDetail) + 0.2868 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7598 + 0.4131 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1338 * (0.5 + 0.5 * sin(time * 0.282743)));
    rgb += emit * 0.7307 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4125 + 0.4182 * presence + 0.4123 * pattern + 0.0992 * (1.0 - deepTrans) + 0.1312 * emit, 0.8627);
