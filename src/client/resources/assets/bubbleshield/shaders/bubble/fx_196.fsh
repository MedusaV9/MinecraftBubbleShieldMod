...
// stack: deep=caustic x3 taps | mid=scales+warp2+flicker | rim=graze_sparkle | flourish=echo | tex=scales
// fbm: ridged x5 octaves | seed ee86c9085f921ed2
// v8 realism: refr 0.6931+0.5850*fres/dist (cap 0.1307) | energy 0.3510+0.4815*p | flow 0.073333 c/s | soft 0.5580m
...
void main() {
    ...
    float refrAmp = min((0.6931 + 0.5850 * fresnel) / max(length(worldPos), 1.0), 0.1307);
