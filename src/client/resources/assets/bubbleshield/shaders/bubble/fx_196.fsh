...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6458, 0.0, 1.0);
    ...
    deepCol += 0.4180 * dp * mix(baseCol, deepStop, 0.3288);
    deepPat += 0.4180 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 5.9482) + par * 0.1503, time);
    deepCol += 0.1747 * dp * mix(baseCol, deepStop, 0.6576);
    deepPat += 0.1747 * dp;
    deepCol *= 0.6581;
    deepPat = pow(clamp(deepPat * 0.6279, 0.0, 1.0), 1.5175);
    ...
    rgb += hotStop * 0.1701 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0685 + 0.2782 * presence + 0.4123 * pattern, 0.8027);
