...
// stack: deep=caustic x3 taps | mid=scales+warp2+flicker | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0685 + 0.2782 * presence + 0.4123 * pattern + 0.0992 * (1.0 - deepTrans), 0.8027);
