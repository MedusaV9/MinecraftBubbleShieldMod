...
void main() {
    ...
    mid = clamp(mid * (0.6936 + 0.5153 * texDetail) + 0.3327 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6199 + 0.4992 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0848 * (0.5 + 0.5 * sin(time * 0.204204)));
    rgb += emit * 0.6888 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3636 + 0.5002 * presence + 0.3240 * pattern + 0.0949 * (1.0 - deepTrans) + 0.1293 * emit, 0.9156);
