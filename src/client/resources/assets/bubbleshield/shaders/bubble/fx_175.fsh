...
// stack: deep=fbm x4 taps | mid=arcs+none+pulse | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0520 + 0.3602 * presence + 0.3240 * pattern + 0.0949 * (1.0 - deepTrans), 0.8556);
