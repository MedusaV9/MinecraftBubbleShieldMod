...
// stack: deep=ridge x3 taps | mid=fluidink+warp1+rotate | rim=graze | flourish=echo | tex=marble_ink
// fbm: turb x3 octaves | seed f18ff26891230eb2
// v8 realism: refr 0.7095+0.6618*fres/dist (cap 0.1138) | energy 0.3113+0.4457*p | flow 0.054167 c/s | soft 0.7589m
...
void main() {
    ...
    float refrAmp = min((0.7095 + 0.6618 * fresnel) / max(length(worldPos), 1.0), 0.1138);
