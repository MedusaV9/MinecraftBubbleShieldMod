...
// stack: deep=ridge x3 taps | mid=fluidink+warp1+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2920), 0.8370);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4900 + 0.5100 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
