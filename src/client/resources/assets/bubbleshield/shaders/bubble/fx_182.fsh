...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5952, 0.0, 1.0);
    ...
    deepCol += 0.4343 * dp * mix(baseCol, deepStop, 0.3305);
    deepPat += 0.4343 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 5.6796) + par * 0.0923, time);
    deepCol += 0.1886 * dp * mix(baseCol, deepStop, 0.6610);
    deepPat += 0.1886 * dp;
    deepCol *= 0.7583;
    deepPat = pow(clamp(deepPat * 0.6162, 0.0, 1.0), 1.0944);
    ...
    rgb += hotStop * 0.3481 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0415 + 0.2874 * presence + 0.3273 * pattern, 0.8171);
