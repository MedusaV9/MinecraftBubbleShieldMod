...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.612611);
...
void main() {
    ...
    deep += 0.4343 * deepField(duvBase + rimDir * 0.0462 + vec2(-0.066667, -0.050000) * time, time);
    deep += 0.1886 * deepField(duvBase + rimDir * 0.0923 + vec2(-0.091667, -0.067500) * time, time);
    deep = pow(clamp(deep * 0.6162, 0.0, 1.0), 1.0944);
