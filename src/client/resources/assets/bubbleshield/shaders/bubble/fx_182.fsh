...
// stack: deep=voro x3 taps | mid=triweave+warp2+pulse | rim=graze_sparkle | flourish=shimmer | tex=hex_lattice
// fbm: turb x5 octaves | seed 7b5a25c15194b47f
// v8 realism: refr 0.4856+0.4058*fres/dist (cap 0.1273) | energy 0.3557+0.5027*p | flow 0.100000 c/s | soft 0.6743m
...
void main() {
    ...
    float refrAmp = min((0.4856 + 0.4058 * fresnel) / max(length(worldPos), 1.0), 0.1273);
