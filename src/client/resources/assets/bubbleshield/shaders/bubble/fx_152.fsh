...
// stack: deep=fbm x3 taps | mid=thinfilm+warp2+flicker | rim=graze | flourish=echo | tex=chrome
// fbm: standard x5 octaves | seed 39be59ce0ba3de93
// v8 realism: refr 0.9437+0.9920*fres/dist (cap 0.1408) | energy 0.2047+0.3987*p | flow 0.105000 c/s | soft 0.9938m
...
void main() {
    ...
    float refrAmp = min((0.9437 + 0.9920 * fresnel) / max(length(worldPos), 1.0), 0.1408);
