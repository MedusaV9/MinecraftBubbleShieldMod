...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.041667, -0.017500) * time, time);
    deep += 0.5609 * deepField(duvBase + rimDir * 0.0652 + vec2(0.065000, -0.027500) * time, time);
    deep = pow(clamp(deep * 0.6406, 0.0, 1.0), 1.3826);
