...
// stack: deep=fbm x3 taps | mid=thinfilm+warp2+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0410 + 0.2524 * presence + 0.4914 * pattern + 0.0965 * (1.0 - deepTrans), 0.8560);
