...
// stack: deep=caustic x3 taps | mid=prismdisperse+warp1+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0775 + 0.2905 * presence + 0.4635 * pattern + 0.1080 * (1.0 - deepTrans), 0.8413);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3107), 0.8413);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4584 + 0.5416 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
