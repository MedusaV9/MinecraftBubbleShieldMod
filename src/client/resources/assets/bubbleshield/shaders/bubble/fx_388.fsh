...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7599, 0.0, 1.0);
    ...
    deepCol += 0.5575 * dp * mix(baseCol, deepStop, 0.3722);
    deepPat += 0.5575 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 5.7111) + par * 0.0782, time);
    deepCol += 0.3108 * dp * mix(baseCol, deepStop, 0.7445);
    deepPat += 0.3108 * dp;
    deepCol *= 0.5609;
    deepPat = pow(clamp(deepPat * 0.5352, 0.0, 1.0), 1.2885);
    ...
    rgb += hotStop * 0.1530 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0676 + 0.3188 * presence + 0.4529 * pattern, 0.8155);
