...
// stack: deep=ridge x3 taps | mid=sacredgeo+warp1+flicker | rim=graze_film | flourish=shimmer | tex=runes
// fbm: turb x6 octaves | seed 9591c4363daabf24
// v8 realism: refr 0.6031+0.8246*fres/dist (cap 0.1317) | energy 0.3125+0.3979*p | flow 0.087500 c/s | soft 1.0011m
...
void main() {
    ...
    float refrAmp = min((0.6031 + 0.8246 * fresnel) / max(length(worldPos), 1.0), 0.1317);
