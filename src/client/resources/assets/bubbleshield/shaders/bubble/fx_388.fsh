...
// stack: deep=ridge x3 taps | mid=sacredgeo+warp1+flicker | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0676 + 0.3188 * presence + 0.4529 * pattern + 0.1576 * (1.0 - deepTrans), 0.8155);
