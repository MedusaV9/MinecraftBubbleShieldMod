...
// stack: deep=fbm x3 taps | mid=crystalrefract+warp1+scroll | rim=graze | flourish=swirl | tex=worley_cells
// fbm: standard x4 octaves | seed 35bd683bf9422210
// v8 realism: refr 0.8748+1.3763*fres/dist (cap 0.1598) | energy 0.2795+0.3592*p | flow 0.100833 c/s | soft 0.7315m
...
void main() {
    ...
    float refrAmp = min((0.8748 + 1.3763 * fresnel) / max(length(worldPos), 1.0), 0.1598);
