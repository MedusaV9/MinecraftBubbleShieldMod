...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5647, 0.0, 1.0);
    ...
    deepCol += 0.5634 * dp * mix(baseCol, deepStop, 0.2915);
    deepPat += 0.5634 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 3.5853) + par * 0.1578, time);
    deepCol += 0.3174 * dp * mix(baseCol, deepStop, 0.5829);
    deepPat += 0.3174 * dp;
    deepCol *= 0.5941;
    deepPat = pow(clamp(deepPat * 0.5317, 0.0, 1.0), 1.2085);
    ...
    rgb += hotStop * 0.2716 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0522 + 0.2902 * presence + 0.4685 * pattern, 0.8050);
