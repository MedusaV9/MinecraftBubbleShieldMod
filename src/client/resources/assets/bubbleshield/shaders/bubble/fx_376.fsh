...
// stack: deep=fbm x3 taps | mid=crystalrefract+warp1+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0522 + 0.2902 * presence + 0.4685 * pattern + 0.1109 * (1.0 - deepTrans), 0.8050);
