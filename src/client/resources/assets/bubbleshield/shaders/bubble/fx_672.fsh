...
// stack: deep=fbm x4 taps | mid=mycelia+warp1+pulse | rim=graze_film | flourish=echo | tex=filaments
// fbm: standard x6 octaves | seed d31e13829e1e66ab
// v8 realism: refr 0.2529+0.3447*fres/dist (cap 0.1010) | energy 0.4911+0.4044*p | flow 0.091667 c/s | soft 1.0898m
...
void main() {
    ...
    float refrAmp = min((0.2529 + 0.3447 * fresnel) / max(length(worldPos), 1.0), 0.1010);
