...
// stack: deep=caustic x4 taps | mid=phantomecho+warp1+rotate | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0568 + 0.1294 * presence + 0.5221 * pattern + 0.0918 * (1.0 - deepTrans), 0.8281);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1583), 0.8281);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4531 + 0.5469 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
