...
// stack: deep=ridge x3 taps | mid=rings+warp1+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0563 + 0.2679 * presence + 0.4101 * pattern + 0.0848 * (1.0 - deepTrans), 0.7908);
