...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6928, 0.0, 1.0);
    ...
    deepCol += 0.4275 * dp * mix(baseCol, deepStop, 0.3205);
    deepPat += 0.4275 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 5.2574) + par * 0.1094, time);
    deepCol += 0.1828 * dp * mix(baseCol, deepStop, 0.6410);
    deepPat += 0.1828 * dp;
    deepCol *= 0.7838;
    deepPat = pow(clamp(deepPat * 0.6210, 0.0, 1.0), 1.2363);
    ...
    rgb += hotStop * 0.1906 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0563 + 0.2679 * presence + 0.4101 * pattern, 0.7908);
