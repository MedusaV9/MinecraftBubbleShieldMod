...
// stack: deep=voro x3 taps | mid=sacredgeo+none+scroll | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.2579 * presence + 0.4347 * pattern + 0.1488 * (1.0 - deepTrans), 0.8174);
