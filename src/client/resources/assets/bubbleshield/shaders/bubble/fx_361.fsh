...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8465, 0.0, 1.0);
    ...
    deepCol += 0.4079 * dp * mix(baseCol, deepStop, 0.4323);
    deepPat += 0.4079 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 5.2030) + par * 0.1196, time);
    deepCol += 0.1664 * dp * mix(baseCol, deepStop, 0.8646);
    deepPat += 0.1664 * dp;
    deepCol *= 0.6317;
    deepPat = pow(clamp(deepPat * 0.6352, 0.0, 1.0), 1.2747);
    ...
    rgb += hotStop * 0.2590 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0458 + 0.2579 * presence + 0.4347 * pattern, 0.8174);
