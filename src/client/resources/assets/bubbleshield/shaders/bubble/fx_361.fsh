...
void main() {
    ...
    mid = clamp(mid * (0.7478 + 0.6404 * texDetail) + 0.2629 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.5111), 0.0, 1.0);
    float emit = atlas.a * (0.7922 + 0.2992 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0858 * (0.5 + 0.5 * sin(time * 0.193732)));
    ...
    float alpha = vertexColor.a * min(0.3452 + 0.3979 * presence + 0.4347 * pattern + 0.1488 * (1.0 - deepTrans) + 0.1416 * emit, 0.8774);
