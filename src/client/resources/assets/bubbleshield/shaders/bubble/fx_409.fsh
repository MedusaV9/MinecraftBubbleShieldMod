...
// stack: deep=ridge x4 taps | mid=ribbonaurora+warp1+pulse | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0747 + 0.1612 * presence + 0.5337 * pattern + 0.1046 * (1.0 - deepTrans), 0.8292);
