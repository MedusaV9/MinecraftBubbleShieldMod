...
void main() {
    ...
    mid = clamp(mid * (0.6588 + 0.5225 * texDetail) + 0.2855 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5623 + 0.3795 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1385 * (0.5 + 0.5 * sin(time * 0.183260)));
    rgb += emit * 0.9140 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3574 + 0.3012 * presence + 0.5337 * pattern + 0.1046 * (1.0 - deepTrans) + 0.1281 * emit, 0.8892);
