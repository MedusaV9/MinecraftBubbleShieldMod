...
// stack: deep=ridge x4 taps | mid=ribbonaurora+warp1+pulse | rim=graze_sparkle | flourish=shimmer | tex=filaments
// fbm: turb x5 octaves | seed cda624eebf292f2b
// v8 realism: refr 0.5214+0.7263*fres/dist (cap 0.1023) | energy 0.3300+0.5449*p | flow 0.080833 c/s | soft 0.6988m
...
void main() {
    ...
    float refrAmp = min((0.5214 + 0.7263 * fresnel) / max(length(worldPos), 1.0), 0.1023);
