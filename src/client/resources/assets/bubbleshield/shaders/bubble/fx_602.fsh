...
// stack: deep=fbm x3 taps | mid=prismdisperse+none+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0404 + 0.2724 * presence + 0.4288 * pattern + 0.1588 * (1.0 - deepTrans), 0.8032);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1616), 0.8032);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3994 + 0.6006 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
