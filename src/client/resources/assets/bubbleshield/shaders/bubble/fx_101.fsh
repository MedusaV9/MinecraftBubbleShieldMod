...
void main() {
    ...
    mid = clamp(mid * (0.7079 + 0.6103 * texDetail) + 0.3108 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4339), 0.0, 1.0);
    float emit = atlas.a * (0.7948 + 0.2900 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1754 * (0.5 + 0.5 * sin(time * 0.277507)));
    rgb += emit * 0.9026 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3656 + 0.4723 * presence + 0.4929 * pattern + 0.1469 * (1.0 - deepTrans) + 0.2010 * emit, 0.9073);
