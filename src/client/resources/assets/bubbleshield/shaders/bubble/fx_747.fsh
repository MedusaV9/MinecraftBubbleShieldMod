...
// stack: deep=voro x4 taps | mid=irisfilm+none+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0465 + 0.2003 * presence + 0.4924 * pattern + 0.1257 * (1.0 - deepTrans), 0.7876);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1855), 0.7876);
    // [layer:v5:ghostalpha]
