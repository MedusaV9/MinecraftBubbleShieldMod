...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.8146, 0.0, 1.0);
    ...
    deepCol += 0.5548 * dp * mix(baseCol, deepStop, 0.3419);
    deepPat += 0.5548 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 5.0459) + par * 0.0973, time);
    deepCol += 0.3079 * dp * mix(baseCol, deepStop, 0.6837);
    deepPat += 0.3079 * dp;
    deepCol *= 0.5114;
    deepPat = pow(clamp(deepPat * 0.5369, 0.0, 1.0), 1.2684);
    ...
    rgb += hotStop * 0.2783 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0578 + 0.2951 * presence + 0.3752 * pattern, 0.7874);
