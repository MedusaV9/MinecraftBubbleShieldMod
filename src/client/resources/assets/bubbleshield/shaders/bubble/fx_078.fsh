...
void main() {
    ...
    mid = clamp(mid * (0.7369 + 0.6588 * texDetail) + 0.3053 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6423 + 0.2583 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0817 * (0.5 + 0.5 * sin(time * 0.272271)));
    rgb += emit * 0.9564 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3808 + 0.4351 * presence + 0.3752 * pattern + 0.0827 * (1.0 - deepTrans) + 0.1336 * emit, 0.8474);
