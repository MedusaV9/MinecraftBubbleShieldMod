...
void main() {
    ...
    mid = clamp(mid * (0.6232 + 0.6113 * texDetail) + 0.2289 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7147 + 0.2632 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0943 * (0.5 + 0.5 * sin(time * 0.287979)));
    rgb += emit * 0.8236 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.2880 + 0.2835 * presence + 0.5609 * pattern + 0.1388 * (1.0 - deepTrans) + 0.1762 * emit, 0.8753);
