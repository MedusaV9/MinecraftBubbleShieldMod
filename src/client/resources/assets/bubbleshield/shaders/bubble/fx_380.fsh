...
// stack: deep=ridge x4 taps | mid=tendrilnet+curl+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0459 + 0.1435 * presence + 0.5609 * pattern + 0.1388 * (1.0 - deepTrans), 0.8153);
