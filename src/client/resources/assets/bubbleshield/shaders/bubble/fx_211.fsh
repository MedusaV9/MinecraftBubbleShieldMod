...
void main() {
    ...
    mid = clamp(mid * (0.6651 + 0.5043 * texDetail) + 0.2560 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6933 + 0.4340 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1654 * (0.5 + 0.5 * sin(time * 0.225147)));
    rgb += emit * 0.9443 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3966 + 0.5395 * presence + 0.3909 * pattern + 0.1578 * (1.0 - deepTrans) + 0.2156 * emit, 0.9211);
