...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6075, 0.0, 1.0);
    ...
    deepCol += 0.4406 * dp * mix(baseCol, deepStop, 0.2955);
    deepPat += 0.4406 * dp;
    dp = deepField(rotA(spinAxis, time * 0.083776) * (sdir * 3.3791) + par * 0.1529, time);
    deepCol += 0.1941 * dp * mix(baseCol, deepStop, 0.5911);
    deepPat += 0.1941 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 4.0445) + par * 0.2294, time);
    deepCol += 0.0855 * dp * mix(baseCol, deepStop, 0.8866);
    deepPat += 0.0855 * dp;
    deepCol *= 0.7293;
    deepPat = pow(clamp(deepPat * 0.5813, 0.0, 1.0), 1.3124);
    ...
    rgb += hotStop * 0.2185 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0558 + 0.3694 * presence + 0.4112 * pattern, 0.8211);
