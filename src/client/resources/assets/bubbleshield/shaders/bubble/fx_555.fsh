...
// stack: deep=ridge x3 taps | mid=runecircuit+curl+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0592 + 0.1662 * presence + 0.4926 * pattern + 0.1347 * (1.0 - deepTrans), 0.8107);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2151), 0.8107);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4704 + 0.5296 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
