...
// stack: deep=ridge x3 taps | mid=runecircuit+curl+rotate | rim=graze_sparkle | flourish=shimmer | tex=runes
// fbm: ridged x4 octaves | seed 529782bd70e5872e
// v8 realism: refr 0.2637+0.3638*fres/dist (cap 0.1417) | energy 0.4770+0.3795*p | flow 0.056667 c/s | soft 0.9304m
...
void main() {
    ...
    float refrAmp = min((0.2637 + 0.3638 * fresnel) / max(length(worldPos), 1.0), 0.1417);
