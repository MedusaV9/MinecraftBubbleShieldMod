...
// stack: deep=fbm x4 taps | mid=spectralveil+curl+pulse | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0611 + 0.1346 * presence + 0.4043 * pattern + 0.1349 * (1.0 - deepTrans), 0.7651);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3282), 0.7651);
    // [layer:v5:ghostalpha]
