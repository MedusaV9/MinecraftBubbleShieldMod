...
// stack: deep=caustic x4 taps | mid=irisfilm+warp2+flicker | rim=graze_sparkle | flourish=swirl | tex=chrome
// fbm: ridged x6 octaves | seed 7df6b819e318b99c
// v8 realism: refr 0.7396+1.3027*fres/dist (cap 0.1505) | energy 0.2178+0.3990*p | flow 0.100833 c/s | soft 0.6219m
...
void main() {
    ...
    float refrAmp = min((0.7396 + 1.3027 * fresnel) / max(length(worldPos), 1.0), 0.1505);
