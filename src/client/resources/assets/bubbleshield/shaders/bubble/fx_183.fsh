...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7063, 0.0, 1.0);
    ...
    deepCol += 0.4697 * dp * mix(baseCol, deepStop, 0.4194);
    deepPat += 0.4697 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 4.4023) + par * 0.1277, time);
    deepCol += 0.2206 * dp * mix(baseCol, deepStop, 0.8389);
    deepPat += 0.2206 * dp;
    deepCol *= 0.6007;
    deepPat = pow(clamp(deepPat * 0.5916, 0.0, 1.0), 1.4228);
    ...
    rgb += hotStop * 0.1849 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0734 + 0.2950 * presence + 0.4494 * pattern, 0.7809);
