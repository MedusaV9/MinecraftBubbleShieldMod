...
void main() {
    ...
    mid = clamp(mid * (0.7135 + 0.4533 * texDetail) + 0.2791 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5689 + 0.2989 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0811 * (0.5 + 0.5 * sin(time * 0.219911)));
    rgb += emit * 0.9458 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4269 + 0.4350 * presence + 0.4494 * pattern + 0.1306 * (1.0 - deepTrans) + 0.2021 * emit, 0.8409);
