...
// stack: deep=fbm x3 taps | mid=aurora+warp2+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0734 + 0.2950 * presence + 0.4494 * pattern + 0.1306 * (1.0 - deepTrans), 0.7809);
