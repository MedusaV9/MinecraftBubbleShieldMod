...
// stack: deep=fbm x3 taps | mid=aurora+warp2+rotate | rim=graze_sparkle | flourish=shimmer | tex=filaments
// fbm: turb x4 octaves | seed ff0eae326c20738d
// v8 realism: refr 0.6803+0.7477*fres/dist (cap 0.1038) | energy 0.4049+0.4594*p | flow 0.079167 c/s | soft 1.0231m
...
void main() {
    ...
    float refrAmp = min((0.6803 + 0.7477 * fresnel) / max(length(worldPos), 1.0), 0.1038);
