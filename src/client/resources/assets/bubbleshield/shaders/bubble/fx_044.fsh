...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.033333, 0.005000) * time, time);
    deep += 0.4880 * deepField(duvBase + rimDir * 0.0376 + vec2(0.051667, 0.010000) * time, time);
    deep += 0.2382 * deepField(duvBase + rimDir * 0.0753 + vec2(0.070000, 0.012500) * time, time);
    deep = pow(clamp(deep * 0.5793, 0.0, 1.0), 1.4436);
