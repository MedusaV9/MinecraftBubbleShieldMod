...
void main() {
    ...
    mid = clamp(mid * (0.6887 + 0.4625 * texDetail) + 0.2768 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6870 + 0.3376 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1708 * (0.5 + 0.5 * sin(time * 0.235619)));
    ...
    float alpha = vertexColor.a * min(0.3145 + 0.3119 * presence + 0.5926 * pattern + 0.1164 * (1.0 - deepTrans) + 0.1702 * emit, 0.9027);
