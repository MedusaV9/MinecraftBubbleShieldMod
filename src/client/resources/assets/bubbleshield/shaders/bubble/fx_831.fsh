...
// stack: deep=caustic x3 taps | mid=gravlens+warp1+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0706 + 0.1340 * presence + 0.5257 * pattern + 0.1191 * (1.0 - deepTrans), 0.8190);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2224), 0.8190);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4279 + 0.5721 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
