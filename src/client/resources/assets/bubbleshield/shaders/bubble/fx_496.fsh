...
// stack: deep=ridge x3 taps | mid=oilslick+warp1+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0613 + 0.3387 * presence + 0.3218 * pattern + 0.1539 * (1.0 - deepTrans), 0.8243);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1705), 0.8243);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5186 + 0.4814 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
