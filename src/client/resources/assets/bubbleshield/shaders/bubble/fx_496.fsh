...
// stack: deep=ridge x3 taps | mid=oilslick+warp1+rotate | rim=graze | flourish=echo | tex=chrome
// fbm: ridged x3 octaves | seed 07e629d7e54549d9
// v8 realism: refr 1.0250+1.7430*fres/dist (cap 0.1010) | energy 0.2443+0.4454*p | flow 0.051667 c/s | soft 1.0267m
...
void main() {
    ...
    float refrAmp = min((1.0250 + 1.7430 * fresnel) / max(length(worldPos), 1.0), 0.1010);
