...
// stack: deep=ridge x3 taps | mid=ectoplasm+warp1+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0480 + 0.2129 * presence + 0.4114 * pattern + 0.1243 * (1.0 - deepTrans), 0.8310);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2008), 0.8310);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4776 + 0.5224 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
