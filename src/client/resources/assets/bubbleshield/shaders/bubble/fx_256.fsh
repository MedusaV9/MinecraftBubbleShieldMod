...
// stack: deep=voro x3 taps | mid=ridged+warp2+flicker | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0478 + 0.2675 * presence + 0.4292 * pattern + 0.1202 * (1.0 - deepTrans), 0.8074);
