...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5569, 0.0, 1.0);
    ...
    deepCol += 0.4602 * dp * mix(baseCol, deepStop, 0.2989);
    deepPat += 0.4602 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 3.9905) + par * 0.1361, time);
    deepCol += 0.2118 * dp * mix(baseCol, deepStop, 0.5979);
    deepPat += 0.2118 * dp;
    deepCol *= 0.5748;
    deepPat = pow(clamp(deepPat * 0.5981, 0.0, 1.0), 1.6345);
    ...
    rgb += hotStop * 0.3439 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0478 + 0.2675 * presence + 0.4292 * pattern, 0.8074);
