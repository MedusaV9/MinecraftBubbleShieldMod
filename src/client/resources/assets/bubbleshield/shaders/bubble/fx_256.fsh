...
// stack: deep=voro x3 taps | mid=ridged+warp2+flicker | rim=graze_sparkle | flourish=echo | tex=ridged
// fbm: turb x3 octaves | seed 7cde3a5b6388e6f7
// v8 realism: refr 0.6511+0.5951*fres/dist (cap 0.1034) | energy 0.3565+0.5161*p | flow 0.092500 c/s | soft 0.6086m
...
void main() {
    ...
    float refrAmp = min((0.6511 + 0.5951 * fresnel) / max(length(worldPos), 1.0), 0.1034);
