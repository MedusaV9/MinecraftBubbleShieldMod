...
void main() {
    ...
    mid = clamp(mid * (0.6122 + 0.4860 * texDetail) + 0.1980 * texDetail, 0.0, 1.5);
    ...
    rim = clamp(rim + 0.6272 * rimLine, 0.0, 1.4);
    ...
    float emit = atlas.a * (0.7978 + 0.3351 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0819 * (0.5 + 0.5 * sin(time * 0.235619)));
    ...
    float alpha = vertexColor.a * min(0.3717 + 0.4912 * presence + 0.4595 * pattern + 0.1536 * (1.0 - deepTrans) + 0.1394 * emit, 0.9160);
