...
// stack: deep=caustic x4 taps | mid=sacredgeo+none+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0548 + 0.3512 * presence + 0.4595 * pattern + 0.1536 * (1.0 - deepTrans), 0.8560);
