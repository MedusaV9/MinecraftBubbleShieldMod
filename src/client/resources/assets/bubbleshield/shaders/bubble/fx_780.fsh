...
// stack: deep=caustic x3 taps | mid=spectralveil+curl+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0578 + 0.1046 * presence + 0.4927 * pattern + 0.1171 * (1.0 - deepTrans), 0.7515);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1601), 0.7515);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4455 + 0.5545 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
