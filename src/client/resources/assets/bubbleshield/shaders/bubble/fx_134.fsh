...
float deepField(vec2 p, float t) {
    vec3 v = voro2(p, vec2(2.0000, 3.0000), t * 0.387463);
...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.046667, -0.012500) * time, time);
    deep += 0.5691 * deepField(duvBase + rimDir * 0.0713 + vec2(0.073333, -0.020000) * time, time);
    deep += 0.3239 * deepField(duvBase + rimDir * 0.1426 + vec2(0.098333, -0.027500) * time, time);
    deep = pow(clamp(deep * 0.5283, 0.0, 1.0), 1.7136);
