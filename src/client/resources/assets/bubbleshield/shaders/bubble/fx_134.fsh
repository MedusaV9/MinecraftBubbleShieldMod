...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6745, 0.0, 1.0);
    ...
    deepCol += 0.5691 * dp * mix(baseCol, deepStop, 0.4396);
    deepPat += 0.5691 * dp;
    dp = deepField(rotA(spinAxis, time * 0.036652) * (sdir * 4.5069) + par * 0.1426, time);
    deepCol += 0.3239 * dp * mix(baseCol, deepStop, 0.8791);
    deepPat += 0.3239 * dp;
    deepCol *= 0.5272;
    deepPat = pow(clamp(deepPat * 0.5283, 0.0, 1.0), 1.7136);
    ...
    rgb += hotStop * 0.2873 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0589 + 0.2842 * presence + 0.4429 * pattern, 0.7865);
