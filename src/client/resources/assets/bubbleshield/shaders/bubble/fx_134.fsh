...
void main() {
    ...
    mid = clamp(mid * (0.7005 + 0.5317 * texDetail) + 0.2472 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6406 + 0.3021 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1357 * (0.5 + 0.5 * sin(time * 0.282743)));
    rgb += emit * 0.6850 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3841 + 0.4242 * presence + 0.4429 * pattern + 0.1059 * (1.0 - deepTrans) + 0.1998 * emit, 0.8465);
