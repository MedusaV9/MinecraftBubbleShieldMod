...
// stack: deep=caustic x4 taps | mid=stainedglass+warp2+pulse | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0645 + 0.3922 * presence + 0.4722 * pattern + 0.0949 * (1.0 - deepTrans), 0.8630);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2419), 0.8630);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4875 + 0.5125 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
