...
void main() {
    ...
    mid = clamp(mid * (0.6286 + 0.6838 * texDetail) + 0.1871 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6203 + 0.3197 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1333 * (0.5 + 0.5 * sin(time * 0.115192)));
    ...
    float alpha = vertexColor.a * min(0.4192 + 0.4223 * presence + 0.4276 * pattern + 0.1584 * (1.0 - deepTrans) + 0.1628 * emit, 0.8623);
