...
// stack: deep=ridge x4 taps | mid=vortex+none+scroll | rim=graze | flourish=glint | tex=marble_ink
// fbm: turb x5 octaves | seed 82fc7a9e0c50749f
// v8 realism: refr 0.6824+0.9518*fres/dist (cap 0.1171) | energy 0.4139+0.4694*p | flow 0.106667 c/s | soft 0.8944m
...
void main() {
    ...
    float refrAmp = min((0.6824 + 0.9518 * fresnel) / max(length(worldPos), 1.0), 0.1171);
