...
void main() {
    ...
    mid = clamp(mid * (0.7201 + 0.4665 * texDetail) + 0.3078 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6472 + 0.3076 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1673 * (0.5 + 0.5 * sin(time * 0.193732)));
    rgb += emit * 0.7521 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4323 + 0.5000 * presence + 0.4289 * pattern + 0.1514 * (1.0 - deepTrans) + 0.1815 * emit, 0.8847);
