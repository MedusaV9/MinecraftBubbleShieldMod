...
// stack: deep=ridge x3 taps | mid=aurora+warp2+pulse | rim=graze_film | flourish=swirl | tex=filaments
// fbm: turb x5 octaves | seed e595c8e4ab66a7bf
// v8 realism: refr 0.7425+0.6850*fres/dist (cap 0.1510) | energy 0.3263+0.4032*p | flow 0.079167 c/s | soft 0.7392m
...
void main() {
    ...
    float refrAmp = min((0.7425 + 0.6850 * fresnel) / max(length(worldPos), 1.0), 0.1510);
