...
// stack: deep=ridge x3 taps | mid=aurora+warp2+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0752 + 0.3600 * presence + 0.4289 * pattern + 0.1514 * (1.0 - deepTrans), 0.8247);
