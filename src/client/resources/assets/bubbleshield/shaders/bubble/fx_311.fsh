...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5868, 0.0, 1.0);
    ...
    deepCol += 0.5330 * dp * mix(baseCol, deepStop, 0.4072);
    deepPat += 0.5330 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 3.9522) + par * 0.1003, time);
    deepCol += 0.2841 * dp * mix(baseCol, deepStop, 0.8144);
    deepPat += 0.2841 * dp;
    deepCol *= 0.6555;
    deepPat = pow(clamp(deepPat * 0.5503, 0.0, 1.0), 1.3852);
    ...
    float alpha = vertexColor.a * min(0.0752 + 0.3600 * presence + 0.4289 * pattern, 0.8247);
