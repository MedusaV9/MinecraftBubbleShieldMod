...
// stack: deep=caustic x3 taps | mid=ribbonaurora+none+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0731 + 0.1444 * presence + 0.5100 * pattern + 0.1467 * (1.0 - deepTrans), 0.8482);
