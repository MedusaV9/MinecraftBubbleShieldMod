...
void main() {
    ...
    mid = clamp(mid * (0.7487 + 0.6926 * texDetail) + 0.3446 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5811 + 0.3548 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1791 * (0.5 + 0.5 * sin(time * 0.230383)));
    ...
    float alpha = vertexColor.a * min(0.3535 + 0.2844 * presence + 0.5100 * pattern + 0.1467 * (1.0 - deepTrans) + 0.2073 * emit, 0.9082);
