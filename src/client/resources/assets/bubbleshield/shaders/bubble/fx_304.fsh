...
void main() {
    ...
    mid = clamp(mid * (0.6252 + 0.5342 * texDetail) + 0.2492 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7689 + 0.3217 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1018 * (0.5 + 0.5 * sin(time * 0.240855)));
    rgb += emit * 0.7750 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3870 + 0.4483 * presence + 0.4047 * pattern + 0.1527 * (1.0 - deepTrans) + 0.1657 * emit, 0.8416);
