...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5663, 0.0, 1.0);
    ...
    deepCol += 0.4863 * dp * mix(baseCol, deepStop, 0.2111);
    deepPat += 0.4863 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 3.7795) + par * 0.0759, time);
    deepCol += 0.2365 * dp * mix(baseCol, deepStop, 0.4223);
    deepPat += 0.2365 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.6214) + par * 0.1138, time);
    deepCol += 0.1150 * dp * mix(baseCol, deepStop, 0.6334);
    deepPat += 0.1150 * dp;
    deepCol *= 0.5286;
    deepPat = pow(clamp(deepPat * 0.5441, 0.0, 1.0), 1.5071);
    ...
    rgb += hotStop * 0.2540 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0599 + 0.3083 * presence + 0.4047 * pattern, 0.7816);
