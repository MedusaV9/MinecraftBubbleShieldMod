...
// stack: deep=ridge x3 taps | mid=deepice+warp1+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0493 + 0.3239 * presence + 0.4429 * pattern + 0.1283 * (1.0 - deepTrans), 0.8963);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2638), 0.8963);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4971 + 0.5029 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
