...
void main() {
    ...
    mid = clamp(mid * (0.6534 + 0.7428 * texDetail) + 0.3150 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.4174), 0.0, 1.0);
    float emit = atlas.a * (0.6554 + 0.3917 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1734 * (0.5 + 0.5 * sin(time * 0.130900)));
    ...
    float alpha = vertexColor.a * min(0.2737 + 0.2505 * presence + 0.4740 * pattern + 0.0973 * (1.0 - deepTrans) + 0.1975 * emit, 0.8485);
