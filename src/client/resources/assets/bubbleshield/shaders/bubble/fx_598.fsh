...
// stack: deep=fbm x3 taps | mid=ectoplasm+warp1+rotate | rim=graze | flourish=glint
...
void main() {
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2073), 0.7841);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5411 + 0.4589 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
