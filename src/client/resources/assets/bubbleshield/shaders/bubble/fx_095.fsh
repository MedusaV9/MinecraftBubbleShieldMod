...
// stack: deep=ridge x3 taps | mid=petals+curl+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0535 + 0.2473 * presence + 0.4253 * pattern + 0.0815 * (1.0 - deepTrans), 0.8540);
