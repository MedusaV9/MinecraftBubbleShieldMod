...
void main() {
    ...
    mid = clamp(mid * (0.6088 + 0.6476 * texDetail) + 0.2266 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6912 + 0.2682 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1289 * (0.5 + 0.5 * sin(time * 0.130900)));
    rgb += emit * 0.7946 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3681 + 0.3873 * presence + 0.4253 * pattern + 0.0815 * (1.0 - deepTrans) + 0.1595 * emit, 0.9140);
