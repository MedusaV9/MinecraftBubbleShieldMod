...
void main() {
    ...
    deepCol += 0.3922 * dp * mix(baseCol, deepStop, 0.3813);
    deepPat += 0.3922 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 4.0116) + par * 0.1360, time);
    deepCol += 0.1538 * dp * mix(baseCol, deepStop, 0.7627);
    deepPat += 0.1538 * dp;
    deepCol *= 0.8264;
    deepPat = pow(clamp(deepPat * 0.6468, 0.0, 1.0), 1.1206);
    ...
    rgb += hotStop * 0.2611 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0535 + 0.2473 * presence + 0.4253 * pattern, 0.8540);
