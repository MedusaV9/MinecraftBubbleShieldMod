...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.018333, -0.042500) * time, time);
    deep += 0.3931 * deepField(duvBase + rimDir * 0.0650 + vec2(0.028333, -0.067500) * time, time);
    deep += 0.1546 * deepField(duvBase + rimDir * 0.1300 + vec2(0.036667, -0.090000) * time, time);
    deep += 0.0608 * deepField(duvBase + rimDir * 0.1950 + vec2(0.046667, -0.115000) * time, time);
    deep = pow(clamp(deep * 0.6217, 0.0, 1.0), 1.1675);
