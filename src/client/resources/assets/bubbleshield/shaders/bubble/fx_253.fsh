...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6738, 0.0, 1.0);
    ...
    deepCol += 0.3931 * dp * mix(baseCol, deepStop, 0.2099);
    deepPat += 0.3931 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 5.8840) + par * 0.1300, time);
    deepCol += 0.1546 * dp * mix(baseCol, deepStop, 0.4197);
    deepPat += 0.1546 * dp;
    dp = deepField(rotA(spinAxis, time * 0.020944) * (sdir * 7.4323) + par * 0.1950, time);
    deepCol += 0.0608 * dp * mix(baseCol, deepStop, 0.6296);
    deepPat += 0.0608 * dp;
    deepCol *= 0.7408;
    deepPat = pow(clamp(deepPat * 0.6217, 0.0, 1.0), 1.1675);
    ...
    rgb += hotStop * 0.3397 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0670 + 0.2568 * presence + 0.4114 * pattern, 0.8088);
