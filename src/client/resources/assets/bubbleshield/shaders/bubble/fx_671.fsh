...
// stack: deep=caustic x3 taps | mid=gravlens+curl+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0467 + 0.1293 * presence + 0.5854 * pattern + 0.1258 * (1.0 - deepTrans), 0.8156);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1633), 0.8156);
    // [layer:v5:ghostalpha]
