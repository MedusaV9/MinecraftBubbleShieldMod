...
// stack: deep=ridge x4 taps | mid=lightning+warp1+pulse | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0594 + 0.3653 * presence + 0.4392 * pattern + 0.1100 * (1.0 - deepTrans), 0.8444);
