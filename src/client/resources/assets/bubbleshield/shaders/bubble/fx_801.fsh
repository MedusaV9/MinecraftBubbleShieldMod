...
// stack: deep=voro x3 taps | mid=raymarchfog+none+rotate | rim=graze | flourish=glint
...
void main() {
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3269), 0.8084);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4497 + 0.5503 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
