...
// stack: deep=caustic x3 taps | mid=solarflare+none+pulse | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0405 + 0.1671 * presence + 0.4701 * pattern + 0.0987 * (1.0 - deepTrans), 0.7959);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2718), 0.7959);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5217 + 0.4783 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
