...
// stack: deep=ridge x4 taps | mid=deepice+curl+flicker | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0696 + 0.3743 * presence + 0.3467 * pattern + 0.0945 * (1.0 - deepTrans), 0.8429);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1590), 0.8429);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5095 + 0.4905 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
