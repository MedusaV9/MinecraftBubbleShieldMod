...
void main() {
    ...
    mid = clamp(mid * (0.7431 + 0.5278 * texDetail) + 0.2634 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6430 + 0.3411 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1541 * (0.5 + 0.5 * sin(time * 0.293215)));
    ...
    float alpha = vertexColor.a * min(0.3970 + 0.3843 * presence + 0.4715 * pattern + 0.1563 * (1.0 - deepTrans) + 0.1351 * emit, 0.8654);
