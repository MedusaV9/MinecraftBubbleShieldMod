...
// stack: deep=fbm x4 taps | mid=voronoi+none+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0633 + 0.2443 * presence + 0.4715 * pattern + 0.1563 * (1.0 - deepTrans), 0.8054);
