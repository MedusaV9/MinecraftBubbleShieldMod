...
// stack: deep=fbm x4 taps | mid=voronoi+none+scroll | rim=graze | flourish=swirl | tex=worley_cells
// fbm: turb x5 octaves | seed 034e5b4ee2ece620
// v8 realism: refr 0.7383+0.9008*fres/dist (cap 0.1278) | energy 0.3182+0.4445*p | flow 0.119167 c/s | soft 1.0849m
...
void main() {
    ...
    float refrAmp = min((0.7383 + 0.9008 * fresnel) / max(length(worldPos), 1.0), 0.1278);
