...
void main() {
    ...
    mid = clamp(mid * (0.6170 + 0.5544 * texDetail) + 0.2271 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.3906), 0.0, 1.0);
    float emit = atlas.a * (0.6641 + 0.2809 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1232 * (0.5 + 0.5 * sin(time * 0.136136)));
    ...
    float alpha = vertexColor.a * min(0.4340 + 0.4374 * presence + 0.3848 * pattern + 0.1308 * (1.0 - deepTrans) + 0.1802 * emit, 0.8995);
