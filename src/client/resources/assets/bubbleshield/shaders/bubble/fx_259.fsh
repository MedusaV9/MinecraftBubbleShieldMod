...
// v8 realism: refr 1.0411+1.6795*fres/dist (cap 0.1175) | energy 0.2361+0.4103*p | flow 0.052500 c/s | soft 0.6283m
...
void main() {
    ...
    float refrAmp = min((1.0411 + 1.6795 * fresnel) / max(length(worldPos), 1.0), 0.1175);
