...
// stack: deep=fbm x4 taps | mid=interference+warp2+rotate | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0731 + 0.3225 * presence + 0.4436 * pattern + 0.0876 * (1.0 - deepTrans), 0.7824);
