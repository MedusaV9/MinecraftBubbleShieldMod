...
// stack: deep=voro x4 taps | mid=gravlens+warp1+pulse | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0685 + 0.0922 * presence + 0.5066 * pattern + 0.1309 * (1.0 - deepTrans), 0.8064);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2352), 0.8064);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4946 + 0.5054 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
