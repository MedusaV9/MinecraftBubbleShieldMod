...
void main() {
    ...
    float mid = clamp(rfLight * 1.0493 + (1.0 - rfTrans) * 0.1962, 0.0, 1.15);
    ...
    float alpha = vertexColor.a * min(0.0779 + 0.3499 * presence + 0.2851 * pattern + 0.1411 * (1.0 - deepTrans), 0.8761);
    // [layer:v5:backface]
