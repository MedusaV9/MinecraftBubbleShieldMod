...
// stack: deep=voro x3 taps | mid=raymarchfog+warp2+pulse | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0779 + 0.2699 * presence + 0.2851 * pattern + 0.1411 * (1.0 - deepTrans), 0.8761);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3321), 0.8761);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5459 + 0.4541 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
