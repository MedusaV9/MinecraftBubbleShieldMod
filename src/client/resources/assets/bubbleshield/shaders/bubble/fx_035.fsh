...
// stack: deep=caustic x4 taps | mid=scales+warp2+pulse | rim=graze_film | flourish=swirl | tex=scales
// fbm: standard x6 octaves | seed f11850d579283c96
// v8 realism: refr 0.5619+0.8108*fres/dist (cap 0.1568) | energy 0.3870+0.4577*p | flow 0.102500 c/s | soft 0.6226m
...
void main() {
    ...
    float refrAmp = min((0.5619 + 0.8108 * fresnel) / max(length(worldPos), 1.0), 0.1568);
