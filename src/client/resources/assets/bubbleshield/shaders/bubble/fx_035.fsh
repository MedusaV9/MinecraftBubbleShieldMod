...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.020000, -0.015000) * time, time);
    deep += 0.4611 * deepField(duvBase + rimDir * 0.0562 + vec2(-0.031667, -0.022500) * time, time);
    deep += 0.2126 * deepField(duvBase + rimDir * 0.1124 + vec2(-0.043333, -0.030000) * time, time);
    deep += 0.0980 * deepField(duvBase + rimDir * 0.1686 + vec2(-0.055000, -0.037500) * time, time);
    deep = pow(clamp(deep * 0.5644, 0.0, 1.0), 1.6763);
