...
// stack: deep=caustic x4 taps | mid=scales+warp2+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0446 + 0.3038 * presence + 0.4414 * pattern + 0.1546 * (1.0 - deepTrans), 0.8082);
