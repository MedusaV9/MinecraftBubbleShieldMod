...
// stack: deep=ridge x3 taps | mid=vortex+curl+flicker | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0738 + 0.2621 * presence + 0.4023 * pattern + 0.0824 * (1.0 - deepTrans), 0.8215);
