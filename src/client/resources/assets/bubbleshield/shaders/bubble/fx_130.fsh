...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7810, 0.0, 1.0);
    ...
    deepCol += 0.3978 * dp * mix(baseCol, deepStop, 0.3708);
    deepPat += 0.3978 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 4.1471) + par * 0.1092, time);
    deepCol += 0.1583 * dp * mix(baseCol, deepStop, 0.7416);
    deepPat += 0.1583 * dp;
    deepCol *= 0.6416;
    deepPat = pow(clamp(deepPat * 0.6426, 0.0, 1.0), 1.6536);
    ...
    float alpha = vertexColor.a * min(0.0738 + 0.2621 * presence + 0.4023 * pattern, 0.8215);
