...
// stack: deep=ridge x3 taps | mid=vortex+curl+flicker | rim=lat | flourish=shimmer | tex=marble_ink
// fbm: turb x6 octaves | seed c87b1506012f3cf2
// v8 realism: refr 0.4805+0.5560*fres/dist (cap 0.1559) | energy 0.4061+0.5064*p | flow 0.074167 c/s | soft 1.0202m
...
void main() {
    ...
    float refrAmp = min((0.4805 + 0.5560 * fresnel) / max(length(worldPos), 1.0), 0.1559);
