...
void main() {
    ...
    mid = clamp(mid * (0.6637 + 0.4559 * texDetail) + 0.2656 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7478 + 0.3648 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1723 * (0.5 + 0.5 * sin(time * 0.214675)));
    rgb += emit * 0.9836 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3857 + 0.5090 * presence + 0.3560 * pattern + 0.1177 * (1.0 - deepTrans) + 0.1236 * emit, 0.9122);
