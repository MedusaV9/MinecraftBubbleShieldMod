...
// stack: deep=voro x3 taps | mid=gravlens+none+rotate | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0649 + 0.1354 * presence + 0.5153 * pattern + 0.1240 * (1.0 - deepTrans), 0.8374);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1755), 0.8374);
    // [layer:v5:ghostalpha]
