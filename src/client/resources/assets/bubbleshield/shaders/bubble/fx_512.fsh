...
// stack: deep=caustic x4 taps | mid=mycelia+curl+scroll | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0505 + 0.1480 * presence + 0.5451 * pattern + 0.1172 * (1.0 - deepTrans), 0.8173);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1538), 0.8173);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4863 + 0.5137 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
