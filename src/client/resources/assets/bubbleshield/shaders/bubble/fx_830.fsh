...
// stack: deep=caustic x3 taps | mid=phantomecho+none+flicker | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0758 + 0.1464 * presence + 0.5748 * pattern + 0.1301 * (1.0 - deepTrans), 0.7727);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2240), 0.7727);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3844 + 0.6156 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
