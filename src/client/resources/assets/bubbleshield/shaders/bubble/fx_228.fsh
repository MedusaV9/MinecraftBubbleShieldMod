...
// stack: deep=ridge x4 taps | mid=plasma+none+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0409 + 0.2441 * presence + 0.4436 * pattern + 0.1407 * (1.0 - deepTrans), 0.8062);
