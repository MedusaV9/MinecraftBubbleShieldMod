...
void main() {
    ...
    mid = clamp(mid * (0.6180 + 0.5193 * texDetail) + 0.1844 * texDetail, 0.0, 1.5);
    ...
    vec3 emitCol = clamp(mix(baseCol, vec3(1.0), 0.5314), 0.0, 1.0);
    float emit = atlas.a * (0.7127 + 0.4594 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1080 * (0.5 + 0.5 * sin(time * 0.277507)));
    ...
    float alpha = vertexColor.a * min(0.3306 + 0.3841 * presence + 0.4436 * pattern + 0.1407 * (1.0 - deepTrans) + 0.1845 * emit, 0.8662);
