...
void main() {
    ...
    deepCol += 0.4644 * dp * mix(baseCol, deepStop, 0.2013);
    deepPat += 0.4644 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 3.5128) + par * 0.0688, time);
    deepCol += 0.2157 * dp * mix(baseCol, deepStop, 0.4026);
    deepPat += 0.2157 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 4.4533) + par * 0.1032, time);
    deepCol += 0.1002 * dp * mix(baseCol, deepStop, 0.6039);
    deepPat += 0.1002 * dp;
    deepCol *= 0.5761;
    deepPat = pow(clamp(deepPat * 0.5617, 0.0, 1.0), 1.3128);
    ...
    rgb += hotStop * 0.1764 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0409 + 0.2441 * presence + 0.4436 * pattern, 0.8062);
