...
// stack: deep=voro x3 taps | mid=irisfilm+curl+scroll | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0414 + 0.1625 * presence + 0.4300 * pattern + 0.1215 * (1.0 - deepTrans), 0.8033);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2197), 0.8033);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5197 + 0.4803 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
