...
// stack: deep=caustic x3 taps | mid=fluidink+warp1+rotate | rim=graze_film | flourish=glint | tex=marble_ink
// fbm: ridged x6 octaves | seed 4c4eae0bbd15c0cd
// v8 realism: refr 0.5940+0.4889*fres/dist (cap 0.1008) | energy 0.3178+0.5485*p | flow 0.072500 c/s | soft 0.9565m
...
void main() {
    ...
    float refrAmp = min((0.5940 + 0.4889 * fresnel) / max(length(worldPos), 1.0), 0.1008);
