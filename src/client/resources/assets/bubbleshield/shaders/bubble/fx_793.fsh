...
// stack: deep=voro x4 taps | mid=solarflare+none+pulse | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0779 + 0.1877 * presence + 0.5994 * pattern + 0.0850 * (1.0 - deepTrans), 0.8244);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2115), 0.8244);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3974 + 0.6026 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
