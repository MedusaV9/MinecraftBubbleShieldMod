...
// stack: deep=ridge x3 taps | mid=waves+warp1+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0423 + 0.3326 * presence + 0.4326 * pattern + 0.1399 * (1.0 - deepTrans), 0.8541);
