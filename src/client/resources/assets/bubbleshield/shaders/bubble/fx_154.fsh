...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7842, 0.0, 1.0);
    ...
    deepCol += 0.4562 * dp * mix(baseCol, deepStop, 0.3462);
    deepPat += 0.4562 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 5.1603) + par * 0.1070, time);
    deepCol += 0.2081 * dp * mix(baseCol, deepStop, 0.6925);
    deepPat += 0.2081 * dp;
    deepCol *= 0.6939;
    deepPat = pow(clamp(deepPat * 0.6008, 0.0, 1.0), 1.5920);
    ...
    rgb += hotStop * 0.2588 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0423 + 0.3326 * presence + 0.4326 * pattern, 0.8541);
