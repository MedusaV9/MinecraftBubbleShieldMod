...
// stack: deep=ridge x3 taps | mid=waves+warp1+pulse | rim=graze_film | flourish=shimmer | tex=caustic_web
// fbm: ridged x4 octaves | seed b4c128097fdcf5c2
// v8 realism: refr 1.0256+1.2784*fres/dist (cap 0.1475) | energy 0.2516+0.3682*p | flow 0.101667 c/s | soft 0.6799m
...
void main() {
    ...
    float refrAmp = min((1.0256 + 1.2784 * fresnel) / max(length(worldPos), 1.0), 0.1475);
