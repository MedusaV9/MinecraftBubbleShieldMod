...
// stack: deep=caustic x3 taps | mid=irisfilm+none+flicker | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0692 + 0.2398 * presence + 0.4991 * pattern + 0.0999 * (1.0 - deepTrans), 0.8016);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2891), 0.8016);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3913 + 0.6087 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
