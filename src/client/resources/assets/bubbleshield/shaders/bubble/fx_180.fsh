...
// stack: deep=fbm x3 taps | mid=kaleido+warp2+pulse | rim=lat | flourish=swirl | tex=cracked_glass
// fbm: turb x5 octaves | seed c9349255a25db86e
// v8 realism: refr 0.8811+1.2092*fres/dist (cap 0.1443) | energy 0.2690+0.3555*p | flow 0.093333 c/s | soft 0.6821m
...
void main() {
    ...
    float refrAmp = min((0.8811 + 1.2092 * fresnel) / max(length(worldPos), 1.0), 0.1443);
