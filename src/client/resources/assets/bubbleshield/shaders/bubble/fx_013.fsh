...
// stack: deep=fbm x3 taps | mid=plasma+warp1+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0468 + 0.3057 * presence + 0.4369 * pattern + 0.0951 * (1.0 - deepTrans), 0.8044);
