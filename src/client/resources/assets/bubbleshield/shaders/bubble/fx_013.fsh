...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7968, 0.0, 1.0);
    ...
    deepCol += 0.4188 * dp * mix(baseCol, deepStop, 0.3577);
    deepPat += 0.4188 * dp;
    dp = deepField(rotA(spinAxis, time * 0.078540) * (sdir * 4.9434) + par * 0.1388, time);
    deepCol += 0.1754 * dp * mix(baseCol, deepStop, 0.7153);
    deepPat += 0.1754 * dp;
    deepCol *= 0.7868;
    deepPat = pow(clamp(deepPat * 0.6273, 0.0, 1.0), 1.0355);
    ...
    float alpha = vertexColor.a * min(0.0468 + 0.3057 * presence + 0.4369 * pattern, 0.8044);
