...
// stack: deep=ridge x3 taps | mid=ribbonaurora+curl+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0749 + 0.1503 * presence + 0.4484 * pattern + 0.0890 * (1.0 - deepTrans), 0.8081);
