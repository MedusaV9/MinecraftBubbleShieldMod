...
// stack: deep=caustic x3 taps | mid=fluidink+curl+flicker | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0521 + 0.2456 * presence + 0.4548 * pattern + 0.1413 * (1.0 - deepTrans), 0.8337);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1731), 0.8337);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5387 + 0.4613 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
