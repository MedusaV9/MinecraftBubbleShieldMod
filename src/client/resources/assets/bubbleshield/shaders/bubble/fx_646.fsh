...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.6859 + fiR.y * 0.4118)), 0.2534);
    ...
    float alpha = vertexColor.a * min(0.0521 + 0.3056 * presence + 0.4548 * pattern + 0.1413 * (1.0 - deepTrans), 0.8337);
    // [layer:v5:backface]
