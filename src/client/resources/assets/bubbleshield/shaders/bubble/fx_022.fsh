...
// stack: deep=voro x4 taps | mid=hex+curl+flicker | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0607 + 0.3450 * presence + 0.3792 * pattern + 0.1229 * (1.0 - deepTrans), 0.7837);
