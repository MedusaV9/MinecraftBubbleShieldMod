...
// stack: deep=voro x4 taps | mid=voidrift+curl+scroll | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.1619 * presence + 0.4292 * pattern + 0.1311 * (1.0 - deepTrans), 0.8336);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3368), 0.8336);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4744 + 0.5256 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
