...
// stack: deep=fbm x4 taps | mid=voidtendril+none+pulse | rim=lat | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0685 + 0.2093 * presence + 0.4642 * pattern + 0.1391 * (1.0 - deepTrans), 0.8501);
