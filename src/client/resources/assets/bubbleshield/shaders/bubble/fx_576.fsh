...
// stack: deep=ridge x3 taps | mid=oilslick+warp2+scroll | rim=lat | flourish=glint | tex=chrome
// fbm: standard x4 octaves | seed 718d9848edf8b0e1
// v8 realism: refr 0.9692+1.5745*fres/dist (cap 0.1383) | energy 0.2132+0.4542*p | flow 0.075833 c/s | soft 0.5236m
...
void main() {
    ...
    float refrAmp = min((0.9692 + 1.5745 * fresnel) / max(length(worldPos), 1.0), 0.1383);
