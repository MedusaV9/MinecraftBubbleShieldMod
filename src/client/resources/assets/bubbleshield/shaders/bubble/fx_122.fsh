...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7221, 0.0, 1.0);
    ...
    deepCol += 0.4023 * dp * mix(baseCol, deepStop, 0.3859);
    deepPat += 0.4023 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 3.2333) + par * 0.0860, time);
    deepCol += 0.1618 * dp * mix(baseCol, deepStop, 0.7717);
    deepPat += 0.1618 * dp;
    deepCol *= 0.8296;
    deepPat = pow(clamp(deepPat * 0.6394, 0.0, 1.0), 1.1242);
    ...
    rgb += hotStop * 0.3365 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0582 + 0.3340 * presence + 0.4848 * pattern, 0.7819);
