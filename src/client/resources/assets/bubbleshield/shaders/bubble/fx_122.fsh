...
// stack: deep=fbm x3 taps | mid=vortex+curl+flicker | rim=graze | flourish=glint | tex=marble_ink
// fbm: standard x5 octaves | seed e6b6efa37940f067
// v8 realism: refr 0.5793+0.7990*fres/dist (cap 0.1301) | energy 0.3097+0.5385*p | flow 0.094167 c/s | soft 0.8723m
...
void main() {
    ...
    float refrAmp = min((0.5793 + 0.7990 * fresnel) / max(length(worldPos), 1.0), 0.1301);
