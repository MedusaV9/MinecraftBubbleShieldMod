...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.008333, -0.048333) * time, time);
    deep += 0.4023 * deepField(duvBase + rimDir * 0.0430 + vec2(0.013333, -0.075000) * time, time);
    deep += 0.1618 * deepField(duvBase + rimDir * 0.0860 + vec2(0.017500, -0.101667) * time, time);
    deep = pow(clamp(deep * 0.6394, 0.0, 1.0), 1.1242);
