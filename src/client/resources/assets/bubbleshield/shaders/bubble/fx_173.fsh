...
void main() {
    ...
    mid = clamp(mid * (0.6954 + 0.7495 * texDetail) + 0.3390 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5813 + 0.4898 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1187 * (0.5 + 0.5 * sin(time * 0.193732)));
    rgb += emit * 0.9024 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4037 + 0.3995 * presence + 0.4043 * pattern + 0.0808 * (1.0 - deepTrans) + 0.1423 * emit, 0.8513);
