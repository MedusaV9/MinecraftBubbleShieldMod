...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6004, 0.0, 1.0);
    ...
    deepCol += 0.5196 * dp * mix(baseCol, deepStop, 0.3892);
    deepPat += 0.5196 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.8700) + par * 0.1201, time);
    deepCol += 0.2700 * dp * mix(baseCol, deepStop, 0.7785);
    deepPat += 0.2700 * dp;
    deepCol *= 0.5857;
    deepPat = pow(clamp(deepPat * 0.5588, 0.0, 1.0), 1.0383);
    ...
    rgb += hotStop * 0.3436 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.2644 * presence + 0.3918 * pattern, 0.8016);
