...
// stack: deep=caustic x3 taps | mid=lightning+curl+scroll | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0723 + 0.2644 * presence + 0.3918 * pattern + 0.1078 * (1.0 - deepTrans), 0.8016);
