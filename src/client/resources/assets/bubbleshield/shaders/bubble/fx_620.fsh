...
// stack: deep=caustic x3 taps | mid=spectralveil+none+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0541 + 0.1618 * presence + 0.4207 * pattern + 0.0939 * (1.0 - deepTrans), 0.7475);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3480), 0.7475);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3859 + 0.6141 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
