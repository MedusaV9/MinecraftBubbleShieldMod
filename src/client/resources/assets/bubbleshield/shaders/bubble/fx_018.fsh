...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.5543, 0.0, 1.0);
    ...
    deepCol += 0.4160 * dp * mix(baseCol, deepStop, 0.2632);
    deepPat += 0.4160 * dp;
    dp = deepField(rotA(spinAxis, time * 0.073304) * (sdir * 3.0069) + par * 0.1332, time);
    deepCol += 0.1730 * dp * mix(baseCol, deepStop, 0.5264);
    deepPat += 0.1730 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.6762) + par * 0.1998, time);
    deepCol += 0.0720 * dp * mix(baseCol, deepStop, 0.7896);
    deepPat += 0.0720 * dp;
    deepCol *= 0.5878;
    deepPat = pow(clamp(deepPat * 0.6020, 0.0, 1.0), 1.4856);
    ...
    rgb += hotStop * 0.2856 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0505 + 0.2920 * presence + 0.4203 * pattern, 0.8577);
