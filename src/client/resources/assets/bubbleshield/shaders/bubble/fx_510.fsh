...
// stack: deep=fbm x3 taps | mid=phantomecho+none+flicker | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0547 + 0.1507 * presence + 0.5631 * pattern + 0.1280 * (1.0 - deepTrans), 0.8146);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1909), 0.8146);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4066 + 0.5934 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
