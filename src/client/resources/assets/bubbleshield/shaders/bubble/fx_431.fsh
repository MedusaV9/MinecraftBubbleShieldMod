...
// stack: deep=fbm x3 taps | mid=gravlens+warp1+pulse | rim=lat | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0527 + 0.1376 * presence + 0.5307 * pattern + 0.1294 * (1.0 - deepTrans), 0.8015);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2719), 0.8015);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3900 + 0.6100 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
