...
// stack: deep=fbm x4 taps | mid=waves+warp1+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0422 + 0.3313 * presence + 0.4482 * pattern + 0.0920 * (1.0 - deepTrans), 0.7828);
