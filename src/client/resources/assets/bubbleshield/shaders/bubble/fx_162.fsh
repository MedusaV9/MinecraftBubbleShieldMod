...
// stack: deep=fbm x4 taps | mid=waves+warp1+rotate | rim=graze | flourish=shimmer | tex=caustic_web
// fbm: standard x5 octaves | seed 40d032a4a028109b
// v8 realism: refr 0.7131+0.8440*fres/dist (cap 0.1496) | energy 0.2135+0.3986*p | flow 0.092500 c/s | soft 0.7545m
...
void main() {
    ...
    float refrAmp = min((0.7131 + 0.8440 * fresnel) / max(length(worldPos), 1.0), 0.1496);
