...
void main() {
    ...
    mid = clamp(mid * (0.6993 + 0.7089 * texDetail) + 0.1893 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7783 + 0.3490 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1434 * (0.5 + 0.5 * sin(time * 0.146608)));
    rgb += emit * 0.6583 * emitCol;
    // [layer:v5:softknee]
    ...
    float alpha = vertexColor.a * min(0.3734 + 0.2996 * presence + 0.5515 * pattern + 0.0994 * (1.0 - deepTrans) + 0.1332 * emit, 0.9090);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1853), 0.9090);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.7536 + 0.2464 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
