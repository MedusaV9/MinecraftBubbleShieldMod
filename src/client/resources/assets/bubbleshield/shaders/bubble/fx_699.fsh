...
// stack: deep=caustic x3 taps | mid=voidrift+warp1+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0744 + 0.1596 * presence + 0.5515 * pattern + 0.0994 * (1.0 - deepTrans), 0.8490);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1853), 0.8490);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5219 + 0.4781 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
