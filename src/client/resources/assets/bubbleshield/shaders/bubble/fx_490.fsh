...
// stack: deep=ridge x4 taps | mid=phantomecho+curl+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0423 + 0.1463 * presence + 0.5554 * pattern + 0.0993 * (1.0 - deepTrans), 0.7668);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2887), 0.7668);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5133 + 0.4867 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
