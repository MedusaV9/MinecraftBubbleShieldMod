...
// stack: deep=caustic x4 taps | mid=aurora+curl+scroll | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0422 + 0.3482 * presence + 0.3652 * pattern + 0.1429 * (1.0 - deepTrans), 0.8223);
