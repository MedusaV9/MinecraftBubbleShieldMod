...
// stack: deep=caustic x4 taps | mid=aurora+curl+scroll | rim=graze_film | flourish=shimmer | tex=filaments
// fbm: ridged x5 octaves | seed 54e58b1cde48ed78
// v8 realism: refr 0.6290+0.6974*fres/dist (cap 0.1280) | energy 0.3694+0.4170*p | flow 0.098333 c/s | soft 0.8283m
...
void main() {
    ...
    float refrAmp = min((0.6290 + 0.6974 * fresnel) / max(length(worldPos), 1.0), 0.1280);
