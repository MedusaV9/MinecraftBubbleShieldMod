...
void main() {
    ...
    deep += 0.4284 * deepField(duvBase + rimDir * 0.0502 + vec2(0.021667, 0.042500) * time, time);
    deep += 0.1835 * deepField(duvBase + rimDir * 0.1004 + vec2(0.030000, 0.057500) * time, time);
    deep = pow(clamp(deep * 0.6204, 0.0, 1.0), 1.7349);
