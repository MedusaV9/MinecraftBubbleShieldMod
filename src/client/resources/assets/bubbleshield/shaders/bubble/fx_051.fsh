...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7259, 0.0, 1.0);
    ...
    deepCol += 0.4284 * dp * mix(baseCol, deepStop, 0.2586);
    deepPat += 0.4284 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 5.5985) + par * 0.1004, time);
    deepCol += 0.1835 * dp * mix(baseCol, deepStop, 0.5171);
    deepPat += 0.1835 * dp;
    dp = deepField(rotA(spinAxis, time * 0.041888) * (sdir * 7.0657) + par * 0.1506, time);
    deepCol += 0.0786 * dp * mix(baseCol, deepStop, 0.7757);
    deepPat += 0.0786 * dp;
    deepCol *= 0.7536;
    deepPat = pow(clamp(deepPat * 0.5915, 0.0, 1.0), 1.7349);
    ...
    rgb += hotStop * 0.2531 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0422 + 0.3482 * presence + 0.3652 * pattern, 0.8223);
