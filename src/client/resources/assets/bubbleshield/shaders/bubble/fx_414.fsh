...
// stack: deep=caustic x3 taps | mid=emberstorm+warp2+scroll | rim=graze_film | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0444 + 0.1860 * presence + 0.5233 * pattern + 0.0977 * (1.0 - deepTrans), 0.8169);
