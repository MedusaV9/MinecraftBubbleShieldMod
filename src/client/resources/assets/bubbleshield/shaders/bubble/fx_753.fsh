...
// stack: deep=fbm x3 taps | mid=solarflare+warp1+pulse | rim=graze_sparkle | flourish=swirl | tex=worley_cells
// fbm: turb x3 octaves | seed e165b47f702952d8
// v8 realism: refr 0.4736+0.6069*fres/dist (cap 0.1284) | energy 0.4155+0.5467*p | flow 0.112500 c/s | soft 0.5968m
...
void main() {
    ...
    float refrAmp = min((0.4736 + 0.6069 * fresnel) / max(length(worldPos), 1.0), 0.1284);
