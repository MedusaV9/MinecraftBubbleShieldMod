...
// stack: deep=fbm x3 taps | mid=solarflare+warp1+pulse | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0579 + 0.1654 * presence + 0.5149 * pattern + 0.1433 * (1.0 - deepTrans), 0.7894);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1778), 0.7894);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5274 + 0.4726 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
