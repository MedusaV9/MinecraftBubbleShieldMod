...
void main() {
    ...
    mid = clamp(mid * (0.6474 + 0.5932 * texDetail) + 0.3213 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5519 + 0.3576 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0866 * (0.5 + 0.5 * sin(time * 0.209440)));
    rgb += emit * 0.6641 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4113 + 0.4390 * presence + 0.4074 * pattern + 0.1233 * (1.0 - deepTrans) + 0.1664 * emit, 0.8794);
