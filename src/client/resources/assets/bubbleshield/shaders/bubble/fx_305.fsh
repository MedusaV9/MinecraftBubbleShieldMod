...
// stack: deep=fbm x4 taps | mid=caustic+warp1+rotate | rim=graze_sparkle | flourish=swirl | tex=caustic_web
// fbm: standard x5 octaves | seed 0b28ebd83dddbc39
// v8 realism: refr 0.8796+1.2723*fres/dist (cap 0.1394) | energy 0.2418+0.4331*p | flow 0.058333 c/s | soft 1.0887m
...
void main() {
    ...
    float refrAmp = min((0.8796 + 1.2723 * fresnel) / max(length(worldPos), 1.0), 0.1394);
