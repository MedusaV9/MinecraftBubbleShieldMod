...
// stack: deep=fbm x4 taps | mid=caustic+warp1+rotate | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0681 + 0.2990 * presence + 0.4074 * pattern + 0.1233 * (1.0 - deepTrans), 0.8194);
