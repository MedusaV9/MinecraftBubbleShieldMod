...
// stack: deep=caustic x4 taps | mid=spectralveil+curl+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0656 + 0.1558 * presence + 0.5099 * pattern + 0.0982 * (1.0 - deepTrans), 0.7688);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3315), 0.7688);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4518 + 0.5482 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
