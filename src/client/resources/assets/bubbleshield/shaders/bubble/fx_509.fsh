...
// stack: deep=ridge x3 taps | mid=stainedglass+curl+flicker | rim=lat | flourish=glint | tex=worley_cells
// fbm: ridged x4 octaves | seed 3da13551745ad6bb
// v8 realism: refr 0.7738+0.9503*fres/dist (cap 0.1008) | energy 0.1978+0.3909*p | flow 0.072500 c/s | soft 0.8937m
...
void main() {
    ...
    float refrAmp = min((0.7738 + 0.9503 * fresnel) / max(length(worldPos), 1.0), 0.1008);
