...
// stack: deep=ridge x3 taps | mid=stainedglass+curl+flicker | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0483 + 0.3467 * presence + 0.4674 * pattern + 0.1118 * (1.0 - deepTrans), 0.8887);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2909), 0.8887);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5464 + 0.4536 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
