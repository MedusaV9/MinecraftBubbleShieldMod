...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7326, 0.0, 1.0);
    ...
    deepCol += 0.4095 * dp * mix(baseCol, deepStop, 0.3154);
    deepPat += 0.4095 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 3.1793) + par * 0.0827, time);
    deepCol += 0.1677 * dp * mix(baseCol, deepStop, 0.6308);
    deepPat += 0.1677 * dp;
    deepCol *= 0.7487;
    deepPat = pow(clamp(deepPat * 0.6341, 0.0, 1.0), 1.5843);
    ...
    rgb += hotStop * 0.1807 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0711 + 0.2424 * presence + 0.4477 * pattern, 0.7972);
