...
// stack: deep=ridge x4 taps | mid=solarflare+warp1+scroll | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0443 + 0.1743 * presence + 0.5523 * pattern + 0.1571 * (1.0 - deepTrans), 0.8531);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2803), 0.8531);
    // [layer:v5:ghostalpha]
