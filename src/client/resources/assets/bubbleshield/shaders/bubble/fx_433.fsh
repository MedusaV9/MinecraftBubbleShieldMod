...
// stack: deep=ridge x4 taps | mid=solarflare+warp1+scroll | rim=graze_film | flourish=shimmer | tex=worley_cells
// fbm: turb x5 octaves | seed 9acd09933bb4ebaf
// v8 realism: refr 0.5160+0.7559*fres/dist (cap 0.1292) | energy 0.3992+0.4738*p | flow 0.079167 c/s | soft 0.9224m
...
void main() {
    ...
    float refrAmp = min((0.5160 + 0.7559 * fresnel) / max(length(worldPos), 1.0), 0.1292);
