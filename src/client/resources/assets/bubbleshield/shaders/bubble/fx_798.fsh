...
// stack: deep=fbm x3 taps | mid=ectoplasm+warp2+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0588 + 0.2101 * presence + 0.4343 * pattern + 0.1445 * (1.0 - deepTrans), 0.8369);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2725), 0.8369);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4524 + 0.5476 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
