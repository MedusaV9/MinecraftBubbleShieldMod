...
void main() {
    ...
    float flourish = 0.3312 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
    ...
    rgb = mix(rgb, hotStop, clamp(ecEdge, 0.0, 1.0) * 0.3801);
    ...
    float alpha = vertexColor.a * min(0.0588 + 0.2677 * presence + 0.4343 * pattern + 0.1445 * (1.0 - deepTrans), 0.8369);
    // [layer:v5:backface]
