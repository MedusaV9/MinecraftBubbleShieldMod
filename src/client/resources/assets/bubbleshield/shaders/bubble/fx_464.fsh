...
// stack: deep=fbm x4 taps | mid=orbittrap+warp1+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0686 + 0.1568 * presence + 0.4660 * pattern + 0.0899 * (1.0 - deepTrans), 0.8276);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2016), 0.8276);
    // [layer:v5:ghostalpha]
