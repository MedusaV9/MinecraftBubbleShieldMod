...
// stack: deep=ridge x4 taps | mid=orbittrap+curl+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0428 + 0.1986 * presence + 0.4537 * pattern + 0.1347 * (1.0 - deepTrans), 0.8069);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3450), 0.8069);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3829 + 0.6171 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
