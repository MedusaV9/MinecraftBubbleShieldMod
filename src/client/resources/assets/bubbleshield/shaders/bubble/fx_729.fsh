...
// stack: deep=ridge x3 taps | mid=stainedglass+none+rotate | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0791 + 0.3172 * presence + 0.4110 * pattern + 0.0979 * (1.0 - deepTrans), 0.8575);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3233), 0.8575);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4266 + 0.5734 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
