...
// stack: deep=voro x4 taps | mid=solarflare+warp2+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0624 + 0.1695 * presence + 0.5536 * pattern + 0.1561 * (1.0 - deepTrans), 0.8048);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3193), 0.8048);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5066 + 0.4934 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
