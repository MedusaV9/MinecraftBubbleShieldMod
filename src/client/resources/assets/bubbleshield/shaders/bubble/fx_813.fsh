...
// stack: deep=voro x4 taps | mid=solarflare+warp2+rotate | rim=graze_sparkle | flourish=echo | tex=worley_cells
// fbm: ridged x3 octaves | seed 7d8828f838266458
// v8 realism: refr 0.6677+0.7642*fres/dist (cap 0.1204) | energy 0.3589+0.4391*p | flow 0.090000 c/s | soft 0.5728m
...
void main() {
    ...
    float refrAmp = min((0.6677 + 0.7642 * fresnel) / max(length(worldPos), 1.0), 0.1204);
