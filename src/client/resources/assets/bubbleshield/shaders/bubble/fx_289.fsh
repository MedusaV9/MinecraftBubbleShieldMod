...
// stack: deep=voro x4 taps | mid=caustic+none+rotate | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0602 + 0.2635 * presence + 0.3856 * pattern + 0.1357 * (1.0 - deepTrans), 0.8573);
