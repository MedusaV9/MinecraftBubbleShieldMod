...
void main() {
    ...
    mid = clamp(mid * (0.6851 + 0.5667 * texDetail) + 0.2878 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.5537 + 0.3483 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1111 * (0.5 + 0.5 * sin(time * 0.141372)));
    rgb += emit * 0.9830 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3879 + 0.4035 * presence + 0.3856 * pattern + 0.1357 * (1.0 - deepTrans) + 0.1810 * emit, 0.9173);
