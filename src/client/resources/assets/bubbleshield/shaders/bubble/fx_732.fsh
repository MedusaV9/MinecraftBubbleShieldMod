...
// stack: deep=voro x3 taps | mid=mycelia+none+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0591 + 0.1794 * presence + 0.5809 * pattern + 0.0819 * (1.0 - deepTrans), 0.8208);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1635), 0.8208);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4587 + 0.5413 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
