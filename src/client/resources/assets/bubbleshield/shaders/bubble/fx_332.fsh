...
// stack: deep=ridge x3 taps | mid=sparkle+warp2+flicker | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0467 + 0.3591 * presence + 0.3568 * pattern + 0.1311 * (1.0 - deepTrans), 0.8362);
