...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7475, 0.0, 1.0);
    ...
    deepCol += 0.4408 * dp * mix(baseCol, deepStop, 0.3849);
    deepPat += 0.4408 * dp;
    dp = deepField(rotA(spinAxis, time * 0.052360) * (sdir * 4.0652) + par * 0.0865, time);
    deepCol += 0.1943 * dp * mix(baseCol, deepStop, 0.7698);
    deepPat += 0.1943 * dp;
    deepCol *= 0.7140;
    deepPat = pow(clamp(deepPat * 0.6116, 0.0, 1.0), 1.1208);
    ...
    rgb += hotStop * 0.2443 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0467 + 0.3591 * presence + 0.3568 * pattern, 0.8362);
