...
// stack: deep=voro x4 taps | mid=spectralveil+curl+pulse | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0685 + 0.1442 * presence + 0.5157 * pattern + 0.0813 * (1.0 - deepTrans), 0.8124);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2849), 0.8124);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3804 + 0.6196 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
