...
void main() {
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.8524 + fiR.y * 0.5722)), 0.2763);
    ...
    float alpha = vertexColor.a * min(0.0715 + 0.2945 * presence + 0.4269 * pattern + 0.0874 * (1.0 - deepTrans), 0.8592);
    // [layer:v5:backface]
