...
// stack: deep=caustic x3 taps | mid=fluidink+none+rotate | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0715 + 0.2345 * presence + 0.4269 * pattern + 0.0874 * (1.0 - deepTrans), 0.8592);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2521), 0.8592);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.3990 + 0.6010 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
