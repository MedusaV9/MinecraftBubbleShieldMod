...
// stack: deep=ridge x3 taps | mid=orbittrap+warp1+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0582 + 0.1582 * presence + 0.5259 * pattern + 0.1574 * (1.0 - deepTrans), 0.8034);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1872), 0.8034);
    // [layer:v5:ghostalpha]
