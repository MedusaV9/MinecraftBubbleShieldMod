...
// stack: deep=ridge x3 taps | mid=waves+none+flicker | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0506 + 0.2968 * presence + 0.4195 * pattern + 0.1137 * (1.0 - deepTrans), 0.8302);
