...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.007500, 0.010000) * time, time);
    deep += 0.5361 * deepField(duvBase + rimDir * 0.0357 + vec2(-0.010000, 0.016667) * time, time);
    deep = pow(clamp(deep * 0.6510, 0.0, 1.0), 1.1827);
