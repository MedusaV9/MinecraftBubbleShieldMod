...
// stack: deep=ridge x4 taps | mid=thinfilm+warp2+rotate | rim=graze_film | flourish=glint | tex=chrome
// fbm: standard x3 octaves | seed d45e17481c636002
// v8 realism: refr 0.8107+1.4270*fres/dist (cap 0.1403) | energy 0.2557+0.4298*p | flow 0.052500 c/s | soft 0.5330m
...
void main() {
    ...
    float refrAmp = min((0.8107 + 1.4270 * fresnel) / max(length(worldPos), 1.0), 0.1403);
