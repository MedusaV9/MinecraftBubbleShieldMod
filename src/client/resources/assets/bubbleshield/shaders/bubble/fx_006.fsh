...
// stack: deep=ridge x4 taps | mid=arcs+warp1+pulse | rim=graze_film | flourish=glint | tex=filaments
// fbm: turb x4 octaves | seed d93a0560b24361be
// v8 realism: refr 0.6183+0.5777*fres/dist (cap 0.1595) | energy 0.3166+0.5172*p | flow 0.059167 c/s | soft 0.6488m
...
void main() {
    ...
    float refrAmp = min((0.6183 + 0.5777 * fresnel) / max(length(worldPos), 1.0), 0.1595);
