...
// stack: deep=caustic x3 taps | mid=chrome+curl+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0409 + 0.3772 * presence + 0.4066 * pattern + 0.0936 * (1.0 - deepTrans), 0.8862);
