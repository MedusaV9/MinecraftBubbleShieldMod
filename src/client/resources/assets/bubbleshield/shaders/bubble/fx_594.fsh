...
// stack: deep=voro x4 taps | mid=deepice+warp1+pulse | rim=graze_sparkle | flourish=swirl | tex=cracked_glass
// fbm: ridged x4 octaves | seed 36752f6d000080fb
// v8 realism: refr 0.7018+1.0387*fres/dist (cap 0.1522) | energy 0.1808+0.3897*p | flow 0.078333 c/s | soft 0.5845m
...
void main() {
    ...
    float refrAmp = min((0.7018 + 1.0387 * fresnel) / max(length(worldPos), 1.0), 0.1522);
