...
// stack: deep=fbm x4 taps | mid=ectoplasm+none+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0561 + 0.1922 * presence + 0.4565 * pattern + 0.1226 * (1.0 - deepTrans), 0.7820);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2640), 0.7820);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4442 + 0.5558 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
