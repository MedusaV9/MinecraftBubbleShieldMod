...
// stack: deep=caustic x3 taps | mid=prismdisperse+warp2+rotate | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0706 + 0.2752 * presence + 0.3653 * pattern + 0.1511 * (1.0 - deepTrans), 0.8378);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3151), 0.8378);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4075 + 0.5925 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
