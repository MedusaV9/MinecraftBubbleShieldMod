...
// stack: deep=fbm x3 taps | mid=gravlens+curl+rotate | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0439 + 0.1397 * presence + 0.4889 * pattern + 0.0828 * (1.0 - deepTrans), 0.8583);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2939), 0.8583);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4285 + 0.5715 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
