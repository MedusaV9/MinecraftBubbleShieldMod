...
// stack: deep=ridge x4 taps | mid=prismdisperse+none+scroll | rim=graze_film | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0663 + 0.2728 * presence + 0.3464 * pattern + 0.0823 * (1.0 - deepTrans), 0.8147);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3394), 0.8147);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4437 + 0.5563 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
