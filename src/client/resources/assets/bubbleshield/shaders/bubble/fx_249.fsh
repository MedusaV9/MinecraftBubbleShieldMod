...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6976, 0.0, 1.0);
    ...
    deepCol += 0.4812 * dp * mix(baseCol, deepStop, 0.3646);
    deepPat += 0.4812 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 2.9906) + par * 0.1031, time);
    deepCol += 0.2316 * dp * mix(baseCol, deepStop, 0.7292);
    deepPat += 0.2316 * dp;
    deepCol *= 0.6693;
    deepPat = pow(clamp(deepPat * 0.5838, 0.0, 1.0), 1.4943);
    ...
    float alpha = vertexColor.a * min(0.0503 + 0.3193 * presence + 0.3552 * pattern, 0.8360);
