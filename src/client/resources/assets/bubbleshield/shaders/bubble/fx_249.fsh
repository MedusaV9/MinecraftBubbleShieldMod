...
// stack: deep=fbm x3 taps | mid=hex+none+rotate | rim=graze | flourish=glint | tex=hex_lattice
// fbm: ridged x5 octaves | seed ca8c1cbff6cb6f20
// v8 realism: refr 0.7104+0.8062*fres/dist (cap 0.1373) | energy 0.3302+0.4675*p | flow 0.095833 c/s | soft 0.5753m
...
void main() {
    ...
    float refrAmp = min((0.7104 + 0.8062 * fresnel) / max(length(worldPos), 1.0), 0.1373);
