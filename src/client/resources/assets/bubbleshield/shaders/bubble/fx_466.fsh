...
void main() {
    ...
    float flourish = 0.3110 * sparkle(wuv * 2.0 + 7.7, time * 1.4, midPer.x * 2.0);
    ...
    rgb = mix(rgb, rgb * (0.55 + 0.9 * accentPalette(fiQ.x * 0.5281 + fiR.y * 0.4917)), 0.3250);
    ...
    float alpha = vertexColor.a * min(0.0469 + 0.2949 * presence + 0.4540 * pattern + 0.0802 * (1.0 - deepTrans), 0.8179);
    // [layer:v5:backface]
