...
// stack: deep=caustic x4 taps | mid=fluidink+warp2+rotate | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0469 + 0.2349 * presence + 0.4540 * pattern + 0.0802 * (1.0 - deepTrans), 0.8179);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3077), 0.8179);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4577 + 0.5423 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
