...
// stack: deep=voro x4 taps | mid=oilslick+none+rotate | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0651 + 0.2837 * presence + 0.3321 * pattern + 0.0890 * (1.0 - deepTrans), 0.8513);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1649), 0.8513);
    // [layer:v5:ghostalpha]
