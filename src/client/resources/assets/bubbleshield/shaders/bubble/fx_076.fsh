...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6685, 0.0, 1.0);
    ...
    deepCol += 0.5670 * dp * mix(baseCol, deepStop, 0.3941);
    deepPat += 0.5670 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 3.7678) + par * 0.1384, time);
    deepCol += 0.3215 * dp * mix(baseCol, deepStop, 0.7883);
    deepPat += 0.3215 * dp;
    deepCol *= 0.5824;
    deepPat = pow(clamp(deepPat * 0.5295, 0.0, 1.0), 1.2105);
    ...
    rgb += hotStop * 0.2035 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0771 + 0.3325 * presence + 0.4558 * pattern, 0.8386);
