...
// stack: deep=caustic x3 taps | mid=circuit+curl+flicker | rim=graze | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0771 + 0.3325 * presence + 0.4558 * pattern + 0.1050 * (1.0 - deepTrans), 0.8386);
