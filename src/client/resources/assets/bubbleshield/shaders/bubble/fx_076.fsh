...
void main() {
    ...
    float deep = deepField(duvBase + vec2(-0.048333, 0.002500) * time, time);
    deep += 0.5670 * deepField(duvBase + rimDir * 0.0692 + vec2(-0.075000, 0.005000) * time, time);
    deep = pow(clamp(deep * 0.6382, 0.0, 1.0), 1.2105);
