...
void main() {
    ...
    mid = clamp(mid * (0.6057 + 0.5984 * texDetail) + 0.3412 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.7343 + 0.4688 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.1438 * (0.5 + 0.5 * sin(time * 0.193732)));
    rgb += emit * 0.8764 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.4378 + 0.4725 * presence + 0.4558 * pattern + 0.1050 * (1.0 - deepTrans) + 0.2089 * emit, 0.8986);
