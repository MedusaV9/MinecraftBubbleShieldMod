...
// stack: deep=ridge x3 taps | mid=solarflare+warp2+flicker | rim=graze | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0524 + 0.1741 * presence + 0.5123 * pattern + 0.1163 * (1.0 - deepTrans), 0.8120);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2387), 0.8120);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4509 + 0.5491 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
