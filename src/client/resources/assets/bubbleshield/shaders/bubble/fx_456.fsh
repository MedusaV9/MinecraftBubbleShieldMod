...
// stack: deep=ridge x3 taps | mid=oilslick+none+scroll | rim=graze_film | flourish=swirl | tex=chrome
// fbm: standard x6 octaves | seed c8e3d59b83bd7d76
// v8 realism: refr 1.0398+1.3919*fres/dist (cap 0.1054) | energy 0.2432+0.4541*p | flow 0.112500 c/s | soft 0.6902m
...
void main() {
    ...
    float refrAmp = min((1.0398 + 1.3919 * fresnel) / max(length(worldPos), 1.0), 0.1054);
