...
// stack: deep=ridge x3 taps | mid=oilslick+none+scroll | rim=graze_film | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0759 + 0.3527 * presence + 0.4075 * pattern + 0.1324 * (1.0 - deepTrans), 0.7824);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1551), 0.7824);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5398 + 0.4602 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
