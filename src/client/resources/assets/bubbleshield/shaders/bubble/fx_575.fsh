...
// stack: deep=caustic x3 taps | mid=runecircuit+warp1+scroll | rim=graze | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0413 + 0.1524 * presence + 0.4850 * pattern + 0.1157 * (1.0 - deepTrans), 0.8146);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2977), 0.8146);
    // [layer:v5:ghostalpha]
