...
// stack: deep=caustic x3 taps | mid=runecircuit+warp1+scroll | rim=graze | flourish=swirl | tex=runes
// fbm: ridged x6 octaves | seed ef2ace2a091636cc
// v8 realism: refr 0.3972+0.4416*fres/dist (cap 0.1027) | energy 0.4781+0.4131*p | flow 0.055000 c/s | soft 0.5106m
...
void main() {
    ...
    float refrAmp = min((0.3972 + 0.4416 * fresnel) / max(length(worldPos), 1.0), 0.1027);
