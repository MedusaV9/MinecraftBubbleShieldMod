...
// stack: deep=caustic x4 taps | mid=kaleido+curl+pulse | rim=graze_film | flourish=swirl
...
void main() {
    ...
    rim = clamp(rim + 0.6026 * rimLine, 0.0, 1.4);
    ...
    float alpha = vertexColor.a * min(0.0567 + 0.3957 * presence + 0.3603 * pattern + 0.1529 * (1.0 - deepTrans), 0.8575);
