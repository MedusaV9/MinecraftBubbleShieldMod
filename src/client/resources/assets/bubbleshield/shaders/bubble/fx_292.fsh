...
// stack: deep=caustic x4 taps | mid=kaleido+curl+pulse | rim=graze_film | flourish=swirl | tex=cracked_glass
// fbm: ridged x4 octaves | seed a111d015292b3c4d
// v8 realism: refr 0.7050+1.0786*fres/dist (cap 0.1183) | energy 0.2283+0.4214*p | flow 0.085833 c/s | soft 0.7238m
...
void main() {
    ...
    float refrAmp = min((0.7050 + 1.0786 * fresnel) / max(length(worldPos), 1.0), 0.1183);
