...
// stack: deep=fbm x3 taps | mid=lavaflow+curl+scroll | rim=lat | flourish=glint | tex=cracked_glass
// fbm: turb x5 octaves | seed a1f4d30d106b69e8
// v8 realism: refr 0.2649+0.2394*fres/dist (cap 0.1002) | energy 0.4676+0.4339*p | flow 0.117500 c/s | soft 1.0373m
...
void main() {
    ...
    float refrAmp = min((0.2649 + 0.2394 * fresnel) / max(length(worldPos), 1.0), 0.1002);
