...
// stack: deep=fbm x3 taps | mid=lavaflow+curl+scroll | rim=lat | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0405 + 0.3609 * presence + 0.3571 * pattern + 0.1054 * (1.0 - deepTrans), 0.9131);
