...
// stack: deep=voro x4 taps | mid=runecircuit+none+rotate | rim=graze_film | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0560 + 0.1656 * presence + 0.5047 * pattern + 0.0817 * (1.0 - deepTrans), 0.8472);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2433), 0.8472);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4555 + 0.5445 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
