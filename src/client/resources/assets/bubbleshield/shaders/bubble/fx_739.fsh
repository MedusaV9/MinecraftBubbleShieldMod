...
// stack: deep=caustic x4 taps | mid=voidrift+warp2+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0516 + 0.1438 * presence + 0.4454 * pattern + 0.1069 * (1.0 - deepTrans), 0.8203);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.1748), 0.8203);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.5476 + 0.4524 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
