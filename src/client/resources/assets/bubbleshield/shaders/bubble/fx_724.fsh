...
// stack: deep=caustic x3 taps | mid=orbittrap+warp2+flicker | rim=graze_sparkle | flourish=echo
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0664 + 0.1637 * presence + 0.4851 * pattern + 0.0819 * (1.0 - deepTrans), 0.8433);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.3252), 0.8433);
    // [layer:v5:ghostalpha]
    ...
    alpha *= 0.4144 + 0.5856 * smoothstep(0.03, 0.42, v5Luma);
    // [layer:v5:dither]
