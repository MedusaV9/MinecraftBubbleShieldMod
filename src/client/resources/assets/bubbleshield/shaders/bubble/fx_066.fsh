...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6986, 0.0, 1.0);
    ...
    deepCol += 0.4415 * dp * mix(baseCol, deepStop, 0.4248);
    deepPat += 0.4415 * dp;
    dp = deepField(rotA(spinAxis, time * 0.057596) * (sdir * 3.4691) + par * 0.0726, time);
    deepCol += 0.1949 * dp * mix(baseCol, deepStop, 0.8496);
    deepPat += 0.1949 * dp;
    deepCol *= 0.7671;
    deepPat = pow(clamp(deepPat * 0.6111, 0.0, 1.0), 1.5212);
    ...
    rgb += hotStop * 0.2634 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0464 + 0.2567 * presence + 0.3538 * pattern, 0.8412);
