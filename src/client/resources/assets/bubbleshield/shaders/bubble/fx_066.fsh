...
// stack: deep=fbm x3 taps | mid=starfield+warp2+flicker | rim=graze_sparkle | flourish=glint
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0464 + 0.1103 * presence + 0.4782 * pattern + 0.0943 * (1.0 - deepTrans), 0.8412);
