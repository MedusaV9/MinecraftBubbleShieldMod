...
// v8 realism: refr 0.4441+0.4147*fres/dist (cap 0.1139) | energy 0.4304+0.4077*p | flow 0.119167 c/s | soft 1.3589m
...
void main() {
    ...
    vec3 bumpN = normalize(sdir + (tanU * atlasSlope.x + tanV * atlasSlope.y) * (0.7756 * atlasPoleW));
    ...
    float refrAmp = min((0.4441 + 0.4147 * fresnel) / max(length(worldPos), 1.0), 0.1139);
