...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.7975, 0.0, 1.0);
    ...
    deepCol += 0.4688 * dp * mix(baseCol, deepStop, 0.3680);
    deepPat += 0.4688 * dp;
    dp = deepField(rotA(spinAxis, time * 0.062832) * (sdir * 4.9608) + par * 0.1234, time);
    deepCol += 0.2198 * dp * mix(baseCol, deepStop, 0.7361);
    deepPat += 0.2198 * dp;
    deepCol *= 0.5959;
    deepPat = pow(clamp(deepPat * 0.5922, 0.0, 1.0), 1.5823);
    ...
    rgb += hotStop * 0.2369 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0733 + 0.3538 * presence + 0.3211 * pattern, 0.7986);
