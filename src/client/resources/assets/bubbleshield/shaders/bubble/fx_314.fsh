...
// stack: deep=fbm x3 taps | mid=curlsmoke+curl+scroll | rim=graze_sparkle | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0733 + 0.3538 * presence + 0.3211 * pattern + 0.1596 * (1.0 - deepTrans), 0.7986);
