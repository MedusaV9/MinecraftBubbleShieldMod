...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6710, 0.0, 1.0);
    ...
    deepCol += 0.4063 * dp * mix(baseCol, deepStop, 0.4347);
    deepPat += 0.4063 * dp;
    dp = deepField(rotA(spinAxis, time * 0.068068) * (sdir * 3.6922) + par * 0.1191, time);
    deepCol += 0.1651 * dp * mix(baseCol, deepStop, 0.8694);
    deepPat += 0.1651 * dp;
    deepCol *= 0.6384;
    deepPat = pow(clamp(deepPat * 0.6364, 0.0, 1.0), 1.6031);
    ...
    rgb += hotStop * 0.2181 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0421 + 0.2776 * presence + 0.3234 * pattern, 0.8405);
