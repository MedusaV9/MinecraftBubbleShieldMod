...
// stack: deep=fbm x3 taps | mid=ridged+none+flicker | rim=lat | flourish=swirl
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0421 + 0.2776 * presence + 0.3234 * pattern + 0.1244 * (1.0 - deepTrans), 0.8405);
