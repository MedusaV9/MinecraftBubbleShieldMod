...
// stack: deep=ridge x4 taps | mid=plasma+warp1+scroll | rim=graze_film | flourish=echo | tex=nebula
// fbm: turb x4 octaves | seed d0b03921979108d2
// v8 realism: refr 0.5029+0.4659*fres/dist (cap 0.1463) | energy 0.3092+0.4211*p | flow 0.098333 c/s | soft 0.6744m
...
void main() {
    ...
    float refrAmp = min((0.5029 + 0.4659 * fresnel) / max(length(worldPos), 1.0), 0.1463);
