...
void main() {
    ...
    float deep = deepField(duvBase + vec2(0.023333, -0.005000) * time, time);
    deep += 0.4841 * deepField(duvBase + rimDir * 0.0321 + vec2(0.035000, -0.007500) * time, time);
    deep += 0.2343 * deepField(duvBase + rimDir * 0.0642 + vec2(0.048333, -0.012500) * time, time);
    deep += 0.1134 * deepField(duvBase + rimDir * 0.0964 + vec2(0.061667, -0.015000) * time, time);
    deep = pow(clamp(deep * 0.5459, 0.0, 1.0), 1.2809);
    ...
    float pn = fbm2(wuv + vec2(fbm2(wuv + vec2(time * 0.091667, 0.0), midPer), fbm2(wuv - vec2(0.0, time * 0.087500), midPer)), midPer);
