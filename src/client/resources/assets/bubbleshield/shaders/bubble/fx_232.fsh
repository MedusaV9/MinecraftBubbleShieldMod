...
void main() {
    ...
    mid = clamp(mid * (0.6469 + 0.6726 * texDetail) + 0.3359 * texDetail, 0.0, 1.5);
    ...
    float emit = atlas.a * (0.6240 + 0.3390 * clamp(pattern, 0.0, 1.0)) * (1.0 - 0.0948 * (0.5 + 0.5 * sin(time * 0.214675)));
    rgb += emit * 0.7470 * emitCol;
    ...
    float alpha = vertexColor.a * min(0.3455 + 0.5081 * presence + 0.3411 * pattern + 0.1438 * (1.0 - deepTrans) + 0.1273 * emit, 0.8828);
