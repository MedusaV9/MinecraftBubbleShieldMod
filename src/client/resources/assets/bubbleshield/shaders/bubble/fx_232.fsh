...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6459, 0.0, 1.0);
    ...
    deepCol += 0.4841 * dp * mix(baseCol, deepStop, 0.2911);
    deepPat += 0.4841 * dp;
    dp = deepField(rotA(spinAxis, time * 0.031416) * (sdir * 5.1157) + par * 0.0642, time);
    deepCol += 0.2343 * dp * mix(baseCol, deepStop, 0.5822);
    deepPat += 0.2343 * dp;
    dp = deepField(rotA(spinAxis, time * 0.026180) * (sdir * 6.3156) + par * 0.0964, time);
    deepCol += 0.1134 * dp * mix(baseCol, deepStop, 0.8734);
    deepPat += 0.1134 * dp;
    deepCol *= 0.5934;
    deepPat = pow(clamp(deepPat * 0.5459, 0.0, 1.0), 1.2809);
    ...
    rgb += hotStop * 0.3276 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0459 + 0.3681 * presence + 0.3411 * pattern, 0.8228);
