...
// stack: deep=ridge x3 taps | mid=hex+curl+rotate | rim=lat | flourish=shimmer | tex=hex_lattice
// fbm: turb x4 octaves | seed d840572fed530b7f
// v8 realism: refr 0.6285+0.6945*fres/dist (cap 0.1028) | energy 0.3779+0.5264*p | flow 0.056667 c/s | soft 0.5964m
...
void main() {
    ...
    float refrAmp = min((0.6285 + 0.6945 * fresnel) / max(length(worldPos), 1.0), 0.1028);
