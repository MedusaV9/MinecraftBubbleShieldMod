...
// stack: deep=ridge x3 taps | mid=plasmaglobe+warp2+scroll | rim=graze_sparkle | flourish=shimmer | tex=filaments
// fbm: ridged x3 octaves | seed 8c6563da0db8d911
// v8 realism: refr 0.6283+0.9062*fres/dist (cap 0.1440) | energy 0.4067+0.5309*p | flow 0.116667 c/s | soft 1.0678m
...
void main() {
    ...
    float refrAmp = min((0.6283 + 0.9062 * fresnel) / max(length(worldPos), 1.0), 0.1440);
