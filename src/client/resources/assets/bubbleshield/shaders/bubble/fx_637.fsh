...
// stack: deep=ridge x3 taps | mid=plasmaglobe+warp2+scroll | rim=graze_sparkle | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0781 + 0.0958 * presence + 0.6136 * pattern + 0.0887 * (1.0 - deepTrans), 0.8717);
    // [layer:v5:backface]
    ...
    alpha = min(alpha * (1.0 + v5Back * 0.2793), 0.8717);
    // [layer:v5:ghostalpha]
