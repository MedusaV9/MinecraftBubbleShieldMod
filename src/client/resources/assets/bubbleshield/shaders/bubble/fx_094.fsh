...
void main() {
    ...
    vec3 hotStop = clamp(1.0 - (1.0 - spun) * (1.0 - spun) * 0.6595, 0.0, 1.0);
    ...
    deepCol += 0.5201 * dp * mix(baseCol, deepStop, 0.3414);
    deepPat += 0.5201 * dp;
    dp = deepField(rotA(spinAxis, time * 0.047124) * (sdir * 3.8162) + par * 0.1496, time);
    deepCol += 0.2705 * dp * mix(baseCol, deepStop, 0.6828);
    deepPat += 0.2705 * dp;
    deepCol *= 0.6446;
    deepPat = pow(clamp(deepPat * 0.5584, 0.0, 1.0), 1.5044);
    ...
    rgb += hotStop * 0.2806 * smoothstep(0.72, 1.0, pattern);
    ...
    float alpha = vertexColor.a * min(0.0674 + 0.2864 * presence + 0.3452 * pattern, 0.8304);
