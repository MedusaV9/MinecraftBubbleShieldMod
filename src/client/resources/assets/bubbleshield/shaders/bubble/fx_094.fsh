...
// stack: deep=voro x3 taps | mid=arcs+warp2+flicker | rim=graze | flourish=shimmer
...
void main() {
    ...
    float alpha = vertexColor.a * min(0.0674 + 0.2864 * presence + 0.3452 * pattern + 0.1212 * (1.0 - deepTrans), 0.8304);
