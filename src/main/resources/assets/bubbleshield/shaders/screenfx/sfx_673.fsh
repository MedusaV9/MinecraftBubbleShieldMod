...
// for effect 673. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:wobble:sincos:pulse:none]
...
void main() {
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1286);
