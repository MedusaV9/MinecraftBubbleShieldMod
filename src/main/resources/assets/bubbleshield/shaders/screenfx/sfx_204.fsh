...
void main() {
    ...
    float scanY = 0.5 + 0.5 * sin((texCoord.y * ParamsA.z - anim * 0.3339) * 6.2831);
    float scanX = 0.5 + 0.5 * sin((texCoord.x * ParamsA.z * 0.7159 + anim * 0.3401) * 6.2831);
    ...
    vec2 oCell = floor(texCoord * InSize / 12.3712);
