...
// for effect 807. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:thermal:banded:steady:sparkle]
...
void main() {
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1537), 0.0, 1.5);
