...
// for effect 306. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:chroma:zoned:pulse:none]
...
void main() {
    ...
    float zone = 0.5 + 0.5 * sin(centerDist * 13.8891 - anim);
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.2176);
