...
// for effect 705. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:desat:tunnel:surge:none]
...
void main() {
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1244);
