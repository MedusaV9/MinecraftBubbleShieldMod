...
// for effect 109. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:chroma:zoned:surge:grain]
...
void main() {
    ...
    float grainFrame = mod(floor(anim * 7.2200), 256.0);
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1200), 0.0, 1.5);
