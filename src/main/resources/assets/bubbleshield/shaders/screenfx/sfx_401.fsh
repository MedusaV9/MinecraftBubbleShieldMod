...
// for effect 401. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:chroma:zoned:steady:none]
...
void main() {
    ...
    float zone = 0.5 + 0.5 * sin(centerDist * 14.5033 - anim);
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1016), 0.0, 1.5);
