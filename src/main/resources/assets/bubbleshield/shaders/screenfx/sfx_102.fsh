...
// for effect 102. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:pixelate:square:steady:grain]
...
void main() {
    ...
    float grainFrame = mod(floor(anim * 6.7081), 256.0);
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1171);
