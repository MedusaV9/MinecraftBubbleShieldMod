...
void main() {
    ...
    float twinkle = smoothstep(0.7823, 1.0, sin(anim * 2.8932 + tw * 6.2831) * 0.5 + 0.5) * step(0.9782, tw);
    ...
    float oTwinkle = smoothstep(0.8524, 1.0, sin(anim * 1.3795 + oTw * 6.2831) * 0.5 + 0.5) * step(0.9815, oTw);
