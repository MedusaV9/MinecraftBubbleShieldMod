...
// for effect 079. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:edgeglow:sobel:steady:pulseglow]
...
void main() {
    ...
    float oBreath = 0.5 + 0.5 * sin(anim * 0.6255 + ParamsB.x * 6.2831);
    float oRim = smoothstep(0.3647, 1.0, centerDist);
    outColor += Primary.rgb * oRim * oBreath * 0.1495;
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1237);
