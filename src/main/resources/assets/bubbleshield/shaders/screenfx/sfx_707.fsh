...
// for effect 707. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:ripple:pond:steady:none]
...
void main() {
    ...
    float phase = vnoise(texCoord * 5.9579) * 2.0696;
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1463), 0.0, 1.5);
