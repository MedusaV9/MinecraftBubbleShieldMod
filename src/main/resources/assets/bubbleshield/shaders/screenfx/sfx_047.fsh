...
// for effect 047. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:scanlines:rolling:steady:grain]
...
void main() {
    ...
    float scan = 0.5 + 0.5 * sin(texCoord.y * lineCount * 6.2831 - anim * 3.3858);
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1965);
