...
// for effect 402. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:bloomglow:ring:pulse:none]
...
void main() {
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1274);
