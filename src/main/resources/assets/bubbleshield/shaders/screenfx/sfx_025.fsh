...
// for effect 025. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:bloomglow:ring:steady:none]
...
void main() {
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1255);
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.0933), 0.0, 1.5);
