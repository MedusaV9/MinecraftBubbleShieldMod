...
// for effect 046. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:pixelate:square:steady:none]
...
void main() {
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1036), 0.0, 1.5);
