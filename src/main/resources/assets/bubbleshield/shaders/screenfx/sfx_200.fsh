...
// for effect 200. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:posterize:lumaonly:steady:none]
...
void main() {
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1996), 0.0, 1.5);
