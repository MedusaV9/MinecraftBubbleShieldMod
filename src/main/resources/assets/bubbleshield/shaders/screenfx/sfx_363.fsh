...
// for effect 363. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:wobble:swirl:drift:none]
...
void main() {
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1499), 0.0, 1.5);
