...
// for effect 024. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:edgeglow:sobel:surge:none]
...
void main() {
    ...
    float surge = 0.5 + 0.5 * sin(anim * 0.5276 + ParamsB.x * 3.1416);
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1042), 0.0, 1.5);
