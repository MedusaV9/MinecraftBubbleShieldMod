...
// for effect 002. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:edgeglow:sobel:steady:grain]
...
void main() {
    ...
    float grainFrame = mod(floor(anim * 6.9498), 256.0);
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.2174);
