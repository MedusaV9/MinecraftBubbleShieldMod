...
// for effect 020. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:chroma:radial:pulse:none]
...
void main() {
    ...
    float animAmp = 0.8 + 0.2 * sin(anim * 1.0807 + ParamsB.x * 6.2831);
    ...
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1588), 0.0, 1.5);
