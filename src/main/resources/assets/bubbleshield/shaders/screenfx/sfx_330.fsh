...
void main() {
    ...
    vec2 gridN = max(safeInSize / max(ParamsA.y * 1.7600, 1.0), vec2(1.0));
    ...
    float grainFrame = mod(floor(anim * 5.3184), 256.0);
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1656);
