...
void main() {
    ...
    vec2 oCell = floor(texCoord * safeInSize / 14.7375);
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1950);
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1259), 0.0, 1.5);
