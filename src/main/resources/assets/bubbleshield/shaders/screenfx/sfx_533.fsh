...
// for effect 533. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:wobble:diag:surge:none]
...
void main() {
    ...
    vec2 axis = vec2(0.8092, 0.5875);
    float wave = sin(dot(texCoord, axis) * ParamsA.z * 1.3324 + anim);
