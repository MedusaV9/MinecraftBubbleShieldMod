...
// for effect 415. Edit the generator and regenerate instead
// (byte-stable, fixed seed).
// [screen:scanlines:rolling:drift:none]
...
void main() {
    ...
    float anim = animRaw + 1.9686 * sin(animRaw * 0.1427) * ParamsB.y;
    float animAmp = 1.0;
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1573);
