...
void main() {
    ...
    float grainFrame = mod(floor(anim * 5.7123), 256.0);
    ...
    outColor = mix(outColor, curved * curved * (3.0 - 2.0 * curved), 0.1737);
    outColor = clamp(mix(vec3(luma(outColor)), outColor, 1.1903), 0.0, 1.5);
